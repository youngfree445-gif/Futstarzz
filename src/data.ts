...
// ==========================================
  ...
  { id: 'velez', name: 'Vélez Sarsfield', league: 'Argentina', dt: 'Gustavo Quinteros', reputation: 4, initialSalary: 2000, marketValue: 11000000, starPlayers: ['Álvaro Montero (GK)', 'Elías Gómez (LB)', 'Manuel Lanzini (CAM)', 'Emanuel Mammana (CB)', 'Rodrigo Aliendro (CM)', 'Claudio Baeza (CDM)', 'Braian Romero (ST)', 'Diego Valdés (CAM)', 'Joaquín García (RB)', 'Tomás Marchiori (GK)', 'Matías Pellegrini (RM)'], description: 'El Fortín de Liniers.', badgeColor: 'border-l-4 border-blue-600 bg-white text-blue-800', badgeLogoUrl: 'V',
  ...
  { id: 'lanus', name: 'Lanús', league: 'Argentina', dt: 'Ricardo Zielinski', reputation: 4, initialSalary: 1800, marketValue: 9500000, starPlayers: ['Marcelino Moreno (CAM)', 'Nahuel Losada (GK)', 'Ramiro Carrera (LM)', 'Sasha Marcich (LB)', 'Eduardo Salvio (RM)', 'Franco Petroli (GK)', 'Carlos Izquierdoz (CB)', 'Agustín Cardozo (CDM)', 'Walter Bou (ST)', 'Lucas Acosta (GK)', 'José Canale (CB)'], description: 'El Granate.', badgeColor: 'border-l-4 border-white bg-red-900 text-white', badgeLogoUrl: '🇱🇻',
  ...
  { id: 'rosario_central', name: 'Rosario Central', league: 'Argentina', dt: 'Ariel Holan', reputation: 4, initialSalary: 2500, marketValue: 16000000, starPlayers: ['Ángel Di María (RW)', 'Conan Ledesma (GK)', 'Jaminton Campaz (LM)', 'Franco Ibarra (CDM)', 'Carlos Quintana (CB)', 'Facundo Mallo (CB)', 'Agustín Sández (LB)', 'Pol Fernández (CM)', 'Emanuel Coronel (RB)', 'Alejo Veliz (ST)', 'Federico Navarro (CDM)'], description: 'El Canalla.', badgeColor: 'border-l-4 border-yellow-500 bg-blue-900 text-yellow-400', badgeLogoUrl: '🇺🇦',
  ...
  { id: 'central_cordoba', name: 'Central Córdoba', league: 'Argentina', dt: 'Abel Balbo', reputation: 2, initialSalary: 1000, marketValue: 4200000, starPlayers: ['Lucas González (CM)', 'Michael Santos (ST)', 'Alan Aguerre (GK)', 'Facundo Mansilla (CB)', 'Horacio Tijanovich (LM)', 'Alejandro Maciel (CB)', 'Matías Vera (CDM)', 'Ezequiel Naya (ST)', 'Marco Iacobellis (RM)', 'Santiago Moyano (RB)', 'Juan Pablo Pignani (CB)'], description: 'El Ferroviario.', badgeColor: 'border-l-4 border-white bg-black text-white', badgeLogoUrl: '🚂',
  ...
  { id: 'barracas', name: 'Barracas Central', league: 'Argentina', dt: 'Alejandro Orfila', reputation: 2, initialSalary: 1000, marketValue: 4200000, starPlayers: ['Iván Tapia (CAM)', 'Facundo Bruera (ST)', 'Yonatthan Rak (CB)', 'Rodrigo Insua (LB)', 'Gonzalo Maroni (CAM)', 'Juan Espínola (GK)', 'Dardo Miloc (CDM)', 'Gonzalo Morales (ST)', 'Gastón Campi (CB)', 'Damián Martínez (RB)', 'Rodrigo Bogarín (CAM)'], description: 'El Guapo.', badgeColor: 'border-l-4 border-white bg-red-600 text-white', badgeLogoUrl: '🔴⚪',
  ...
  { id: 'all_boys', name: 'All Boys', league: 'Argentina', dt: 'Mauricio Giganti', reputation: 2, initialSalary: 750, marketValue: 2500000, starPlayers: ['Ricardo Blanco (CAM)', 'Iván Zafarana (CB)', 'Maximiliano Coronel (CB)', 'Hernán Grana (RB)', 'Agustin Gallo (CM)', 'Matías Nouet (RW)', 'Franco Quiróz (LB)', 'Emiliano Purita (RB)', 'Alejo Tabares (LM)', 'Tomás Assenato (CM)', 'Juan Pablo Noce (GK)'], description: 'El Albo. Compite en B Nacional.', badgeColor: 'border-l-4 border-black bg-white text-black', badgeLogoUrl: '⚽',
  ...
  { id: 'almirante_brown', name: 'Almirante Brown', league: 'Argentina', dt: 'Andrés Montenegro', reputation: 2, initialSalary: 750, marketValue: 2500000, starPlayers: ['Facundo Quignon (CDM)', 'Gustavo Cabral (CB)', 'Leonardo Jara (RB)', 'Agustín Dattola (CB)', 'Jonatan Goya (CAM)', 'Nazareno Bazán (ST)', 'Máximo Levi (CB)', 'Tomas Villoldo (LB)', 'Hernan Perrone (CM)', 'Tobías Zárate (ST)', 'Ramiro Fernández (LB)'], description: 'La Fragata. Compite en B Nacional.', badgeColor: 'border-l-4 border-yellow-500 bg-black text-yellow-400', badgeLogoUrl: '⚓',
  ...
  { id: 'central_norte', name: 'Central Norte', league: 'Argentina', dt: 'Mario Sciacqua', reputation: 2, initialSalary: 600, marketValue: 1500000, starPlayers: ['Arián Pucheta (CB)', 'Ramiro Costa (ST)', 'Agustin Aleo (LB)', 'Mauricio Rosales (RB)', 'Gonzalo Álvez (RM)', 'Maximiliano Padilla (LB)', 'Matías Villarreal (CDM)', 'Kevin Fernández (CAM)', 'Franco Vedoya (RW)', 'Joaquin Mateo (ST)', 'Leonardo Felissia (CB)'], description: 'El Cuervo salteño. Compite en B Nacional.', badgeColor: 'border-l-4 border-white bg-black text-white', badgeLogoUrl: '🐦',
  ...
  { id: 'san_miguel', name: 'San Miguel', league: 'Argentina', dt: 'Por confirmar', reputation: 2, initialSalary: 600, marketValue: 1500000, starPlayers: ['Leandro Desábato (CDM)', 'Lucas Brochero (RM)', 'Bruno Nasta (ST)', 'Daniel Juárez (ST)', 'Juan Lungarzo (GK)', 'Lucas Delgado (ST)', 'Facundo Omar Cardozo (LB)', 'Alexis Cruz (LB)', 'Lucio Pérez (RB)', 'Dixon Renteria (CB)', 'Máximo Oses (LM)'], description: 'Compite en B Nacional.', badgeColor: 'border-l-4 border-white bg-green-700 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'https://pub-3bd35431294c47068cbf31a95d572166.r2.dev/logos/san-miguel-logo-footylogos.svg', division: 2 },
  { id: 'san_telmo', name: 'San Telmo', league: 'Argentina', dt: 'Marcelo Vázquez', reputation: 2, initialSalary: 600, marketValue: 1500000, starPlayers: ['Facundo Roncaglia (CB)', 'Matías Laba (CDM)', 'Fabián Henríquez (CM)', 'Javier Iritier (LW)', 'Martín Batallini (ST)', 'Franco Tisera (ST)', 'Lucas Baldunciel (RW)', 'Emanuel Díaz (CB)', 'Juan Cruz Zurbriggen (ST)', 'Gabriel Paredes (LB)', 'Elías Brítez (CM)'], description: 'El Candombero. Compite en B Nacional.', badgeColor: 'border-l-4 border-sky-400 bg-blue-800 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'acassuso', name: 'Acassuso', league: 'Argentina', dt: 'Tobías Kohan', reputation: 2, initialSalary: 550, marketValue: 1200000, starPlayers: ['Kevin Dubini (CAM)', 'David Escalante (ST)', 'Mariano Monllor (GK)', 'Ramiro Reynoso (CM)', 'Gabriel Atamañuk (GK)', 'Lucas Rey (RW)', 'Álex Ruiz (LB)', 'Nahuel Petillo (CM)', 'Juan Ponce de León (RB)', 'Lucas Pioli (CB)', 'Joel Gonzalo Ghirardello (CB)'], description: 'Compite en B Nacional.', badgeColor: 'border-l-4 border-white bg-blue-800 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'sao_paulo', name: 'São Paulo', league: 'Brasileña', dt: 'Luis Zubeldía', reputation: 4, initialSalary: 4200, marketValue: 24000000, starPlayers: ['Jonathan Calleri (ST)', 'Rafael Tolói (CB)', 'Lucas Moura (RW)', 'Wendell (LB)', 'Oscar (CAM)', 'Pablo Maia (CDM)', 'Rafael (GK)', 'Enzo Díaz (LB)', 'Luciano (ST)', 'Ferreirinha (LW)', 'André Silva (ST)'], description: 'El Tricolor Paulista.', badgeColor: 'border-l-4 border-red-600 bg-white text-black', badgeLogoUrl: '⚪',
    badgeImageUrl: 'https://pub-3bd35431294c47068cbf31a95d572166.r2.dev/logos/sao-paulo/sao-paulo-logo-footylogos.svg', division: 1 },
  { id: 'atletico_mineiro', name: 'Atlético Mineiro', league: 'Brasileña', dt: 'Gabriel Milito', reputation: 4, initialSalary: 4400, marketValue: 26000000, starPlayers: ['Hulk (ST)', 'Dudu (LW)', 'Everson (GK)', 'Renan Lodi (LB)', 'Júnior Alonso (CB)', 'Bernard (LW)', 'Vitor Hugo (CB)', 'Gustavo Scarpa (CAM)', 'Ángelo Preciado (RB)', 'Maycon (CM)', 'Mateo Cassierra (ST)'], description: 'O Galo.', badgeColor: 'border-l-4 border-white bg-black text-white', badgeLogoUrl: '🐔',
  ...
  { id: 'vitoria', name: 'Vitória', league: 'Brasileña', dt: 'Thiago Carpini', reputation: 3, initialSalary: 2000, marketValue: 10000000, starPlayers: ['Marinho (RW)', 'Gabriel (GK)', 'Emmanuel Martínez (CAM)', 'Osvaldo (RW)', 'Aitor (CAM)', 'Lucas Arcanjo (GK)', 'Fabrício (ST)', 'Camutanga (CB)', 'Gabriel Baralhas (CDM)', 'Matheuzinho (CAM)', 'Luan Cândido (LB)'], description: 'O Leão da Barra.', badgeColor: 'border-l-4 border-black bg-red-600 text-white', badgeLogoUrl: '🦁',
    badgeImageUrl: 'https://pub-3bd35431294c47068cbf31a95d572166.r2.dev/logos/vitoria/vitoria-logo-footylogos.svg', division: 1 },
  { id: 'vasco_da_gama', name: 'Vasco da Gama', league: 'Brasileña', dt: 'Rafael Paiva', reputation: 4, initialSalary: 3500, marketValue: 18000000, starPlayers: ['Jair (CDM)', 'Thiago Mendes (CDM)', 'Tchê Tchê (CM)', 'Lucas Piton (LB)', 'Léo Jardim (GK)', 'Paulo Henrique (RB)', 'Robert Renan (CB)', 'Hugo Moura (CDM)', 'Nuno Moreira (RW)', 'Andrés Gómez (LW)', 'David (LW)'], description: 'Gigante da Colina.', badgeColor: 'border-l-4 border-white bg-black text-white', badgeLogoUrl: '⚓',
  ...
  { id: 'santos', name: 'Santos', league: 'Brasileña', dt: 'Fábio Carille', reputation: 4, initialSalary: 3800, marketValue: 20000000, starPlayers: ['Neymar (CAM)', 'Gabriel (ST)', 'Zé Rafael (CM)', 'Willian Arão (CDM)', 'Lucas Veríssimo (CB)', 'Luan Peres (CB)', 'Rony (ST)', 'Mayke (RB)', 'Adonis Frías (CB)', 'Benjamín Rollheiser (RW)', 'Gabriel Menino (CM)'], description: 'O Peixe.', badgeColor: 'border-l-4 border-black bg-white text-black', badgeLogoUrl: '🐟',
  ...
  { id: 'santos_laguna', name: 'Santos Laguna', league: 'Mexicana', dt: 'Ignacio Ambriz', reputation: 3, initialSalary: 2500, marketValue: 10000000, starPlayers: ['Carlos Acevedo (GK)', 'Ezequiel Bullaude (CAM)', 'Lucas Di Yorio (ST)', 'Kevin Balanta (CB)', 'Carlos Gruezo (CDM)', 'Javier Güemez (CDM)', 'Choco Lozano (ST)', 'Bruno Amione (CB)', 'Cristian Dájome (RM)', 'Fran Villalba (RM)', 'Ramiro Sordo (LW)'], description: 'Los Guerreros.', badgeColor: 'border-l-4 border-white bg-green-700 text-white', badgeLogoUrl: '👼',
  ...
  { id: 'puebla', name: 'Puebla', league: 'Mexicana', dt: 'José Manuel de la Torre', reputation: 3, initialSalary: 2200, marketValue: 8500000, starPlayers: ['Emiliano Gómez (ST)', 'Julio González (GK)', 'Juan Pablo Vargas (CB)', 'Nicolás Díaz (CB)', 'Edgar Guerra (RM)', 'Lucas Cavallini (ST)', 'Ángelo Araos (CAM)', 'Daniel Gutiérrez (GK)', 'Kevin Velasco (LM)', 'Alejandro Organista (CM)', 'Brayan Garnica (RM)'], description: 'La Franja.', badgeColor: 'border-l-4 border-sky-400 bg-white text-slate-900', badgeLogoUrl: '🎽',
    badgeImageUrl: 'https://pub-3bd35431294c47068cbf31a95d572166.r2.dev/logos/puebla/puebla-logo-footylogos.svg', division: 1 },
  { id: 'queretaro', name: 'Querétaro', league: 'Mexicana', dt: 'Mauro Gerk', reputation: 3, initialSalary: 2000, marketValue: 7500000, starPlayers: ['Santiago Homenchenko (CDM)', 'Jhojan Julio (LM)', 'Lucas Abascia (CB)', 'Francisco Venegas (LB)', 'Mateo Coronel (ST)', 'Diego Reyes (CB)', 'Pablo Barrera (RM)', 'Guillermo Allison (GK)', 'Lucas Rodríguez (LM)', 'Alí Ávila (ST)', 'Jaime Gómez (RB)'], description: 'Los Gallos Blancos.', badgeColor: 'border-l-4 border-black bg-blue-800 text-white', badgeLogoUrl: '🐓',
  ...
  { id: 'atlético_fc', name: 'Atlético FC', league: 'Ecuatoriana', dt: 'DT Genérico', reputation: 1, initialSalary: 700, marketValue: 2000000, starPlayers: ['Fidel Martínez (RM)', 'Fabián Villa (CB)', 'Jhonier Alomía (CB)', 'Danny Reales (CB)', 'Wílmer Godoy (CM)', 'Joseph Espinoza (CM)', 'David Agudelo (GK)', 'José Palacios (CB)', 'Gabriel Erazo (ST)', 'Miguel Suárez (GK)', 'Juan Jaramillo (GK)'], description: 'Liga Pro Serie B.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 2 },
  ...
  { id: 'vfb_stuttgart', name: 'VfB Stuttgart', league: 'Alemana', dt: 'Sebastian Hoeneß', reputation: 4, initialSalary: 2000, marketValue: 10000000, starPlayers: ['Maximilian Mittelstädt (LB)', 'Angelo Stiller (CDM)', 'Deniz Undav (ST)', 'Alexander Nübel (GK)', 'Julian Chabot (CB)', 'Ermedin Demirović (ST)', 'Jamie Leweling (RM)', 'Bilal El Khannouss (CAM)', 'Atakan Karazor (CDM)', 'Chris Führich (LM)', 'Tiago Tomás (LM)'], description: 'VfB Stuttgart. Compite en Bundesliga.', badgeColor: 'border-l-4 border-red-600 bg-slate-900/40 text-red-200', badgeLogoUrl: '🔴⚪',
  ...
  { id: 'aston_villa', name: 'Aston Villa', league: 'Inglesa', dt: 'DT Genérico', reputation: 4, initialSalary: 2000, marketValue: 10000000, starPlayers: ['Emiliano Martínez (GK)', 'Youri Tielemans (CM)', 'Ezri Konsa (CB)', 'Morgan Rogers (CAM)', 'Boubacar Kamara (CDM)', 'Ollie Watkins (ST)', 'Matty Cash (RB)', 'Amadou Onana (CDM)', 'John McGinn (RM)', 'Pau Torres (CB)', 'Lucas Digne (LB)'], description: 'Aston Villa. Compite en Premier League.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'brighton_hove_albion', name: 'Brighton & Hove Albion', league: 'Inglesa', dt: 'DT Genérico', reputation: 4, initialSalary: 2000, marketValue: 10000000, starPlayers: ['Kaoru Mitoma (LM)', 'Bart Verbruggen (GK)', 'Jan Paul van Hecke (CB)', 'Carlos Baleba (CDM)', 'Yankuba Minteh (RM)', 'Ferdi Kadıoğlu (LB)', 'Danny Welbeck (ST)', 'Yasin Ayari (CDM)', 'Maxim De Cuyper (LB)', 'Mats Wieffer (CDM)', 'Pascal Groß (CDM)'], description: 'Brighton & Hove Albion. Compite en Premier League.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'nottingham_forest', name: 'Nottingham Forest', league: 'Inglesa', dt: 'DT Genérico', reputation: 3, initialSalary: 1500, marketValue: 6000000, starPlayers: ['Matz Sels (GK)', 'Murillo (CB)', 'Elliot Anderson (CDM)', 'Nikola Milenković (CB)', 'Morgan Gibbs-White (CAM)', 'Chris Wood (ST)', 'Ola Aina (RB)', 'Neco Williams (LB)', 'Stefan Ortega (GK)', 'Ibrahim Sangaré (CDM)', 'Callum Hudson-Odoi (LM)'], description: 'Nottingham Forest. Compite en Premier League.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'sunderland', name: 'Sunderland', league: 'Inglesa', dt: 'DT Genérico', reputation: 2, initialSalary: 1000, marketValue: 3000000, starPlayers: ['Granit Xhaka (CDM)', 'Nordi Mukiele (CB)', 'Omar Alderete (CB)', 'Reinildo (LB)', 'Robin Roefs (GK)', 'Daniel Ballard (CB)', 'Trai Hume (RB)', 'Enzo Le Fée (CM)', 'Lutsharel Geertruida (CB)', 'Habib Diarra (CM)', 'Noah Sadiki (CM)'], description: 'Sunderland. Compite en Premier League.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'bologna', name: 'Bologna', league: 'Italiana', dt: 'DT Genérico', reputation: 4, initialSalary: 2000, marketValue: 10000000, starPlayers: ['Riccardo Orsolini (RM)', 'Remo Freuler (CDM)', 'Łukasz Skorupski (GK)', 'Lewis Ferguson (CDM)', 'João Mário (RB)', 'Jens Odgaard (CAM)', 'Santiago Castro (ST)', 'Jhon Lucumí (CB)', 'Juan Miranda (LB)', 'Nicolò Cambiaghi (LM)', 'Nikola Moro (CDM)'], description: 'Bologna. Compite en Serie A Enilive.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'https://pub-3bd35431294c47068cbf31a95d572166.r2.dev/logos/bologna/bologna-logo-footylogos.svg', division: 1 },
  { id: 'cagliari', name: 'Cagliari', league: 'Italiana', dt: 'DT Genérico', reputation: 4, initialSalary: 2000, marketValue: 10000000, starPlayers: ['Elia Caprile (GK)', 'Yerry Mina (CB)', 'Sebastiano Esposito (ST)', 'Michael Folorunsho (CM)', 'Andrea Belotti (ST)', 'Marco Palestra (RB)', 'Semih Kılıçsoy (ST)', 'Zé Pedro (CB)', 'Alberto Dossena (CB)', 'Gianluca Gaetano (CAM)', 'Michel Ndary Adopo (CM)'], description: 'Cagliari. Compite en Serie A Enilive.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'https://pub-3bd35431294c47068cbf31a95d572166.r2.dev/logos/cagliari/cagliari-logo-footylogos.svg', division: 1 },
  { id: 'como', name: 'Como', league: 'Italiana', dt: 'DT Genérico', reputation: 4, initialSalary: 2000, marketValue: 10000000, starPlayers: ['Nico Paz (CAM)', 'Morata (ST)', 'Diego Carlos (CB)', 'Martin Baturina (CAM)', 'Maxence Caqueret (CM)', 'Jean Butez (GK)', 'Nicolas Kühn (RW)', 'Mërgim Vojvoda (RB)', 'Jesús Rodríguez (LM)', 'Sergi Roberto (CDM)', 'Assane Diao (LM)'], description: 'Como. Compite en Serie A Enilive.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'fiorentina', name: 'Fiorentina', league: 'Italiana', dt: 'DT Genérico', reputation: 4, initialSalary: 2000, marketValue: 10000000, starPlayers: ['De Gea (GK)', 'Moise Kean (ST)', 'Robin Gosens (LB)', 'Dodô (RB)', 'Albert Guðmundsson (ST)', 'Manor Solomon (LM)', 'Nicolò Fagioli (CM)', 'Rolando Mandragora (CM)', 'Luca Ranieri (CB)', 'Roberto Piccoli (ST)', 'Fabiano Parisi (LB)'], description: 'Fiorentina. Compite en Serie A Enilive.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'genoa', name: 'Genoa', league: 'Italiana', dt: 'DT Genérico', reputation: 4, initialSalary: 2000, marketValue: 10000000, starPlayers: ['Morten Frendrup (CDM)', 'Justin Bijlow (GK)', 'Leo Østigård (CB)', 'Johan Vásquez (CB)', 'Ruslan Malinovskyi (CM)', 'Vitinha (ST)', 'Brooke Norton-Cuffy (RB)', 'Aarón Martín (LB)', 'Tommaso Baldanzi (CAM)', 'Maxwel Cornet (LM)', 'Nicola Leali (GK)'], description: 'Genoa. Compite en Serie A Enilive.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'juventus', name: 'Juventus', league: 'Italiana', dt: 'DT Genérico', reputation: 4, initialSalary: 2000, marketValue: 10000000, starPlayers: ['Bremer (CB)', 'Manuel Locatelli (CDM)', 'Loïs Openda (ST)', 'Khéphren Thuram (CM)', 'Kenan Yıldız (CAM)', 'Jonathan David (ST)', 'Michele Di Gregorio (GK)', 'Dušan Vlahović (ST)', 'Pierre Kalulu (CB)', 'Andrea Cambiaso (LB)', 'Teun Koopmeiners (CAM)'], description: 'Juventus. Compite en Serie A Enilive.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'napoli', name: 'Napoli', league: 'Italiana', dt: 'DT Genérico', reputation: 4, initialSalary: 2000, marketValue: 10000000, starPlayers: ['Kevin De Bruyne (CM)', 'Scott McTominay (CM)', 'Amir Rrahmani (CB)', 'Stanislav Lobotka (CM)', 'André-Franck Zambo Anguissa (CM)', 'Giovanni Di Lorenzo (RB)', 'Romelu Lukaku (ST)', 'Alessandro Buongiorno (CB)', 'Alex Meret (GK)', 'Matteo Politano (RW)', 'David Neres (LW)'], description: 'Napoli. Compite en Serie A Enilive.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'https://pub-3bd35431294c47068cbf31a95d572166.r2.dev/logos/napoli/napoli-logo-footylogos.svg', division: 1 },
  { id: 'parma', name: 'Parma', league: 'Italiana', dt: 'DT Genérico', reputation: 4, initialSalary: 2000, marketValue: 10000000, starPlayers: ['Gabriel Strefezza (RM)', 'Zion Suzuki (GK)', 'Enrico Delprato (CB)', 'Emanuele Valeri (LB)', 'Hans Nicolussi Caviglia (CDM)', 'Adrián Bernabé (CM)', 'Abdoulaye Ndiaye (CB)', 'Mandela Keita (CDM)', 'Jacob Ondrejka (LW)', 'Gaetano Oristanio (CAM)', 'Matija Frigan (ST)'], description: 'Parma. Compite en Serie A Enilive.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'https://pub-3bd35431294c47068cbf31a95d572166.r2.dev/logos/parma/parma-logo-footylogos.svg', division: 1 },
  { id: 'roma', name: 'Roma', league: 'Italiana', dt: 'DT Genérico', reputation: 4, initialSalary: 2000, marketValue: 10000000, starPlayers: ['Paulo Dybala (CAM)', 'Mile Svilar (GK)', 'Gianluca Mancini (CB)', 'Evan Ndicka (CB)', 'Bryan Cristante (CM)', 'Artem Dovbyk (ST)', 'Kouadio Manu Koné (CM)', 'Lorenzo Pellegrini (CAM)', 'Mario Hermoso (CB)', 'Matías Soulé (CAM)', 'Donyell Malen (ST)'], description: 'Roma. Compite en Serie A Enilive.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'https://pub-3bd35431294c47068cbf31a95d572166.r2.dev/logos/roma/roma-logo-footylogos.svg', division: 1 },
  { id: 'torino', name: 'Torino', league: 'Italiana', dt: 'DT Genérico', reputation: 4, initialSalary: 2000, marketValue: 10000000, starPlayers: ['Duván Zapata (ST)', 'Nikola Vlašić (CAM)', 'Ché Adams (ST)', 'Cristiano Biraghi (LB)', 'Valentino Lazaro (RM)', 'Saúl Coco (CB)', 'Giovanni Simeone (ST)', 'Guillermo Maripán (CB)', 'Cesare Casadei (CM)', 'Franco Israel (GK)', 'Ivan Ilić (CDM)'], description: 'Torino. Compite en Serie A Enilive.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'https://pub-3bd35431294c47068cbf31a95d572166.r2.dev/logos/torino/torino-logo-footylogos.svg', division: 1 },
  { id: 'udinese', name: 'Udinese', league: 'Italiana', dt: 'DT Genérico', reputation: 4, initialSalary: 2000, marketValue: 10000000, starPlayers: ['Oumar Solet (CB)', 'Jesper Karlström (CDM)', 'Nicolò Zaniolo (ST)', 'Maduka Okoye (GK)', 'Arthur Atta (CM)', 'Jurgen Ekkelenkamp (CM)', 'Keinan Davis (ST)', 'Thomas Kristensen (CB)', 'Christian Kabasele (CB)', 'Alessandro Zanoli (RB)', 'Adam Buksa (ST)'], description: 'Udinese. Compite en Serie A Enilive.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'https://pub-3bd35431294c47068cbf31a95d572166.r2.dev/logos/udinese/udinese-logo-footylogos.svg', division: 1 },
  { id: 'venezia', name: 'Venezia', league: 'Italiana', dt: 'DT Genérico', reputation: 4, initialSalary: 2000, marketValue: 10000000, starPlayers: ['Filip Stanković (GK)', 'Gianluca Busio (CM)', 'Kike Pérez (CM)', 'Andrea Adorante (ST)', 'Alfred Duncan (CM)', 'Lion Lauberbach (ST)', 'Michael Svoboda (CB)', 'John Yeboah (ST)', 'Issa Doumbia (CM)', 'Casas (ST)', 'Joël Marcel Schingtienne (CB)'], description: 'Venezia. Compite en Serie A Enilive.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
 ...
 // ==========================================
  ...
  { id: 'olympique_de_marseille', name: 'Olympique de Marseille', league: 'Francesa', dt: 'Bruno Génésio', reputation: 4, initialSalary: 2000, marketValue: 10000000, starPlayers: ['Mason Greenwood (RM)', 'Gerónimo Rulli (GK)', 'Benjamin Pavard (CB)', 'Pierre-Emile Højbjerg (CDM)', 'Pierre-Emerick Aubameyang (ST)', 'Nayef Aguerd (CB)', 'Leonardo Balerdi (CB)', 'Igor Paixão (LM)', 'Quinten Timber (CM)', 'Facundo Medina (CB)', 'Amine Gouiri (ST)'], description: 'Olympique de Marseille. Compite en Ligue 1 McDonalds.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  // --- ESPAÑA (PRIMERA) ---
  // ==========================================
  { id: 'athletic_club_esp', name: 'Athletic Club', league: 'Española', dt: 'DT Genérico', reputation: 4, initialSalary: 2000, marketValue: 10000000, starPlayers: ['Fabrício Isidoro (CM)', 'Ronaldo Tavares (ST)', 'Polli (GK)', 'Philipe Sampaio (CB)', 'Zeca (RB)', 'Gustavinho (CAM)', 'Glauco (GK)', 'Léo Chú (LM)', 'Dixon Vera (LW)', 'Sidimar (CB)', 'Gian Franco Cabezas (CM)'], description: 'Compite en LALIGA EA SPORTS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'atletico_de_madrid', name: 'Atlético de Madrid', league: 'Española', dt: 'DT Genérico', reputation: 4, initialSalary: 2000, marketValue: 10000000, starPlayers: ['Jan Oblak (GK)', 'Julián Alvarez (ST)', 'Marcos Llorente (RB)', 'Antoine Griezmann (ST)', 'Dávid Hancko (LB)', 'Pablo Barrios (CM)', 'Álex Baena (LM)', 'Alexander Sørloth (ST)', 'Ademola Lookman (ST)', 'José María Giménez (CB)', 'Giuliano (RM)'], description: 'Compite en LALIGA EA SPORTS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'ca_osasuna', name: 'CA Osasuna', league: 'Española', dt: 'DT Genérico', reputation: 4, initialSalary: 2000, marketValue: 10000000, starPlayers: ['Ante Budimir (ST)', 'Sergio Herrera (GK)', 'Flavien-Enzo Boyomo (CB)', 'Catena (CB)', 'Moncayola (CM)', 'Lucas Torró (CDM)', 'Rubén García (RM)', 'Víctor Muñoz (LW)', 'Valentin Rosier (RB)', 'Javi Galán (LB)', 'Aimar Oroz (CAM)'], description: 'Compite en LALIGA EA SPORTS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'fc_barcelona', name: 'FC Barcelona', league: 'Española', dt: 'DT Genérico', reputation: 4, initialSalary: 2000, marketValue: 10000000, starPlayers: ['Pedri (CM)', 'Lamine Yamal (RW)', 'Raphinha (LW)', 'Frenkie de Jong (CM)', 'Joan García (GK)', 'Jules Koundé (RB)', 'Robert Lewandowski (ST)', 'João Cancelo (RB)', 'Ferran Torres (ST)', 'Dani Olmo (CAM)', 'Eric García (CB)'], description: 'Compite en LALIGA EA SPORTS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'girona_fc', name: 'Girona FC', league: 'Española', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Marc-André ter Stegen (GK)', 'Paulo Gazzaniga (GK)', 'Arnau Martínez (RB)', 'Viktor Tsygankov (RM)', 'Azzedine Ounahi (CM)', 'Álex Moreno (LB)', 'Fran Beltrán (CM)', 'Bryan Gil (LW)', 'Vladyslav Vanat (ST)', 'Thomas Lemar (CM)', 'Iván Martín (CM)'], description: 'Descendió a LALIGA HYPERMOTION para la temporada 2026-27.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'rcd_espanyol', name: 'RCD Espanyol', league: 'Española', dt: 'DT Genérico', reputation: 4, initialSalary: 2000, marketValue: 10000000, starPlayers: ['Marko Dmitrović (GK)', 'Carlos Romero (LB)', 'Edu Expósito (CAM)', 'Leandro Cabrera (CB)', 'Puado (LM)', 'Omar El Hilali (RB)', 'Pol Lozano (CDM)', 'Pere Milla (LM)', 'Calero (CB)', 'Urko González (CDM)', 'Tyrhys Dolan (RW)'], description: 'Compite en LALIGA EA SPORTS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'rayo_vallecano', name: 'Rayo Vallecano', league: 'Española', dt: 'DT Genérico', reputation: 4, initialSalary: 2000, marketValue: 10000000, starPlayers: ['Álvaro García (LM)', 'Isi (CAM)', 'De Frutos (RM)', 'Augusto Batalla (GK)', 'Andrei Rațiu (RB)', 'Florian Lejeune (CB)', 'Pep Chavarría (LB)', 'Pathé Ciss (CDM)', 'Óscar Valentín (CDM)', 'Abdul Mumin (CB)', 'Unai López (CM)'], description: 'Compite en LALIGA EA SPORTS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'real_madrid', name: 'Real Madrid', league: 'Española', dt: 'DT Genérico', reputation: 4, initialSalary: 2000, marketValue: 10000000, starPlayers: ['Kylian Mbappé (ST)', 'Thibaut Courtois (GK)', 'Jude Bellingham (CAM)', 'Vini Jr. (LW)', 'Federico Valverde (CM)', 'Trent Alexander-Arnold (RB)', 'Antonio Rüdiger (CB)', 'Aurélien Tchouaméni (CDM)', 'Carvajal (RB)', 'Éder Militão (CB)', 'Rodrygo (LM)'], description: 'Compite en LALIGA EA SPORTS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'real_sociedad', name: 'Real Sociedad', league: 'Española', dt: 'DT Genérico', reputation: 4, initialSalary: 2000, marketValue: 10000000, starPlayers: ['Álex Remiro (GK)', 'Oyarzabal (ST)', 'Takefusa Kubo (RM)', 'Yangel Herrera (CM)', 'Sergio Gómez (LM)', 'Brais Méndez (CM)', 'Barrenetxea (LW)', 'Jon Mikel Aramburu (RB)', 'Carlos Soler (CM)', 'Zubeldia (CB)', 'Gorrotxa (CDM)'], description: 'Compite en LALIGA EA SPORTS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'burgos_cf', name: 'Burgos CF', league: 'Española', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Atienza (CDM)', 'Iñigo Córdoba (LM)', 'Jesús Ruiz (GK)', 'Cantero (GK)', 'Florian Miguel (LB)', 'Curro Sánchez (CAM)', 'Fer Niño (ST)', 'Sergio González (CB)', 'Mario González (ST)', 'Kévin Appin (CM)', 'Oier Luengo (CB)'], description: 'Compite en LALIGA HYPERMOTION.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'https://pub-3bd35431294c47068cbf31a95d572166.r2.dev/logos/burgos-cf/burgos-cf-logo-footylogos.svg', division: 2 },
  { id: 'cd_castellon', name: 'CD Castellón', league: 'Española', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Cala (CAM)', 'Jérémy Mellot (RB)', 'Brian Cipenga (LM)', 'Raúl Sánchez (LM)', 'Romain Matthys (GK)', 'Alberto Jiménez (CB)', 'Fabrizio Brignani (CB)', 'Ousmane Camara (ST)', 'Isra Suero (ST)', 'Amir Abedzadeh (GK)', 'Awer Mabil (RM)'], description: 'Compite en LALIGA HYPERMOTION.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'cd_leganes', name: 'CD Leganés', league: 'Española', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Juan Soriano (GK)', 'Dani Rodríguez (LM)', 'Amadou Diawara (CDM)', 'Lalo Aguilar (CB)', 'Juan Cruz (RW)', 'Rubén Peña (RB)', 'Franquesa (LB)', 'Seydouba Cisse (CM)', 'Duk (LW)', 'Jorge Sáenz (CB)', 'Melero (CM)'], description: 'Compite en LALIGA HYPERMOTION.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'cadiz_cf', name: 'Cádiz CF', league: 'Española', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Suso (RM)', 'Ontiveros (LM)', 'Rominigue Kouamé (CM)', 'Iza Carcelén (RB)', 'Álex Fernández (CM)', 'Brian Ocampo (LM)', 'David Gil (GK)', 'Iuri Tabatadze (RM)', 'Sergio Ortuño (CM)', 'Antoñito Cordero (LM)', 'Víctor Aznar (GK)'], description: 'Compite en LALIGA HYPERMOTION.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'https://pub-3bd35431294c47068cbf31a95d572166.r2.dev/logos/cadiz-cf/cadiz-cf-logo-footylogos.svg', division: 2 },
  { id: 'cordoba_cf', name: 'Córdoba CF', league: 'Española', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Carracedo (RW)', 'Adri Fuentes (ST)', 'Isma Ruiz (CDM)', 'Jacobo González (LW)', 'Albarrán (RB)', 'Xavi Sintes (CB)', 'Iker Álvarez (GK)', 'Mikel Goti (CAM)', 'Carlos Marín (GK)', 'Franck Fomeyem (CB)', 'Vilarrasa (LB)'], description: 'Compite en LALIGA HYPERMOTION.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'https://pub-3bd35431294c47068cbf31a95d572166.r2.dev/logos/cordoba/cordoba-logo-footylogos.svg', division: 2 },
  { id: 'fc_andorra', name: 'FC Andorra', league: 'Española', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Edgar (CB)', 'Áron Yaakobishvili (GK)', 'Imanol (LB)', 'Kim Min Su (LW)', 'Nicolás Ratti (GK)', 'Lautaro (ST)', 'Manu Nieto (ST)', 'Olabarrieta (RW)', 'Jastin (LM)', 'Marc Cardona (ST)', 'Thomas Carrique (RB)'], description: 'Compite en LALIGA HYPERMOTION.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'granada_cf', name: 'Granada CF', league: 'Española', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Rubén Alcaraz (CM)', 'Álex Sola (RW)', 'José Arnáiz (CAM)', 'Manu Lama (CB)', 'Loïc Williams (CB)', 'Baïla Diallo (LB)', 'Alemañ (CM)', 'Sergio Ruiz (CDM)', 'Jorge Pascual (ST)', 'Gonzalo Petit (ST)', 'Izan González (CM)'], description: 'Compite en LALIGA HYPERMOTION.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'sd_eibar', name: 'SD Eibar', league: 'Española', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Juan Bernat (LB)', 'Nolaskoain (CDM)', 'Magunagoitia (GK)', 'Marco Moreno (CB)', 'Corpas (RM)', 'Sergio Álvarez (CDM)', 'Cubero (RB)', 'Arbilla (CB)', 'Jon Bautista (ST)', 'Javi Martón (ST)', 'Aleix Garrido (CM)'], description: 'Compite en LALIGA HYPERMOTION.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'ud_almeria', name: 'UD Almería', league: 'Española', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Arribas (CAM)', 'Embarba (LW)', 'Rodrigo Ely (CB)', 'Andrés Fernández (GK)', 'Álex Muñoz (LB)', 'Dion Lopy (CDM)', 'Morci (LW)', 'Daijiro Chirino (RB)', 'Federico Bonini (CB)', 'Puigmal (RM)', 'Nélson Monte (CB)'], description: 'Compite en LALIGA HYPERMOTION.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'ud_las_palmas', name: 'UD Las Palmas', league: 'Española', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Sandro (RM)', 'Kirian (CM)', 'Dinko Horkaš (GK)', 'Mika Mármol (CB)', 'Manu Fuster (LM)', 'Enzo Loiodice (CM)', 'Sergio Barcia (CB)', 'Taisei Miyashiro (LW)', 'Álex Suárez (CB)', 'Viti Rozada (RB)', 'Nicolás Benedetti (CAM)'], description: 'Compite en LALIGA HYPERMOTION.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
