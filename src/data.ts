...
export const CLUBS_DATABASE: Club[] = [[
  ...
  },
  {
    ...
    "starPlayers": [
      "Dayro Moreno (ST)",
      "James Aguirre (GK)",
      "Andrés Felipe Roa (CAM)",
      "Michael Barrios (RM)",
      "Robert Mejía (CDM)",
      "Iván Rojas (CDM)",
      "Juan David Cuesta (RB)",
      "Jaime Alvarado (CDM)",
      "Jorge Cardona (CB)",
      "Jeider Riquett (CB)",
      "Déinner Quiñones (RM)"
  ...
  },
  {
    ...
    "starPlayers": [
      ...
      "Yesús Cabrera (CAM)",
      "Darío Denis (GK)",
      "Juan Carlos Díaz (CDM)",
      "Jairo Molina (ST)",
      "Arlen Banguero (CB)",
      "Yaliston Martínez (LB)",
      "Sebastián Palma (CB)",
      "Sebastián Salazar (CM)",
      "Andrés Aedo (CDM)",
      "Rogerio Caicedo (GK)"
    ],
  ...
  },
  {
    ...
    "starPlayers": [
      "Frank Castañeda (RM)",
      "Sebastián Rodríguez (CB)",
      "Luis Payares (CB)",
      "Omar Albornoz (LM)",
      "Víctor Mejía (CM)",
      "Mauricio Duarte (LB)",
      "Juan Diego Ceballos (CM)",
      "Luifer Hernández (ST)",
      "Luis Hinestroza (CDM)",
      "Joao Abonia (RW)",
      "Jhon Quiñones (CB)"
  ...
  },
  {
    ...
    "starPlayers": [
      "Jarlan Barrera (CAM)",
      "Mauro Manotas (ST)",
      "Cristian Graciano (RB)",
      "Fredy Montero (ST)",
      "Didier Pino (CDM)",
      "Luis Yanes (LW)",
      "Ronaldo Lora (CB)",
      "Aldo Montes (GK)",
      "Juan Sebastian Herrera (RB)",
      "Andrés Escobar (LW)",
      "Luis Guevara (CM)"
    ],
  ...
  },
  {
    ...
    "starPlayers": [
      ...
      "Misael Martínez (ST)",
      "Víctor Cabezas (GK)",
      "Juan Jose Vásquez (LB)",
      "Jhon Lerma (RB)",
      "Jimmy Congo (CDM)",
      "Cristian Iguarán (ST)",
      "Joaquín Mattalía (GK)",
      "Juan Diego Giraldo (CM)",
      "David Murillo (RB)",
      "José Palacios (RM)"
    ],
  ...
  },
  {
    ...
    "starPlayers": [
      ...
      "Juan Ararat (RW)",
      "Juan David Rueda (ST)",
      "Juan Pablo García Habib (RB)",
      "Santiago José Jiménez (CM)",
      "Rafael Tapia (ST)",
      "Harlem Salas (LW)",
      "Kevin Chacón (GK)",
      "Jordi Hernández (CB)",
      "Wilmer Bustamante (CM)"
    ],
  ...
  },
  {
    ...
    "marketValue": 1400000,
    "starPlayers": [
      "Cristián Mosquera (RB)",
      "Brayan Castro (RW)",
      "Diego Castillo (ST)",
      "Juan Martínez (LW)",
      "Andrés Buelvas (ST)",
      "Kevin Castro (CDM)",
      "Harold Sandoval Lasso (ST)",
      "Juan Camilo Moreno (LB)",
      "Santiago Ruiz (CB)",
      "Ronaldo Tavera (CDM)",
      "Mauricio Medina (RB)"
    ],
  ...
  },
  {
    ...
    "badgeColor": "border-l-4 border-red-800 bg-blue-950 text-white",
    "badgeLogoUrl": "🌪️",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/1775.png",
    "division": 1
  },
  {
    "id": "river",
    ...
    "starPlayers": [
      ...
      "Gonzalo Montiel (RB)",
      "Marcos Acuña (LB)",
      "Juan Fernando Quintero (CAM)",
      "Franco Armani (GK)",
      "Lucas Martínez Quarta (CB)",
      "Sebastián Driussi (ST)",
      "Lautaro Rivero (CB)",
      "Fausto Vera (CM)",
      "Maximiliano Salas (ST)",
      "Facundo Colidio (ST)"
    ],
    "description": "El Millonario.",
    "badgeColor": "border-l-4 border-red-500 bg-white text-slate-900",
    "badgeLogoUrl": "🐓",
  ...
  },
  {
    ...
    "starPlayers": [
      "Leandro Paredes (CM)",
      "Santiago Ascacíbar (CDM)",
      "Exequiel Zeballos (LW)",
      "Miguel Ángel Merentiel (ST)",
      "Ayrton Costa (CB)",
      "Ander Herrera (CM)",
      "Rodrigo Battaglia (CDM)",
      "Agustín Marchesín (GK)",
      "Lautaro Blanco (LB)",
      "Carlos Palacios (CAM)",
      "Lautaro Di Lollo (CB)"
    ],
    "description": "El Xeneize.",
    "badgeColor": "border-l-4 border-amber-500 bg-blue-900 text-amber-400",
    "badgeLogoUrl": "🏆",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/189.png",
    "division": 1
  },
  {
    "id": "estudiantes_lp",
    ...
    "description": "El Pincha.",
    "badgeColor": "border-l-4 border-red-600 bg-slate-900 text-white",
    "badgeLogoUrl": "🦁",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/288.png",
    "division": 1
  },
  {
    "id": "gimnasia_lp",
    ...
    "description": "El Lobo platense.",
    "badgeColor": "border-l-4 border-blue-800 bg-white text-blue-900",
    "badgeLogoUrl": "🐺",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/10885.png",
    "division": 1
  },
  {
    "id": "racing",
    ...
    "badgeColor": "border-l-4 border-sky-400 bg-sky-950 text-white",
    "badgeLogoUrl": "🎓",
    "badgeImageUrl": "https://upload.wikimedia.org/wikipedia/commons/thumb/5/56/Escudo_de_Racing_Club_%282014%29.svg/250px-Escudo_de_Racing_Club_%282014%29.svg.png",
    "division": 1
  },
  {
    "id": "velez",
    ...
    "starPlayers": [
      ...
      "Joaquín García (RB)",
      "Tomás Marchiori (GK)",
      "Matías Pellegrini (RM)"
    ],
    "description": "El Fortín de Liniers.",
    "badgeColor": "border-l-4 border-blue-600 bg-white text-blue-800",
    "badgeLogoUrl": "V",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/1029.png",
    "division": 1
  },
  {
    "id": "independiente",
    ...
    "badgeColor": "border-l-4 border-white bg-red-600 text-white",
    "badgeLogoUrl": "😈",
  ...
  },
  {
    ...
    "description": "El Granate.",
    "badgeColor": "border-l-4 border-white bg-red-900 text-white",
    "badgeLogoUrl": "🇱🇻",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/333.png",
    "division": 1
  },
  {
    "id": "newells",
    ...
    "description": "La Lepra.",
    "badgeColor": "border-l-4 border-red-600 bg-black text-white",
    "badgeLogoUrl": "🔴⚫",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/1286.png",
    "division": 1
  },
  {
    "id": "banfield",
    ...
    "marketValue": 7000000,
    "starPlayers": [
      "Facundo Sanguinetti (GK)",
      "Sergio Vittor (CB)",
      "Santiago López García (RB)",
      "Danilo Arboleda (CB)",
      "Mauro Méndez (ST)",
      "Bruno Sepúlveda (ST)",
      "Nicolas Meriano (CB)",
    ...
    "description": "El Taladro.",
    "badgeColor": "border-l-4 border-green-600 bg-white text-green-800",
    "badgeLogoUrl": " drill ",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/830.png",
    "division": 1
  },
  {
    "id": "rosario_central",
    ...
    "starPlayers": [
      ...
      "Emanuel Coronel (RB)",
      "Alejo Veliz (ST)",
      "Federico Navarro (CDM)"
    ],
    "description": "El Canalla.",
    "badgeColor": "border-l-4 border-yellow-500 bg-blue-900 text-yellow-400",
    "badgeLogoUrl": "🇺🇦",
  ...
  },
  {
    ...
    "badgeColor": "border-l-4 border-yellow-500 bg-red-600 text-yellow-200",
    "badgeLogoUrl": "🔴🟡",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/1829.png",
    "division": 1
  },
  {
    "id": "argentinos_jrs",
    ...
    "description": "El Bicho de La Paternal.",
    "badgeColor": "border-l-4 border-white bg-red-600 text-white",
    "badgeLogoUrl": "🐞",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/1030.png",
    "division": 1
  },
  {
    "id": "belgrano",
    ...
    "description": "El Pirata.",
    "badgeColor": "border-l-4 border-black bg-sky-400 text-white",
    "badgeLogoUrl": "🏴‍☠️",
  ...
  },
  {
    ...
    "starPlayers": [
      "Leandro Díaz (ST)",
      "Martín Benítez (CAM)",
      "Leonel Di Plácido (RB)",
      "Gastón Suso (CB)",
      "Ramiro Ruiz Rodríguez (RM)",
      "Gianluca Ferrari (CB)",
      "Renzo Tesuri (RM)",
      "Kevin Ortiz (CM)",
      "Maximiliano Villa (RB)",
      "Luis Ingolotti (GK)",
      "Javier Domínguez (CM)"
    ],
    "description": "El Decano.",
    "badgeColor": "border-l-4 border-white bg-sky-300 text-slate-900",
    "badgeLogoUrl": "🩵⚪",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/14554.png",
    "division": 1
  },
  {
    ...
    "description": "El Halcón de Varela.",
    "badgeColor": "border-l-4 border-yellow-500 bg-green-700 text-yellow-300",
    "badgeLogoUrl": "🦅",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/2402.png",
    "division": 1
  },
  {
    "id": "huracan",
    ...
    "starPlayers": [
      ...
      "Sebastián Meza (GK)",
      "Federico Vera (RB)",
      "Alejandro Martínez (LW)",
      "Lucas Blondel (RB)"
    ],
    "description": "El Globo.",
    "badgeColor": "border-l-4 border-red-600 bg-white text-slate-900",
    "badgeLogoUrl": "🎈",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/2063.png",
    "division": 1
  },
  {
    "id": "tigre",
    ...
    "marketValue": 6200000,
    "starPlayers": [
      "Gonzalo Martínez (CAM)",
      "Jalil Elías (CDM)",
      "Joaquín Laso (CB)",
      "Bruno Leyes (CDM)",
      "Jabes Saralegui (RM)",
      "Joaquín Mosqueira (CDM)",
      "Felipe Zenobio (GK)",
      "David Romero (ST)",
      "Nahuel Banegas (LB)",
      "Elías Cabrera (LM)",
    ...
    "description": "El Matador de Victoria.",
    "badgeColor": "border-l-4 border-red-600 bg-blue-800 text-white",
    "badgeLogoUrl": "🐯",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/11831.png",
    "division": 1
  },
  {
    "id": "union_sf",
  ...
  },
  {
    ...
    "description": "La T cordobesa.",
    "badgeColor": "border-l-4 border-blue-900 bg-white text-blue-900",
    "badgeLogoUrl": "T",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/39252.png",
    "division": 1
  },
  {
    ...
    "starPlayers": [
      ...
      "Augusto Lotti (ST)",
      "Juan Saborido (RB)",
      "Maximiliano Amarfil (CM)",
      "Guido Mainero (RM)",
      "Franco Zapiola (LM)",
      "Bautista Merlini (CAM)"
    ],
    "description": "El Calamar.",
    "badgeColor": "border-l-4 border-amber-600 bg-white text-amber-700",
    "badgeLogoUrl": "🦑",
  ...
  },
  {
    ...
    "marketValue": 4500000,
    "starPlayers": [
      "Mauricio Martínez (CDM)",
      "Jonatan Gómez (CM)",
      "Juan Manuel Insaurralde (CB)",
      "Junior Marabel (ST)",
      "Javier Burrai (GK)",
      "Lucas Suárez (CB)",
      "Yair Arismendi (LB)",
    ...
    "description": "El Verde de Junín.",
    "badgeColor": "border-l-4 border-white bg-green-600 text-white",
    "badgeLogoUrl": "🟢",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/12454.png",
    "division": 1
  },
  {
    "id": "central_cordoba",
    ...
    "starPlayers": [
      ...
      "Alan Aguerre (GK)",
      "Facundo Mansilla (CB)",
      "Horacio Tijanovich (LM)",
      "Alejandro Maciel (CB)",
      "Matías Vera (CDM)",
      "Ezequiel Naya (ST)",
      "Marco Iacobellis (RM)",
      "Santiago Moyano (RB)",
      "Juan Pablo Pignani (CB)"
    ],
    "description": "El Ferroviario.",
    "badgeColor": "border-l-4 border-white bg-black text-white",
    "badgeLogoUrl": "🚂",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/31284.png",
    "division": 1
  },
  {
    ...
    "badgeColor": "border-l-4 border-white bg-red-600 text-white",
    "badgeLogoUrl": "🔴⚪",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/25184.png",
    "division": 1
  },
  {
    "id": "indep_rivadavia",
    ...
    "description": "La Lepra Mendocina.",
    "badgeColor": "border-l-4 border-white bg-blue-800 text-white",
    "badgeLogoUrl": "🔵",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/1234.png",
    "division": 1
  },
  {
    ...
    "description": "Los Malevos.",
    "badgeColor": "border-l-4 border-white bg-black text-white",
    "badgeLogoUrl": "⚫",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/19775.png",
    "division": 1
  },
  {
    "id": "aldosivi",
    ...
    "starPlayers": [
      "Sebastián Moyano (GK)",
      "Axel Werner (GK)",
      "Guillermo Enrique (RB)",
      "Nicolás Zalazar (CB)",
      "Joaquín Novillo (CB)",
      "Esteban Rolón (CDM)",
      "Néstor Breitenbruch (CB)",
      "Nicolás Cordero (ST)",
      "Alan Sosa (LM)",
      "Lucas Rodríguez (LB)",
      "Ignacio Chicco (GK)"
    ],
    "description": "El Tiburón de Mar del Plata.",
    "badgeColor": "border-l-4 border-yellow-400 bg-green-700 text-yellow-300",
    "badgeLogoUrl": "🦈",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/12301.png",
    "division": 1
  },
  {
    "id": "estudiantes_rc",
    ...
    "description": "El León del Imperio.",
    "badgeColor": "border-l-4 border-sky-400 bg-slate-100 text-sky-600",
    "badgeLogoUrl": "🦁",
  ...
  },
  {
    ...
    "description": "El Pituco.",
    "badgeColor": "border-l-4 border-white bg-black text-white",
    "badgeLogoUrl": "🐺",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/14687.png",
    "division": 1
  },
  {
    "id": "san_martin_sj",
    ...
    "description": "Compite en B Nacional.",
    "badgeColor": "border-l-4 border-green-600 bg-black text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/10511.png",
    "division": 2
  },
  {
    "id": "godoy_cruz",
    ...
    "starPlayers": [
      ...
      "Nahuel Ulariaga (ST)",
      "Matías Ramírez (LM)",
      "Gastón Gil Romero (CDM)",
      "Misael Sosa (RW)",
      "Esteban Burgos (CB)",
      "Martín Pino (ST)",
      "Federico Milo (LB)"
    ],
    "description": "El Tomba (Descendido en el mod).",
    "badgeColor": "border-l-4 border-white bg-blue-800 text-white",
    "badgeLogoUrl": "🍷",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/3711.png",
    "division": 2
  },
  {
    "id": "agropecuario",
    ...
    "starPlayers": [
      ...
      "Rodrigo Castro (CAM)",
      "Brian Blando (ST)",
      "Alejandro Gagliardi (ST)",
      "Tomás Lecanda (CB)",
      "Luciano Acosta (GK)",
      "Alan Aguirre (CB)",
      "Santiago Gallucci (CDM)",
      "Jorge Valdéz Chamarro (CM)",
      "Rodrigo Mosqueira (LM)",
      "Milton Ramos (LB)"
    ],
    "description": "Compite en B Nacional.",
    "badgeColor": "border-l-4 border-red-600 bg-green-700 text-white",
    "badgeLogoUrl": "🚜",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/38545.png",
    "division": 2
  },
  {
    "id": "all_boys",
    ...
    "description": "El Albo. Compite en B Nacional.",
    "badgeColor": "border-l-4 border-black bg-white text-black",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/12100.png",
    "division": 2
  },
  {
    "id": "almagro",
    ...
    "starPlayers": [
      ...
      "Enzo Silcan (LB)",
      "Enzo Martínez (LM)",
      "Juan Pablo Zozaya (GK)"
    ],
    "description": "El Tricolor. Compite en B Nacional.",
    "badgeColor": "border-l-4 border-black bg-sky-400 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/14977.png",
    "division": 2
  },
  {
    "id": "almirante_brown",
    ...
    "description": "La Fragata. Compite en B Nacional.",
    "badgeColor": "border-l-4 border-yellow-500 bg-black text-yellow-400",
    "badgeLogoUrl": "⚓",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/12672.png",
    "division": 2
  },
  {
    "id": "atlanta",
    "name": "Atlanta",
    "league": "Argentina",
    "dt": "Cristian Pellerano",
    "reputation": 2,
    "initialSalary": 700,
    "marketValue": 2000000,
    "starPlayers": [
      "Christian Bernardi (CAM)",
      "Nicolás Previtali (CDM)",
      "Leonel Galeano (CB)",
      "Braian Rivero (CDM)",
      "Alejandro Quintana (ST)",
      "Tomás Castro Ponce (CAM)",
      "Francisco Rago (GK)",
      "Rodrigo Moreira (CB)",
      "Martin García (RB)",
      "Gustavo Mendoza (CDM)",
    ...
    "description": "El Bohemio. Compite en B Nacional.",
    "badgeColor": "border-l-4 border-yellow-500 bg-blue-800 text-yellow-400",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/51663.png",
    "division": 2
  },
  {
    "id": "mitre",
  ...
  },
  {
    ...
    "starPlayers": [
      ...
      "Mauricio Rosales (RB)",
      "Gonzalo Álvez (RM)",
      "Maximiliano Padilla (LB)",
      "Matías Villarreal (CDM)",
      "Kevin Fernández (CAM)",
      "Franco Vedoya (RW)",
      "Joaquin Mateo (ST)",
      "Leonardo Felissia (CB)"
    ],
    "description": "El Cuervo salteño. Compite en B Nacional.",
    "badgeColor": "border-l-4 border-white bg-black text-white",
    "badgeLogoUrl": "🐦",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/14670.png",
    "division": 2
  },
  {
    "id": "chacarita",
    ...
    "description": "El Funebrero. Compite en B Nacional.",
    "badgeColor": "border-l-4 border-white bg-red-600 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/2154.png",
    "division": 2
  },
  {
    "id": "chaco_for_ever",
    ...
    "badgeColor": "border-l-4 border-white bg-black text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/12681.png",
    "division": 2
  },
  {
    "id": "colegiales",
    ...
    "starPlayers": [
      "Emanuel Insua (LB)",
      "Mauro Albertengo (ST)",
      "Leandro Martínez Montagnoli (CB)",
      "Gonzalo Baglivo (CDM)",
      "Facundo Rivero (CB)",
      "Lucio Castillo (CAM)",
      "Nicolás Toloza (ST)",
      "Alejandro Chiavetto (CM)",
      "Elías Ocampo (RM)",
      "Leonardo González (RW)",
      "Mateo Mamaní (ST)"
    ],
    "description": "Compite en B Nacional.",
    "badgeColor": "border-l-4 border-yellow-500 bg-blue-800 text-yellow-400",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/13339.png",
    "division": 2
  },
  {
    "id": "colon",
    ...
    "marketValue": 5500000,
    "starPlayers": [
      "Federico Lértora (CDM)",
      "Pier Barrios (CB)",
      "Federico Rasmussen (CB)",
      "Mauro Peinipil (RB)",
      "Facundo Castro (ST)",
      "Nicolás Thaller (CB)",
      "Matías Godoy (LM)",
    ...
    "description": "El Sabalero. Histórico en la B Nacional.",
    "badgeColor": "border-l-4 border-black bg-red-600 text-white",
    "badgeLogoUrl": "🐘",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/1070.png",
    "division": 2
  },
  {
    "id": "defensores_belgrano",
    ...
    "badgeColor": "border-l-4 border-black bg-red-600 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/6062.png",
    "division": 2
  },
  {
    "id": "dep_madryn",
    ...
    "badgeColor": "border-l-4 border-yellow-500 bg-black text-yellow-400",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/14318.png",
    "division": 2
  },
  {
    "id": "dep_maipu",
    ...
    "marketValue": 1800000,
    "starPlayers": [
      "Fausto Emanuel Montero (CM)",
      "Nicolás Faggioli (CB)",
      "Gastón Mansilla (RM)",
      "Nahuel Galardi (GK)",
      "Juan Pablo Gobetto (CM)",
      "Matias Viguet (LM)",
      "Nicolás Fernández (CB)",
      "Mirko Bonfigli (CM)",
      "Marcelo Eggel (CAM)",
      "Felipe Rivarola (ST)",
      "Luciano Arnijas (CM)"
    ...
    "badgeColor": "border-l-4 border-white bg-red-600 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/19523.png",
    "division": 2
  },
  {
    "id": "dep_moron",
    ...
    "starPlayers": [
      "Mariano Bíttolo (LB)",
      "Juan Cruz Esquivel (LW)",
      "Gonzalo Berterame (RM)",
      "Juan Manuel Olivares (CM)",
      "Matías Benítez (RW)",
      "Julio Salvá (GK)",
      "Braian Salvareschi (CB)",
      "Joaquín Livera (LB)",
      "Santiago Kubiszyn (CAM)",
      "Franco Toloza (ST)",
      "Francisco Flores (CB)"
    ],
    "description": "El Gallo. Compite en B Nacional.",
    "badgeColor": "border-l-4 border-red-600 bg-white text-red-600",
    "badgeLogoUrl": "🐓",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/12458.png",
    "division": 2
  },
  {
    "id": "estudiantes_ba",
  ...
  },
  {
    ...
    "badgeColor": "border-l-4 border-white bg-green-600 text-white",
    "badgeLogoUrl": "🚂",
    "badgeImageUrl": "https://upload.wikimedia.org/wikipedia/commons/thumb/2/2f/Escudo_club_ferro_c_oeste.svg/250px-Escudo_club_ferro_c_oeste.svg.png",
    "division": 2
  },
  {
    "id": "gimnasia_jujuy",
    ...
    "description": "Compite en B Nacional.",
    "badgeColor": "border-l-4 border-sky-400 bg-white text-sky-400",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/10885.png",
    "division": 2
  },
  {
    ...
    "starPlayers": [
      ...
      "Oscar Vanegas (CB)",
      "Tomás Oneto (CB)",
      "Juan Sánchez Sotelo (ST)",
      "Fernando Godoy (CM)",
      "David Véliz (LM)",
      "Thomas Amilivia (ST)",
      "Axel Bordón (RB)",
      "Maico Quiroz (CDM)",
      "Leandro Finochietto (GK)",
      "Gianluca Pugliese (LW)"
    ],
    "description": "Compite en B Nacional.",
    "badgeColor": "border-l-4 border-red-600 bg-blue-800 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/58188.png",
    "division": 2
  },
  {
    "id": "gimnasia_tiro",
    ...
    "badgeColor": "border-l-4 border-sky-400 bg-white text-sky-400",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/14688.png",
    "division": 2
  },
  {
    "id": "los_andes",
    ...
    "starPlayers": [
      ...
      "Matías González (RM)",
      "Sebastian López (GK)",
      "Juan Manuel Vázquez (LM)",
      "Javier Bustillos (GK)"
    ],
    "description": "El Milrayitas. Compite en B Nacional.",
    "badgeColor": "border-l-4 border-white bg-red-600 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/5208.png",
    "division": 2
  },
  {
    "id": "nueva_chicago",
    ...
    "marketValue": 2500000,
    "starPlayers": [
      "Alan Nahuel Ruiz (CAM)",
      "Emiliano Méndez (CDM)",
      "Gonzalo Paz (CB)",
      "Guillermo Ferracuti (LB)",
      "Ramiro Balbuena (RM)",
      "Dylan Gissi (CB)",
      "Gabriel Vega (CM)",
      "Matías Vera (RB)",
      "Luciano Jachfe (GK)",
      "Sebastían Cocimano (ST)",
      "Bruno Palazzo (CB)"
    ],
    "description": "El Torito de Mataderos. Compite en B Nacional.",
    "badgeColor": "border-l-4 border-black bg-green-600 text-white",
    "badgeLogoUrl": "🐂",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/10534.png",
    "division": 2
  },
  {
    "id": "patronato",
    ...
    "starPlayers": [
      ...
      "Marcos Enrique (CDM)",
      "Franco Meritello (CB)",
      "Fernando Evangelista (LB)",
      "Alan Sosa (GK)",
      "Fernando Moreyra (CB)",
      "Agustin Araujo (LM)",
      "Franco Soldano (ST)",
      "Maximiliano Rueda (CM)"
    ],
    "description": "El Patrón. Compite en B Nacional.",
    "badgeColor": "border-l-4 border-black bg-red-600 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/19806.png",
    "division": 2
  },
  {
    "id": "quilmes",
    ...
    "description": "El Cervecero. Compite en B Nacional.",
    "badgeColor": "border-l-4 border-blue-800 bg-white text-blue-900",
    "badgeLogoUrl": "🍺",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/1826.png",
    "division": 2
  },
  {
    "id": "racing_cba",
    ...
    "marketValue": 1800000,
    "starPlayers": [
      "Ricardo Centurión (LM)",
      "Sebastian Marfort (CB)",
      "Alejandro Rébola (CB)",
      "Marcio Gómez (CB)",
      "Gaspar Vega (CM)",
      "Pablo Chavarría (ST)",
  ...
  },
  {
    ...
    "description": "El Ciruja. Compite en B Nacional.",
    "badgeColor": "border-l-4 border-white bg-red-600 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/12709.png",
    "division": 2
  },
  {
    "id": "san_miguel",
    ...
    "marketValue": 1500000,
    "starPlayers": [
      "Leandro Desábato (CDM)",
      "Lucas Brochero (RM)",
      "Bruno Nasta (ST)",
      "Daniel Juárez (ST)",
      "Juan Lungarzo (GK)",
      "Lucas Delgado (ST)",
      "Facundo Omar Cardozo (LB)",
      "Alexis Cruz (LB)",
      "Lucio Pérez (RB)",
      "Dixon Renteria (CB)",
      "Máximo Oses (LM)"
    ...
    "description": "Compite en B Nacional.",
    "badgeColor": "border-l-4 border-white bg-green-700 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/19634.png",
    "division": 2
  },
  {
    "id": "san_telmo",
    ...
    "starPlayers": [
      ...
      "Lucas Baldunciel (RW)",
      "Emanuel Díaz (CB)",
      "Juan Cruz Zurbriggen (ST)",
      "Gabriel Paredes (LB)",
      "Elías Brítez (CM)"
    ],
    "description": "El Candombero. Compite en B Nacional.",
    "badgeColor": "border-l-4 border-sky-400 bg-blue-800 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/13651.png",
    "division": 2
  },
  {
    "id": "temperley",
    ...
    "description": "El Gasolero. Compite en B Nacional.",
    "badgeColor": "border-l-4 border-white bg-sky-400 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/14542.png",
    "division": 2
  },
  {
    "id": "tristan_suarez",
    ...
    "starPlayers": [
      ...
      "Joaquín Bigo (GK)",
      "Agustín Baldi (CB)",
      "Nicolás Fernández (LB)",
      "Nicolás Del Priore (CM)",
      "Álvaro Veliez (ST)",
      "Mauricio Manuel Guzmán (CB)",
      "Alejandro Molina (RB)"
    ],
    "description": "El Lechero. Compite en B Nacional.",
    "badgeColor": "border-l-4 border-white bg-blue-800 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/1771.png",
    "division": 2
  },
  {
    "id": "midland",
    ...
    "marketValue": 1200000,
    "starPlayers": [
      "Fernando González (CB)",
      "Juan Cruz Vega (CAM)",
      "Agustín Campana (LW)",
      "Leonel Gigli (CB)",
      "Emilio Porro (RB)",
      "Lautaro Díaz Laharque (RB)",
      "Genaro Cepeda (CB)",
      "Maximiliano Rogoski (CM)",
      "Santino Primante (ST)",
      "Pablo Casarico (CB)",
      "Marcos Roseti (RM)"
    ],
    ...
    "badgeColor": "border-l-4 border-white bg-blue-800 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/5.png",
    "division": 2
  },
  {
    "id": "acassuso",
    ...
    "starPlayers": [
      ...
      "Álex Ruiz (LB)",
      "Nahuel Petillo (CM)",
      "Juan Ponce de León (RB)",
      "Lucas Pioli (CB)",
      "Joel Gonzalo Ghirardello (CB)"
    ],
    "description": "Compite en B Nacional.",
    "badgeColor": "border-l-4 border-white bg-blue-800 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/12677.png",
    "division": 2
  },
  {
    "id": "c_bolivar",
  ...
  },
  {
    ...
    "description": "La Crema. Compite en B Nacional.",
    "badgeColor": "border-l-4 border-white bg-sky-400 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/10233.png",
    "division": 2
  },
  {
    "id": "alvarado",
    ...
    "starPlayers": [
      "Tomás Berra (CB)",
      "Tomás Fernández (CB)",
      "Leonardo Incorvaia (CB)",
      "Fermín Iriarte (RB)",
      "Nahuel González (GK)",
      "Nahuel Speck (LW)",
      "Lucas Chiozza (CAM)",
      "Germán Cervera (ST)",
      "Facundo Centurión (CB)",
      "Germán Sosa (ST)",
      "Cristian Gorgerino (LB)"
    ],
    "description": "Compite en Tercera División.",
    "badgeColor": "border-l-4 border-white bg-blue-800 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/1247.png",
    "division": 3
  },
  {
    "id": "armenio",
    ...
    "starPlayers": [
      ...
      "Nicolas Sánchez (RM)",
      "Facundo Tello (CM)",
      "Federico Marchesini (CB)",
      "Lucas Palma (ST)",
      "Valentin Chocobar (CAM)",
      "Juan Pablo Domínguez (GK)",
      "Nahuel Troxler (RB)",
      "Leandro Ramos (CAM)"
    ],
    "description": "Compite en Tercera División.",
  ...
  },
  {
    ...
    "description": "El Arse. Compite en Tercera División.",
    "badgeColor": "border-l-4 border-sky-400 bg-red-600 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/23194.png",
    "division": 3
  },
  {
    "id": "boca_unidos",
    ...
    "starPlayers": [
      ...
      "Luis Ojeda (GK)",
      "Antonio Medina (ST)",
      "Sebastián Navarro (CM)",
      "Bryan Mendoza (RM)",
      "Ataliva Schweizer (CDM)",
      "Pablo Moreyra (CB)",
      "Ángel Piz (CM)",
      "Martín Ojeda (CM)"
    ],
    "description": "Compite en Tercera División.",
    "badgeColor": "border-l-4 border-yellow-500 bg-red-600 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/189.png",
    "division": 3
  },
  ...
  },
  {
    ...
    "starPlayers": [
      ...
      "Brandon Obregón (CAM)",
      "Facundo Crespo (GK)",
      "Víctor Manchafico (CB)",
      "Fernando Pettineroli (RM)",
      "Sebastián Jeldres (ST)",
      "Yago Piro (CB)",
      "Gonzalo Lucero (LM)",
      "Andrés Almirón (RW)",
      "Marcos Pérez (CM)",
      "Maximiliano López (LW)"
    ],
    "description": "Compite en Tercera División.",
    "badgeColor": "border-l-4 border-black bg-white text-black",
    "badgeLogoUrl": "⚽",
  ...
  },
  {
    ...
    "description": "El Cartero. Compite en Tercera.",
    "badgeColor": "border-l-4 border-black bg-yellow-500 text-black",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/982.png",
    "division": 3
  },
  {
    "id": "def_unidos",
    ...
    "starPlayers": [
      "Martin Gimenez (ST)",
      "Fabricio Henricot (GK)",
      "Luis Olivera (LB)",
      "Maximiliano Ortigoza (RM)",
      "Fernando Arébalo (RB)",
      "Alan Sombra (ST)",
      "Mauro Alarcon (RB)",
      "Franco Suárez (CB)",
  ...
  },
  {
    ...
    "starPlayers": [
      ...
      "Pablo Despósito (CM)",
      "Nicolás Sánchez (ST)",
      "Santiago Villarreal (RB)",
      "Federico Otero (LM)",
      "Giuliano Gualtieri (CM)",
      "Agustín Arias (ST)",
      "Ariel Barreiro (LB)",
      "Kevin Ghigliazza (CAM)"
    ],
    "description": "El Docke. Compite en Tercera.",
    "badgeColor": "border-l-4 border-yellow-500 bg-blue-800 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/2440.png",
    "division": 3
  },
  {
    "id": "douglas_haig",
    ...
    "marketValue": 1000000,
    "starPlayers": [
      "Robertino Seratto (CM)",
      "Guillermo Pereira (CAM)",
      "Martin Caballo (CDM)",
      "Marcos Giménez (CM)",
      "Elián Tus (LW)",
      "Juan Muriel Orlando (ST)",
      "Nicolás Canela (CB)",
      "Fabricio González (ST)",
      "Boris Magnago (RM)",
      "Mauro Ponce De León (LM)",
      "Brian Meza (CDM)"
    ],
    "description": "Compite en Tercera División.",
    "badgeColor": "border-l-4 border-black bg-red-600 text-white",
  ...
  },
  {
    ...
    "starPlayers": [
      "Gonzalo Pedrosa (CB)",
      "Mathias Fernández (RB)",
      "Mariano Arango (LB)",
      "Miguel López (CAM)",
      "Alejandro Ávalos (CM)",
      "Federico Haberkorn (ST)",
      "Nicolás Rodríguez (GK)",
      "Héctor Igarzábal (CB)",
      "Alan Espeche (RW)",
      "Iván Arbello (LW)",
      "Antonio Paulides (CB)"
    ...
    "badgeColor": "border-l-4 border-white bg-green-600 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://upload.wikimedia.org/wikipedia/commons/thumb/1/10/Club_Atletico_Excursionistas.svg/250px-Club_Atletico_Excursionistas.svg.png",
    "division": 3
  },
  {
    "id": "guillermo_brown",
    ...
    "starPlayers": [
      ...
      "Agustin Álvarez (CB)",
      "Gabriel Lazarte (LB)",
      "Francisco Illarregui (RW)",
      "Agustín Grinovero (GK)",
      "Luis Dezi (ST)",
      "Natanael Hernández (LB)"
    ],
    "description": "Compite en Tercera División.",
    "badgeColor": "border-l-4 border-white bg-blue-800 text-white",
    "badgeLogoUrl": "⚽",
  ...
  },
  {
    ...
    "marketValue": 1000000,
    "starPlayers": [
      "Pablo Palacios Alvarenga (ST)",
      "Isaac Monti (CB)",
      "Martín Esparza (LM)",
      "Matias Vicedo (ST)",
      "Leonel Canzoniero (LB)",
      "Ezequiel Santángelo (RB)",
      "Gaston Osores (CB)",
      "Juan Pablo Serrano (GK)",
      "Gabriel Taborda (CAM)",
      "Juan Cruz Nadal (GK)",
      "Nicolás González (RW)"
    ],
    ...
    "badgeColor": "border-l-4 border-white bg-blue-800 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/1403.png",
    "division": 3
  },
  {
    "id": "laferrere",
    ...
    "starPlayers": [
      "Tiago Libares (GK)",
      "Alejandro Benítez (CAM)",
      "Emanuel Trejo (CDM)",
      "Alan Ortíz (CAM)",
      "Luciano Nebot (CB)",
      "Franco Romero (ST)",
      "Benjamín Portillo (CM)",
      "Josué Salvadores (CM)",
      "Ignacio Cavoret (CB)",
      "Nicolás Manzi (CB)",
      "Eloy Rodríguez (ST)"
    ],
    "description": "El Villero. Compite en Tercera.",
    "badgeColor": "border-l-4 border-white bg-green-600 text-white",
    "badgeLogoUrl": "⚽",
    "division": 3
  },
  {
    ...
    "starPlayers": [
      "Braian Guille (LM)",
      "Joaquín Susvielles (ST)",
      "Martín Ferreyra (CB)",
      "Néstor Moiraghi (CB)",
      "Agustin Bellone (RB)",
      "Marcelo Olivera (ST)",
      "Enzo Coacci (LW)",
      "Federico González (ST)",
      "Diego Ramírez (CM)",
      "Manuel Vargas (CM)",
      "Luciano Lapetina (LB)"
    ],
  ...
  },
  {
    ...
    "starPlayers": [
      "German Lesman (ST)",
      "Gianfranco Ferrero (LB)",
      "Emanuel Mercado (ST)",
      "Brian Flores (CB)",
      "Mariano Gancedo (LB)",
      "Agustín Pastorelli (LM)",
      "Santiago Churchi (CM)",
      "Leonardo Martina (GK)",
      "Leonardo Ferreyra (RB)",
      "Jonathan Paiz (CB)",
      "Máximo Forlin (RW)"
    ],
    "description": "Compite en Tercera División.",
  ...
  },
  {
    ...
    "badgeColor": "border-l-4 border-black bg-white text-black",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/30038.png",
    "division": 3
  },
  {
    "id": "cruzeiro",
    ...
    "description": "La Bestia Negra.",
    "badgeColor": "border-l-4 border-white bg-blue-600 text-white",
    "badgeLogoUrl": "🦊",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/609.png",
    "division": 1
  },
  {
    "id": "gremio",
    ...
    "starPlayers": [
      "Weverton (GK)",
      "Cristian Pavón (RW)",
      "Martin Braithwaite (ST)",
      "Juan Ignacio Nardoni (CM)",
      "Walter Kannemann (CB)",
      "Arthur (CM)",
      "Tetê (RW)",
      "Marcos Rocha (RB)",
      "Willian (LW)",
      "Mathías Villasanti (CDM)",
      "Wagner Leonardo (CB)"
    ],
  ...
  },
  {
    ...
    "description": "O Verdão.",
    "badgeColor": "border-l-4 border-white bg-green-600 text-white",
    "badgeLogoUrl": "🟢",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/1023.png",
    "division": 1
  },
  {
    "id": "botafogo",
    ...
    "starPlayers": [
      ...
      "Artur (RW)",
      "Arthur Cabral (ST)",
      "Alexander Barboza (CB)",
      "Joaquín Correa (CAM)"
    ],
    "description": "O Glorioso.",
    "badgeColor": "border-l-4 border-white bg-black text-white",
    "badgeLogoUrl": "🌟",
  ...
  },
  {
    ...
    "starPlayers": [
      ...
      "Fábio (GK)",
      "Guilherme Arana (LB)",
      "Jefferson Savarino (CAM)",
      "Otávio (CDM)",
      "Yeferson Soteldo (LW)",
      "Ganso (CAM)",
      "Samuel Xavier (RB)",
      "John Kennedy (ST)",
      "Matheus Martinelli (CDM)"
    ],
    "description": "Tricolor das Laranjeiras.",
    "badgeColor": "border-l-4 border-red-700 bg-green-800 text-white",
    "badgeLogoUrl": "🔴🟢",
  ...
  },
  {
    ...
    "description": "El Tricolor Paulista.",
    "badgeColor": "border-l-4 border-red-600 bg-white text-black",
    "badgeLogoUrl": "⚪",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/585.png",
    "division": 1
  },
  {
    "id": "atletico_mineiro",
    ...
    "badgeColor": "border-l-4 border-white bg-black text-white",
    "badgeLogoUrl": "🐔",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/330.png",
    "division": 1
  },
  {
    "id": "corinthians",
    ...
    "description": "El Timão.",
    "badgeColor": "border-l-4 border-black bg-white text-black",
    "badgeLogoUrl": "⚓",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/199.png",
    "division": 1
  },
  {
    "id": "flamengo",
    ...
    "starPlayers": [
      ...
      "Pedro (ST)",
      "Danilo (CB)",
      "Everton Cebolinha (LW)",
      "Nicolás de la Cruz (CM)"
    ],
    "description": "El Megaclube de Río.",
    "badgeColor": "border-l-4 border-black bg-red-600 text-white",
    "badgeLogoUrl": "🔴⚫",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/614.png",
    "division": 1
  },
  {
    "id": "internacional",
  ...
  },
  {
    ...
    "badgeColor": "border-l-4 border-red-600 bg-white text-black",
    "badgeLogoUrl": "🐂",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/8793.png",
    "division": 1
  },
  {
    "id": "vitoria",
    ...
    "starPlayers": [
      "Marinho (RW)",
      "Gabriel (GK)",
      "Emmanuel Martínez (CAM)",
      "Osvaldo (RW)",
      "Aitor (CAM)",
      "Lucas Arcanjo (GK)",
      "Fabrício (ST)",
      "Camutanga (CB)",
      "Gabriel Baralhas (CDM)",
      "Matheuzinho (CAM)",
      "Luan Cândido (LB)"
    ],
    "description": "O Leão da Barra.",
    "badgeColor": "border-l-4 border-black bg-red-600 text-white",
    "badgeLogoUrl": "🦁",
  ...
  },
  {
    ...
    "description": "Gigante da Colina.",
    "badgeColor": "border-l-4 border-white bg-black text-white",
    "badgeLogoUrl": "⚓",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/978.png",
    "division": 1
  },
  {
    "id": "bahia",
    ...
    "description": "Esquadrão de Aço.",
    "badgeColor": "border-l-4 border-red-600 bg-blue-600 text-white",
    "badgeLogoUrl": "🔵🔴",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/432.png",
    "division": 1
  },
  {
    "id": "mirassol",
    ...
    "description": "Leão da Alta.",
    "badgeColor": "border-l-4 border-green-600 bg-yellow-500 text-black",
    "badgeLogoUrl": "🦁",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/6574.png",
    "division": 1
  },
  {
    "id": "santos",
  ...
  },
  {
    ...
    "description": "El Furacão.",
    "badgeColor": "border-l-4 border-black bg-red-600 text-white",
    "badgeLogoUrl": "🌪️",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/679.png",
    "division": 1
  },
  {
    "id": "remo",
    ...
    "starPlayers": [
      ...
      "Víctor Cantillo (CDM)",
      "Duplexe Tchamba (CB)",
      "Patrick de Paula (CDM)",
      "Zé Welison (CDM)",
      "Matheus Alexandre (RB)",
      "Marllon (CB)",
      "Leonel Picco (CDM)",
      "Panagiotis Tachtsidis (CDM)"
    ],
    "description": "Leão Azul.",
    "badgeColor": "border-l-4 border-white bg-blue-900 text-white",
    "badgeLogoUrl": "🦁",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/10997.png",
    "division": 1
  },
  {
    "id": "coritiba",
    ...
    "description": "Coxa-Branca.",
    "badgeColor": "border-l-4 border-green-600 bg-white text-black",
    "badgeLogoUrl": "🟢⚪",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/199.png",
    "division": 1
  },
  {
    ...
    "starPlayers": [
      ...
      "Walter Clar (LB)",
      "Rafael Thyere (CB)",
      "Giovanni Augusto (CAM)",
      "Robert Santos (CAM)",
      "Maurício Garcez (LW)",
      "Ênio (LW)",
      "Neto Pessoa (ST)"
    ],
    "description": "El Huracán del Oeste.",
    "badgeColor": "border-l-4 border-white bg-green-600 text-white",
    "badgeLogoUrl": "🏹",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/928.png",
    "division": 1
  },
  {
    ...
    "description": "Compite en Brasileirao B.",
    "badgeColor": "border-l-4 border-white bg-green-600 text-white",
    "badgeLogoUrl": "🟢",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/506.png",
    "division": 2
  },
  {
    "id": "fortaleza_br",
    ...
    "description": "Descendido sorpresivamente en el mod.",
    "badgeColor": "border-l-4 border-red-600 bg-blue-800 text-white",
    "badgeLogoUrl": "🦁",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/32041.png",
    "division": 2
  },
  {
    ...
    "badgeColor": "border-l-4 border-white bg-black text-white",
    "badgeLogoUrl": "⚫",
    "badgeImageUrl": "https://upload.wikimedia.org/wikipedia/commons/thumb/3/38/Cear%C3%A1_Sporting_Club_logo.svg/250px-Cear%C3%A1_Sporting_Club_logo.svg.png",
    "division": 2
  },
  {
    "id": "sport_recife",
  ...
  },
  {
    ...
    "starPlayers": [
      ...
      "Railan (RB)",
      "Yamil Asad (LW)",
      "Rodrigo Rodrigues (ST)"
    ],
    "description": "Compite en Brasileirao B.",
    "badgeColor": "border-l-4 border-yellow-500 bg-green-600 text-white",
    "badgeLogoUrl": "🔰",
    "badgeImageUrl": "https://pub-3bd35431294c47068cbf31a95d572166.r2.dev/logos/cuiaba/cuiaba-logo-footylogos.svg",
    "division": 2
  },
  {
    ...
    "badgeColor": "border-l-4 border-black bg-red-600 text-white",
    "badgeLogoUrl": "🐉",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/40188.png",
    "division": 2
  },
  {
    "id": "novorizontino",
    ...
    "starPlayers": [
      ...
      "Luís Oyama (CDM)",
      "Matheus Bianqui (CM)",
      "Nilson Castrillón (RB)",
      "Carlinhos (CB)"
    ],
    "description": "Compite en Brasileirao B.",
    "badgeColor": "border-l-4 border-black bg-yellow-500 text-black",
    "badgeLogoUrl": "🐯",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/11141.png",
    "division": 2
  },
  {
    "id": "goias",
    ...
    "badgeColor": "border-l-4 border-white bg-green-600 text-white",
    "badgeLogoUrl": "🟢",
    "badgeImageUrl": "https://pub-3bd35431294c47068cbf31a95d572166.r2.dev/logos/goias/goias-logo-footylogos.svg",
    "division": 2
  },
  {
    "id": "criciuma",
    ...
    "badgeColor": "border-l-4 border-black bg-yellow-500 text-black",
    "badgeLogoUrl": "🐯",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/3631.png",
    "division": 2
  },
  {
    "id": "crb",
    ...
    "badgeColor": "border-l-4 border-white bg-red-600 text-white",
    "badgeLogoUrl": "🔴⚪",
    "badgeImageUrl": "https://pub-3bd35431294c47068cbf31a95d572166.r2.dev/logos/crb/crb-logo-footylogos.svg",
    "division": 2
  },
  {
    "id": "operario",
    ...
    "marketValue": 3000000,
    "starPlayers": [
      "Gabriel Boschilia (CAM)",
      "Pablo (ST)",
      "Juan Pablo Zuluaga (CM)",
      "Ademilson (ST)",
      "Matheus Trindade (CDM)",
      "Vagner (GK)",
      "Edwin Torres (RM)",
      "Klaus (CB)",
      "José Cuenú (CB)",
  ...
  },
  {
    ...
    "badgeColor": "border-l-4 border-white bg-red-600 text-white",
    "badgeLogoUrl": "🐯",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/368.png",
    "division": 2
  },
  {
    "id": "avai",
  ...
  },
  {
    ...
    "description": "Botafogo de Ribeirão Preto.",
    "badgeColor": "border-l-4 border-white bg-red-600 text-white",
    "badgeLogoUrl": "🔴⚪",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/20466.png",
    "division": 2
  },
  {
    ...
    "badgeColor": "border-l-4 border-white bg-black text-white",
    "badgeLogoUrl": "⚫",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/621.png",
    "division": 2
  },
  {
    "id": "londrina",
    "name": "Londrina",
    "league": "Brasileña",
    "dt": "Claudinei Oliveira",
    "reputation": 2,
    "initialSalary": 900,
    "marketValue": 3000000,
    "starPlayers": [
      "Gilberto (ST)",
      "Mauricio Kozlinski (GK)",
      "Wallace (CB)",
      "Thalis (CAM)",
      "Lucas Marques (CDM)",
      "Iago Teles (LW)",
      "Luan Ribeiro (GK)",
      "Paulinho Moccelin (LW)",
      "Kevyn (LB)",
      "Bruno Santos (ST)",
      "André Luiz (CDM)"
    ],
    ...
    "badgeColor": "border-l-4 border-white bg-sky-400 text-white",
    "badgeLogoUrl": "🩵",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/1158.png",
    "division": 2
  },
  {
    "id": "ponte_preta",
  ...
  },
  {
    ...
    "badgeColor": "border-l-4 border-black bg-yellow-500 text-black",
    "badgeLogoUrl": "🟡",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/294.png",
    "division": 2
  },
  {
    "id": "nautico",
    ...
    "badgeColor": "border-l-4 border-red-600 bg-white text-red-600",
    "badgeLogoUrl": "🔴⚪",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/72309.png",
    "division": 2
  },
  {
    "id": "america_mex",
    ...
    "starPlayers": [
      ...
      "Víctor Dávila (ST)",
      "Cristián Borja (LB)",
      "Jonathan dos Santos (CDM)",
      "Henry Martín (ST)"
    ],
    "description": "Las Águilas del Estadio Azteca.",
    "badgeColor": "border-l-4 border-yellow-400 bg-blue-900 text-yellow-200",
    "badgeLogoUrl": "🦅",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/3631.png",
    "division": 1
  },
  {
    ...
    "description": "Rayados.",
    "badgeColor": "border-l-4 border-blue-600 bg-white text-blue-900",
    "badgeLogoUrl": "🔵",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/2407.png",
    "division": 1
  },
  {
    "id": "tigres",
    ...
    "starPlayers": [
      ...
      "Diego Lainez (RW)",
      "Juan Brunetta (CAM)",
      "Fernando Gorriarán (CDM)",
      "Joaquim (CB)",
      "Rodrigo Aguirre (ST)",
      "André-Pierre Gignac (ST)",
      "Jesús Angulo (CB)",
      "Rômulo (CDM)",
      "Jesús Garza (RB)"
    ],
    "description": "Los Felinos.",
    "badgeColor": "border-l-4 border-yellow-500 bg-blue-900 text-yellow-300",
    "badgeLogoUrl": "🐯",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/7055.png",
    "division": 1
  },
  {
    "id": "cruz_azul",
    ...
    "description": "La Máquina.",
    "badgeColor": "border-l-4 border-white bg-blue-700 text-white",
    "badgeLogoUrl": "🚂",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/3711.png",
    "division": 1
  },
  {
    ...
    "starPlayers": [
      ...
      "Juninho Vieira (ST)",
      "Rubén Duarte (CB)",
      "Guillermo Martínez (ST)",
      "Robert Morales (ST)",
      "Leonardo Suárez (RM)"
    ],
    "description": "Los Universitarios.",
    "badgeColor": "border-l-4 border-yellow-500 bg-blue-900 text-yellow-400",
    "badgeLogoUrl": "🐾",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/7633.png",
    "division": 1
  },
  {
    "id": "chivas",
    ...
    "description": "El Rebaño Sagrado.",
    "badgeColor": "border-l-4 border-white bg-red-600 text-white",
    "badgeLogoUrl": "🐐",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/6711.png",
    "division": 1
  },
  {
    "id": "toluca",
    ...
    "description": "Los Diablos Rojos.",
    "badgeColor": "border-l-4 border-black bg-red-600 text-white",
    "badgeLogoUrl": "😈",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/17467.png",
    "division": 1
  },
  {
    "id": "pachuca",
    ...
    "starPlayers": [
      ...
      "Carlos Moreno (GK)",
      "Eduardo Bauermann (CB)",
      "Sergio Barreto (CB)",
      "Víctor Guzmán (CAM)",
      "Kenedy (LM)",
      "Luis Quiñones (RM)"
    ],
    "description": "Los Tuzos.",
    "badgeColor": "border-l-4 border-white bg-blue-900 text-white",
    "badgeLogoUrl": "🐿️",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/4035.png",
    "division": 1
  },
  {
    "id": "leon",
    ...
    "starPlayers": [
      "Diber Cambindo (ST)",
      "Rodrigo Echeverría (CM)",
      "Ismael Díaz (LW)",
      "Sebastián Vegas (CB)",
      "Salvador Reyes (LB)",
      "Rogelio Funes Mori (ST)",
      "Óscar García (GK)",
      "Jordi Cortizo (LM)",
      "Stiven Barreiro (CB)",
      "Juan Domínguez (RM)",
      "Fernando Beltrán (CDM)"
    ],
    "description": "La Fiera.",
    "badgeColor": "border-l-4 border-white bg-green-600 text-white",
    "badgeLogoUrl": "🦁",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/826.png",
    "division": 1
  },
  {
    "id": "atlas",
    ...
    "description": "Los Zorros.",
    "badgeColor": "border-l-4 border-red-600 bg-black text-white",
    "badgeLogoUrl": "🦊",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/8816.png",
    "division": 1
  },
  {
    "id": "santos_laguna",
  ...
  },
  {
    ...
    "badgeColor": "border-l-4 border-black bg-red-600 text-white",
    "badgeLogoUrl": "🐕",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/13353.png",
    "division": 1
  },
  {
    "id": "puebla",
    ...
    "starPlayers": [
      ...
      "Daniel Gutiérrez (GK)",
      "Kevin Velasco (LM)",
      "Alejandro Organista (CM)",
      "Brayan Garnica (RM)"
    ],
    "description": "La Franja.",
    "badgeColor": "border-l-4 border-sky-400 bg-white text-slate-900",
    "badgeLogoUrl": "🎽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/5662.png",
    "division": 1
  },
  {
    "id": "queretaro",
    ...
    "marketValue": 7500000,
    "starPlayers": [
      "Santiago Homenchenko (CDM)",
      "Jhojan Julio (LM)",
      "Lucas Abascia (CB)",
      "Francisco Venegas (LB)",
      "Mateo Coronel (ST)",
      "Diego Reyes (CB)",
      "Pablo Barrera (RM)",
      "Guillermo Allison (GK)",
      "Lucas Rodríguez (LM)",
      "Alí Ávila (ST)",
      "Jaime Gómez (RB)"
    ],
    "description": "Los Gallos Blancos.",
    "badgeColor": "border-l-4 border-black bg-blue-800 text-white",
    "badgeLogoUrl": "🐓",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/4961.png",
    "division": 1
  },
  {
    "id": "mazatlan",
    ...
    "description": "Los Cañoneros.",
    "badgeColor": "border-l-4 border-white bg-purple-800 text-white",
    "badgeLogoUrl": "⚓",
  ...
  },
  {
    ...
    "starPlayers": [
      "Ezequiel Unsain (GK)",
      "Lorenzo Faravelli (CM)",
      "Julián Carranza (ST)",
      "Alexis Peña (CB)",
      "Agustín Almendra (CM)",
      "Javier Ruiz (RW)",
      "Agustín Oliveros (CB)",
      "Cristian Calderón (LB)",
      "Kevin Rosero (RM)",
      "Tomás Badaloni (ST)",
      "Emilio Lara (RB)"
    ],
    "description": "Los Rayos.",
    "badgeColor": "border-l-4 border-red-600 bg-white text-slate-900",
    "badgeLogoUrl": "⚡",
  ...
  },
  {
    ...
    "description": "Bravos.",
    "badgeColor": "border-l-4 border-red-600 bg-green-600 text-white",
    "badgeLogoUrl": "🐎",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/49283.png",
    "division": 1
  },
  {
    "id": "san_luis",
  ...
  },
  {
    ...
    "starPlayers": [
      ...
      "Diego Cruz (CB)",
      "Armando Escobar (LW)",
      "Maximiliano García (CM)",
      "Ronaldo González (CM)",
      "Johan Alonzo (RW)",
      "Axl Padilla (RB)"
    ],
    "description": "Liga de Expansión MX.",
  ...
  },
  {
    ...
    "starPlayers": [
      "Juan José Calero (ST)",
      "Santiago Ramírez (GK)",
      "Adolfo Domínguez (CDM)",
      "Sleyther Lora (RW)",
      "Jonathan Martínez (CAM)",
      "Mario Trejo (CB)",
      "Duilio Tejeda (RW)",
      "Néstor Vidrio (CB)",
      "Javier Casillas (RB)",
  ...
  },
  {
    ...
    "starPlayers": [
      ...
      "Diego García (RB)",
      "Edson Torres (CAM)",
      "Michell Rodríguez (RW)",
      "José Guadalupe Hernández (LB)",
      "Luis Razo (ST)",
      "Deivoon Magaña (RM)",
      "José Peralta (RW)",
      "Alonso Escoboza (LB)",
    ...
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/1075.png",
    "division": 2
  },
  {
    "id": "morelia",
  ...
  },
  {
    ...
    "starPlayers": [
      ...
      "Jesús Brígido (LW)",
      "Felipe López (GK)",
      "Juan de Dios Aguayo (CB)",
      "Arturo Ledesma (CB)",
      "Sergio Hernández (CAM)",
      "Alejandro Bravo (CM)",
      "Joél Pérez (LW)",
      "Édson Rivera (ST)"
    ],
  ...
  },
  {
    ...
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/56089.png",
    "division": 2
  },
  {
    "id": "correcaminos",
    ...
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/45604.png",
    "division": 2
  },
  {
    "id": "dorados",
  ...
  },
  {
    ...
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/9636.png",
    "division": 2
  },
  {
    "id": "tlaxcala",
    ...
    "starPlayers": [
      ...
      "Christian (ST)",
      "Andrés Iniestra (CM)",
      "Giovani Hernández (CAM)",
      "Gabino Espinoza (GK)",
      "Edson Santos (LB)",
      "Salomón Obama Ondo (RW)",
      "Juan Blanco (LW)"
    ],
    "description": "Liga de Expansión MX.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
  ...
  },
  {
    ...
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/4941.png",
    "division": 2
  },
  {
    "id": "alebrijes",
    ...
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/3938.png",
    "division": 2
  },
  {
    "id": "colocolo",
    ...
    "starPlayers": [
      ...
      "Fernando De Paul (GK)",
      "Felipe Méndez (CDM)",
      "Maximiliano Romero (ST)",
      "Tomás Alarcón (CDM)",
      "Matías Fernández (RB)",
      "Jonathan Villagra (CB)"
    ],
    "description": "El Cacique.",
    "badgeColor": "border-l-4 border-white bg-black text-white",
    "badgeLogoUrl": "🏁",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/1247.png",
    "division": 1
  },
  {
    ...
    "description": "La U.",
    "badgeColor": "border-l-4 border-red-600 bg-blue-900 text-white",
    "badgeLogoUrl": "🦉",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/2352.png",
    "division": 1
  },
  {
    ...
    "description": "Los Cruzados.",
    "badgeColor": "border-l-4 border-blue-600 bg-white text-slate-900",
    "badgeLogoUrl": "🛡️",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/410.png",
    "division": 1
  },
  {
    "id": "palestino",
  ...
  },
  {
    ...
    "starPlayers": [
      ...
      "Matías Fracchia (CB)",
      "Dylan Escobar (RB)",
      "Salvador Cordero (CDM)"
    ],
    "description": "Primera División de Chile.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/813.png",
    "division": 1
  },
  {
    "id": "cobresal",
    ...
    "starPlayers": [
      ...
      "Bryan Carvallo (CAM)",
      "Julián Brea (RW)",
      "Guillermo Pacheco (RB)",
      "Juan Fuentes (CDM)",
      "Esteban Valencia (CM)",
      "José Tiznado (CB)",
      "Franco Bechtholdt (CB)"
    ],
    "description": "Primera División de Chile.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
  ...
  },
  {
    ...
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/29.png",
    "division": 1
  },
  {
    "id": "unión_la_calera",
    ...
    "starPlayers": [
      ...
      "Yerko Leiva (CM)",
      "Camilo Moya (CDM)",
      "Nicolás Avellaneda (GK)",
      "Rodrigo Cáseres (CB)",
      "Cristián Gutiérrez (LB)",
      "Bayron Oyarzo (RW)",
      "Francisco Pozzo (ST)"
    ],
    "description": "Primera División de Chile.",
  ...
  },
  {
    ...
    "starPlayers": [
      ...
      "Santiago Silva (CM)",
      "Ezequiel Cañete (CM)",
      "Lionel Altamirano (ST)",
      "Rodrigo Odriozola (GK)",
      "Maximiliano Rodríguez Vejar (ST)",
      "Claudio Sepúlveda (CDM)",
      "Renzo Malanca (CB)",
      "Benjamín Mellado (CB)"
    ],
    "description": "Primera División de Chile.",
  ...
  },
  {
    ...
    "starPlayers": [
      ...
      "Michael Vadulli (LW)",
      "Nicolás Orellana (CM)",
      "Raimundo Rebolledo (RB)",
      "Marco Collao (CM)",
      "Daniel Piña (CB)",
      "Giovani Chiaverano (RW)"
    ],
    "description": "Primera División de Chile.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
  ...
  },
  {
    ...
    "starPlayers": [
      "Jean Meneses (LW)",
      "Joaquín Montecinos (RW)",
      "Nicolás Peñailillo (LB)",
      "Alfonso Parot (LB)",
      "César Pinares (CAM)",
      "Gonzalo Sosa (ST)",
      "Ramón Martínez (CDM)",
  ...
  },
  {
    ...
    "marketValue": 5000000,
    "starPlayers": [
      "Gonzalo Escalante (CM)",
      "Federico Lanzillotta (GK)",
      "Rafael Delgado (LB)",
      "Francis Mac Allister (CDM)",
      "Matías Marín (CM)",
      "Diego Rubio (ST)",
      "Nicolás Stefanelli (ST)",
      "Lucas Alarcón (CB)",
      "Alexander Oroz (LW)",
      "Andrés Zanini (CB)",
      "Ángelo Henríquez (ST)"
  ...
  },
  {
    ...
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "badges/universidad_de_concepción.png",
    "division": 1
  },
  {
    "id": "unión_española",
    ...
    "starPlayers": [
      ...
      "Martín Parra (GK)",
      "Ignacio Núñez (CM)",
      "Sebastián Pereira (CB)",
      "Andrés Vilches (ST)",
      "Bastián Roco (CB)",
      "Bruno Jáuregui (CDM)",
      "Gabriel Norambuena (LB)"
    ],
    "description": "Primera B de Chile.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/7097.png",
    "division": 2
  },
  {
    "id": "deportes_iquique",
  ...
  },
  {
    ...
    "starPlayers": [
      "Leandro Benegas (ST)",
      "Rodrigo Colombo (CB)",
      "Ronald de la Fuente (LB)",
      "Henry Sanhueza (CB)",
      "Joaquín Romo (CM)",
      "Gabriel Sarria (CB)",
      "Damian Ezequiel Tello (GK)",
      "Braulio Guisolfo (CDM)",
      "Javier Retamales (CAM)",
      "Juan Pablo Gómez (RB)",
      "Enzo Ormeño (CM)"
    ],
    "description": "Primera B de Chile.",
  ...
  },
  {
    ...
    "starPlayers": [
      ...
      "Carlos Ross (RW)",
      "John Santander (LB)",
      "Claudio Zamorano (CDM)",
      "Manuel López (ST)",
      "Jorge Ortiz (CAM)",
      "Nicolás Temperini (GK)"
    ],
    "description": "Primera B de Chile.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
  ...
  },
  {
    ...
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/82686.png",
    "division": 2
  },
  {
    "id": "san_marcos_de_arica",
  ...
  },
  {
    ...
    "marketValue": 2500000,
    "starPlayers": [
      "Sebastián Zúñiga (CAM)",
      "Cristian Insaurralde (LW)",
      "Felipe Fritz (LB)",
      "Tomás Aránguiz (CM)",
      "Gustavo Gotti (ST)",
      "Jorge Gatica (CM)",
    ...
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/131.png",
    "division": 2
  },
  {
  ...
  },
  {
    ...
    "starPlayers": [
      "Gonzalo Álvarez (RW)",
      "Francisco Alarcón (CB)",
      "Germán Estigarribia (ST)",
      "Álvaro Salazar (GK)",
      "Felipe Saavedra (LB)",
      "Christian Cepeda (CB)",
      "Camilo Rodríguez (RB)",
  ...
  },
  {
    ...
    "starPlayers": [
      "Brian Torrealba (RB)",
      "Diego Buonanotte (CAM)",
      "Felipe Reynero (RW)",
      "Rodrigo González (RB)",
      "Maximiliano Cuadra (ST)",
      "Yerko Urra (GK)",
      "Camilo Núñez (CDM)",
      "Brayan Valdivia (RW)",
      "Luis Acevedo (ST)",
  ...
  },
  {
    ...
    "starPlayers": [
      ...
      "Ariel Morales (CB)",
      "Kevin Egaña (LB)",
      "Cristóbal Vargas (CAM)",
      "Maximiliano Riveros (CB)",
      "Gabriel Castillo (CM)",
      "Richard Paredes (CAM)"
    ],
    "description": "Primera B de Chile.",
  ...
  },
  {
    ...
    "reputation": 4,
    "initialSalary": 2200,
    "marketValue": 15400000,
    "starPlayers": [
      "Leonardo Fernández (CAM)",
      "Gastón Togni (LM)",
      "Diego Laxalt (LB)",
      "Emanuel Gularte (CB)",
      "Matías Arezo (ST)",
      ...
      "Abel Hernández (ST)",
      "Facundo Batista (ST)",
      "Washington Aguerre (GK)",
      "Lucas Ferreira (CB)",
      "Luis Miguel Angulo (LM)"
    ],
    "description": "El Carbonero.",
    "badgeColor": "border-l-4 border-yellow-500 bg-black text-yellow-300",
    "badgeLogoUrl": "🏆",
    "badgeImageUrl": "https://pub-3bd35431294c47068cbf31a95d572166.r2.dev/logos/penarol/penarol-logo-footylogos.svg",
    "division": 1
  },
  {
    "id": "nacional_uru",
    ...
    "description": "El Bolso.",
    "badgeColor": "border-l-4 border-blue-600 bg-red-950 text-blue-200",
    "badgeLogoUrl": "🔴⚪🔵",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/7098.png",
    "division": 1
  },
  {
    "id": "defensor_sporting",
    ...
    "description": "El Tuerto.",
    "badgeColor": "border-l-4 border-purple-600 bg-purple-900 text-white",
    "badgeLogoUrl": "🟣",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/1465.png",
    "division": 1
  },
  {
    "id": "danubio",
    ...
    "marketValue": 6500000,
    "starPlayers": [
      "Sebastián Rodríguez (CM)",
      "Mauro Goicoechea (GK)",
      "Sebastián Fernández (ST)",
      "Iván Rossi (CDM)",
      "Emiliano Velázquez (CB)",
      "Camilo Mayada (RB)",
      "Tomás Cavanagh (LB)",
      "Leandro Sosa (CDM)",
      "Mateo Rinaldi (CB)",
  ...
  },
  {
    ...
    "starPlayers": [
      ...
      "Tomás Conechny (LM)",
      "Duván Vergara (LW)",
      "Valentín Carboni (CAM)"
    ],
    "description": "Campeonato Uruguayo.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/1444.png",
    "division": 1
  },
  {
    "id": "liverpool_uru",
    ...
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/31.png",
    "division": 1
  },
  {
    "id": "cerro_largo_uru",
    ...
    "starPlayers": [
      "Sebastián Assís (CDM)",
      "Nicolás Bertocchi (CDM)",
      "Lucas Correa (CB)",
      "Gustavo Viera (ST)",
      "Juan Moreno (GK)",
      "Mario García (CM)",
      "Fernando Souza (RB)",
      "Alexander Hernández (CAM)",
      "Maximiliano Añasco (LW)",
      "Ihojan Pérez (RM)",
      "Federico Sellecchia (ST)"
    ],
    "description": "Campeonato Uruguayo.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
  ...
  },
  {
    ...
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://pub-3bd35431294c47068cbf31a95d572166.r2.dev/logos/montevideo-wanderers/montevideo-wanderers-logo-footylogos.svg",
    "division": 1
  },
  {
    "id": "montevideo_city_torque_uru",
    ...
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "badges/montevideo_city_torque_uru.png",
    "division": 1
  },
  {
    "id": "boston_river_uru",
    ...
    "starPlayers": [
      ...
      "Martín González (CB)",
      "Facundo Muñoa (CM)",
      "Facundo Rodríguez (ST)"
    ],
    "description": "Campeonato Uruguayo.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/9168.png",
    "division": 1
  },
  {
    "id": "cerro_uru",
  ...
  },
  {
    ...
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://pub-3bd35431294c47068cbf31a95d572166.r2.dev/logos/progreso/progreso-logo-footylogos.svg",
    "division": 1
  },
  {
    "id": "juventud_de_las_piedras_uru",
  ...
  },
  {
    ...
    "starPlayers": [
      "Hernán Toledo (LM)",
      "Matías de los Santos (CB)",
      "Francisco Ginella (CM)",
      "Tobías Figueroa (ST)",
      "José Álvarez (LM)",
      "Leonardo Pais (RM)",
      "Agustín Pereira (RB)",
  ...
  },
  {
    ...
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/714.png",
    "division": 1
  },
  {
    "id": "maldonado_uru",
    ...
    "starPlayers": [
      ...
      "Hernán Petryk (RB)",
      "Facundo Tealde (CB)",
      "Santiago Cartagena (CDM)",
      "Maximiliano González (CDM)",
      "Adriano Freitas (GK)",
      "Santiago Ramírez (ST)",
      "Maximiliano Noble (CAM)"
    ],
    "description": "Campeonato Uruguayo.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
  ...
  },
  {
    ...
    "starPlayers": [
      ...
      "Martín Pérez Guedes (CM)",
      "Aldo Corzo (CB)",
      "Bryan Reyna (LM)",
      "José Carabalí (LB)",
      "Lisandro Alzugaray (RW)"
    ],
    "description": "Los Cremas.",
    "badgeColor": "border-l-4 border-yellow-200 bg-red-900 text-yellow-100",
    "badgeLogoUrl": "🟨🟥",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/4961.png",
    "division": 1
  },
  {
    ...
    "description": "Los Íntimos.",
    "badgeColor": "border-l-4 border-blue-800 bg-slate-100 text-blue-900",
    "badgeLogoUrl": "🔵⚪",
  ...
  },
  {
    ...
    "marketValue": 8000000,
    "starPlayers": [
      "Santiago González (RW)",
      "Christofer Gonzáles (CAM)",
      "Martín Távara (CM)",
      "Felipe Vizeu (ST)",
      "Gustavo Cazonatti (CDM)",
      "Yoshimar Yotún (CM)",
      "Luis Iberico (ST)",
      "Luis Abram (CB)",
      "Diego Enríquez (GK)",
    ...
    "description": "Los Celestes.",
    "badgeColor": "border-l-4 border-sky-400 bg-sky-800 text-white",
    "badgeLogoUrl": "🩵",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/336.png",
    "division": 1
  },
  {
    "id": "melgar",
  ...
  },
  {
    ...
    "starPlayers": [
      "Kevin Sandoval (LW)",
      "Agustin Gómez (CB)",
      "Horacio Benincasa (CB)",
      "Claudio Torrejón (CDM)",
      "Aldair Salazar (CB)",
      "Patrick Zubczuk (GK)",
      "Agustín González (CM)",
      "Agustín Graneros (ST)",
      "José Luis Sinisterra (ST)",
      "Francisco Arancibia (RW)",
      "Beto da Silva (LW)"
    ],
    "description": "Liga 1 Te Apuesto.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/1108.png",
    "division": 1
  },
  {
    "id": "adt",
  ...
  },
  {
    ...
    "starPlayers": [
      ...
      "Ángel Zamudio (GK)",
      "Ricardo Salcedo (CDM)",
      "Javier Sanguinetti (CAM)",
      "Jeremy Rostaing (RB)",
      "Hugo Ángeles Chávez (LB)",
      "Yonatan Murillo (CB)",
      "Nahuel Luján (LW)",
      "Diego Campos (GK)",
      "Ronal Huaccha (ST)"
  ...
  },
  {
    ...
    "starPlayers": [
      ...
      "Rodrigo Tapia (CB)",
      "Freddy Oncoy (CM)",
      "Rafael Guarderas (CDM)",
      "Elsar Rodas (LB)",
      "Nicolás Delgadillo (LW)",
      "Paulo de la Cruz (RW)",
      "Lucas Acevedo (CB)",
      "Diego Barreto (CAM)",
      "Cristian Neira (CAM)"
    ...
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/17554.png",
    "division": 1
  },
  {
    "id": "cusco_fc",
    ...
    "starPlayers": [
      ...
      "Andy Vidal (GK)",
      "Lucas Colitto (LW)",
      "Gabriel Carabajal (CAM)",
      "Nicolás Silva (RW)",
      "Facundo Callejo (ST)",
      "Miguel Aucca (CM)",
      "Oswaldo Valenzuela (CDM)",
      "Juan Manuel Tévez (ST)",
      "Aldair Fuentes (CB)",
      "José Bolívar (LB)"
    ],
    "description": "Liga 1 Te Apuesto.",
  ...
  },
  {
    ...
    "starPlayers": [
      ...
      "Kevin Becerra (CB)",
      "Ademar Robles (CM)",
      "Maximiliano Amondarain (CB)"
    ],
    "description": "Liga 1 Te Apuesto.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/51772.png",
    "division": 1
  },
  {
    "id": "los_chankas",
  ...
  },
  {
    ...
    "starPlayers": [
      ...
      "Gustavo Aliaga (CM)",
      "Jorge Toledo (RB)",
      "Maximiliano Juambeltz (ST)",
      "Adán Henricks (ST)"
    ],
    "description": "Liga 1 Te Apuesto.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://pub-3bd35431294c47068cbf31a95d572166.r2.dev/logos/adc-juan-pablo-ii/adc-juan-pablo-ii-logo-footylogos.svg",
    "division": 1
  },
  {
    "id": "fc_cajamarca",
    ...
    "starPlayers": [
      "Hernán Barcos (ST)",
      "Pablo Míguez (CB)",
      "Pablo Lavandeira (CAM)",
      "Brandon Palacios (LW)",
      "Enmanuel Páucar (CDM)",
      "Nilson Loyola (LB)",
      "Jonathan Betancourt (LW)",
      "Ricardo Lagos (LB)",
      "Tomás Andrade (CAM)",
      "Matías Almirón (CB)",
      "Jefferson Orejuela (CDM)"
    ],
    "description": "Liga 1 Te Apuesto.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/2521.png",
    "division": 1
  },
  {
    "id": "moquegua",
  ...
  },
  {
    ...
    "description": "El Rey de Copas.",
    "badgeColor": "border-l-4 border-gray-100 bg-slate-900 text-white",
    "badgeLogoUrl": "⚪",
  ...
  },
  {
    ...
    "description": "El Matagigantes.",
    "badgeColor": "border-l-4 border-pink-700 bg-indigo-950 text-pink-200",
    "badgeLogoUrl": "🛡️",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/10093.png",
    "division": 1
  },
  {
    ...
    "starPlayers": [
      ...
      "Tomás Martínez (CAM)",
      "Bryan Carabalí (RB)",
      "Gustavo Vallecilla (CB)",
      "Jefferson Intriago (CM)",
      "Jhonny Quiñónez (CDM)",
      "Byron Castillo (RB)"
    ],
    "description": "El Ídolo del Astillero.",
    "badgeColor": "border-l-4 border-red-600 bg-yellow-500 text-black",
    "badgeLogoUrl": "🟡",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/131.png",
    "division": 1
  },
  {
    ...
    "description": "El Bombillo.",
    "badgeColor": "border-l-4 border-gray-300 bg-blue-800 text-white",
    "badgeLogoUrl": "💡",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/1531.png",
    "division": 1
  },
  {
    "id": "técnico_universitario",
  ...
  },
  {
    ...
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://pub-3bd35431294c47068cbf31a95d572166.r2.dev/logos/delfin-sc/delfin-sc-logo-footylogos.svg",
    "division": 1
  },
  {
    "id": "deportivo_cuenca",
  ...
  },
  {
    ...
    "marketValue": 5000000,
    "starPlayers": [
      "José Luis Marrufo (CB)",
      "Federico Paz (ST)",
      "José Luis Cazares (CDM)",
      "Rodrigo Rodríguez (GK)",
      "Gastón Blanc (CM)",
      "Jean Carlos Estacio (CDM)",
      "Denilson Bolaños (RB)",
      "Santiago Etchebarne (CB)",
      "Luis Ayala (LB)",
      "Franco Posse (ST)",
      "Marlon Medranda (LB)"
    ],
    ...
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://pub-3bd35431294c47068cbf31a95d572166.r2.dev/logos/cd-macara/cd-macara-logo-footylogos.svg",
    "division": 1
  },
  {
    "id": "aucas",
  ...
  },
  {
    ...
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/979.png",
    "division": 1
  },
  {
    "id": "libertad_fc",
  ...
  },
  {
    ...
    "marketValue": 5000000,
    "starPlayers": [
      "Juan Luis Anangonó (ST)",
      "Segundo Portocarrero (LM)",
      "Charles Vélez (CDM)",
      "Kevin Mina (ST)",
      "José Angulo (GK)",
      "Cristhian Solano (LW)",
  ...
  {
    "id": "independiente_del_valle_juniors",
    "name": "Independiente del Valle Juniors",
    "league": "Ecuatoriana",
    "dt": "DT Genérico",
    "reputation": 1,
    "initialSalary": 700,
  ...
  },
  {
    ...
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/86.png",
    "division": 2
  },
  {
    "id": "atlético_fc",
  ...
  {
    "id": "dep_santo_domingo",
    "name": "Dep. Santo Domingo",
    "league": "Ecuatoriana",
    "dt": "DT Genérico",
    "reputation": 1,
    "initialSalary": 700,
  ...
  },
  {
    ...
    "starPlayers": [
      "Marvin Bejarano (LB)",
      "Robson (CB)",
      "Rolando Blackburn (ST)",
      "Gonzalo Rehak (GK)",
      "Jorge Scolari (CB)",
      "Leandro Corulo (CB)",
      "Limberg Gutiérrez (CAM)",
      "Santiago Cuiza (CDM)",
      "Diego Wayar (CDM)",
      "Alexis Ribera (RM)",
      "Cristhian Árabe (CM)"
  ...
  },
  {
    ...
    "marketValue": 8000000,
    "starPlayers": [
      "Martín Cauteruccio (ST)",
      "Carlos Lampe (GK)",
      "Damian Batallini (RW)",
      "Patricio Rodríguez (LW)",
      "Braian Oyola (LM)",
      "Carlos Melgar (CAM)",
      "José Sagredo (CB)",
      "Xavier Arreaga (CB)",
      "Santiago Echeverría (CB)",
      "Leonel Justiniano (CM)",
      "Erwin Saavedra (RM)"
    ],
    "description": "Equipo compitiendo en Liga Boliviana.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
  ...
  },
  {
    ...
    "starPlayers": [
      ...
      "Luis Alí (RW)",
      "Fran Supayabe (RB)",
      "Vladimir Castellón (ST)",
      "Bleiner Agrón (CB)",
      "Gonzalo Añasgo (LB)",
      "Carlos Chore (CB)",
      "Emerson Velasquez (CB)",
      "Luis Vargas (CM)",
      "Maximiliano Gómez (RW)",
      "Juan Pablo Rioja (CB)"
    ],
    "description": "Equipo compitiendo en Liga Boliviana.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
  ...
  },
  {
    ...
    "starPlayers": [
      "Bayron Garcés (ST)",
      "Moisés Villarroel (CM)",
      "Jeyson Chura (RM)",
      "Roberto Hinojoza (CAM)",
      "Marc Enoumba (CB)",
      "Braulio Uraezaña (GK)",
      "José María Carrasco (CB)",
      "Gabriel Valverde (CB)",
      "Matías Abisab (CAM)",
      "César Menacho (RW)",
      "Auli Oliveros (CAM)"
  ...
  },
  {
    ...
    "starPlayers": [
      ...
      "José Verdún (ST)",
      "Rubén Cordano (GK)",
      "Erwin Junior Sánchez (CM)",
      "Rodrigo Ramallo (LW)",
      "Luis Barbosa (CB)",
      "John Deiby Araujo (RW)",
      "Oscar Vaca (LB)",
      "Jefferson Ramos (ST)",
      "Jaime Cornejo (RM)"
    ],
  ...
  },
  {
    ...
    "starPlayers": [
      ...
      "David Robles (CB)",
      "Milton Maciel (RM)",
      "Jorge Enrique Flores (LB)",
      "Ramiro Cristóbal (CDM)",
      "Carlos Añez (RW)",
      "Jorge Araúz (GK)",
      "Denilso Fernandez (RW)"
    ],
    "description": "Equipo compitiendo en Liga Boliviana.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
  ...
  },
  {
    ...
    "starPlayers": [
      ...
      "Ángel Benítez (CDM)",
      "Kevin Pereira (RW)",
      "Fernando Benítez (CDM)",
      "Sebastián Quintana (CM)"
    ],
  ...
  },
  {
    ...
    "starPlayers": [
      ...
      "Alejandro Silva (CM)",
      "Bryan Bentaberry (CB)",
      "Juan Fernando Alfaro (CM)",
      "Richard Ortiz (CDM)",
      "Alan Rodríguez (LB)",
      "Sebastián Ferreira (ST)"
    ],
    "description": "Equipo compitiendo en Liga Paraguaya.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
  ...
  },
  {
    ...
    "marketValue": 8000000,
    "starPlayers": [
      "Cecilio Domínguez (RW)",
      "Pablo Vegetti (ST)",
      "Gustavo Velázquez (CB)",
      "Ignacio Aliseda (LW)",
      "Jonatan Torres (ST)",
      "Mateo Klimowicz (CAM)",
      "Alexis Martín Arias (GK)",
      "Juan Iturbe (CAM)",
      "Santiago Mosquera (LW)",
      "Gastón Giménez (CDM)",
      "Roberto Fernández (GK)"
    ],
    "description": "Equipo compitiendo en Liga Paraguaya.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
  ...
  },
  {
    ...
    "starPlayers": [
      "Gaspar Servio (GK)",
      "Fernando Fernández (ST)",
      "Diego Fernández (LM)",
      "Juan Daniel Pérez (RB)",
      "Agustín Manzur (CM)",
      "Patricio Tanda (CDM)",
      "Marcos Gómez (CM)",
      "Imanol Segovia (CB)",
  ...
  },
  {
    ...
    "starPlayers": [
      "Brian Blasi (RB)",
      "Rodrigo Rojas (CM)",
      "Ángel Cardozo Lucena (CM)",
      "Rodi Ferreira (RB)",
      "William Mendieta (CAM)",
      "Elías Sarquis (LM)",
      "Fernando Martínez (CDM)",
      "Gustavo Manzur (CDM)",
      "Javier Vallejos (CB)",
      "Mauricio Roldán (ST)",
      "Pedro Báez (ST)"
  ...
  },
  {
    ...
    "marketValue": 3500000,
    "starPlayers": [
      "Alexander González (RB)",
      "Lucas Bruera (GK)",
      "Jean Franco Fuentes (CB)",
      "Maurice Cova (CM)",
      "Jonathan Bilbao (CB)",
      "Edson Tortolero (CAM)",
      "Leonardo Aponte (CB)",
  ...
  },
  {
    ...
    "starPlayers": [
      ...
      "Jesús Yendis (LB)",
      "Michael Covea (CAM)",
      "Frankarlos Benítez (GK)",
      "Eduardo Fereira (RB)",
      "Francisco La Mantía (CB)",
  ...
  },
  {
    ...
    "starPlayers": [
      ...
      "Joyce Ossa (CB)",
      "Edder Farías (ST)",
      "Felipe Jaramillo (CDM)",
      "Jean Colorado (CM)",
      "Édgar Carrión (LW)",
      "Eduardo Lima (GK)",
      "Jeferson Caraballo (CM)",
      "Franklin González (ST)",
      "Fernando Basante (ST)",
      "Thomas Riveros (GK)"
    ],
    "description": "Equipo compitiendo en Liga Venezolana.",
  ...
  },
  {
    ...
    "starPlayers": [
      "Lautaro Morales (GK)",
      "Kendrys Silva (RB)",
      "Juan Camilo Zapata (ST)",
      "Samuel Sosa (RW)",
      "Jovanny Bolívar (ST)",
      "Yanniel Hernández (LB)",
      "Charlis Ortiz (ST)",
      "Vicente Rodríguez (CM)",
      "Francisco Solé (CDM)",
      "Juan Manuel Cuesta (CAM)",
      "Carlos Cermeño (CM)"
    ],
    "description": "Equipo compitiendo en Liga Venezolana.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
  ...
  },
  {
    ...
    "starPlayers": [
      "Julián Figueroa (CDM)",
      "Kevin De la Hoz (CB)",
      "Juan Carlos Ortíz (RW)",
      "Jorge Páez (CM)",
      "José Rivas (ST)",
      "Francisco Bareiro (ST)",
      "Luis Terán (GK)",
      "Steven Pabón (CB)",
      "Marlon Fernández (CAM)",
      "Enderson Torrealba (RW)",
      "Kevin González (CDM)"
    ],
    "description": "Equipo compitiendo en Liga Venezolana.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
  ...
  },
  {
    ...
    "starPlayers": [
      ...
      "Yan Sasse (RW)",
      "Bechir Ben Said (GK)",
      "Mohamed Amine Tougai (CB)",
      "Chiheb Jebali (CAM)",
      "Mohamed Amine Ben Hamida (LB)",
      "Kouceila Boualia (RW)",
      "Houssem Tka (CM)",
      "Florian Thomas Danho (ST)"
    ],
    "description": "Equipo compitiendo en Resto del Mundo.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
  ...
  },
  {
    ...
    "starPlayers": [
      ...
      "Said El Mala (LM)",
      "Marius Bülter (ST)",
      "Alessio Castro-Montes (RM)",
      "Ísak Bergmann Jóhannesson (CM)",
      "Ragnar Ache (ST)",
      "Tom Krauß (CDM)",
      "Ron-Robert Zieler (GK)",
      "Sebastian Sebulonsen (RB)"
    ],
    "description": "1. FC Köln. Compite en Bundesliga.",
    "badgeColor": "border-l-4 border-red-600 bg-slate-900/40 text-red-200",
    "badgeLogoUrl": "🔴⚪",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/3.png",
    "division": 1
  },
  {
    "id": "1_fsv_mainz_05",
    ...
    "starPlayers": [
      ...
      "Danny da Costa (CB)",
      "Phillipp Mwene (LB)",
      "Benedict Hollerbach (ST)"
    ],
    "description": "1. FSV Mainz 05. Compite en Bundesliga.",
    "badgeColor": "border-l-4 border-red-600 bg-red-950/40 text-red-200",
    "badgeLogoUrl": "🔴⚪",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/39.png",
    "division": 1
  },
  {
    ...
    "description": "Borussia Dortmund. Compite en Bundesliga.",
    "badgeColor": "border-l-4 border-yellow-400 bg-zinc-950/40 text-yellow-300",
    "badgeLogoUrl": "💛🖤",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/16.png",
    "division": 1
  },
  {
    ...
    "description": "Borussia Mönchengladbach. Compite en Bundesliga.",
    "badgeColor": "border-l-4 border-zinc-300 bg-zinc-950/40 text-zinc-200",
    "badgeLogoUrl": "⚫⚪",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/18.png",
    "division": 1
  },
  {
    ...
    "starPlayers": [
      ...
      "Can Uzun (CAM)",
      "Hugo Larsson (CM)",
      "Arnaud Kalimuendo (ST)",
      "Ellyes Skhiri (CDM)"
    ],
    "description": "Eintracht Frankfurt. Compite en Bundesliga.",
    "badgeColor": "border-l-4 border-red-600 bg-zinc-950/40 text-red-200",
    "badgeLogoUrl": "⚫🔴",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/24.png",
    "division": 1
  },
  {
    "id": "fc_augsburg",
    ...
    "marketValue": 10000000,
    "starPlayers": [
      "Jeffrey Gouweleeuw (CB)",
      "Chrislain Matsima (CB)",
      "Finn Dahmen (GK)",
      "Dimitris Giannoulis (LB)",
      "Alexis Claude-Maurice (CAM)",
      "Keven Schlotterbeck (CB)",
      "Kristijan Jakić (CDM)",
      "Han-Noah Massengo (CDM)",
      "Michael Gregoritsch (ST)",
      "Cédric Zesiger (CB)",
      "Robin Fellhauer (CDM)"
    ],
    "description": "FC Augsburg. Compite en Bundesliga.",
    "badgeColor": "border-l-4 border-red-600 bg-green-950/40 text-red-200",
    "badgeLogoUrl": "🔴🟢",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/167.png",
    "division": 1
  },
  {
    "id": "fc_bayern_munchen",
    ...
    "description": "FC Bayern München. Compite en Bundesliga.",
    "badgeColor": "border-l-4 border-red-600 bg-red-950/40 text-red-200",
    "badgeLogoUrl": "🔴⚪",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/27.png",
    "division": 1
  },
  {
    "id": "fc_heidenheim",
    ...
    "description": "FC Heidenheim. Compite en Bundesliga.",
    "badgeColor": "border-l-4 border-red-600 bg-blue-950/40 text-red-200",
    "badgeLogoUrl": "🔴🔵",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/1158.png",
    "division": 1
  },
  {
    ...
    "starPlayers": [
      ...
      "Eric Smith (CB)",
      "Jackson Irvine (CM)",
      "Mathias Rasmussen (CM)",
      "Mathias Pereira Lage (ST)",
      "Manolis Saliakas (RB)",
      "Joel Chima Fujita (CM)",
      "Martijn Kaars (ST)",
      "James Sands (CDM)",
      "Danel Sinani (CAM)"
    ],
    "description": "FC St. Pauli. Compite en Bundesliga.",
    "badgeColor": "border-l-4 border-amber-800 bg-zinc-950/40 text-amber-200",
    "badgeLogoUrl": "🟤⚪",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/873.png",
    "division": 1
  },
  {
    "id": "rb_leipzig",
    ...
    "starPlayers": [
      ...
      "David Raum (LB)",
      "Castello Lukeba (CB)",
      "Christoph Baumgartner (CAM)",
      "Benjamin Henrichs (RB)",
      "Ridle Baku (RB)",
      "Nicolas Seiwald (CDM)",
      "Yan Diomande (RW)",
      "Rômulo (ST)",
    ...
    "description": "RB Leipzig. Compite en Bundesliga.",
    "badgeColor": "border-l-4 border-red-500 bg-slate-900/40 text-red-200",
    "badgeLogoUrl": "🔴⚪",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/23826.png",
    "division": 1
  },
  {
    "id": "sc_freiburg",
    ...
    "description": "SC Freiburg. Compite en Bundesliga.",
    "badgeColor": "border-l-4 border-red-600 bg-zinc-950/40 text-red-200",
    "badgeLogoUrl": "🔴⚫",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/60.png",
    "division": 1
  },
  {
    "id": "sv_werder_bremen",
    ...
    "description": "SV Werder Bremen. Compite en Bundesliga.",
    "badgeColor": "border-l-4 border-green-600 bg-green-950/40 text-green-200",
    "badgeLogoUrl": "🟢⚪",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/86.png",
    "division": 1
  },
  {
    ...
    "description": "TSG Hoffenheim. Compite en Bundesliga.",
    "badgeColor": "border-l-4 border-blue-500 bg-blue-950/40 text-blue-200",
    "badgeLogoUrl": "🔵⚪",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/533.png",
    "division": 1
  },
  {
    "id": "union_berlin",
    ...
    "description": "1. FC Union Berlin. Compite en Bundesliga.",
    "badgeColor": "border-l-4 border-red-600 bg-red-950/40 text-yellow-300",
    "badgeLogoUrl": "🔴🟡",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/89.png",
    "division": 1
  },
  {
    "id": "vfl_wolfsburg",
    ...
    "starPlayers": [
      ...
      "Denis Vavro (CB)",
      "Moritz Jenz (CB)",
      "Konstantinos Koulierakis (CB)",
      "Christian Eriksen (CAM)",
      "Mattias Svanberg (CM)"
    ],
    "description": "VfL Wolfsburg. Compite en Bundesliga.",
    "badgeColor": "border-l-4 border-green-500 bg-green-950/40 text-green-200",
    "badgeLogoUrl": "🟢⚪",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/167.png",
    "division": 1
  },
  {
    ...
    "starPlayers": [
      ...
      "Jamie Leweling (RM)",
      "Bilal El Khannouss (CAM)",
      "Atakan Karazor (CDM)",
      "Chris Führich (LM)",
      "Tiago Tomás (LM)"
    ],
    "description": "VfB Stuttgart. Compite en Bundesliga.",
    "badgeColor": "border-l-4 border-red-600 bg-slate-900/40 text-red-200",
    "badgeLogoUrl": "🔴⚪",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/79.png",
    "division": 1
  },
  {
    "id": "bayer_leverkusen",
    ...
    "description": "Bayer 04 Leverkusen. Compite en Bundesliga.",
    "badgeColor": "border-l-4 border-red-600 bg-zinc-950/40 text-red-300",
    "badgeLogoUrl": "🔴⚫",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/15.png",
    "division": 1
  },
  {
    "id": "hamburg",
    ...
    "description": "Hamburger SV. Compite en Bundesliga.",
    "badgeColor": "border-l-4 border-blue-700 bg-zinc-950/40 text-blue-200",
    "badgeLogoUrl": "🔵⚫",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/41.png",
    "division": 1
  },
  {
    "id": "1_fc_kaiserslautern",
    "name": "1. FC Kaiserslautern",
    "league": "Alemana",
    "dt": "Torsten Lieberknecht",
    "reputation": 2,
    "initialSalary": 800,
    "marketValue": 2500000,
    "starPlayers": [
    ...
    "description": "1. FC Kaiserslautern. Compite en Bundesliga 2.",
    "badgeColor": "border-l-4 border-red-600 bg-red-950/40 text-red-200",
    "badgeLogoUrl": "🔴⚪",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/3.png",
    "division": 2
  },
  {
    ...
    "description": "1. FC Nürnberg. Compite en Bundesliga 2.",
    "badgeColor": "border-l-4 border-red-800 bg-zinc-950/40 text-red-200",
    "badgeLogoUrl": "🔴⚪",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/89.png",
    "division": 2
  },
  {
    ...
    "description": "Darmstadt 98. Compite en Bundesliga 2.",
    "badgeColor": "border-l-4 border-blue-600 bg-blue-950/40 text-blue-200",
    "badgeLogoUrl": "🔵⚪",
    "badgeImageUrl": "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3a/Darmstadt_98_football_club_new_logo_2015.png/250px-Darmstadt_98_football_club_new_logo_2015.png",
    "division": 2
  },
  {
    ...
    "description": "Eintracht Braunschweig. Compite en Bundesliga 2.",
    "badgeColor": "border-l-4 border-yellow-400 bg-blue-950/40 text-yellow-300",
    "badgeLogoUrl": "🦁🟡",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/24.png",
    "division": 2
  },
  {
    ...
    "marketValue": 2500000,
    "starPlayers": [
      "Florian Kastenmeier (GK)",
      "Tim Oberdorf (CB)",
      "Florent Muslija (CAM)",
      "Jesper Daland (CB)",
      "Cedric Itten (ST)",
      "Marin Ljubičić (ST)",
      "Anouar El Azzouzi (CDM)",
      "Matthias Zimmermann (RB)",
      "Tim Breithaupt (CDM)",
      "Emmanuel Iyoha (LM)",
      "Christopher Lenz (LB)"
    ],
    "description": "Fortuna Düsseldorf. Compite en Bundesliga 2.",
    "badgeColor": "border-l-4 border-red-600 bg-slate-900/40 text-red-200",
    "badgeLogoUrl": "🔴⚪",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/32041.png",
    "division": 2
  },
  {
    ...
    "description": "Greuther Fürth. Compite en Bundesliga 2.",
    "badgeColor": "border-l-4 border-green-600 bg-green-950/40 text-green-200",
    "badgeLogoUrl": "🟢⚪",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/3709.png",
    "division": 2
  },
  {
    "id": "hannover_96",
    ...
    "description": "Hannover 96. Compite en Bundesliga 2.",
    "badgeColor": "border-l-4 border-green-600 bg-zinc-950/40 text-green-200",
    "badgeLogoUrl": "🟢⚫",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/6321.png",
    "division": 2
  },
  {
    "id": "hertha_bsc",
    ...
    "description": "Hertha BSC. Compite en Bundesliga 2.",
    "badgeColor": "border-l-4 border-blue-600 bg-blue-950/40 text-blue-200",
    "badgeLogoUrl": "🔵⚪",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/4961.png",
    "division": 2
  },
  {
    ...
    "starPlayers": [
      ...
      "Sebastian Jung (RB)",
      "David Herold (LB)",
      "Fabian Schleusener (ST)",
      "Christoph Kobald (CB)",
      "Dženis Burnić (CM)",
      "Nicolai Rapp (CB)",
      "Marcel Beifus (CB)",
      "Hans Christian Bernat (GK)",
      "Stephan Ambrosius (CB)"
    ],
    "description": "Karlsruher SC. Compite en Bundesliga 2.",
    "badgeColor": "border-l-4 border-sky-500 bg-sky-950/40 text-sky-200",
    "badgeLogoUrl": "🔵⚪",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/1420.png",
    "division": 2
  },
  {
    "id": "magdeburg",
    ...
    "description": "1. FC Magdeburg. Compite en Bundesliga 2.",
    "badgeColor": "border-l-4 border-blue-600 bg-blue-950/40 text-blue-200",
    "badgeLogoUrl": "🔵⚪",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/167.png",
    "division": 2
  },
  {
    ...
    "description": "Preußen Münster. Compite en Bundesliga 2.",
    "badgeColor": "border-l-4 border-green-600 bg-zinc-950/40 text-green-200",
    "badgeLogoUrl": "⚫💚",
    "division": 2
  },
  {
    ...
    "starPlayers": [
      ...
      "Timo Becker (CB)",
      "Hasan Kuruçay (CB)",
      "Ron Schallenberg (CDM)"
    ],
    "description": "FC Schalke 04. Compite en Bundesliga 2.",
    "badgeColor": "border-l-4 border-blue-700 bg-blue-950/40 text-blue-200",
    "badgeLogoUrl": "🔵⚪",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/33.png",
    "division": 2
  },
  {
    "id": "sc_paderborn_07",
    ...
    "starPlayers": [
      ...
      "Raphael Obermair (RM)",
      "Filip Bilbija (CAM)",
      "Calvin Brackelmann (CB)",
      "Dennis Seimen (GK)",
      "Tjark Scheller (CB)",
      "Laurin Curda (RM)",
      "Santiago Castañeda (CDM)",
      "Mika Baur (CM)",
      "Steffen Tigges (ST)",
      "Sebastian Klaas (CM)"
    ],
    "description": "SC Paderborn 07. Compite en Bundesliga 2.",
    "badgeColor": "border-l-4 border-blue-600 bg-blue-950/40 text-blue-200",
    "badgeLogoUrl": "🔵⚪",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/127.png",
    "division": 2
  },
  {
    "id": "sv_elversberg",
    ...
    "starPlayers": [
      ...
      "Łukasz Poręba (CDM)",
      "Immanuel Pherai (CAM)",
      "Florian Le Joncour (CB)",
      "Bambasé Conté (CAM)",
      "Jan Gyamerah (RB)",
      "Lasse Günther (LB)"
    ],
    "description": "SV Elversberg. Compite en Bundesliga 2.",
    "badgeColor": "border-l-4 border-blue-500 bg-blue-950/40 text-blue-200",
    "badgeLogoUrl": "🔵⚪",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/64.png",
    "division": 2
  },
  {
    "id": "holstein_kiel",
    ...
    "starPlayers": [
      ...
      "Marco Komenda (CB)",
      "Marko Ivezić (CB)",
      "Jonas Therkelsen (CAM)"
    ],
    "description": "Holstein Kiel. Compite en Bundesliga 2.",
    "badgeColor": "border-l-4 border-blue-600 bg-blue-950/40 text-blue-200",
    "badgeLogoUrl": "🔵⚪",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/405.png",
    "division": 2
  },
  {
    ...
    "description": "VfL Bochum. Compite en Bundesliga 2.",
    "badgeColor": "border-l-4 border-sky-600 bg-blue-950/40 text-sky-200",
    "badgeLogoUrl": "🔵⚪",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/4035.png",
    "division": 2
  },
  {
    ...
    "starPlayers": [
      ...
      "Jonas Kersken (GK)",
      "Tim Handwerker (LB)",
      "Thaddäus-Monju Momuluh (RM)",
      "Marius Wörl (CM)",
      "Joel Grodowski (ST)",
      "Noah Joel Sarenren Bazee (RW)"
    ],
    "description": "Arminia Bielefeld. Compite en Bundesliga 2.",
    "badgeColor": "border-l-4 border-sky-400 bg-zinc-950/40 text-sky-200",
    "badgeLogoUrl": "⚫🔵",
    "badgeImageUrl": "https://pub-3bd35431294c47068cbf31a95d572166.r2.dev/logos/arminia-bielefeld/arminia-bielefeld-logo-footylogos.svg",
    "division": 2
  },
  {
    "id": "dynamo_dresden",
    ...
    "starPlayers": [
      "Niklas Hauptmann (CM)",
      "Christoph Daferner (ST)",
      "Elias Bethke (GK)",
      "Tim Schreiber (GK)",
      "Thomas Keller (CB)",
      "Alexander Rossipal (LB)",
      "Robert Wagner (CM)",
      "Jakob Lemmer (RW)",
      "Vinko Šapina (CDM)",
      "Jonas Sterner (RB)",
    ...
    "description": "Dynamo Dresden. Compite en Bundesliga 2.",
    "badgeColor": "border-l-4 border-yellow-400 bg-zinc-950/40 text-yellow-300",
    "badgeLogoUrl": "💛🖤",
    "badgeImageUrl": "https://pub-3bd35431294c47068cbf31a95d572166.r2.dev/logos/dynamo-dresden/dynamo-dresden-logo-footylogos.svg",
    "division": 2
  },
  {
    "id": "arsenal",
    ...
    "description": "Arsenal. Compite en Premier League.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/11.png",
    "division": 1
  },
  {
    ...
    "description": "Chelsea. Compite en Premier League.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/631.png",
    "division": 1
  },
  {
    "id": "liverpool_eng",
    ...
    "description": "Liverpool. Compite en Premier League.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/31.png",
    "division": 1
  },
  {
    ...
    "description": "Manchester City. Compite en Premier League.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/281.png",
    "division": 1
  },
  {
    ...
    "description": "Manchester United. Compite en Premier League.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/985.png",
    "division": 1
  },
  {
    ...
    "description": "Tottenham Hotspur. Compite en Premier League.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/148.png",
    "division": 1
  },
  {
    "id": "newcastle_united",
    ...
    "description": "Newcastle United. Compite en Premier League.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/762.png",
    "division": 1
  },
  {
    "id": "aston_villa",
    ...
    "description": "Aston Villa. Compite en Premier League.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/405.png",
    "division": 1
  },
  {
    ...
    "description": "West Ham United. Compite en Premier League.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/399.png",
    "division": 1
  },
  {
    "id": "brighton_hove_albion",
    ...
    "description": "Brighton & Hove Albion. Compite en Premier League.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/1237.png",
    "division": 1
  },
  {
    "id": "brentford",
    ...
    "description": "Brentford. Compite en Premier League.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/1148.png",
    "division": 1
  },
  {
    "id": "crystal_palace",
    ...
    "description": "Crystal Palace. Compite en Premier League.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/873.png",
    "division": 1
  },
  {
    ...
    "starPlayers": [
      ...
      "Idrissa Gueye (CDM)",
      "Kiernan Dewsbury-Hall (CAM)",
      "Vitaliy Mykolenko (LB)",
      "Dwight McNeil (LM)",
      "Jake O'Brien (RB)"
    ],
    "description": "Everton. Compite en Premier League.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/29.png",
    "division": 1
  },
  {
    ...
    "description": "Fulham. Compite en Premier League.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/931.png",
    "division": 1
  },
  {
    ...
    "starPlayers": [
      ...
      "Sam Johnstone (GK)",
      "Hugo Bueno (LB)",
      "Jean-Ricner Bellegarde (CAM)",
      "Toti (CB)"
    ],
    "description": "Wolverhampton Wanderers. Compite en Premier League.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/23194.png",
    "division": 1
  },
  {
    ...
    "starPlayers": [
      ...
      "Stefan Ortega (GK)",
      "Ibrahim Sangaré (CDM)",
      "Callum Hudson-Odoi (LM)"
    ],
    "description": "Nottingham Forest. Compite en Premier League.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/703.png",
    "division": 1
  },
  {
    "id": "afc_bournemouth",
    ...
    "starPlayers": [
      ...
      "Bafodé Diakité (CB)",
      "Justin Kluivert (CAM)",
      "Eli Junior Kroupi (ST)",
      "Ryan Christie (CDM)",
      "Lewis Cook (CDM)"
    ],
    "description": "AFC Bournemouth. Compite en Premier League.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/989.png",
    "division": 1
  },
  {
    "id": "burnley",
    ...
    "description": "Burnley. Compite en Premier League.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://pub-3bd35431294c47068cbf31a95d572166.r2.dev/logos/burnley/burnley-logo-footylogos.svg",
    "division": 1
  },
  {
    "id": "leeds_united",
    ...
    "description": "Leeds United. Compite en Premier League.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/399.png",
    "division": 1
  },
  {
    ...
    "description": "Sunderland. Compite en Premier League.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/289.png",
    "division": 1
  },
  {
    "id": "atalanta",
    ...
    "description": "Atalanta. Compite en Serie A Enilive.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/51663.png",
    "division": 1
  },
  {
    ...
    "description": "Bologna. Compite en Serie A Enilive.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/1025.png",
    "division": 1
  },
  {
    "id": "cagliari",
    ...
    "starPlayers": [
      "Elia Caprile (GK)",
      "Yerry Mina (CB)",
      "Sebastiano Esposito (ST)",
      "Michael Folorunsho (CM)",
      "Andrea Belotti (ST)",
      "Marco Palestra (RB)",
      "Semih Kılıçsoy (ST)",
      "Zé Pedro (CB)",
      ...
      "Michel Ndary Adopo (CM)"
    ],
    "description": "Cagliari. Compite en Serie A Enilive.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/1390.png",
    "division": 1
  },
  {
    "id": "como",
    ...
    "description": "Como. Compite en Serie A Enilive.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/1047.png",
    "division": 1
  },
  {
    "id": "empoli",
    ...
    "description": "Empoli. Compite en Serie A Enilive.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/6195.png",
    "division": 1
  },
  {
    "id": "fiorentina",
    ...
    "starPlayers": [
      ...
      "Robin Gosens (LB)",
      "Dodô (RB)",
      "Albert Guðmundsson (ST)",
      "Manor Solomon (LM)",
      "Nicolò Fagioli (CM)",
      "Rolando Mandragora (CM)",
      "Luca Ranieri (CB)",
      "Roberto Piccoli (ST)",
      "Fabiano Parisi (LB)"
    ],
    "description": "Fiorentina. Compite en Serie A Enilive.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/430.png",
    "division": 1
  },
  {
    "id": "genoa",
    ...
    "starPlayers": [
      ...
      "Leo Østigård (CB)",
      "Johan Vásquez (CB)",
      "Ruslan Malinovskyi (CM)",
      "Vitinha (ST)",
      "Brooke Norton-Cuffy (RB)",
      "Aarón Martín (LB)",
      "Tommaso Baldanzi (CAM)",
      "Maxwel Cornet (LM)",
      "Nicola Leali (GK)"
    ],
    "description": "Genoa. Compite en Serie A Enilive.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/252.png",
    "division": 1
  },
  {
    "id": "hellas_verona",
    ...
    "starPlayers": [
      ...
      "Victor Nelsson (CB)",
      "Gift Orban (ST)",
      "Nicolás Valentini (CB)",
      "Pol Lirola (RB)",
      "Sandi Lovrič (CM)",
      "Armel Bella-Kotchap (CB)",
      "Domagoj Bradarić (LB)",
      "Roberto Gagliardini (CDM)"
    ],
    "description": "Hellas Verona. Descendió a la Serie BKT para la temporada 2026-27.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/12.png",
    "division": 2
  },
  {
    ...
    "description": "Inter. Compite en Serie A Enilive.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/46.png",
    "division": 1
  },
  {
    ...
    "description": "Juventus. Compite en Serie A Enilive.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/506.png",
    "division": 1
  },
  {
    ...
    "description": "Lazio. Compite en Serie A Enilive.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/398.png",
    "division": 1
  },
  {
    "id": "lecce",
    ...
    "marketValue": 10000000,
    "starPlayers": [
      "Wladimiro Falcone (GK)",
      "Antonino Gallo (LB)",
      "Lassana Coulibaly (CDM)",
      "Riccardo Sottil (LM)",
      "Omri Gandelman (CAM)",
      "Walid Cheddira (ST)",
      "Kialonda Gaspar (CB)",
      ...
      "Jamil Siebert (CB)",
      "Ylber Ramadani (CDM)",
      "Santiago Pierotti (RM)"
    ],
    "description": "Lecce. Compite en Serie A Enilive.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/1005.png",
    "division": 1
  },
  {
    "id": "milan",
    ...
    "description": "Milan. Compite en Serie A Enilive.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/5.png",
    "division": 1
  },
  {
    ...
    "description": "Monza. Compite en Serie A Enilive.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/2919.png",
    "division": 1
  },
  {
    "id": "napoli",
    ...
    "starPlayers": [
      ...
      "Scott McTominay (CM)",
      "Amir Rrahmani (CB)",
      "Stanislav Lobotka (CM)",
      "André-Franck Zambo Anguissa (CM)",
    ...
    "description": "Napoli. Compite en Serie A Enilive.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/6195.png",
    "division": 1
  },
  {
    ...
    "marketValue": 10000000,
    "starPlayers": [
      "Gabriel Strefezza (RM)",
      "Zion Suzuki (GK)",
      "Enrico Delprato (CB)",
      "Emanuele Valeri (LB)",
      "Hans Nicolussi Caviglia (CDM)",
      "Adrián Bernabé (CM)",
      "Abdoulaye Ndiaye (CB)",
      "Mandela Keita (CDM)",
      "Jacob Ondrejka (LW)",
      "Gaetano Oristanio (CAM)",
      "Matija Frigan (ST)"
    ],
    "description": "Parma. Compite en Serie A Enilive.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/12.png",
    "division": 1
  },
  {
    ...
    "starPlayers": [
      ...
      "Bryan Cristante (CM)",
      "Artem Dovbyk (ST)",
      "Kouadio Manu Koné (CM)",
      "Lorenzo Pellegrini (CAM)",
      "Mario Hermoso (CB)",
      "Matías Soulé (CAM)",
      "Donyell Malen (ST)"
    ],
    "description": "Roma. Compite en Serie A Enilive.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/12.png",
    "division": 1
  },
  {
    ...
    "description": "Torino. Compite en Serie A Enilive.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/416.png",
    "division": 1
  },
  {
    ...
    "starPlayers": [
      "Oumar Solet (CB)",
      "Jesper Karlström (CDM)",
      "Nicolò Zaniolo (ST)",
      "Maduka Okoye (GK)",
      "Arthur Atta (CM)",
      "Jurgen Ekkelenkamp (CM)",
      "Keinan Davis (ST)",
      "Thomas Kristensen (CB)",
      "Christian Kabasele (CB)",
      "Alessandro Zanoli (RB)",
      "Adam Buksa (ST)"
    ],
    "description": "Udinese. Compite en Serie A Enilive.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/410.png",
    "division": 1
  },
  {
    ...
    "starPlayers": [
      ...
      "Issa Doumbia (CM)",
      "Casas (ST)",
      "Joël Marcel Schingtienne (CB)"
    ],
    "description": "Venezia. Compite en Serie A Enilive.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/607.png",
    "division": 1
  },
  {
    "id": "bari",
    ...
    "starPlayers": [
      ...
      "Giulio Maggiore (CM)",
      "Cas Odenthal (CB)",
      "Christian Gytkjær (ST)",
      "Anthony Partipilo (ST)",
      "Andrea Cistana (CB)",
      "Gabriele Moncini (ST)",
      "Dimitrios Nikolaou (CB)",
      "Kevin Piscopo (CAM)",
      "Matthias Braunöder (CM)"
    ],
    "description": "Bari. Compite en Serie BKT.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/830.png",
    "division": 2
  },
  {
    ...
    "description": "Brescia. Compite en Serie BKT.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/681.png",
    "division": 2
  },
  {
    "id": "carrarese",
    ...
    "description": "Carrarese. Compite en Serie BKT.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/25184.png",
    "division": 2
  },
  {
    ...
    "marketValue": 2500000,
    "starPlayers": [
      "Mirko Pigliacelli (GK)",
      "Pietro Iemmello (ST)",
      "Federico Di Francesco (LW)",
      "Jacopo Petriccione (CDM)",
      "Marco D'Alessandro (LM)",
      "Rémi Oudin (CAM)",
      "Marco Pompetti (CM)",
      "Simone Pontisso (CM)",
      "Filippo Pittarello (ST)",
      "Tommaso Cassandro (RB)",
      "Davide Buglio (CM)"
    ],
    "description": "Catanzaro. Compite en Serie BKT.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/51663.png",
    "division": 2
  },
  {
    ...
    "starPlayers": [
      "Giovanni Zaro (CB)",
      "Dimitri Bisoli (CM)",
      "Gaetano Castrovilli (CM)",
      "Michele Castagnetti (CDM)",
      "Cristian Shpendi (ST)",
    ...
    "description": "Cesena. Compite en Serie BKT.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/631.png",
    "division": 2
  },
  {
    ...
    "description": "Cittadella. Compite en Serie BKT.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/25467.png",
    "division": 2
  },
  {
    "id": "cosenza",
    ...
    "description": "Cosenza. Compite en Serie BKT.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/2919.png",
    "division": 2
  },
  {
    ...
    "starPlayers": [
      "Emil Audero (GK)",
      "Sebastiano Luperto (CB)",
      "Jamie Vardy (ST)",
      "Antonio Sanabria (ST)",
      "Federico Baschirotto (CB)",
      "Alessio Zerbin (RM)",
      "Martín Payero (CM)",
      "Jari Vandeputte (CM)",
      "Federico Bonazzoli (ST)",
      "Morten Thorsby (CM)",
      "Marco Silvestri (GK)"
    ],
    "description": "Cremonese. Compite en Serie BKT.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/2407.png",
    "division": 2
  },
  {
    ...
    "starPlayers": [
      "Giacomo Calò (CDM)",
      "Ilario Monterisi (CB)",
      "Ilias Koutsoupias (CM)",
      "Farès Ghedjemis (RW)",
      "Anthony Oyono (RB)",
      "Gabriele Calvani (CB)",
      "Gabriele Bracaglia (CB)",
      "Antonio Raimondo (ST)",
      "Antonio Fiori (LM)",
      "Lorenzo Palmisani (GK)",
      "Riccardo Marchizza (LB)"
    ],
    "description": "Frosinone. Ascendió a la Serie A Enilive para la temporada 2026-27.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/8970.png",
    "division": 1
  },
  {
    "id": "juve_stabia",
    ...
    "starPlayers": [
      ...
      "Salim Diakité (RB)",
      "Marco Bellich (CB)",
      "Leonardo Candellone (ST)",
      "Andrea Giorgini (CB)",
      "Alessandro Gabrielloni (ST)",
      "Fabio Maistro (CAM)",
      "Nicola Mosti (CAM)",
      "Omar Correia (CDM)",
      "Christian Pierobon (CM)"
    ],
    "description": "Juve Stabia. Compite en Serie BKT.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://pub-3bd35431294c47068cbf31a95d572166.r2.dev/logos/juve-stabia/juve-stabia-logo-footylogos.svg",
    "division": 2
  },
  {
    "id": "mantova",
    ...
    "description": "Mantova. Compite en Serie BKT.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/51663.png",
    "division": 2
  },
  {
    ...
    "marketValue": 2500000,
    "starPlayers": [
      "Leandro Chichizola (GK)",
      "Luca Zanimacchia (RM)",
      "Davide Adorni (CB)",
      "Francesco Zampano (LB)",
      "Simone Santoro (CM)",
      "Niklas Pyyhtiä (CM)",
      "Daniel Tonoli (CB)",
      "Fabio Gerli (CM)",
    ...
    "description": "Modena. Compite en Serie BKT.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/2919.png",
    "division": 2
  },
  {
    ...
    "starPlayers": [
      ...
      "Mattia Bani (CB)",
      "Niccolò Pierozzi (RB)",
      "Filippo Ranocchia (CM)",
      "Giangiacomo Magnani (CB)",
      "Pietro Ceccaroni (CB)",
      "Jacopo Segre (CM)",
      "Jérémy Le Douaron (CAM)"
    ],
    "description": "Palermo. Compite en Serie BKT.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/3938.png",
    "division": 2
  },
  {
    ...
    "starPlayers": [
      ...
      "Mattéo Tramoni (CAM)",
      "Felipe Loyola (CM)",
      "Simone Canestrelli (CB)",
      "Stefano Moreo (ST)",
      "Simone Scuffet (GK)",
      "Samuel Iling-Junior (LM)"
    ],
    "description": "Pisa. Compite en Serie BKT.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/629.png",
    "division": 2
  },
  {
    ...
    "starPlayers": [
      "Manolo Portanova (CM)",
      "Tommaso Fumagalli (ST)",
      "Mario Sampirisi (RB)",
      "Matteo Rover (RM)",
      "Cedric Diomandè Gondo (ST)",
      "Francesco Vicari (CB)",
      "Yeferson Paz (RB)",
      "Alessandro Micai (GK)",
      "Andrea Papetti (CB)",
    ...
    "description": "Reggiana. Compite en Serie BKT.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/1106.png",
    "division": 2
  },
  {
    "id": "salernitana",
    ...
    "description": "Salernitana. Compite en Serie BKT.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/51663.png",
    "division": 2
  },
  {
    ...
    "marketValue": 2500000,
    "starPlayers": [
      "Salvatore Esposito (CDM)",
      "Massimo Coda (ST)",
      "Antonín Barák (CM)",
      "Mattia Viti (CB)",
      "Matteo Brunori (CAM)",
      "Oliver Abildgaard (CB)",
      "Nicholas Pierini (ST)",
      "Fabio Depaoli (RB)",
      "Lorenzo Venuti (RB)",
      "Jordan Ferri (CDM)",
    ...
    "description": "Sampdoria. Compite en Serie BKT.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/3631.png",
    "division": 2
  },
  {
    ...
    "starPlayers": [
      ...
      "Armand Laurienté (LW)",
      "Nemanja Matić (CDM)",
      "Kristian Thorstvedt (CM)",
      "Ismaël Koné (CM)",
      "Andrea Pinamonti (ST)",
      "Arijanet Murić (GK)",
      "Ulisses Garcia (LB)",
      "Jay Idzes (CB)",
      "Tarik Muharemović (CB)",
      "Josh Doig (LB)"
    ],
    "description": "Sassuolo. Compite en Serie BKT.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/6574.png",
    "division": 2
  },
  {
    ...
    "starPlayers": [
      "Boris Radunović (GK)",
      "Alessandro Bellemo (CM)",
      "Filippo Bandinelli (CM)",
      "Gianluca Lapadula (ST)",
      "Leonardo Sernicola (RB)",
      "Marco Ruggero (CB)",
      "Petko Hristov (CB)",
      "Szymon Żurkowski (CM)",
      "Giuseppe Aurelio (LB)",
    ...
    "description": "Spezia. Compite en Serie BKT.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/1023.png",
    "division": 2
  },
  {
    ...
    "description": "Sudtirol. Compite en Serie BKT.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "division": 2
  },
  {
    ...
    "starPlayers": [
      ...
      "Danny Namaso (LM)",
      "Josué Casimir (RM)",
      "Oussama El Azzouzi (CDM)"
    ],
    "description": "AJ Auxerre. Compite en Ligue 1 McDonalds.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/290.png",
    "division": 1
  },
  {
    "id": "angers_sco",
    ...
    "starPlayers": [
      ...
      "Carlens Arcus (RB)",
      "Jacques Ekomié (LB)",
      "Branco van den Boomen (CM)",
      "Yassin Belkhdim (CM)",
      "Amine Sbaï (LM)",
      "Louis Mouton (CAM)",
      "Goduine Koyalipou (ST)"
    ],
    "description": "Angers SCO. Compite en Ligue 1 McDonalds.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/1420.png",
    "division": 1
  },
  {
    ...
    "starPlayers": [
      "Denis Zakaria (CDM)",
      "Lukáš Hrádecký (GK)",
      "Maghnes Akliouche (CAM)",
      "Lamine Camara (CM)",
      "Alexandr Golovin (CAM)",
      "Folarin Balogun (ST)",
      "Thilo Kehrer (CB)",
      "Paul Pogba (CM)",
      "Eric Dier (CB)",
    ...
    "description": "AS Monaco. Compite en Ligue 1 McDonalds.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/162.png",
    "division": 1
  },
  {
    "id": "as_saint_etienne",
    ...
    "starPlayers": [
      "Lucas Stassin (ST)",
      "Gautier Larsonneur (GK)",
      "Julien Le Cardinal (CB)",
      "Zuriko Davitashvili (LW)",
      "Irvin Cardona (RW)",
      "Augustine Boakye (RW)",
      "João Ferreira (RB)",
      "Chico Lamba (CB)",
    ...
    "description": "AS Saint-Étienne. Compite en Ligue 1 McDonalds.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/583.png",
    "division": 1
  },
  {
    "id": "brest",
    ...
    "description": "Brest. Compite en Ligue 1 McDonalds.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/826.png",
    "division": 1
  },
  {
    ...
    "starPlayers": [
      ...
      "Rassoul Ndiaye (CM)",
      "Loïc Négo (RB)",
      "Étienne Youté Kinkoué (CB)"
    ],
    "description": "Le Havre AC. Compite en Ligue 1 McDonalds.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/738.png",
    "division": 1
  },
  {
    "id": "lens",
    ...
    "description": "Lens. Compite en Ligue 1 McDonalds.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/826.png",
    "division": 1
  },
  {
    ...
    "description": "Lille OSC. Compite en Ligue 1 McDonalds.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/38628.png",
    "division": 1
  },
  {
    ...
    "description": "Montpellier HSC. Compite en Ligue 1 McDonalds.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/3938.png",
    "division": 1
  },
  {
    ...
    "description": "Nantes. Compite en Ligue 1 McDonalds.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/928.png",
    "division": 1
  },
  {
    ...
    "description": "Nice. Compite en Ligue 1 McDonalds.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/417.png",
    "division": 1
  },
  {
    "id": "olympique_lyonnais",
    ...
    "description": "Olympique Lyonnais. Compite en Ligue 1 McDonalds.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/1041.png",
    "division": 1
  },
  {
    "id": "olympique_de_marseille",
    ...
    "description": "Olympique de Marseille. Compite en Ligue 1 McDonalds.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/244.png",
    "division": 1
  },
  {
    ...
    "description": "Paris Saint-Germain. Compite en Ligue 1 McDonalds.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/583.png",
    "division": 1
  ...
  {
    "id": "racing_club_de_strasbourg_alsace",
    ...
    "description": "Racing Club de Strasbourg Alsace. Compite en Ligue 1 McDonalds.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/667.png",
    "division": 1
  },
  {
    "id": "stade_de_reims",
    ...
    "starPlayers": [
      ...
      "Théo Leoni (CDM)",
      "Mory Gbane (CDM)",
      "Yassine Benhattab (RW)",
      "Ewen Jaouen (GK)",
      "Maxime Busi (RB)",
      "Hiroki Sekine (RB)",
      "Alexandre Olliero (GK)"
    ],
    "description": "Stade de Reims. Compite en Ligue 1 McDonalds.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/273.png",
    "division": 1
  },
  {
    "id": "stade_rennais_fc",
    ...
    "description": "Stade Rennais FC. Compite en Ligue 1 McDonalds.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/273.png",
    "division": 1
  },
  {
    ...
    "starPlayers": [
      ...
      "Rasmus Nicolaisen (CB)",
      "Yann Gboho (LW)",
      "Djibril Sidibé (RB)",
      "Aron Dønnum (RM)",
      "Mark McKenzie (CB)",
      "Cristian Cásseres Jr (CDM)",
      "Emersonn (ST)",
      "Warren Kamanzi (RB)",
      "Frank Magri (ST)"
    ],
    "description": "Toulouse FC. Compite en Ligue 1 McDonalds.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/415.png",
    "division": 1
  },
  {
    "id": "ajax",
    ...
    "description": "Ajax. Compite en Eredivisie.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/290.png",
    "division": 1
  },
  {
    ...
    "description": "Almere City FC. Compite en Eredivisie.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/14545.png",
    "division": 1
  },
  {
    ...
    "starPlayers": [
      ...
      "Kees Smit (CAM)",
      "Matěj Šín (CAM)",
      "Alexandre Penetra (CB)",
      "Seiya Maikuma (RB)",
      "Mexx Meerdink (ST)",
      "Patati (RM)",
      "Peer Koopmeiners (CDM)"
    ],
    "description": "AZ. Compite en Eredivisie.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e0/AZ_Alkmaar.svg/250px-AZ_Alkmaar.svg.png",
    "division": 1
  },
  {
    "id": "fc_groningen",
    ...
    "starPlayers": [
      ...
      "Younes Taha (CAM)",
      "Thom van Bergen (ST)",
      "Brynjólfur Willumsson (ST)",
      "Tygo Land (CM)",
      "Tika de Jonge (CM)"
    ],
    "description": "FC Groningen. Compite en Eredivisie.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/1158.png",
    "division": 1
  },
  {
    ...
    "starPlayers": [
      ...
      "Sondre Ørjasæter (LW)",
      "Mathias Kjølø (CDM)",
      "Ricky van Wolfswinkel (ST)"
    ],
    "description": "FC Twente. Compite en Eredivisie.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/1158.png",
    "division": 1
  },
  {
    ...
    "description": "FC Utrecht. Compite en Eredivisie.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/49283.png",
    "division": 1
  },
  {
    ...
    "starPlayers": [
      ...
      "Givairo Read (RB)",
      "Anel Ahmedhodžić (CB)",
      "Oussama Targhalline (CM)"
    ],
    "description": "Feyenoord. Compite en Eredivisie.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://pub-3bd35431294c47068cbf31a95d572166.r2.dev/logos/feyenoord/feyenoord-logo-footylogos.svg",
    "division": 1
  },
  {
    "id": "go_ahead_eagles",
    ...
    "description": "Go Ahead Eagles. Compite en Eredivisie.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://pub-3bd35431294c47068cbf31a95d572166.r2.dev/logos/go-ahead-eagles/go-ahead-eagles-logo-footylogos.svg",
    "division": 1
  },
  {
    "id": "heracles_almelo",
    ...
    "starPlayers": [
      "Remko Pasveer (GK)",
      "Jeff Reine-Adélaïde (CAM)",
      "Damon Mirani (CB)",
      "Naci Ünüvar (LM)",
      "Ajdin Hrustić (CM)",
      "Walid Ould-Chikh (LM)",
      "Luka Kulenović (ST)",
      "Alec Van Hoorenbeeck (CB)",
      "Fabian de Keijzer (GK)",
      "Ivan Mesík (LB)",
      "Jan Žambůrek (CDM)"
    ],
    "description": "Heracles Almelo. Compite en Eredivisie.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/95571.png",
    "division": 1
  },
  {
    ...
    "starPlayers": [
      ...
      "Mohamed Nassoh (LM)",
      "Amine Salama (ST)",
      "Cherrion Valerius (RB)"
    ],
    "description": "NAC Breda. Compite en Eredivisie.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/1075.png",
    "division": 1
  },
  {
    ...
    "description": "NEC Nijmegen. Compite en Eredivisie.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/417.png",
    "division": 1
  },
  {
    ...
    "marketValue": 10000000,
    "starPlayers": [
      "Jasper Schendelaar (GK)",
      "Younes Namli (RM)",
      "Jamiro Monteiro (CAM)",
      "Zico Buurmeester (CM)",
      "Simon Graves (CB)",
      "Anselmo García MacNulty (CB)",
      "Koen Kostons (ST)",
      "Tom de Graaff (GK)",
      "Ryan Thomas (CM)",
      "Odysseus Velanas (LM)",
    ...
    "description": "PEC Zwolle. Compite en Eredivisie.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/13339.png",
    "division": 1
  },
  {
    ...
    "description": "PSV. Compite en Eredivisie.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0c/PSV_Eindhoven_-_Philips_Stadion_-_Kleedkamer_Welkom_-_Cropped_Logo.jpg/250px-PSV_Eindhoven_-_Philips_Stadion_-_Kleedkamer_Welkom_-_Cropped_Logo.jpg",
    "division": 1
  },
  {
    "id": "rkc_waalwijk",
    ...
    "description": "RKC Waalwijk. Compite en Eredivisie.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/3329.png",
    "division": 1
  },
  {
    "id": "sc_heerenveen",
    ...
    "starPlayers": [
      "Ringo Meerveld (CAM)",
      "Joris van Overeem (CDM)",
      "Jacob Trenskow (RM)",
      "Oliver Braude (RB)",
      "Marcus Linday (CDM)",
      "Bernt Klaverboer (GK)",
      "Maas Willemsen (CB)",
      "Vasilios Zagaritis (LB)",
      "Luuk Brouwers (CM)",
      "Dylan Vente (ST)",
      "Maxence Rivera (LM)"
    ],
    "description": "SC Heerenveen. Compite en Eredivisie.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://pub-3bd35431294c47068cbf31a95d572166.r2.dev/logos/sc-heerenveen/sc-heerenveen-logo-footylogos.svg",
    "division": 1
  },
  {
    "id": "sparta_rotterdam",
    ...
    "description": "Sparta Rotterdam. Compite en Eredivisie.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/1095.png",
    "division": 1
  },
  {
    ...
    "description": "Willem II. Compite en Eredivisie.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/69261.png",
    "division": 1
  },
  {
    "id": "avs_futebol_sad",
    ...
    "starPlayers": [
      ...
      "Kiki (LB)",
      "Algobia (CM)",
      "Cristian Devenish (CB)",
      "Tomané (ST)",
      "Simão Bertelli (GK)",
      "Carlos Ponck (CB)",
      "Aderllan Santos (CB)",
      "Guillem Molina (RB)",
      "Babatunde Akinsola (LM)",
      "Óscar Perea (LM)"
    ],
    "description": "Compite en Liga Portugal.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/3876.png",
    "division": 1
  },
  {
    "id": "boavista_fc",
  ...
  },
  {
    ...
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/2423.png",
    "division": 1
  },
  {
    "id": "estrela_amadora",
    ...
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/2431.png",
    "division": 1
  },
  {
    "id": "estoril_praia",
  ...
  },
  {
    ...
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/8024.png",
    "division": 1
  },
  {
    "id": "fc_famalicao",
  ...
  },
  {
    ...
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/720.png",
    "division": 1
  },
  {
    "id": "gil_vicente_fc",
    ...
    "starPlayers": [
      ...
      "Weverson (LB)",
      "Buatu (CB)",
      "Facundo Agustín Cáseres (CDM)",
      "Gustavo Varela (ST)"
    ],
    "description": "Compite en Liga Portugal.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/2424.png",
    "division": 1
  },
  {
    "id": "moreirense_fc",
  ...
  },
  {
    ...
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/2425.png",
    "division": 1
  },
  {
    "id": "sl_benfica",
  ...
  },
  {
    ...
    "starPlayers": [
      ...
      "Gonçalo Inácio (CB)",
      "Ousmane Diomande (CB)",
      "Luis Javier Suárez (ST)",
      "Maximiliano Araújo (LM)",
      "Hidemasa Morita (CM)",
      "Geny Catamo (RM)",
      "Zeno Debast (CB)"
    ],
  ...
  },
  {
    ...
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/2420.png",
    "division": 1
  },
  {
    "id": "atlanta_united",
  ...
  },
  {
    ...
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/4078.png",
    "division": 1
  },
  {
    "id": "charlotte_fc",
    ...
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/78435.png",
    "division": 1
  },
  {
    "id": "chicago_fire",
  ...
  },
  {
    ...
    "starPlayers": [
      ...
      "Shaq Moore (RB)",
      "Osaze Urhoghide (CB)",
      "Joaquín Valiente (CAM)",
      "Anderson Julio (ST)",
      "Sebastien Ibeagha (CB)",
      "Kaick (CM)",
      "Patrickson Delgado (CM)",
      "Christian Cappis (CM)"
    ],
    "description": "Compite en MLS.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
  ...
  },
  {
    ...
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/63966.png",
    "division": 1
  },
  {
    "id": "new_england",
    ...
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/626.png",
    "division": 1
  },
  {
    "id": "new_york_city_fc",
    ...
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/40058.png",
    "division": 1
  },
  {
    "id": "ny_red_bulls",
  ...
  },
  {
    ...
    "marketValue": 10000000,
    "starPlayers": [
      "Juan Manuel Sanabria (LB)",
      "Victor Olatunji (ST)",
      "Morgan Guilavogui (LW)",
      "Diego Luna (LM)",
      "Pablo Ruiz (CDM)",
      "Stijn Spierings (CM)",
      "Lukas Engel (LB)",
    ...
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/6643.png",
    "division": 1
  },
  {
    "id": "san_diego_fc",
    ...
    "starPlayers": [
      ...
      "Andrés Reyes (CB)",
      "Alex Mighten (LM)",
      "Christopher McVey (CB)"
    ],
    "description": "Compite en MLS.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/114977.png",
    "division": 1
  },
  {
    "id": "san_jose",
  ...
  },
  {
    ...
    "starPlayers": [
      "Dejan Joveljić (ST)",
      "Manu García (CAM)",
      "Lasse Berg Johnsen (CM)",
      "Magomed-Shapi Suleymanov (RM)",
      "Jake Davis (RB)",
      "John Pulskamp (GK)",
      "Ethan Bartlow (CB)",
      "Stefan Cleveland (GK)",
  ...
  },
  {
    ...
    "marketValue": 10000000,
    "starPlayers": [
      "Djordje Mihailovic (CAM)",
      "Josh Sargent (ST)",
      "Walker Zimmerman (CB)",
      "Benjamín Kuscevic (CB)",
      "José Cifuentes (CM)",
      "Richie Laryea (RM)",
      "Dániel Sallói (LW)",
      "Jonathan Osorio (CM)",
  ...
  },
  {
    ...
    "starPlayers": [
      ...
      "Dixon Vera (LW)",
      "Sidimar (CB)",
      "Gian Franco Cabezas (CM)"
    ],
    "description": "Compite en LALIGA EA SPORTS.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/621.png",
    "division": 1
  ...
  },
  {
    ...
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/331.png",
    "division": 1
  },
  {
    "id": "celta",
  ...
  },
  {
    ...
    "description": "Descendió a LALIGA HYPERMOTION para la temporada 2026-27.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/252.png",
    "division": 2
  },
  {
    ...
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/3368.png",
    "division": 1
  },
  {
    "id": "r_oviedo",
  ...
  },
  {
    ...
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/150.png",
    "division": 1
  },
  {
    "id": "real_madrid",
  ...
  },
  {
    ...
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/1049.png",
    "division": 1
  },
  {
    "id": "villarreal_cf",
    ...
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/1050.png",
    "division": 1
  },
  {
    "id": "ad_ceuta_fc",
    ...
    "description": "Compite en LALIGA HYPERMOTION.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/14545.png",
    "division": 2
  ...
  },
  {
    ...
    "description": "Ascendió a LALIGA EA SPORTS para la temporada 2026-27 tras ganar la final del playoff a la UD Almería.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/1084.png",
    "division": 1
  },
  {
    ...
    "description": "Ascendió a LALIGA EA SPORTS para la temporada 2026-27 como campeón de Segunda, tras 14 años fuera de Primera.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/10403.png",
    "division": 1
  },
  {
    "id": "r_sporting",
  ...
  },
  {
    ...
    "starPlayers": [
      ...
      "Ximo Navarro (RB)",
      "Mella (RM)",
      "Samuele Mulattieri (ST)"
    ],
    "description": "Ascendió a LALIGA EA SPORTS para la temporada 2026-27, tras 8 años fuera de Primera.",
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/13379.png",
    "division": 1
  ...
  },
  {
    ...
    "badgeColor": "border-l-4 border-slate-500 bg-slate-900 text-white",
    "badgeLogoUrl": "⚽",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/13046.png",
    "division": 2
  },
  {
    "id": "sd_eibar",
  ...
  },
  {
    ...
    "description": "Clasificado a la Champions League 2025-26. El grande de Brujas, referente de la Jupiler Pro League.",
    "badgeColor": "border-l-4 border-blue-600 bg-slate-900/40 text-blue-100",
    "badgeLogoUrl": "🔵⚫",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/4941.png",
    "division": 1
  },
  {
    ...
    "description": "Clasificado a la Champions League 2025-26. Campeón belga, en plena resurrección europea.",
    "badgeColor": "border-l-4 border-yellow-400 bg-blue-900 text-yellow-200",
    "badgeLogoUrl": "💛💙",
    "badgeImageUrl": "https://pub-3bd35431294c47068cbf31a95d572166.r2.dev/logos/union-saint-gilloise/union-saint-gilloise-logo-footylogos.svg",
    "division": 1
  },
  {
    "id": "krc_genk",
    ...
    "description": "Clasificado a la Europa League 2025-26. Cantera prolífica del fútbol belga.",
    "badgeColor": "border-l-4 border-blue-500 bg-slate-900/40 text-blue-100",
    "badgeLogoUrl": "🔵⚪",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/826.png",
    "division": 1
  },
  {
    ...
    "description": "Clasificado a la Champions League 2025-26. El gigante del Pireo, dominador de la Super League griega.",
    "badgeColor": "border-l-4 border-red-600 bg-red-950/40 text-red-200",
    "badgeLogoUrl": "🔴⚪",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/1164.png",
    "division": 1
  },
  {
    ...
    "description": "Clasificado a la Europa League 2025-26. Referente del norte de Grecia.",
    "badgeColor": "border-l-4 border-slate-300 bg-black text-white",
    "badgeLogoUrl": "⚫⚪",
    "badgeImageUrl": "https://pub-3bd35431294c47068cbf31a95d572166.r2.dev/logos/paok/paok-logo-footylogos.svg",
    "division": 1
  },
  {
    "id": "panathinaikos",
    ...
    "description": "Clasificado a la Europa League 2025-26. El trébol de Atenas.",
    "badgeColor": "border-l-4 border-green-500 bg-slate-900/40 text-green-100",
    "badgeLogoUrl": "☘️💚",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/221.png",
    "division": 1
  },
  {
    ...
    "description": "Clasificado a la Champions League 2025-26. Campeón checo, con paso firme en Europa.",
    "badgeColor": "border-l-4 border-red-600 bg-red-950/40 text-red-200",
    "badgeLogoUrl": "🔴⚪",
    "badgeImageUrl": "https://pub-3bd35431294c47068cbf31a95d572166.r2.dev/logos/slavia-praha/slavia-praha-logo-footylogos.svg",
    "division": 1
  },
  {
    "id": "viktoria_plzen",
    ...
    "description": "Clasificado a la Europa League 2025-26. Habitual de la fase de grupos europea.",
    "badgeColor": "border-l-4 border-blue-600 bg-slate-900/40 text-blue-100",
    "badgeLogoUrl": "🔵⚪",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/1158.png",
    "division": 1
  },
  {
    ...
    "description": "Clasificado a la Champions League 2025-26. La revelación noruega, fútbol vistoso desde el Ártico.",
    "badgeColor": "border-l-4 border-yellow-400 bg-black text-yellow-200",
    "badgeLogoUrl": "💛⚫",
    "division": 1
  },
  {
    ...
    "starPlayers": [
      ...
      "Fredrik Knudsen (CB)",
      "Jacob Sørensen (CDM)",
      "Mathias Dyngeland (GK)",
      "Jón Dagur Þorsteinsson (LW)",
      "Vetle Dragsnes (LB)",
      "Joachim Soltvedt (LB)",
      "Bård Finne (ST)",
      "Niklas Castro (LW)",
      "Sævar Atli Magnússon (RW)",
      "Noah Jean Holm (ST)"
    ],
    "description": "Clasificado a la Europa League 2025-26. Orgullo de Bergen.",
    "badgeColor": "border-l-4 border-red-500 bg-slate-900/40 text-red-100",
    "badgeLogoUrl": "🔴⚪",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/1075.png",
    "division": 1
  },
  {
    ...
    "starPlayers": [
      ...
      "Jordan Larsson (RM)",
      "Amir Richardson (CM)",
      "Pantelis Hatzidiakos (CB)",
      "Marcos López (LB)",
      "Mads Emil Madsen (CM)",
      "Youssoufa Moukoko (ST)"
    ],
    "description": "Clasificado a la Champions League 2025-26. El más grande de Dinamarca.",
    "badgeColor": "border-l-4 border-red-500 bg-white text-slate-900",
    "badgeLogoUrl": "⚪🔴",
    "division": 1
  },
  {
    ...
    "description": "Clasificado a la Europa League 2025-26. Pionero del análisis de datos en el fútbol danés.",
    "badgeColor": "border-l-4 border-red-600 bg-black text-red-200",
    "badgeLogoUrl": "🔴⚫",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/5.png",
    "division": 1
  },
  {
    ...
    "description": "Clasificado a la Champions League 2025-26. Cim Bom Bom, campeón de Turquía.",
    "badgeColor": "border-l-4 border-red-500 bg-yellow-500 text-red-900",
    "badgeLogoUrl": "🟡🔴",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/6711.png",
    "division": 1
  },
  {
    ...
    "description": "Clasificado a la Europa League 2025-26. El gigante amarillo y azul marino de Estambul.",
    "badgeColor": "border-l-4 border-blue-800 bg-yellow-400 text-blue-950",
    "badgeLogoUrl": "💛🔵",
    "badgeImageUrl": "https://pub-3bd35431294c47068cbf31a95d572166.r2.dev/logos/fenerbahce/fenerbahce-logo-footylogos.svg",
    "division": 1
  },
  {
    "id": "qarabag",
    ...
    "starPlayers": [
      ...
      "Marko Janković (CM)",
      "Oleksiy Kashchuk (RW)",
      "Elvin Cafarquliyev (LB)",
      "Shahruddin Magomedaliyev (GK)"
    ],
    "description": "Clasificado a la Champions League 2025-26. Dominador absoluto del fútbol azerí.",
    "badgeColor": "border-l-4 border-blue-700 bg-slate-900/40 text-blue-100",
    "badgeLogoUrl": "🔵⚪",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/11.png",
    "division": 1
  },
  {
    ...
    "description": "Clasificado a la Champions League 2025-26. Debut histórico del fútbol chipriota en la fase de liga.",
    "badgeColor": "border-l-4 border-sky-500 bg-slate-900/40 text-sky-100",
    "badgeLogoUrl": "🔵⚪",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/10004.png",
    "division": 1
  },
  {
    ...
    "description": "Clasificado a la Champions League 2025-26. Primer club kazajo en la fase de liga de la máxima competición europea.",
    "badgeColor": "border-l-4 border-yellow-400 bg-black text-yellow-200",
    "badgeLogoUrl": "💛⚫",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/1061.png",
    "division": 1
  },
  {
    ...
    "description": "Clasificado a la Europa League 2025-26. Cantera y proyección constante en Austria.",
    "badgeColor": "border-l-4 border-red-600 bg-white text-red-700",
    "badgeLogoUrl": "🔴⚪",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/167.png",
    "division": 1
  },
  {
    ...
    "description": "Clasificado a la Europa League 2025-26. Campeón austríaco, el otro grande de Graz.",
    "badgeColor": "border-l-4 border-slate-300 bg-black text-white",
    "badgeLogoUrl": "⚫⚪",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/12.png",
    "division": 1
  },
  {
    ...
    "description": "Clasificado a la Europa League 2025-26. Histórico de Glasgow, azul real.",
    "badgeColor": "border-l-4 border-blue-700 bg-slate-900/40 text-blue-100",
    "badgeLogoUrl": "🔵⚪",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/1420.png",
    "division": 1
  },
  {
    ...
    "description": "Clasificado a la Europa League 2025-26. Los Hoops verdiblancos de Glasgow.",
    "badgeColor": "border-l-4 border-green-600 bg-white text-green-800",
    "badgeLogoUrl": "💚⚪",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/17554.png",
    "division": 1
  },
  {
    ...
    "marketValue": 8200000,
    "starPlayers": [
      "Edimilson Fernandes (CDM)",
      "Christian Fassnacht (RM)",
      "Alvyn Sanches (CAM)",
      "Marvin Keller (GK)",
      "Gregory Wüthrich (CB)",
      "Joël Almada Monteiro (LM)",
      "Samuel Essende (ST)",
      "Armin Gigović (CDM)",
      "Chris Bedia (ST)",
      "Rayan Raveloson (CM)",
    ...
    "description": "Clasificado a la Europa League 2025-26. El más laureado de Suiza en la última década.",
    "badgeColor": "border-l-4 border-yellow-400 bg-black text-yellow-200",
    "badgeLogoUrl": "💛⚫",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/12100.png",
    "division": 1
  },
  {
    ...
    "description": "Clasificado a la Europa League 2025-26. Histórico suizo, cuna de la Selección desde su cantera.",
    "badgeColor": "border-l-4 border-red-600 bg-blue-950 text-red-200",
    "badgeLogoUrl": "🔴🔵",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/131.png",
    "division": 1
  },
  {
    ...
    "starPlayers": [
      "Dénes Dibusz (GK)",
      "Mohammed Abu Fani (CM)",
      "Cadu (LM)",
      "Cebrail Makreckis (RB)",
      "Naby Keïta (CM)",
      "Kristoffer Zachariassen (CAM)",
      "Stefan Gartenmann (CB)",
      "Jonathan Levi (RW)",
      "Ibrahim Cissé (CB)",
      "Gavriel Kanichowsky (CM)",
      "Bamidele Yusuf (LW)"
    ],
    "description": "Clasificado a la Europa League 2025-26. El gigante de Budapest.",
    "badgeColor": "border-l-4 border-green-600 bg-white text-green-800",
    "badgeLogoUrl": "💚⚪",
    "division": 1
  },
  {
    ...
    "description": "Clasificado a la Europa League 2025-26. La Estrella Roja de Belgrado.",
    "badgeColor": "border-l-4 border-red-600 bg-red-950/40 text-red-200",
    "badgeLogoUrl": "🔴⚪",
    "badgeImageUrl": "badges/red_star_belgrade.png",
    "division": 1
  },
  {
    "id": "dinamo_zagreb",
    ...
    "description": "Clasificado a la Europa League 2025-26. Dominador habitual del fútbol croata.",
    "badgeColor": "border-l-4 border-blue-600 bg-slate-900/40 text-blue-100",
    "badgeLogoUrl": "🔵⚪",
    "badgeImageUrl": "https://pub-3bd35431294c47068cbf31a95d572166.r2.dev/logos/gnk-dinamo-zagreb/gnk-dinamo-zagreb-logo-footylogos.svg",
    "division": 1
  },
  {
    "id": "ludogorets",
    ...
    "description": "Clasificado a la Europa League 2025-26. Amo absoluto de la liga búlgara.",
    "badgeColor": "border-l-4 border-orange-500 bg-black text-orange-200",
    "badgeLogoUrl": "🟠⚫",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/1158.png",
    "division": 1
  },
  {
    ...
    "starPlayers": [
      ...
      "Robin Olsen (GK)",
      "Otto Rosengren (CM)",
      "Sead Hakšabanović (LM)",
      "Anders Christiansen (CAM)",
    ...
    "description": "Clasificado a la Europa League 2025-26. El más grande de Suecia.",
    "badgeColor": "border-l-4 border-sky-500 bg-white text-sky-700",
    "badgeLogoUrl": "🔵⚪",
    "badgeImageUrl": "https://pub-3bd35431294c47068cbf31a95d572166.r2.dev/logos/malmo-ff/malmo-ff-logo-footylogos.svg",
    "division": 1
  },
  {
    "id": "fcsb",
    ...
    "description": "Clasificado a la Europa League 2025-26. El histórico club de Bucarest.",
    "badgeColor": "border-l-4 border-red-600 bg-blue-950 text-red-200",
    "badgeLogoUrl": "🔴🔵",
    "badgeImageUrl": "https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/167.png",
    "division": 1
  },
  {
    ...
    "description": "Clasificado a la Europa League 2025-26. El más laureado de Israel en Europa.",
    "badgeColor": "border-l-4 border-yellow-400 bg-blue-900 text-yellow-200",
    "badgeLogoUrl": "💛🔵",
