...
export const CLUBS_DATABASE: Club[] = [
  ...
  // ==========================================
  {
    ...
    initialSalary: 1800,
    marketValue: 9500000,
    starPlayers: ['Francisco Fydriszewski', 'Teófilo Gutiérrez', 'Luis Fernando Muriel', 'Yimmi Chará', 'Cristian Barrios', 'Mauro Silveira'],
  ...
  },
  {
    ...
    starPlayers: ['Franco Armani', 'William Tesillo', 'Edwin Cardona', 'Chicho Arango', 'Andrés Reyes', 'Elías Cabrera'],
  ...
  },
  {
    ...
    starPlayers: ['Radamel Falcao García', 'Álvaro Montero', 'Mackalister Silva', 'Daniel Ruiz', 'Andrey Estupiñán', 'James Aguirre'],
  ...
  },
  {
    ...
    initialSalary: 1600,
    marketValue: 8000000,
    starPlayers: ['Hugo Rodallega', 'Fabián Sambueza', 'Franco Fagúndez', 'Helibelton Palacios', 'Leandro Castellanos', 'Kevin Balanta'],
  ...
  },
  {
    ...
    initialSalary: 1550,
    marketValue: 7500000,
    starPlayers: ['Andrés Mosquera Marmolejo', 'Agustín Martegani', 'Juan José Córdoba', 'Jeison Medina', 'Iván Arboleda'],
  ...
  },
  {
    ...
    initialSalary: 1200,
    marketValue: 5550000,
    starPlayers: ['Dayro Moreno (ST)', 'Andrés Felipe Roa (CAM)', 'Michael Barrios (RM)', 'Robert Mejía (CDM)', 'Iván Rojas (CDM)', 'Juan David Cuesta (RB)', 'Jaime Alvarado (CDM)', 'Jorge Cardona (CB)', 'Jeider Riquett (CB)', 'Déinner Quiñones (RM)'],
  ...
  },
  {
    ...
    initialSalary: 1250,
    marketValue: 6000000,
    starPlayers: ['Carlos Bacca (ST)', 'Emanuel Reynoso (CAM)', 'Juan Dinenno (ST)', 'Pedro Gallese (GK)', 'Avilés Hurtado (LW)', 'Andrés Colorado (CDM)', 'Alejandro Rodríguez (GK)', 'Fabián Viáfara (RB)', 'Felipe Aguilar (CB)', 'Johan Martinez (LW)', 'Julián Quiñónes (CB)'],
...
// ==========================================
  ...
  // ==========================================
  { id: 'san_lorenzo', name: 'San Lorenzo de Almagro', league: 'Argentina', dt: 'Néstor Gorosito', reputation: 4, initialSalary: 2100, marketValue: 13000000, starPlayers: ['Adam Bareiro', 'Nahuel Barrios', 'Luciano Vietto', 'Gonzalo Ábrego'], description: 'El Ciclón de Boedo, con Luciano Vietto llegando libre tras su paso por Racing.', badgeColor: 'border-l-4 border-red-800 bg-blue-950 text-white', badgeLogoUrl: '🌪️',
  ...
  { id: 'estudiantes_lp', name: 'Estudiantes de La Plata', league: 'Argentina', dt: 'Alexander Medina', reputation: 4, initialSalary: 2450, marketValue: 11550000, starPlayers: ['Enzo Pérez', 'Adolfo Gaich', 'Guido Carrillo', 'Tomás Palacios'], description: 'El Pincha, con Adolfo Gaich como primer refuerzo tras su salida libre del CSKA Moscú y Tomás Palacios a préstamo desde el Inter de Milán.', badgeColor: 'border-l-4 border-red-600 bg-slate-900 text-white', badgeLogoUrl: '🦁',
  ...
  { id: 'fluminense', name: 'Fluminense', league: 'Brasileña', dt: 'Luis Zubeldía', reputation: 4, initialSalary: 4300, marketValue: 20450000, starPlayers: ['Luciano Acosta (CAM)', 'Germán Cano (ST)', 'Fábio (GK)', 'Guilherme Arana (LB)', 'Jefferson Savarino (CAM)', 'Otávio (CDM)', 'Yeferson Soteldo (LW)', 'Ganso (CAM)', 'Samuel Xavier (RB)', 'John Kennedy (ST)', 'Matheus Martinelli (CDM)'], description: 'Tricolor das Laranjeiras.', badgeColor: 'border-l-4 border-red-700 bg-green-800 text-white', badgeLogoUrl: '🔴🟢',
  ...
  { id: 'fortaleza_br', name: 'Fortaleza', league: 'Brasileña', dt: 'Juan Pablo Vojvoda', reputation: 3, initialSalary: 1500, marketValue: 5450000, starPlayers: ['Tomás Pochettino (CAM)', 'João Ricardo (GK)', 'Tomás Cardona (CB)', 'Emanuel Brítez (CB)', 'Vitinho (RW)', 'Lucas Crispim (CAM)', 'Maílton (RB)', 'Gabriel Fuentes (LB)', 'Lucas Sasha (CDM)', 'Gazal (CB)', 'Brenno (GK)'], description: 'Descendido sorpresivamente en el mod.', badgeColor: 'border-l-4 border-red-600 bg-blue-800 text-white', badgeLogoUrl: '🦁',
  ...
  { id: 'borussia_monchengladbach', name: 'Borussia Mönchengladbach', league: 'Alemana', dt: 'Eugen Polanski', reputation: 4, initialSalary: 57700, marketValue: 155425000, starPlayers: ['Adalid Terrazas Abasto (CAM)', 'Rodrigo Emanuel Saracho (GK)', 'Máximo David Alonso Fontes (LM)', 'Erwin Junior Sánchez Paniagua (CAM)'], description: 'Borussia Mönchengladbach. Compite en Bundesliga.', badgeColor: 'border-l-4 border-zinc-300 bg-zinc-950/40 text-zinc-200', badgeLogoUrl: '⚫⚪',
  ...
  { id: 'fc_augsburg', name: 'FC Augsburg', league: 'Alemana', dt: 'Manuel Baum', reputation: 4, initialSalary: 18700, marketValue: 150725000, starPlayers: ['Jeffrey Gouweleeuw (CB)', 'Chrislain Matsima (CB)', 'Finn Dahmen (GK)', 'Dimitris Giannoulis (LB)', 'Alexis Claude-Maurice (CAM)', 'Keven Schlotterbeck (CB)', 'Kristijan Jakić (CDM)', 'Han-Noah Massengo (CDM)', 'Michael Gregoritsch (ST)', 'Cédric Zesiger (CB)', 'Robin Fellhauer (CDM)'], description: 'FC Augsburg. Compite en Bundesliga.', badgeColor: 'border-l-4 border-red-600 bg-green-950/40 text-red-200', badgeLogoUrl: '🔴🟢',
  ...
  { id: 'fc_st_pauli', name: 'FC St. Pauli', league: 'Alemana', dt: 'Marcel Rapp', reputation: 4, initialSalary: 2000, marketValue: 37700000, starPlayers: ['Nikola Vasilj (GK)', 'Hauke Wahl (CB)', 'Eric Smith (CB)', 'Jackson Irvine (CM)', 'Mathias Rasmussen (CM)', 'Mathias Pereira Lage (ST)', 'Manolis Saliakas (RB)', 'Joel Chima Fujita (CM)', 'Martijn Kaars (ST)', 'James Sands (CDM)', 'Danel Sinani (CAM)'], description: 'FC St. Pauli. Compite en Bundesliga.', badgeColor: 'border-l-4 border-amber-800 bg-zinc-950/40 text-amber-200', badgeLogoUrl: '🟤⚪',
  ...
  { id: 'tsg_hoffenheim', name: 'TSG Hoffenheim', league: 'Alemana', dt: 'Christian Ilzer', reputation: 4, initialSalary: 39900, marketValue: 207650000, starPlayers: ['Harrison Contreras Mora (CM)', 'Gerardo José Padrón Colmenares (LM)', 'Junior José Paredes Jaspe (ST)', 'Mamadou Mbaye (CB)'], description: 'TSG Hoffenheim. Compite en Bundesliga.', badgeColor: 'border-l-4 border-blue-500 bg-blue-950/40 text-blue-200', badgeLogoUrl: '🔵⚪',
  ...
  { id: 'vfb_stuttgart', name: 'VfB Stuttgart', league: 'Alemana', dt: 'Sebastian Hoenss', reputation: 4, initialSalary: 32600, marketValue: 355725000, starPlayers: ['Maximilian Mittelstädt (LB)', 'Angelo Stiller (CDM)', 'Deniz Undav (ST)', 'Alexander Nübel (GK)', 'Julian Chabot (CB)', 'Ermedin Demirović (ST)', 'Jamie Leweling (RM)', 'Bilal El Khannouss (CAM)', 'Atakan Karazor (CDM)', 'Chris Führich (LM)', 'Tiago Tomás (LM)'], description: 'VfB Stuttgart. Compite en Bundesliga.', badgeColor: 'border-l-4 border-red-600 bg-slate-900/40 text-red-200', badgeLogoUrl: '🔴⚪',
  ...
  { id: 'darmstadt_98', name: 'Darmstadt 98', league: 'Alemana', dt: 'Florian Kohfeldt', reputation: 2, initialSalary: 800, marketValue: 30275000, starPlayers: ['Tim Kleindienst (ST)', 'Franck Honorat (RM)', 'Rocco Reitz (CM)', 'Robin Hack (LM)'], description: 'Darmstadt 98. Compite en Bundesliga 2.', badgeColor: 'border-l-4 border-blue-600 bg-blue-950/40 text-blue-200', badgeLogoUrl: '🔵⚪',
  ...
  { id: 'hertha_bsc', name: 'Hertha BSC', league: 'Alemana', dt: 'Stefan Leitl', reputation: 2, initialSalary: 26400, marketValue: 22885000, starPlayers: ['Fabian Reese (LM)', 'Josip Brekalo (LM)', 'Michaël Cuisance (CM)', 'Tjark Ernst (GK)', 'Paul Seguin (CDM)', 'Dawid Kownacki (ST)', 'Toni Leistner (CB)', 'Márton Dárdai (CB)', 'Michał Karbownik (LB)', 'Diego Demme (CDM)', 'Linus Gechter (CB)'], description: 'Hertha BSC. Compite en Bundesliga 2.', badgeColor: 'border-l-4 border-blue-600 bg-blue-950/40 text-blue-200', badgeLogoUrl: '🔵⚪',
  ...
  { id: 'sc_paderborn_07', name: 'SC Paderborn 07', league: 'Alemana', dt: 'Ralf Kettemann', reputation: 2, initialSalary: 800, marketValue: 7675000, starPlayers: ['Felix Götze (CB)', 'Raphael Obermair (RM)', 'Filip Bilbija (CAM)', 'Calvin Brackelmann (CB)', 'Dennis Seimen (GK)', 'Tjark Scheller (CB)', 'Laurin Curda (RM)', 'Santiago Castañeda (CDM)', 'Mika Baur (CM)', 'Steffen Tigges (ST)', 'Sebastian Klaas (CM)'], description: 'SC Paderborn 07. Compite en Bundesliga 2.', badgeColor: 'border-l-4 border-blue-600 bg-blue-950/40 text-blue-200', badgeLogoUrl: '🔵⚪',
  ...
  { id: 'vfl_bochum', name: 'VfL Bochum', league: 'Alemana', dt: 'Uwe Rösler', reputation: 2, initialSalary: 800, marketValue: 25150000, starPlayers: ['Timo Horn (GK)', 'Kevin Vogt (CB)', 'Maximilian Wittek (LB)', 'Matúš Bero (CM)', 'Philipp Hofmann (ST)', 'Oliver Olsen (RB)', 'Gerrit Holtmann (LM)', 'Ibrahim Sissoko (ST)', 'Philipp Strompf (CB)', 'Koji Miyoshi (RM)', 'Marcel Sobottka (CDM)'], description: 'VfL Bochum. Compite en Bundesliga 2.', badgeColor: 'border-l-4 border-sky-600 bg-blue-950/40 text-sky-200', badgeLogoUrl: '🔵⚪',
  ...
  { id: 'fiorentina', name: 'Fiorentina', league: 'Italiana', dt: 'Fabio Grosso', reputation: 4, initialSalary: 47800, marketValue: 303560000, starPlayers: ['De Gea (GK)', 'Moise Kean (ST)', 'Robin Gosens (LB)', 'Dodô (RB)', 'Albert Guðmundsson (ST)', 'Manor Solomon (LM)', 'Nicolò Fagioli (CM)', 'Rolando Mandragora (CM)', 'Luca Ranieri (CB)', 'Roberto Piccoli (ST)', 'Fabiano Parisi (LB)'], description: 'Fiorentina. Compite en Serie A Enilive.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'milan', name: 'Milan', league: 'Italiana', dt: 'Rúben Amorim', reputation: 4, initialSalary: 89800, marketValue: 626510000, starPlayers: ['Rafael Leão (LW)', 'Christian Pulisic (RW)', 'Mike Maignan (GK)', 'Adrien Rabiot (CM)', 'Youssouf Fofana (CDM)', 'Strahinja Pavlović (CB)', 'Fikayo Tomori (CB)', 'Samuel Chukwueze (RW)', 'Ardon Jashari (CM)', 'Ruben Loftus-Cheek (CM)', 'Santiago Giménez (ST)'], description: 'Milan. Compite en Serie A Enilive, reforzado con Ardon Jashari (Club Brugge) y Samuel Chukwueze.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
 ...
 // ==========================================
  ...
  { id: 'fc_porto', name: 'FC Porto', league: 'Portuguesa', dt: 'Francesco Farioli', reputation: 4, initialSalary: 51000, marketValue: 312325000, starPlayers: ['Diogo Costa (GK)', 'Thiago Silva (CB)', 'Jakub Kiwior (CB)', 'Alan Varela (CDM)', 'Jan Bednarek (CB)', 'Gabri Veiga (CAM)', 'Samu (ST)', 'Victor Froholdt (CM)', 'Pepê (CAM)', 'Borja Sainz (LW)', 'Pablo Rosario (CDM)'], description: 'Compite en Liga Portugal.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'real_betis', name: 'Real Betis', league: 'Española', dt: 'Manuel Pellegrini', reputation: 4, initialSalary: 2000, marketValue: 228875000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Compite en LALIGA EA SPORTS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'sevilla_fc', name: 'Sevilla FC', league: 'Española', dt: 'Matías Almeyda', reputation: 4, initialSalary: 82600, marketValue: 192675000, starPlayers: ['Odysseas Vlachodimos (GK)', 'Azpilicueta (CB)', 'Ruben Vargas (LW)', 'Carmona (RB)', 'Chidera Ejuke (LW)', 'Nemanja Gudelj (CDM)', 'Batista Mendy (CDM)', 'Kike Salas (CB)', 'Juanlu Sánchez (RB)', 'Lucien Agoumé (CDM)', 'Djibril Sow (CM)'], description: 'Compite en LALIGA EA SPORTS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
