...
// ==========================================
  ...
  { id: 'banfield', themeColor: { primary: '#16a34a', secondary: '#f5f0e8' }, name: 'Banfield', league: 'Argentina', dt: 'Pedro Troglio', reputation: 3, initialSalary: 1400, marketValue: 7000000, starPlayers: ['Facundo Sanguinetti (GK)', 'Sergio Vittor (CB)', 'Santiago López García (RB)', 'Danilo Arboleda (CB)', 'Bruno Sepúlveda (ST)', 'Nicolás Colazo (LB)', 'Ignacio Abraham (LB)', 'Lautaro Ríos (CM)', 'Gino Santilli (GK)'], description: 'El Taladro.', badgeColor: 'border-l-4 border-green-600 bg-white text-green-800', badgeLogoUrl: ' drill ',
    badgeImageUrl: 'badges/clubs/banfield.png', division: 1 },
  { id: 'rosario_central', themeColor: { primary: '#eab308', secondary: '#f5f0e8' }, name: 'Rosario Central', league: 'Argentina', dt: 'Jorge Almirón', reputation: 4, initialSalary: 2500, marketValue: 16000000, starPlayers: ['Ángel Di María (RW)', 'Jaminton Campaz (LM)', 'Franco Ibarra (CDM)', 'Carlos Quintana (CB)', 'Facundo Mallo (CB)', 'Agustín Sández (LB)', 'Pol Fernández (CM)', 'Emanuel Coronel (RB)', 'Alejo Veliz (ST)', 'Federico Navarro (CDM)'], description: 'El Canalla.', badgeColor: 'border-l-4 border-yellow-500 bg-blue-900 text-yellow-400', badgeLogoUrl: '🇺🇦',
  ...
  { id: 'tigre', themeColor: { primary: '#dc2626', secondary: '#f5f0e8' }, name: 'Tigre', league: 'Argentina', dt: 'Diego Dabove', reputation: 3, initialSalary: 1300, marketValue: 6200000, starPlayers: ['Gonzalo Martínez (CAM)', 'Jalil Elías (CDM)', 'Joaquín Laso (CB)', 'Bruno Leyes (CDM)', 'Felipe Zenobio (GK)', 'Nahuel Banegas (LB)', 'Sebastián Medina (LM)'], description: 'El Matador de Victoria.', badgeColor: 'border-l-4 border-red-600 bg-blue-800 text-white', badgeLogoUrl: '🐯',
  ...
  { id: 'sarmiento', name: 'Sarmiento', league: 'Argentina', dt: 'Facundo Sava', reputation: 2, initialSalary: 1050, marketValue: 4500000, starPlayers: ['Mauricio Martínez (CDM)', 'Jonatan Gómez (CM)', 'Juan Manuel Insaurralde (CB)', 'Junior Marabel (ST)', 'Yair Arismendi (LB)', 'Cristian Zabala (CDM)', 'Renzo Orihuela (CB)', 'Gastón González (LM)'], description: 'El Verde de Junín.', badgeColor: 'border-l-4 border-white bg-green-600 text-white', badgeLogoUrl: '🟢',
    badgeImageUrl: 'badges/clubs/sarmiento.png', division: 1 },
  { id: 'central_cordoba', name: 'Central Córdoba', league: 'Argentina', dt: 'Sebastián Domínguez', reputation: 2, initialSalary: 1000, marketValue: 4200000, starPlayers: ['Lucas González (CM)', 'Alan Aguerre (GK)', 'Facundo Mansilla (CB)', 'Horacio Tijanovich (LM)', 'Matías Vera (CDM)', 'Ezequiel Naya (ST)', 'Santiago Moyano (RB)'], description: 'El Ferroviario.', badgeColor: 'border-l-4 border-white bg-black text-white', badgeLogoUrl: '🚂',
    badgeImageUrl: 'badges/clubs/central_cordoba.png', division: 1 },
  { id: 'barracas', name: 'Barracas Central', league: 'Argentina', dt: 'Damián Ayude', reputation: 2, initialSalary: 1000, marketValue: 4200000, starPlayers: ['Iván Tapia (CAM)', 'Facundo Bruera (ST)', 'Yonatthan Rak (CB)', 'Rodrigo Insua (LB)', 'Juan Espínola (GK)', 'Dardo Miloc (CDM)', 'Gastón Campi (CB)', 'Damián Martínez (RB)', 'Rodrigo Bogarín (CAM)'], description: 'El Guapo.', badgeColor: 'border-l-4 border-white bg-red-600 text-white', badgeLogoUrl: '🔴⚪',
  ...
  { id: 'central_norte', name: 'Central Norte', league: 'Argentina', dt: 'Adrián Bastía', reputation: 2, initialSalary: 600, marketValue: 1500000, starPlayers: ['Arián Pucheta (CB)', 'Ramiro Costa (ST)', 'Agustin Aleo (LB)', 'Mauricio Rosales (RB)', 'Maximiliano Padilla (LB)', 'Matías Villarreal (CDM)', 'Kevin Fernández (CAM)', 'Franco Vedoya (RW)', 'Joaquin Mateo (ST)', 'Leonardo Felissia (CB)'], description: 'El Cuervo salteño. Compite en B Nacional.', badgeColor: 'border-l-4 border-white bg-black text-white', badgeLogoUrl: '🐦',
  ...
  { id: 'colon', name: 'Colón', league: 'Argentina', dt: 'Ezequiel Medrán', reputation: 3, initialSalary: 1200, marketValue: 5500000, starPlayers: ['Federico Lértora (CDM)', 'Pier Barrios (CB)', 'Federico Rasmussen (CB)', 'Mauro Peinipil (RB)', 'Facundo Castro (ST)', 'Nicolás Thaller (CB)', 'Lucas Cano (ST)', 'Agustín Toledo (CDM)'], description: 'El Sabalero. Histórico en la B Nacional.', badgeColor: 'border-l-4 border-black bg-red-600 text-white', badgeLogoUrl: '🐘',
  ...
  { id: 'patronato', name: 'Patronato', league: 'Argentina', dt: 'Marcelo Candia', reputation: 2, initialSalary: 800, marketValue: 3000000, starPlayers: ['Renzo Reynaga (ST)', 'Federico Bravo (CDM)', 'Hernán Rivero (ST)', 'Marcos Enrique (CDM)', 'Franco Meritello (CB)', 'Fernando Evangelista (LB)', 'Fernando Moreyra (CB)', 'Agustin Araujo (LM)', 'Franco Soldano (ST)', 'Maximiliano Rueda (CM)'], description: 'El Patrón. Compite en B Nacional.', badgeColor: 'border-l-4 border-black bg-red-600 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'tristan_suarez', name: 'Tristán Suárez', league: 'Argentina', dt: 'José María Martínez', reputation: 2, initialSalary: 600, marketValue: 1500000, starPlayers: ['Nicolás Sánchez (LM)', 'Diego Becker (LM)', 'Manuel Guillén (RB)', 'Joaquín Bigo (GK)', 'Agustín Baldi (CB)', 'Nicolás Fernández (LB)', 'Nicolás Del Priore (CM)', 'Álvaro Veliez (ST)', 'Mauricio Manuel Guzmán (CB)', 'Alejandro Molina (RB)'], description: 'El Lechero. Compite en B Nacional.', badgeColor: 'border-l-4 border-white bg-blue-800 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'santos_laguna', name: 'Santos Laguna', league: 'Mexicana', dt: 'Renato Paiva', reputation: 3, initialSalary: 2500, marketValue: 10000000, starPlayers: ['Carlos Acevedo (GK)', 'Lucas Di Yorio (ST)', 'Kevin Balanta (CB)', 'Carlos Gruezo (CDM)', 'Javier Güemez (CDM)', 'Choco Lozano (ST)', 'Bruno Amione (CB)', 'Fran Villalba (RM)', 'Ramiro Sordo (LW)'], description: 'Los Guerreros.', badgeColor: 'border-l-4 border-white bg-green-700 text-white', badgeLogoUrl: '👼',
  ...
  { id: 'sporting_cristal', themeColor: { primary: '#38bdf8', secondary: '#f5f0e8' }, name: 'Sporting Cristal', league: 'Peruana', dt: 'Enderson Moreira', reputation: 4, initialSalary: 1600, marketValue: 8000000, starPlayers: ['Santiago González (RW)', 'Christofer Gonzáles (CAM)', 'Martín Távara (CM)', 'Gustavo Cazonatti (CDM)', 'Yoshimar Yotún (CM)', 'Luis Iberico (ST)', 'Luis Abram (CB)', 'Diego Enríquez (GK)', 'Írven Ávila (ST)', 'Renato Solís (GK)'], description: 'Los Celestes.', badgeColor: 'border-l-4 border-sky-400 bg-sky-800 text-white', badgeLogoUrl: '🩵',
  ...
  { id: '1_fc_nurnberg', themeColor: { primary: '#991b1b', secondary: '#f5f0e8' }, name: '1. FC Nürnberg', league: 'Alemana', dt: 'Miroslav Klose', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Julian Justvan (CAM)', 'Finn Ole Becker (CM)', 'Jan Reichert (GK)', 'Berkay Yilmaz (LB)', 'Adam Markhiev (CDM)', 'Rafael Lubach (CM)', 'Mohamed Alì Zoma (ST)', 'Henri Koudossou (RB)'], description: '1. FC Nürnberg. Compite en Bundesliga 2.', badgeColor: 'border-l-4 border-red-800 bg-zinc-950/40 text-red-200', badgeLogoUrl: '🔴⚪',
  ...
  { id: 'holstein_kiel', themeColor: { primary: '#2563eb', secondary: '#f5f0e8' }, name: 'Holstein Kiel', league: 'Alemana', dt: 'Tim Walter', reputation: 2, initialSalary: 800, marketValue: 21575000, starPlayers: ['David Zec (CB)', 'Jonas Meffert (CDM)', 'John Tolkin (LB)', 'Steven Skrzybski (ST)', 'Carl Johansson (CB)', 'Marko Ivezić (CB)', 'Jonas Therkelsen (CAM)'], description: 'Holstein Kiel. Compite en Bundesliga 2.', badgeColor: 'border-l-4 border-blue-600 bg-blue-950/40 text-blue-200', badgeLogoUrl: '🔵⚪',
 ...
 // ==========================================
  ...
  { id: 'cd_mirandes', name: 'CD Mirandés', league: 'Española', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Carlos Fernández (ST)', 'Igor Nikic (GK)', 'Javi Hernández (RM)', 'Nikola Maraš (CB)', 'Postigo (CB)', 'Pica (CB)', 'Martín Pascual (CB)', 'Mickaël Malsa (CDM)', 'Hugo Novoa (RM)'], description: 'Compite en LALIGA HYPERMOTION.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
