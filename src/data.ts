...
// ==========================================
 ...
 // ==========================================
  ...
  // Fuente: https://en.wikipedia.org/wiki/Eerste_Divisie (temporada 2024/25).
  // De los 20 de la categoría faltan a propósito los cuatro filiales -- Jong Ajax, Jong PSV, Jong AZ
  // y Jong FC Utrecht --: por reglamento de la KNVB NO pueden ascender a la Eredivisie, así que
  // meterlos dejaría a `resolverMovimientos` subiendo a "Jong Ajax" a Primera, que es imposible.
  // Quedan los 16 que sí tienen derecho a ascenso.
  { id: 'ado_den_haag', name: 'ADO Den Haag', league: 'Holandesa', dt: 'Darije Kalezić', reputation: 3, initialSalary: 1200, marketValue: 9500000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'ADO Den Haag, de La Haya. Compite en la Eerste Divisie.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 2 },
  { id: 'sc_cambuur', name: 'SC Cambuur', league: 'Holandesa', dt: 'Henk de Jong', reputation: 3, initialSalary: 1200, marketValue: 8600000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'SC Cambuur, de Leeuwarden. Compite en la Eerste Divisie.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 2 },
  ...
  { id: 'sc_telstar', name: 'SC Telstar', league: 'Holandesa', dt: 'Mike Snoei', reputation: 2, initialSalary: 900, marketValue: 4400000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'SC Telstar, de Velsen. Compite en la Eerste Divisie.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 2 },
