...
// ==========================================
 ...
 // ==========================================
  ...
  { id: 'heracles_almelo', name: 'Heracles Almelo', league: 'Holandesa', dt: 'Bas Sibum', reputation: 4, initialSalary: 2000, marketValue: 38185000, starPlayers: ['Remko Pasveer (GK)', 'Jeff Reine-Adélaïde (CAM)', 'Damon Mirani (CB)', 'Naci Ünüvar (LM)', 'Ajdin Hrustić (CM)', 'Walid Ould-Chikh (LM)', 'Luka Kulenović (ST)', 'Alec Van Hoorenbeeck (CB)', 'Fabian de Keijzer (GK)', 'Ivan Mesík (LB)', 'Jan Žambůrek (CDM)'], description: 'Heracles Almelo. Compite en la Eerste Divisie.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/heracles_almelo.png', division: 2 },
  { id: 'nac_breda', name: 'NAC Breda', league: 'Holandesa', dt: 'Jo Jansen', reputation: 4, initialSalary: 2000, marketValue: 33750000, starPlayers: ['André Ayew (ST)', 'Daniel Bielica (GK)', 'Denis Odoi (CB)', 'Lewis Holtby (CM)', 'Leo Greiml (CB)', 'Boy Kemper (LB)', 'Kamal Sowah (LM)', 'Clint Leemans (CM)', 'Mohamed Nassoh (LM)', 'Amine Salama (ST)', 'Cherrion Valerius (RB)'], description: 'NAC Breda. Compite en la Eerste Divisie.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'https://pub-3bd35431294c47068cbf31a95d572166.r2.dev/logos/nac-breda/nac-breda-logo-footylogos.svg', division: 2 },
  ...
  { id: 'ado_den_haag', name: 'ADO Den Haag', league: 'Holandesa', dt: 'Darije Kalezić', reputation: 3, initialSalary: 1200, marketValue: 9500000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'ADO Den Haag, de La Haya. Compite en la Eredivisie.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 1 },
  { id: 'sc_cambuur', name: 'SC Cambuur', league: 'Holandesa', dt: 'Henk de Jong', reputation: 3, initialSalary: 1200, marketValue: 8600000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'SC Cambuur, de Leeuwarden. Compite en la Eredivisie.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 1 },
  ...
  { id: 'fc_volendam', name: 'FC Volendam', league: 'Holandesa', dt: 'Regillio Simons', reputation: 3, initialSalary: 1200, marketValue: 13200000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'FC Volendam. Compite en la Eerste Divisie.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 2 },
  // ==========================================
  // --- PORTUGAL (PRIMERA) ---
  // ==========================================
