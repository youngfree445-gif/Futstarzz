...
// ==========================================
  ...
  { id: 'tristan_suarez', name: 'Tristán Suárez', league: 'Argentina', dt: 'José María Martínez', reputation: 2, initialSalary: 600, marketValue: 1500000, starPlayers: ['Nicolás Sánchez (LM)', 'Diego Becker (LM)', 'Joaquín Bigo (GK)', 'Agustín Baldi (CB)', 'Nicolás Fernández (LB)', 'Nicolás Del Priore (CM)', 'Álvaro Veliez (ST)', 'Mauricio Manuel Guzmán (CB)', 'Alejandro Molina (RB)'], description: 'El Lechero. Compite en B Nacional.', badgeColor: 'border-l-4 border-white bg-blue-800 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'fortaleza_br', themeColor: { primary: '#dc2626', secondary: '#f5f0e8' }, name: 'Fortaleza', league: 'Brasileña', dt: 'Juan Pablo Vojvoda', reputation: 3, initialSalary: 1500, marketValue: 5450000, starPlayers: ['Tomás Pochettino (CAM)', 'João Ricardo (GK)', 'Tomás Cardona (CB)', 'Emanuel Brítez (CB)', 'Vitinho (RW)', 'Lucas Crispim (CAM)', 'Lucas Sasha (CDM)', 'Gazal (CB)', 'Brenno (GK)'], description: 'Descendido sorpresivamente en el mod.', badgeColor: 'border-l-4 border-red-600 bg-blue-800 text-white', badgeLogoUrl: '🦁',
  ...
  { id: 'reggiana', name: 'Reggiana', league: 'Italiana', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Manolo Portanova (CM)', 'Mario Sampirisi (RB)', 'Matteo Rover (RM)', 'Cedric Diomandè Gondo (ST)', 'Francesco Vicari (CB)', 'Alessandro Micai (GK)', 'Andrea Papetti (CB)', 'Tobias Reinhart (CM)', 'Danilo Quaranta (CB)'], description: 'Reggiana. Compite en Serie BKT.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
 ...
 // ==========================================
  ...
  { id: 'heracles_almelo', name: 'Heracles Almelo', league: 'Holandesa', dt: 'Bas Sibum', reputation: 4, initialSalary: 2000, marketValue: 38185000, starPlayers: ['Jeff Reine-Adélaïde (CAM)', 'Damon Mirani (CB)', 'Ajdin Hrustić (CM)', 'Walid Ould-Chikh (LM)', 'Luka Kulenović (ST)', 'Fabian de Keijzer (GK)', 'Ivan Mesík (LB)', 'Jan Žambůrek (CDM)'], description: 'Heracles Almelo. Compite en la Eerste Divisie.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'columbus_crew', name: 'Columbus Crew', league: 'Estadounidense', dt: 'DT Genérico', reputation: 3, initialSalary: 2000, marketValue: 34000000, starPlayers: ['Dániel Gazdag (CAM)', 'André Gomes (CDM)', 'Steven Moreira (CB)', 'Nariman Akhundzada (RW)', 'Patrick Schulte (GK)', 'Andrés Herrera (RB)', 'Dylan Chambost (CM)', 'Mohamed Farsi (RM)'], description: 'Compite en MLS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'cultural_leonesa', name: 'Cultural Leonesa', league: 'Española', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Edgar Badia (GK)', 'Nemanja Radoja (CDM)', 'Chacón (CAM)', 'Lucas Ribeiro (RM)', 'Rubén Sobrino (RM)', 'Iván Calero (RB)', 'Matia Barzić (CB)', 'Rodri Suárez (CB)', 'Roger Hinojo (LB)', 'Tresaco (LM)'], description: 'Compite en LALIGA HYPERMOTION.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
