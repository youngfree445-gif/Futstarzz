...
// ==========================================
  ...
  { id: 'borussia_monchengladbach', name: 'Borussia Mönchengladbach', league: 'Alemana', dt: 'Eugen Polanski', reputation: 4, initialSalary: 57700, marketValue: 300000000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Borussia Mönchengladbach. Compite en Bundesliga.', badgeColor: 'border-l-4 border-zinc-300 bg-zinc-950/40 text-zinc-200', badgeLogoUrl: '⚫⚪',
  ...
  { id: 'fc_augsburg', name: 'FC Augsburg', league: 'Alemana', dt: 'Manuel Baum', reputation: 4, initialSalary: 18700, marketValue: 97100000, starPlayers: ['Jeffrey Gouweleeuw (CB)', 'Chrislain Matsima (CB)', 'Finn Dahmen (GK)', 'Dimitris Giannoulis (LB)', 'Alexis Claude-Maurice (CAM)', 'Keven Schlotterbeck (CB)', 'Kristijan Jakić (CDM)', 'Han-Noah Massengo (CDM)', 'Michael Gregoritsch (ST)', 'Cédric Zesiger (CB)', 'Robin Fellhauer (CDM)'], description: 'FC Augsburg. Compite en Bundesliga.', badgeColor: 'border-l-4 border-red-600 bg-green-950/40 text-red-200', badgeLogoUrl: '🔴🟢',
  ...
  { id: 'fc_bayern_munchen', name: 'FC Bayern München', league: 'Alemana', dt: 'Vincent Kompany', reputation: 5, initialSalary: 164000, marketValue: 852900000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'FC Bayern München. Compite en Bundesliga.', badgeColor: 'border-l-4 border-red-600 bg-red-950/40 text-red-200', badgeLogoUrl: '🔴⚪',
  ...
  { id: 'tsg_hoffenheim', name: 'TSG Hoffenheim', league: 'Alemana', dt: 'Christian Ilzer', reputation: 4, initialSalary: 39900, marketValue: 207650000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'TSG Hoffenheim. Compite en Bundesliga.', badgeColor: 'border-l-4 border-blue-500 bg-blue-950/40 text-blue-200', badgeLogoUrl: '🔵⚪',
  ...
  { id: 'vfl_wolfsburg', name: 'VfL Wolfsburg', league: 'Alemana', dt: 'Tobias Strobl', reputation: 4, initialSalary: 55400, marketValue: 287830000, starPlayers: ['Kamil Grabara (GK)', 'Mohamed Amoura (ST)', 'Maximilian Arnold (CDM)', 'Joakim Mæhle (LB)', 'Patrick Wimmer (LM)', 'Lovro Majer (CAM)', 'Denis Vavro (CB)', 'Moritz Jenz (CB)', 'Konstantinos Koulierakis (CB)', 'Christian Eriksen (CAM)', 'Mattias Svanberg (CM)'], description: 'VfL Wolfsburg. Compite en Bundesliga.', badgeColor: 'border-l-4 border-green-500 bg-green-950/40 text-green-200', badgeLogoUrl: '🟢⚪',
  ...
  { id: 'vfb_stuttgart', name: 'VfB Stuttgart', league: 'Alemana', dt: 'Sebastian Hoenss', reputation: 4, initialSalary: 32600, marketValue: 169630000, starPlayers: ['Maximilian Mittelstädt (LB)', 'Angelo Stiller (CDM)', 'Deniz Undav (ST)', 'Alexander Nübel (GK)', 'Julian Chabot (CB)', 'Ermedin Demirović (ST)', 'Jamie Leweling (RM)', 'Bilal El Khannouss (CAM)', 'Atakan Karazor (CDM)', 'Chris Führich (LM)', 'Tiago Tomás (LM)'], description: 'VfB Stuttgart. Compite en Bundesliga.', badgeColor: 'border-l-4 border-red-600 bg-slate-900/40 text-red-200', badgeLogoUrl: '🔴⚪',
  ...
  { id: 'hertha_bsc', name: 'Hertha BSC', league: 'Alemana', dt: 'Stefan Leitl', reputation: 2, initialSalary: 26400, marketValue: 137050000, starPlayers: ['Fabian Reese (LM)', 'Josip Brekalo (LM)', 'Michaël Cuisance (CM)', 'Tjark Ernst (GK)', 'Paul Seguin (CDM)', 'Dawid Kownacki (ST)', 'Toni Leistner (CB)', 'Márton Dárdai (CB)', 'Michał Karbownik (LB)', 'Diego Demme (CDM)', 'Linus Gechter (CB)'], description: 'Hertha BSC. Compite en Bundesliga 2.', badgeColor: 'border-l-4 border-blue-600 bg-blue-950/40 text-blue-200', badgeLogoUrl: '🔵⚪',
  ...
  { id: 'brighton_hove_albion', name: 'Brighton & Hove Albion', league: 'Inglesa', dt: 'Fabian Hürzeler', reputation: 4, initialSalary: 47700, marketValue: 248100000, starPlayers: ['Kaoru Mitoma (LM)', 'Bart Verbruggen (GK)', 'Jan Paul van Hecke (CB)', 'Carlos Baleba (CDM)', 'Yankuba Minteh (RM)', 'Ferdi Kadıoğlu (LB)', 'Danny Welbeck (ST)', 'Yasin Ayari (CDM)', 'Maxim De Cuyper (LB)', 'Mats Wieffer (CDM)', 'Pascal Groß (CDM)'], description: 'Brighton & Hove Albion. Compite en Premier League.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'https://assets.football-logos.cc/logos/england/1500x1500/brighton.f54f0b50.png', division: 1 },
  { id: 'brentford', name: 'Brentford', league: 'Inglesa', dt: 'Keith Andrews', reputation: 3, initialSalary: 32000, marketValue: 166450000, starPlayers: ['Igor Thiago (ST)', 'Michael Kayode (RB)', 'Mikkel Damsgaard (CAM)', 'Caoimhin Kelleher (GK)', 'Kevin Schade (LM)', 'Mathias Jensen (CM)', 'Jordan Henderson (CDM)', 'Nathan Collins (CB)', 'Dango Ouattara (RM)', 'Sepp van den Berg (CB)', 'Yehor Yarmoliuk (CDM)'], description: 'Brentford. Compite en Premier League.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'https://pub-3bd35431294c47068cbf31a95d572166.r2.dev/logos/brentford/brentford-logo-footylogos.svg', division: 1 },
  { id: 'crystal_palace', name: 'Crystal Palace', league: 'Inglesa', dt: 'Pierre Sage', reputation: 3, initialSalary: 46000, marketValue: 239450000, starPlayers: ['Dean Henderson (GK)', 'Daniel Muñoz (RB)', 'Jean-Philippe Mateta (ST)', 'Maxence Lacroix (CB)', 'Adam Wharton (CDM)', 'Ismaïla Sarr (RW)', 'Chris Richards (CB)', 'Tyrick Mitchell (LB)', 'Yeremy Pino (LW)', 'Brennan Johnson (RW)', 'Daichi Kamada (CM)'], description: 'Crystal Palace. Compite en Premier League.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  // --- ITALIA (PRIMERA) ---
  // ==========================================
  { id: 'atalanta', name: 'Atalanta', league: 'Italiana', dt: 'Maurizio Sarri', reputation: 5, initialSalary: 79900, marketValue: 415350000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Atalanta. Compite en Serie A Enilive.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'fiorentina', name: 'Fiorentina', league: 'Italiana', dt: 'Fabio Grosso', reputation: 4, initialSalary: 47800, marketValue: 248800000, starPlayers: ['De Gea (GK)', 'Moise Kean (ST)', 'Robin Gosens (LB)', 'Dodô (RB)', 'Albert Guðmundsson (ST)', 'Manor Solomon (LM)', 'Nicolò Fagioli (CM)', 'Rolando Mandragora (CM)', 'Luca Ranieri (CB)', 'Roberto Piccoli (ST)', 'Fabiano Parisi (LB)'], description: 'Fiorentina. Compite en Serie A Enilive.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'hellas_verona', name: 'Hellas Verona', league: 'Italiana', dt: 'DT Genérico', reputation: 2, initialSalary: 20900, marketValue: 108450000, starPlayers: ['Lorenzo Montipò (GK)', 'Suat Serdar (CM)', 'Ali Al Musrati (CDM)', 'Victor Nelsson (CB)', 'Gift Orban (ST)', 'Nicolás Valentini (CB)', 'Pol Lirola (RB)', 'Sandi Lovrič (CM)', 'Armel Bella-Kotchap (CB)', 'Domagoj Bradarić (LB)', 'Roberto Gagliardini (CDM)'], description: 'Hellas Verona. Descendió a la Serie BKT para la temporada 2026-27.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'inter', name: 'Inter', league: 'Italiana', dt: 'Cristian Chivu', reputation: 5, initialSalary: 110200, marketValue: 573300000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Inter. Compite en Serie A Enilive.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'lazio', name: 'Lazio', league: 'Italiana', dt: 'Gennaro Gattuso', reputation: 4, initialSalary: 62800, marketValue: 326600000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Lazio. Compite en Serie A Enilive.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'milan', name: 'Milan', league: 'Italiana', dt: 'Rúben Amorim', reputation: 4, initialSalary: 89800, marketValue: 466900000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Milan. Compite en Serie A Enilive.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'torino', name: 'Torino', league: 'Italiana', dt: 'Ignazio Abate', reputation: 4, initialSalary: 35400, marketValue: 184130000, starPlayers: ['Duván Zapata (ST)', 'Nikola Vlašić (CAM)', 'Ché Adams (ST)', 'Cristiano Biraghi (LB)', 'Valentino Lazaro (RM)', 'Saúl Coco (CB)', 'Giovanni Simeone (ST)', 'Guillermo Maripán (CB)', 'Cesare Casadei (CM)', 'Franco Israel (GK)', 'Ivan Ilić (CDM)'], description: 'Torino. Compite en Serie A Enilive.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
 ...
 // ==========================================
  ...
  { id: 'lens', name: 'Lens', league: 'Francesa', dt: 'Dino Toppmöller', reputation: 4, initialSalary: 2000, marketValue: 10000000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Lens. Compite en Ligue 1 McDonalds.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/826.png', division: 1 },
  { id: 'lille_osc', name: 'Lille OSC', league: 'Francesa', dt: 'Davide Ancelotti', reputation: 4, initialSalary: 52300, marketValue: 272000000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Lille OSC. Compite en Ligue 1 McDonalds.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'stade_rennais_fc', name: 'Stade Rennais FC', league: 'Francesa', dt: 'Franck Haise', reputation: 4, initialSalary: 35600, marketValue: 185150000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Stade Rennais FC. Compite en Ligue 1 McDonalds.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'sl_benfica', name: 'SL Benfica', league: 'Portuguesa', dt: 'DT Genérico', reputation: 5, initialSalary: 54900, marketValue: 285500000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Compite en Liga Portugal.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'sc_braga', name: 'SC Braga', league: 'Portuguesa', dt: 'DT Genérico', reputation: 4, initialSalary: 22900, marketValue: 119150000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Compite en Liga Portugal.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'sporting_cp', name: 'Sporting CP', league: 'Portuguesa', dt: 'DT Genérico', reputation: 5, initialSalary: 38100, marketValue: 198200000, starPlayers: ['Morten Hjulmand (CDM)', 'Pedro Gonçalves (LM)', 'Trincão (CAM)', 'Rui Silva (GK)', 'Gonçalo Inácio (CB)', 'Ousmane Diomande (CB)', 'Luis Javier Suárez (ST)', 'Maximiliano Araújo (LM)', 'Hidemasa Morita (CM)', 'Geny Catamo (RM)', 'Zeno Debast (CB)'], description: 'Compite en Liga Portugal.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'ca_osasuna', name: 'CA Osasuna', league: 'Española', dt: 'Luis Miguel Ramis', reputation: 4, initialSalary: 18000, marketValue: 93500000, starPlayers: ['Ante Budimir (ST)', 'Sergio Herrera (GK)', 'Flavien-Enzo Boyomo (CB)', 'Catena (CB)', 'Moncayola (CM)', 'Lucas Torró (CDM)', 'Rubén García (RM)', 'Víctor Muñoz (LW)', 'Valentin Rosier (RB)', 'Javi Galán (LB)', 'Aimar Oroz (CAM)'], description: 'Compite en LALIGA EA SPORTS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'real_madrid', name: 'Real Madrid', league: 'Española', dt: 'José Mourinho', reputation: 5, initialSalary: 152600, marketValue: 793500000, starPlayers: ['Kylian Mbappé (ST)', 'Thibaut Courtois (GK)', 'Jude Bellingham (CAM)', 'Vini Jr. (LW)', 'Federico Valverde (CM)', 'Trent Alexander-Arnold (RB)', 'Antonio Rüdiger (CB)', 'Aurélien Tchouaméni (CDM)', 'Carvajal (RB)', 'Éder Militão (CB)', 'Rodrygo (LM)'], description: 'Compite en LALIGA EA SPORTS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'real_sociedad', name: 'Real Sociedad', league: 'Española', dt: 'Pellegrino Matarazzo', reputation: 4, initialSalary: 72500, marketValue: 377000000, starPlayers: ['Álex Remiro (GK)', 'Oyarzabal (ST)', 'Takefusa Kubo (RM)', 'Yangel Herrera (CM)', 'Sergio Gómez (LM)', 'Brais Méndez (CM)', 'Barrenetxea (LW)', 'Jon Mikel Aramburu (RB)', 'Carlos Soler (CM)', 'Zubeldia (CB)', 'Gorrotxa (CDM)'], description: 'Compite en LALIGA EA SPORTS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'sevilla_fc', name: 'Sevilla FC', league: 'Española', dt: 'DT Genérico', reputation: 4, initialSalary: 82600, marketValue: 429400000, starPlayers: ['Odysseas Vlachodimos (GK)', 'Azpilicueta (CB)', 'Ruben Vargas (LW)', 'Carmona (RB)', 'Chidera Ejuke (LW)', 'Nemanja Gudelj (CDM)', 'Batista Mendy (CDM)', 'Kike Salas (CB)', 'Juanlu Sánchez (RB)', 'Lucien Agoumé (CDM)', 'Djibril Sow (CM)'], description: 'Compite en LALIGA EA SPORTS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'rangers_fc', name: 'Rangers FC', league: 'Escocesa', dt: 'Derek McInnes', reputation: 4, initialSalary: 20200, marketValue: 105000000, starPlayers: ['Emmanuel Fernandez', 'Youssef Chermiti', 'Nicolas Raskin', 'Ivor Pandur', 'Dan Neil'], description: 'Clasificado a la Europa League 2025-26. Histórico de Glasgow, azul real.', badgeColor: 'border-l-4 border-blue-700 bg-slate-900/40 text-blue-100', badgeLogoUrl: '🔵⚪',
  ...
  { id: 'dinamo_zagreb', name: 'GNK Dinamo Zagreb', league: 'Croata', dt: 'Mario Kovačević', reputation: 3, initialSalary: 21000, marketValue: 109200000, starPlayers: ['Dion Beljo', 'Sergi Domínguez', 'Luka Stojkovic', 'Scott McKenna', 'Niko Galesic'], description: 'Clasificado a la Europa League 2025-26. Dominador habitual del fútbol croata.', badgeColor: 'border-l-4 border-blue-600 bg-slate-900/40 text-blue-100', badgeLogoUrl: '🔵⚪',
