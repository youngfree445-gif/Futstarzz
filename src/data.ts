...
// ==========================================
  ...
  { id: 'san_marcos_de_arica', name: 'San Marcos de Arica', league: 'Chilena', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Primera B de Chile.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeImageUrl: 'badges/clubs/san_marcos_de_arica.png', badgeLogoUrl: '⚽', division: 2 },
  ...
  { id: 'deportes_antofagasta', name: 'Deportes Antofagasta', league: 'Chilena', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Primera B de Chile.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeImageUrl: 'badges/clubs/deportes_antofagasta.png', badgeLogoUrl: '⚽', division: 2 },
  ...
  { id: 'racing_club_uru', name: 'Racing Club', league: 'Uruguaya', dt: 'DT Genérico', reputation: 2, initialSalary: 1100, marketValue: 4000000, starPlayers: ['Adrián Martínez (ST)', 'Facundo Cambeses (GK)', 'Marcos Rojo (CB)', 'Marco Di Cesare (CB)', 'Santiago Solari (RW)', 'Tomás Conechny (LM)', 'Duván Vergara (LW)', 'Valentín Carboni (CAM)'], description: 'Campeonato Uruguayo.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'atlético_sullana', name: 'Atlético Sullana', league: 'Peruana', dt: 'DT Genérico', reputation: 2, initialSalary: 1000, marketValue: 3500000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Liga 1 Te Apuesto.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeImageUrl: 'badges/clubs/atlético_sullana.png', badgeLogoUrl: '⚽', division: 1 },
 ...
 // ==========================================
  ...
  { id: 'cd_tondela', name: 'CD Tondela', league: 'Portuguesa', dt: 'DT Genérico', reputation: 3, initialSalary: 1000, marketValue: 9800000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Compite en Liga Portugal 2.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 2 },
