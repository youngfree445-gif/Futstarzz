...
// ==========================================
  ...
  { id: 'tigre', themeColor: { primary: '#dc2626', secondary: '#f5f0e8' }, name: 'Tigre', league: 'Argentina', dt: 'Diego Dabove', reputation: 3, initialSalary: 1300, marketValue: 6200000, starPlayers: ['Gonzalo Martínez (CAM)', 'Jalil Elías (CDM)', 'Joaquín Laso (CB)', 'Bruno Leyes (CDM)', 'Joaquín Mosqueira (CDM)', 'Felipe Zenobio (GK)', 'Nahuel Banegas (LB)', 'Elías Cabrera (LM)', 'Sebastián Medina (LM)'], description: 'El Matador de Victoria.', badgeColor: 'border-l-4 border-red-600 bg-blue-800 text-white', badgeLogoUrl: '🐯',
  ...
  { id: 'central_norte', name: 'Central Norte', league: 'Argentina', dt: 'Adrián Bastía', reputation: 2, initialSalary: 600, marketValue: 1500000, starPlayers: ['Arián Pucheta (CB)', 'Ramiro Costa (ST)', 'Agustin Aleo (LB)', 'Mauricio Rosales (RB)', 'Matías Villarreal (CDM)', 'Kevin Fernández (CAM)', 'Franco Vedoya (RW)', 'Joaquin Mateo (ST)', 'Leonardo Felissia (CB)'], description: 'El Cuervo salteño. Compite en B Nacional.', badgeColor: 'border-l-4 border-white bg-black text-white', badgeLogoUrl: '🐦',
  ...
  { id: 'colon', name: 'Colón', league: 'Argentina', dt: 'Ezequiel Medrán', reputation: 3, initialSalary: 1200, marketValue: 5500000, starPlayers: ['Federico Lértora (CDM)', 'Pier Barrios (CB)', 'Federico Rasmussen (CB)', 'Mauro Peinipil (RB)', 'Facundo Castro (ST)', 'Nicolás Thaller (CB)', 'Matías Godoy (LM)', 'Lucas Cano (ST)', 'Agustín Toledo (CDM)'], description: 'El Sabalero. Histórico en la B Nacional.', badgeColor: 'border-l-4 border-black bg-red-600 text-white', badgeLogoUrl: '🐘',
  ...
  { id: 'ponte_preta', name: 'Ponte Preta', league: 'Brasileña', dt: 'Nelsinho Baptista', reputation: 2, initialSalary: 900, marketValue: 3000000, starPlayers: ['Lucas Cunha (CB)', 'Jonathan Cafú (RW)', 'William Pottker (RW)', 'David Braz (CB)', 'Élvis (CAM)', 'Diogo Silva (GK)', 'Luís Phelipe (LW)'], description: 'Macaca.', badgeColor: 'border-l-4 border-black bg-white text-black', badgeLogoUrl: '🐒',
  ...
  { id: 'mazatlan', name: 'Mazatlán FC', league: 'Mexicana', dt: 'Ismael Rescalvo', reputation: 3, initialSalary: 2000, marketValue: 7500000, starPlayers: ['Yoel Bárcenas (LM)', 'Dudu (RW)', 'Ricardo Rodríguez (GK)', 'Jordan Sierra (CM)', 'José Esquivel (CDM)', 'Mauro Laínez (LM)', 'Josué Ovalle (RW)', 'Fábio (ST)'], description: 'Los Cañoneros.', badgeColor: 'border-l-4 border-white bg-purple-800 text-white', badgeLogoUrl: '⚓',
  ...
  { id: 'hamburg', themeColor: { primary: '#1d4ed8', secondary: '#f5f0e8' }, name: 'Hamburger SV', league: 'Alemana', dt: 'Merlin Polzin', reputation: 4, initialSalary: 2000, marketValue: 91325000, starPlayers: ['Luka Vušković (CB)', 'Daniel Heuer Fernandes (GK)', 'Albert Sambi Lokonga (CM)', 'Miro Muheim (LB)', 'Jordan Torunarigha (CB)', 'Albert Grønbæk (CAM)', 'Nicolai Remberg (CM)', 'Daniel Elfadli (CB)'], description: 'Hamburger SV. Compite en Bundesliga.', badgeColor: 'border-l-4 border-blue-700 bg-zinc-950/40 text-blue-200', badgeLogoUrl: '🔵⚫',
  ...
  { id: 'hannover_96', themeColor: { primary: '#16a34a', secondary: '#f5f0e8' }, name: 'Hannover 96', league: 'Alemana', dt: 'Christian Titz', reputation: 2, initialSalary: 800, marketValue: 13950000, starPlayers: ['Enzo Leopold (CM)', 'Benjamin Källman (ST)', 'Boris Tomiak (CB)', 'Maurice Neubauer (LB)', 'Elias Saad (LW)', 'Noah Weißhaupt (LM)', 'Virgil Ghiță (CB)', 'Noël Aséko (CDM)', 'Maik Nawrocki (CB)', 'Mustapha Bundu (RW)'], description: 'Hannover 96. Compite en Bundesliga 2.', badgeColor: 'border-l-4 border-green-600 bg-zinc-950/40 text-green-200', badgeLogoUrl: '🟢⚫',
  ...
  { id: 'holstein_kiel', themeColor: { primary: '#2563eb', secondary: '#f5f0e8' }, name: 'Holstein Kiel', league: 'Alemana', dt: 'Tim Walter', reputation: 2, initialSalary: 800, marketValue: 21575000, starPlayers: ['David Zec (CB)', 'Jonas Meffert (CDM)', 'Umut Tohumcu (CAM)', 'John Tolkin (LB)', 'Steven Skrzybski (ST)', 'Carl Johansson (CB)', 'Marko Ivezić (CB)', 'Jonas Therkelsen (CAM)'], description: 'Holstein Kiel. Compite en Bundesliga 2.', badgeColor: 'border-l-4 border-blue-600 bg-blue-950/40 text-blue-200', badgeLogoUrl: '🔵⚪',
  ...
  { id: 'burnley', name: 'Burnley', league: 'Inglesa', dt: 'Scott Parker', reputation: 2, initialSalary: 27900, marketValue: 304050000, starPlayers: ['Florentino (CDM)', 'Kyle Walker (RB)', 'Josh Cullen (CDM)', 'Quilindschy Hartman (LB)', 'Hannibal (CM)', 'Marcus Edwards (RM)', 'Zian Flemming (ST)'], description: 'Burnley. Compite en Premier League.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'hull_city', name: 'Hull City', league: 'Inglesa', dt: 'DT Genérico', reputation: 3, initialSalary: 18000, marketValue: 180000000, starPlayers: ['Paddy McNair (CB)', 'Charlie Hughes (CB)', 'Ryan Giles (LB)', 'Regan Slater (CDM)', 'Abdülkadir Ömür (CM)', 'Eliot Matazo (CM)', 'Liam Millar (LM)', 'Mohamed Belloumi (RM)', 'Oli McBurnie (ST)'], description: 'Hull City. Compite en la Premier League.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeImageUrl: 'badges/clubs/hull_city.png', badgeLogoUrl: '⚽', division: 2 },
  ...
  { id: 'fiorentina', themeColor: { primary: '#682E8B', secondary: '#FFFFFF' }, name: 'Fiorentina', league: 'Italiana', dt: 'Fabio Grosso', reputation: 4, initialSalary: 47800, marketValue: 303560000, starPlayers: ['De Gea (GK)', 'Dodô (RB)', 'Albert Guðmundsson (ST)', 'Manor Solomon (LM)', 'Nicolò Fagioli (CM)', 'Rolando Mandragora (CM)', 'Luca Ranieri (CB)', 'Fabiano Parisi (LB)'], description: 'Fiorentina. Compite en Serie A Enilive.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/fiorentina.png', division: 1 },
  { id: 'genoa', name: 'Genoa', league: 'Italiana', dt: 'Daniele De Rossi', reputation: 4, initialSalary: 2000, marketValue: 132070000, starPlayers: ['Morten Frendrup (CDM)', 'Justin Bijlow (GK)', 'Leo Østigård (CB)', 'Johan Vásquez (CB)', 'Vitinha (ST)', 'Brooke Norton-Cuffy (RB)', 'Tommaso Baldanzi (CAM)'], description: 'Genoa. Compite en Serie A Enilive.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'inter', themeColor: { primary: '#0068A8', secondary: '#000000' }, name: 'Inter', league: 'Italiana', dt: 'Cristian Chivu', reputation: 5, initialSalary: 110200, marketValue: 573300000, starPlayers: ['Lautaro Martínez (ST)', 'Nicolò Barella (CM)', 'Yann Sommer (GK)', 'Hakan Çalhanoğlu (CM)', 'Alessandro Bastoni (CB)', 'Federico Dimarco (LB)', 'Manuel Akanji (CB)', 'Aleksandar Stanković (CDM)', 'Yann Bisseck (CB)', 'Henrikh Mkhitaryan (CM)'], description: 'Inter. Compite en Serie A Enilive, reforzado con Manuel Akanji y Aleksandar Stanković, tras la salida de Denzel Dumfries.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/tm/inter.png', division: 1 },
  { id: 'juventus', themeColor: { primary: '#000000', secondary: '#FFFFFF' }, name: 'Juventus', league: 'Italiana', dt: 'Luciano Spalletti', reputation: 5, initialSalary: 123200, marketValue: 640400000, starPlayers: ['Bremer (CB)', 'Manuel Locatelli (CDM)', 'Loïs Openda (ST)', 'Khéphren Thuram (CM)', 'Kenan Yıldız (CAM)', 'Jonathan David (ST)', 'Pierre Kalulu (CB)', 'Andrea Cambiaso (LB)', 'Teun Koopmeiners (CAM)'], description: 'Juventus. Compite en Serie A Enilive.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'milan', themeColor: { primary: '#FB090B', secondary: '#000000' }, name: 'Milan', league: 'Italiana', dt: 'Rúben Amorim', reputation: 4, initialSalary: 89800, marketValue: 626510000, starPlayers: ['Christian Pulisic (RW)', 'Mike Maignan (GK)', 'Adrien Rabiot (CM)', 'Youssouf Fofana (CDM)', 'Strahinja Pavlović (CB)', 'Fikayo Tomori (CB)', 'Samuel Chukwueze (RW)', 'Ardon Jashari (CM)', 'Ruben Loftus-Cheek (CM)'], description: 'Milan. Compite en Serie A Enilive, reforzado con Ardon Jashari (Club Brugge) y Samuel Chukwueze.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
 ...
 // ==========================================
  ...
  { id: 'as_monaco', themeColor: { primary: '#CC092F', secondary: '#FFFFFF' }, name: 'AS Monaco', league: 'Francesa', dt: 'Filipe Luís', reputation: 5, initialSalary: 67500, marketValue: 350900000, starPlayers: ['Denis Zakaria (CDM)', 'Lukáš Hrádecký (GK)', 'Lamine Camara (CM)', 'Alexandr Golovin (CAM)', 'Folarin Balogun (ST)', 'Thilo Kehrer (CB)', 'Paul Pogba (CM)', 'Eric Dier (CB)', 'Takumi Minamino (LM)', 'Vanderson (RB)'], description: 'AS Monaco. Compite en Ligue 1 McDonalds.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/as_monaco.png', division: 1 },
  { id: 'as_saint_etienne', name: 'AS Saint-Étienne', league: 'Francesa', dt: 'Ian Cathro', reputation: 4, initialSalary: 2000, marketValue: 57885000, starPlayers: ['Lucas Stassin (ST)', 'Gautier Larsonneur (GK)', 'Julien Le Cardinal (CB)', 'Zuriko Davitashvili (LW)', 'Irvin Cardona (RW)', 'Augustine Boakye (RW)', 'João Ferreira (RB)', 'Chico Lamba (CB)', 'Mickaël Nadé (CB)', 'Maxime Bernauer (CB)'], description: 'AS Saint-Étienne. Compite en Ligue 1 McDonalds.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'olympique_de_marseille', themeColor: { primary: '#2FAEE0', secondary: '#FFFFFF' }, name: 'Olympique de Marseille', league: 'Francesa', dt: 'Bruno Genesio', reputation: 5, initialSalary: 50500, marketValue: 262750000, starPlayers: ['Benjamin Pavard (CB)', 'Pierre-Emile Højbjerg (CDM)', 'Pierre-Emerick Aubameyang (ST)', 'Nayef Aguerd (CB)', 'Igor Paixão (LM)', 'Quinten Timber (CM)', 'Amine Gouiri (ST)'], description: 'Olympique de Marseille. Compite en Ligue 1 McDonalds.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'stade_de_reims', name: 'Stade de Reims', league: 'Francesa', dt: 'Nicolas Usaï', reputation: 4, initialSalary: 2000, marketValue: 10000000, starPlayers: ['Keito Nakamura (LM)', 'Nicolas Pallois (CB)', 'Joseph Okumu (CB)', 'Akieme (LB)', 'Théo Leoni (CDM)', 'Mory Gbane (CDM)', 'Maxime Busi (RB)'], description: 'Stade de Reims. Compite en Ligue 1 McDonalds.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'fc_twente', name: 'FC Twente', league: 'Holandesa', dt: 'Joseph Oosting', reputation: 4, initialSalary: 2000, marketValue: 78585000, starPlayers: ['Lars Unnerstall (GK)', 'Bart van Rooij (RB)', 'Robin Pröpper (CB)', 'Daan Rots (RW)', 'Sam Lammers (ST)', 'Sondre Ørjasæter (LW)', 'Ricky van Wolfswinkel (ST)'], description: 'FC Twente. Compite en Eredivisie.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'nac_breda', name: 'NAC Breda', league: 'Holandesa', dt: 'Jo Jansen', reputation: 4, initialSalary: 2000, marketValue: 33750000, starPlayers: ['André Ayew (ST)', 'Denis Odoi (CB)', 'Lewis Holtby (CM)', 'Leo Greiml (CB)', 'Kamal Sowah (LM)', 'Clint Leemans (CM)', 'Mohamed Nassoh (LM)', 'Cherrion Valerius (RB)'], description: 'NAC Breda. Compite en la Eerste Divisie.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'sporting_cp', themeColor: { primary: '#00713C', secondary: '#FFFFFF' }, name: 'Sporting CP', league: 'Portuguesa', dt: 'Rui Borges', reputation: 5, initialSalary: 38100, marketValue: 468650000, starPlayers: ['Pedro Gonçalves (LM)', 'Trincão (CAM)', 'Rui Silva (GK)', 'Gonçalo Inácio (CB)', 'Luis Javier Suárez (ST)', 'Maximiliano Araújo (LM)', 'Geny Catamo (RM)', 'Zeno Debast (CB)'], description: 'Compite en Liga Portugal.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'colorado_rapids', name: 'Colorado Rapids', league: 'Estadounidense', dt: 'DT Genérico', reputation: 2, initialSalary: 2000, marketValue: 21000000, starPlayers: ['Paxten Aaronson (CM)', 'Zack Steffen (GK)', 'Rob Holding (CB)', 'Reggie Cannon (RB)', 'Keegan Rosenberry (RB)', 'Hamzat Ojediran (CDM)', 'Rafael Navarro (ST)'], description: 'Compite en MLS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/colorado_rapids.png', division: 1 },
  { id: 'columbus_crew', name: 'Columbus Crew', league: 'Estadounidense', dt: 'DT Genérico', reputation: 3, initialSalary: 2000, marketValue: 34000000, starPlayers: ['Dániel Gazdag (CAM)', 'Steven Moreira (CB)', 'Nariman Akhundzada (RW)', 'Patrick Schulte (GK)', 'Andrés Herrera (RB)', 'Dylan Chambost (CM)', 'Mohamed Farsi (RM)'], description: 'Compite en MLS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'real_salt_lake', name: 'Real Salt Lake', league: 'Estadounidense', dt: 'DT Genérico', reputation: 2, initialSalary: 2000, marketValue: 23000000, starPlayers: ['Juan Manuel Sanabria (LB)', 'Victor Olatunji (ST)', 'Morgan Guilavogui (LW)', 'Diego Luna (LM)', 'Pablo Ruiz (CDM)', 'Stijn Spierings (CM)', 'Lukas Engel (LB)', 'DeAndre Yedlin (RB)', 'Emeka Eneli (CDM)', 'Juan Arias (CB)', 'Justen Glad (CB)'], description: 'Compite en MLS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'girona_fc', name: 'Girona FC', league: 'Española', dt: 'Quique Álvarez', reputation: 2, initialSalary: 800, marketValue: 209400000, starPlayers: ['Marc-André ter Stegen (GK)', 'Paulo Gazzaniga (GK)', 'Azzedine Ounahi (CM)', 'Álex Moreno (LB)', 'Fran Beltrán (CM)', 'Bryan Gil (LW)', 'Vladyslav Vanat (ST)'], description: 'Descendió a LALIGA HYPERMOTION para la temporada 2026-27.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'cd_mirandes', name: 'CD Mirandés', league: 'Española', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Carlos Fernández (ST)', 'Igor Nikic (GK)', 'Juan Gutiérrez (CB)', 'Javi Hernández (RM)', 'Postigo (CB)', 'Pica (CB)', 'Martín Pascual (CB)', 'Mickaël Malsa (CDM)'], description: 'Compite en LALIGA HYPERMOTION.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/cd_mirandes.png', division: 2 },
  { id: 'cultural_leonesa', name: 'Cultural Leonesa', league: 'Española', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Edgar Badia (GK)', 'Nemanja Radoja (CDM)', 'Chacón (CAM)', 'Lucas Ribeiro (RM)', 'Rubén Sobrino (RM)', 'Iván Calero (RB)', 'Rodri Suárez (CB)', 'Roger Hinojo (LB)', 'Tresaco (LM)'], description: 'Compite en LALIGA HYPERMOTION.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'ud_almeria', name: 'UD Almería', league: 'Española', dt: 'García Pimienta', reputation: 2, initialSalary: 800, marketValue: 46100000, starPlayers: ['Arribas (CAM)', 'Embarba (LW)', 'Rodrigo Ely (CB)', 'Andrés Fernández (GK)', 'Álex Muñoz (LB)', 'Morci (LW)', 'Daijiro Chirino (RB)', 'Federico Bonini (CB)', 'Puigmal (RM)', 'Nélson Monte (CB)'], description: 'Compite en LALIGA HYPERMOTION.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'olympiacos', themeColor: { primary: '#dc2626', secondary: '#f5f0e8' }, name: 'Olympiacos FC', league: 'Griega', dt: 'José Luis Mendilibar', reputation: 5, initialSalary: 5000, marketValue: 34000000, starPlayers: ['Christos Mouzakitis', 'Santiago Hezze', 'Lorenzo Pirola', 'Jota Silva'], description: 'Clasificado a la Champions League 2025-26. El gigante del Pireo, dominador de la Super League griega.', badgeColor: 'border-l-4 border-red-600 bg-red-950/40 text-red-200', badgeLogoUrl: '🔴⚪',
  ...
  { id: 'midtjylland', themeColor: { primary: '#dc2626', secondary: '#f5f0e8' }, name: 'FC Midtjylland', league: 'Danesa', dt: 'Mike Tullberg', reputation: 4, initialSalary: 2600, marketValue: 16500000, starPlayers: ['Philip Billing (CM)', 'Mads Bech Sørensen (CB)', 'Darío Osorio (RM)', 'Franculino (ST)', 'Elías Rafn Ólafsson (GK)', 'Martin Erlić (CB)', 'Ousmane Diao (CB)', 'Lee Han Beom (CB)', 'Victor Bak (LB)', 'Mikael Uhre (ST)'], description: 'Clasificado a la Europa League 2025-26. Pionero del análisis de datos en el fútbol danés.', badgeColor: 'border-l-4 border-red-600 bg-black text-red-200', badgeLogoUrl: '🔴⚫',
