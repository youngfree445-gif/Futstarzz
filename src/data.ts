...
// ==========================================
  ...
  { id: 'colon', name: 'Colón', league: 'Argentina', dt: 'Ezequiel Medrán', reputation: 3, initialSalary: 1200, marketValue: 5500000, starPlayers: ['Federico Lértora (CDM)', 'Pier Barrios (CB)', 'Federico Rasmussen (CB)', 'Mauro Peinipil (RB)', 'Facundo Castro (ST)', 'Nicolás Thaller (CB)', 'Matías Godoy (LM)', 'Lucas Cano (ST)', 'Agustín Toledo (CDM)', 'Darío Sarmiento (RM)'], description: 'El Sabalero. Histórico en la B Nacional.', badgeColor: 'border-l-4 border-black bg-red-600 text-white', badgeLogoUrl: '🐘',
  ...
  { id: 'fortaleza_br', themeColor: { primary: '#dc2626', secondary: '#f5f0e8' }, name: 'Fortaleza', league: 'Brasileña', dt: 'Juan Pablo Vojvoda', reputation: 3, initialSalary: 1500, marketValue: 5450000, starPlayers: ['Tomás Pochettino (CAM)', 'João Ricardo (GK)', 'Tomás Cardona (CB)', 'Lucas Crispim (CAM)', 'Lucas Sasha (CDM)', 'Gazal (CB)', 'Brenno (GK)'], description: 'Descendido sorpresivamente en el mod.', badgeColor: 'border-l-4 border-red-600 bg-blue-800 text-white', badgeLogoUrl: '🦁',
  ...
  { id: 'ponte_preta', name: 'Ponte Preta', league: 'Brasileña', dt: 'Nelsinho Baptista', reputation: 2, initialSalary: 900, marketValue: 3000000, starPlayers: ['Lucas Cunha (CB)', 'Jonathan Cafú (RW)', 'William Pottker (RW)', 'David Braz (CB)', 'Élvis (CAM)', 'Brandão (ST)', 'Diogo Silva (GK)', 'David da Hora (LW)', 'Luís Phelipe (LW)'], description: 'Macaca.', badgeColor: 'border-l-4 border-black bg-white text-black', badgeLogoUrl: '🐒',
  ...
  { id: 'mazatlan', name: 'Mazatlán FC', league: 'Mexicana', dt: 'Ismael Rescalvo', reputation: 3, initialSalary: 2000, marketValue: 7500000, starPlayers: ['Yoel Bárcenas (LM)', 'Lucas Merolla (CB)', 'Dudu (RW)', 'Ricardo Rodríguez (GK)', 'Jordan Sierra (CM)', 'José Esquivel (CDM)', 'Mauro Laínez (LM)', 'Josué Ovalle (RW)', 'Fábio (ST)'], description: 'Los Cañoneros.', badgeColor: 'border-l-4 border-white bg-purple-800 text-white', badgeLogoUrl: '⚓',
  ...
  { id: 'cobresal', name: 'Cobresal', league: 'Chilena', dt: 'DT Genérico', reputation: 3, initialSalary: 1200, marketValue: 5000000, starPlayers: ['Steffan Pino (ST)', 'Franco Frías (ST)', 'César Yanis (RW)', 'Bryan Carvallo (CAM)', 'Julián Brea (RW)', 'Guillermo Pacheco (RB)', 'Juan Fuentes (CDM)', 'Esteban Valencia (CM)', 'José Tiznado (CB)', 'Franco Bechtholdt (CB)'], description: 'Primera División de Chile.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'deportes_limache', name: 'Deportes Limache', league: 'Chilena', dt: 'DT Genérico', reputation: 3, initialSalary: 1200, marketValue: 5000000, starPlayers: ['Jean Meneses (LW)', 'Joaquín Montecinos (RW)', 'Nicolás Peñailillo (LB)', 'Alfonso Parot (LB)', 'César Pinares (CAM)', 'Ramón Martínez (CDM)', 'César Fuentes (CDM)', 'Daniel Castro (LW)', 'Claudio González (GK)', 'Marcos Arturia (ST)'], description: 'Primera División de Chile.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  // ==========================================
  { id: 'penarol', themeColor: { primary: '#eab308', secondary: '#f5f0e8' }, name: 'Peñarol', league: 'Uruguaya', dt: 'Diego Aguirre', reputation: 4, initialSalary: 2200, marketValue: 15400000, starPlayers: ['Leonardo Fernández (CAM)', 'Gastón Togni (LM)', 'Diego Laxalt (LB)', 'Matías Arezo (ST)', 'Javier Cabrera (RM)', 'Abel Hernández (ST)', 'Facundo Batista (ST)', 'Washington Aguerre (GK)', 'Lucas Ferreira (CB)', 'Luis Miguel Angulo (LM)'], description: 'El Carbonero.', badgeColor: 'border-l-4 border-yellow-500 bg-black text-yellow-300', badgeLogoUrl: '🏆',
  ...
  { id: 'boston_river_uru', name: 'Boston River', league: 'Uruguaya', dt: 'DT Genérico', reputation: 2, initialSalary: 1100, marketValue: 4000000, starPlayers: ['Gastón Ramírez (CM)', 'Agustín Amado (CM)', 'Bruno Antúnez (GK)', 'Juan Acosta (RB)', 'Leandro Suhr (RW)', 'Fredy Martínez (LB)', 'Martín González (CB)', 'Facundo Muñoa (CM)', 'Facundo Rodríguez (ST)'], description: 'Campeonato Uruguayo.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'adt', name: 'ADT', league: 'Peruana', dt: 'DT Genérico', reputation: 2, initialSalary: 1000, marketValue: 3500000, starPlayers: ['Jonathan Bauman (ST)', 'Joao Rojas (CAM)', 'Víctor Cedrón (CAM)', 'Luis Pérez (CM)', 'Jordan Guivin (CM)', 'Aldair Rodríguez (ST)', 'John Narváez (CB)', 'Carlos Solís (GK)', 'Juan Valencia (GK)', 'Luis Benítes (LW)'], description: 'Liga 1 Te Apuesto.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'fc_cajamarca', name: 'FC Cajamarca', league: 'Peruana', dt: 'DT Genérico', reputation: 2, initialSalary: 1000, marketValue: 3500000, starPlayers: ['Pablo Míguez (CB)', 'Brandon Palacios (LW)', 'Enmanuel Páucar (CDM)', 'Nilson Loyola (LB)', 'Jonathan Betancourt (LW)', 'Tomás Andrade (CAM)', 'Matías Almirón (CB)', 'Jefferson Orejuela (CDM)'], description: 'Liga 1 Te Apuesto.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'orense', name: 'Orense', league: 'Ecuatoriana', dt: 'DT Genérico', reputation: 2, initialSalary: 1200, marketValue: 5000000, starPlayers: ['Ángel Mena (RW)', 'Valentín Burgoa (CAM)', 'Erick Plúas (CDM)', 'Stefano Callegari (CB)', 'Diego Armas (CAM)', 'Nixon Molina (CDM)', 'Rolando Silva (GK)', 'Renny Jaramillo (CDM)', 'Alan Lorenzo (CB)', 'Óscar Quiñónez (CB)'], description: 'Liga Pro Serie A.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'fc_st_pauli', themeColor: { primary: '#92400e', secondary: '#f5f0e8' }, name: 'FC St. Pauli', league: 'Alemana', dt: 'Marcel Rapp', reputation: 4, initialSalary: 2000, marketValue: 37700000, starPlayers: ['Nikola Vasilj (GK)', 'Eric Smith (CB)', 'Jackson Irvine (CM)', 'Mathias Rasmussen (CM)', 'Mathias Pereira Lage (ST)', 'Manolis Saliakas (RB)', 'Joel Chima Fujita (CM)', 'Martijn Kaars (ST)'], description: 'FC St. Pauli. Compite en Bundesliga.', badgeColor: 'border-l-4 border-amber-800 bg-zinc-950/40 text-amber-200', badgeLogoUrl: '🟤⚪',
  ...
  { id: 'hertha_bsc', themeColor: { primary: '#2563eb', secondary: '#f5f0e8' }, name: 'Hertha BSC', league: 'Alemana', dt: 'Stefan Leitl', reputation: 2, initialSalary: 26400, marketValue: 22885000, starPlayers: ['Josip Brekalo (LM)', 'Tjark Ernst (GK)', 'Paul Seguin (CDM)', 'Toni Leistner (CB)', 'Márton Dárdai (CB)', 'Michał Karbownik (LB)', 'Diego Demme (CDM)', 'Linus Gechter (CB)'], description: 'Hertha BSC. Compite en Bundesliga 2.', badgeColor: 'border-l-4 border-blue-600 bg-blue-950/40 text-blue-200', badgeLogoUrl: '🔵⚪',
  ...
  { id: 'wolverhampton_wanderers', name: 'Wolverhampton Wanderers', league: 'Inglesa', dt: 'Vítor Pereira', reputation: 3, initialSalary: 75200, marketValue: 260925000, starPlayers: ['André (CDM)', 'José Sá (GK)', 'Santiago Bueno (CB)', 'Tolu Arokodare (ST)', 'Sam Johnstone (GK)', 'Hugo Bueno (LB)', 'Jean-Ricner Bellegarde (CAM)', 'Toti (CB)'], description: 'Wolverhampton Wanderers. Compite en Premier League.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/wolverhampton_wanderers.png', division: 1 },
  { id: 'nottingham_forest', name: 'Nottingham Forest', league: 'Inglesa', dt: 'Oliver Glasner', reputation: 3, initialSalary: 1500, marketValue: 521925000, starPlayers: ['Matz Sels (GK)', 'Murillo (CB)', 'Nikola Milenković (CB)', 'Morgan Gibbs-White (CAM)', 'Chris Wood (ST)', 'Ola Aina (RB)', 'Neco Williams (LB)', 'Stefan Ortega (GK)', 'Ibrahim Sangaré (CDM)', 'Callum Hudson-Odoi (LM)'], description: 'Nottingham Forest. Compite en Premier League.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'bologna', name: 'Bologna', league: 'Italiana', dt: 'Domenico Tedesco', reputation: 4, initialSalary: 2000, marketValue: 250770000, starPlayers: ['Riccardo Orsolini (RM)', 'Remo Freuler (CDM)', 'Łukasz Skorupski (GK)', 'Lewis Ferguson (CDM)', 'João Mário (RB)', 'Jens Odgaard (CAM)', 'Juan Miranda (LB)', 'Nicolò Cambiaghi (LM)', 'Nikola Moro (CDM)'], description: 'Bologna. Compite en Serie A Enilive.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'parma', name: 'Parma', league: 'Italiana', dt: 'Carlos Cuesta', reputation: 4, initialSalary: 2000, marketValue: 104085000, starPlayers: ['Enrico Delprato (CB)', 'Emanuele Valeri (LB)', 'Hans Nicolussi Caviglia (CDM)', 'Adrián Bernabé (CM)', 'Abdoulaye Ndiaye (CB)', 'Mandela Keita (CDM)', 'Gaetano Oristanio (CAM)', 'Matija Frigan (ST)'], description: 'Parma. Compite en Serie A Enilive.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'torino', name: 'Torino', league: 'Italiana', dt: 'Ignazio Abate', reputation: 4, initialSalary: 35400, marketValue: 217995000, starPlayers: ['Duván Zapata (ST)', 'Nikola Vlašić (CAM)', 'Ché Adams (ST)', 'Cristiano Biraghi (LB)', 'Valentino Lazaro (RM)', 'Saúl Coco (CB)', 'Guillermo Maripán (CB)', 'Cesare Casadei (CM)', 'Franco Israel (GK)', 'Ivan Ilić (CDM)'], description: 'Torino. Compite en Serie A Enilive.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'carrarese', name: 'Carrarese', league: 'Italiana', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Nicolas Schiavi (CM)', 'Julián Illanes (CB)', 'Marco Bleve (GK)', 'Luis Hasa (CM)', 'Fabio Abiuso (ST)', 'Filippo Oliana (CB)', 'Mattia Finotto (ST)', 'Vincenzo Fiorillo (GK)', 'Bartosz Salamon (CB)'], description: 'Carrarese. Compite en Serie BKT.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'spezia', name: 'Spezia', league: 'Italiana', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 17235000, starPlayers: ['Filippo Bandinelli (CM)', 'Gianluca Lapadula (ST)', 'Petko Hristov (CB)', 'Szymon Żurkowski (CM)', 'Mattia Valoti (CAM)', 'Ádám Nagy (CM)'], description: 'Spezia. Compite en Serie BKT.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
 ...
 // ==========================================
  ...
  { id: 'fc_groningen', name: 'FC Groningen', league: 'Holandesa', dt: 'Dick Lukkien', reputation: 4, initialSalary: 2000, marketValue: 45125000, starPlayers: ['Stije Resink (CDM)', 'Etienne Vaessen (GK)', 'Thijmen Blokzijl (CB)', 'Marco Rente (RB)', 'Dies Janse (CB)', 'Younes Taha (CAM)', 'Thom van Bergen (ST)', 'Brynjólfur Willumsson (ST)', 'Tygo Land (CM)', 'Tika de Jonge (CM)'], description: 'FC Groningen. Compite en Eredivisie.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/fc_groningen.png', division: 1 },
  { id: 'fc_twente', name: 'FC Twente', league: 'Holandesa', dt: 'Joseph Oosting', reputation: 4, initialSalary: 2000, marketValue: 78585000, starPlayers: ['Lars Unnerstall (GK)', 'Bart van Rooij (RB)', 'Ramiz Zerrouki (CDM)', 'Robin Pröpper (CB)', 'Daan Rots (RW)', 'Sam Lammers (ST)', 'Mees Hilgers (CB)', 'Sondre Ørjasæter (LW)', 'Mathias Kjølø (CDM)', 'Ricky van Wolfswinkel (ST)'], description: 'FC Twente. Compite en Eredivisie.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/fc_twente.png', division: 1 },
  { id: 'fc_utrecht', name: 'FC Utrecht', league: 'Holandesa', dt: 'Ron Jans', reputation: 4, initialSalary: 2000, marketValue: 92335000, starPlayers: ['Vasilios Barkas (GK)', 'Mike van der Hoorn (CB)', 'Yoann Cathline (LW)', 'Sébastien Haller (ST)', 'Dani de Wit (CAM)', 'Mike Eerdhuijzen (CB)', 'Gjivai Zechiël (CM)'], description: 'FC Utrecht. Compite en Eredivisie.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'go_ahead_eagles', name: 'Go Ahead Eagles', league: 'Holandesa', dt: 'Mike Klein', reputation: 4, initialSalary: 2000, marketValue: 40800000, starPlayers: ['Jari De Busser (GK)', 'Melle Meulensteen (CDM)', 'Joris Kramer (CB)', 'Mathis Suray (LM)', 'Victor Edvardsen (ST)', 'Dean James (LB)', 'Alfons Sampsted (RB)', 'Gerrit Nauber (CB)', 'Evert Linthorst (CDM)'], description: 'Go Ahead Eagles. Compite en Eredivisie.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/go_ahead_eagles.png', division: 1 },
  { id: 'heracles_almelo', name: 'Heracles Almelo', league: 'Holandesa', dt: 'Bas Sibum', reputation: 4, initialSalary: 2000, marketValue: 38185000, starPlayers: ['Remko Pasveer (GK)', 'Jeff Reine-Adélaïde (CAM)', 'Damon Mirani (CB)', 'Naci Ünüvar (LM)', 'Ajdin Hrustić (CM)', 'Walid Ould-Chikh (LM)', 'Luka Kulenović (ST)', 'Alec Van Hoorenbeeck (CB)', 'Fabian de Keijzer (GK)', 'Ivan Mesík (LB)', 'Jan Žambůrek (CDM)'], description: 'Heracles Almelo. Compite en la Eerste Divisie.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'pec_zwolle', name: 'PEC Zwolle', league: 'Holandesa', dt: 'Mirjam Clifford', reputation: 4, initialSalary: 2000, marketValue: 39975000, starPlayers: ['Jasper Schendelaar (GK)', 'Younes Namli (RM)', 'Jamiro Monteiro (CAM)', 'Simon Graves (CB)', 'Koen Kostons (ST)', 'Ryan Thomas (CM)', 'Odysseus Velanas (LM)'], description: 'PEC Zwolle. Compite en Eredivisie.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'portland_timbers', name: 'Portland Timbers', league: 'Estadounidense', dt: 'DT Genérico', reputation: 3, initialSalary: 2000, marketValue: 28000000, starPlayers: ['David da Costa (CAM)', 'Alexander Aravena (LM)', 'Kamal Miller (CB)', 'Antony (LM)', 'Brandon Bye (RB)', 'Diego Chará (CDM)', 'Joao Ortiz (CDM)', 'Kristoffer Velde (LM)', 'Cole Bassett (CAM)', 'Jímer Fory (LB)'], description: 'Compite en MLS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'ud_las_palmas', name: 'UD Las Palmas', league: 'Española', dt: 'Rubén de la Barrera', reputation: 2, initialSalary: 800, marketValue: 43350000, starPlayers: ['Sandro (RM)', 'Kirian (CM)', 'Dinko Horkaš (GK)', 'Mika Mármol (CB)', 'Manu Fuster (LM)', 'Enzo Loiodice (CM)', 'Taisei Miyashiro (LW)', 'Álex Suárez (CB)', 'Viti Rozada (RB)'], description: 'Compite en LALIGA HYPERMOTION.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
