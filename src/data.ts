...
// ==========================================
  ...
  { id: 'racing_club_uru', name: 'Racing Club', league: 'Uruguaya', dt: 'DT Genérico', reputation: 2, initialSalary: 1100, marketValue: 4000000, starPlayers: ['Adrián Martínez (ST)', 'Facundo Cambeses (GK)', 'Marcos Rojo (CB)', 'Gastón Martirena (RM)', 'Marco Di Cesare (CB)', 'Santiago Solari (RW)', 'Tomás Conechny (LM)', 'Duván Vergara (LW)', 'Valentín Carboni (CAM)'], description: 'Campeonato Uruguayo.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'vfl_wolfsburg', themeColor: { primary: '#22c55e', secondary: '#f5f0e8' }, name: 'VfL Wolfsburg', league: 'Alemana', dt: 'Tobias Strobl', reputation: 4, initialSalary: 55400, marketValue: 230625000, starPlayers: ['Kamil Grabara (GK)', 'Mohamed Amoura (ST)', 'Maximilian Arnold (CDM)', 'Joakim Mæhle (LB)', 'Lovro Majer (CAM)', 'Denis Vavro (CB)', 'Moritz Jenz (CB)', 'Christian Eriksen (CAM)', 'Mattias Svanberg (CM)'], description: 'VfL Wolfsburg. Compite en Bundesliga.', badgeColor: 'border-l-4 border-green-500 bg-green-950/40 text-green-200', badgeLogoUrl: '🟢⚪',
  ...
  { id: 'hamburg', themeColor: { primary: '#1d4ed8', secondary: '#f5f0e8' }, name: 'Hamburger SV', league: 'Alemana', dt: 'Merlin Polzin', reputation: 4, initialSalary: 2000, marketValue: 91325000, starPlayers: ['Luka Vušković (CB)', 'Daniel Heuer Fernandes (GK)', 'Albert Sambi Lokonga (CM)', 'Miro Muheim (LB)', 'Jean-Luc Dompé (LW)', 'Jordan Torunarigha (CB)', 'Albert Grønbæk (CAM)', 'Nicolai Remberg (CM)', 'Daniel Elfadli (CB)'], description: 'Hamburger SV. Compite en Bundesliga.', badgeColor: 'border-l-4 border-blue-700 bg-zinc-950/40 text-blue-200', badgeLogoUrl: '🔵⚫',
  ...
  { id: 'brighton_hove_albion', name: 'Brighton & Hove Albion', league: 'Inglesa', dt: 'Fabian Hürzeler', reputation: 4, initialSalary: 47700, marketValue: 527100000, starPlayers: ['Kaoru Mitoma (LM)', 'Bart Verbruggen (GK)', 'Carlos Baleba (CDM)', 'Yankuba Minteh (RM)', 'Ferdi Kadıoğlu (LB)', 'Yasin Ayari (CDM)', 'Maxim De Cuyper (LB)', 'Mats Wieffer (CDM)', 'Pascal Groß (CDM)'], description: 'Brighton & Hove Albion. Compite en Premier League.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'crystal_palace', name: 'Crystal Palace', league: 'Inglesa', dt: 'Pierre Sage', reputation: 3, initialSalary: 46000, marketValue: 451335000, starPlayers: ['Dean Henderson (GK)', 'Daniel Muñoz (RB)', 'Jean-Philippe Mateta (ST)', 'Adam Wharton (CDM)', 'Ismaïla Sarr (RW)', 'Chris Richards (CB)', 'Tyrick Mitchell (LB)', 'Yeremy Pino (LW)', 'Daichi Kamada (CM)'], description: 'Crystal Palace. Compite en Premier League.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'west_bromwich_albion', name: 'West Bromwich Albion', league: 'Inglesa', dt: 'DT Genérico', reputation: 1, initialSalary: 5500, marketValue: 35000000, starPlayers: ['Max O\'Leary (GK)', 'Chris Mepham (CB)', 'Krystian Bielik (CB)', 'Nolan Galves (RB)', 'Callum Styles (LB)', 'Ousmane Diakité (CDM)', 'Jayson Molumby (CM)', 'Mikey Johnston (LM)', 'Matt Ingram (GK)'], description: 'West Bromwich Albion. Compite en el Championship.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeImageUrl: 'badges/clubs/west_bromwich_albion.png', badgeLogoUrl: '⚽', division: 2 },
  ...
  { id: 'hull_city', name: 'Hull City', league: 'Inglesa', dt: 'DT Genérico', reputation: 3, initialSalary: 18000, marketValue: 180000000, starPlayers: ['Paddy McNair (CB)', 'Charlie Hughes (CB)', 'Cody Drameh (RB)', 'Ryan Giles (LB)', 'Regan Slater (CDM)', 'Abdülkadir Ömür (CM)', 'Eliot Matazo (CM)', 'Liam Millar (LM)', 'Mohamed Belloumi (RM)', 'Oli McBurnie (ST)'], description: 'Hull City. Compite en la Premier League.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeImageUrl: 'badges/clubs/hull_city.png', badgeLogoUrl: '⚽', division: 2 },
  ...
  { id: 'cagliari', name: 'Cagliari', league: 'Italiana', dt: 'Fabio Pisacane', reputation: 4, initialSalary: 2000, marketValue: 97845000, starPlayers: ['Elia Caprile (GK)', 'Yerry Mina (CB)', 'Sebastiano Esposito (ST)', 'Andrea Belotti (ST)', 'Zé Pedro (CB)', 'Gianluca Gaetano (CAM)', 'Michel Ndary Adopo (CM)'], description: 'Cagliari. Compite en Serie A Enilive.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'fiorentina', themeColor: { primary: '#682E8B', secondary: '#FFFFFF' }, name: 'Fiorentina', league: 'Italiana', dt: 'Fabio Grosso', reputation: 4, initialSalary: 47800, marketValue: 303560000, starPlayers: ['De Gea (GK)', 'Moise Kean (ST)', 'Dodô (RB)', 'Albert Guðmundsson (ST)', 'Manor Solomon (LM)', 'Nicolò Fagioli (CM)', 'Rolando Mandragora (CM)', 'Luca Ranieri (CB)', 'Fabiano Parisi (LB)'], description: 'Fiorentina. Compite en Serie A Enilive.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/fiorentina.png', division: 1 },
  { id: 'genoa', name: 'Genoa', league: 'Italiana', dt: 'Daniele De Rossi', reputation: 4, initialSalary: 2000, marketValue: 132070000, starPlayers: ['Morten Frendrup (CDM)', 'Justin Bijlow (GK)', 'Leo Østigård (CB)', 'Johan Vásquez (CB)', 'Vitinha (ST)', 'Brooke Norton-Cuffy (RB)', 'Aarón Martín (LB)', 'Tommaso Baldanzi (CAM)'], description: 'Genoa. Compite en Serie A Enilive.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'juventus', themeColor: { primary: '#000000', secondary: '#FFFFFF' }, name: 'Juventus', league: 'Italiana', dt: 'Luciano Spalletti', reputation: 5, initialSalary: 123200, marketValue: 640400000, starPlayers: ['Bremer (CB)', 'Manuel Locatelli (CDM)', 'Loïs Openda (ST)', 'Khéphren Thuram (CM)', 'Kenan Yıldız (CAM)', 'Jonathan David (ST)', 'Michele Di Gregorio (GK)', 'Pierre Kalulu (CB)', 'Andrea Cambiaso (LB)', 'Teun Koopmeiners (CAM)'], description: 'Juventus. Compite en Serie A Enilive.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'torino', name: 'Torino', league: 'Italiana', dt: 'Ignazio Abate', reputation: 4, initialSalary: 35400, marketValue: 217995000, starPlayers: ['Duván Zapata (ST)', 'Nikola Vlašić (CAM)', 'Ché Adams (ST)', 'Cristiano Biraghi (LB)', 'Valentino Lazaro (RM)', 'Saúl Coco (CB)', 'Cesare Casadei (CM)', 'Franco Israel (GK)', 'Ivan Ilić (CDM)'], description: 'Torino. Compite en Serie A Enilive.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/torino.png', division: 1 },
  { id: 'udinese', name: 'Udinese', league: 'Italiana', dt: 'Kosta Runjaic', reputation: 4, initialSalary: 2000, marketValue: 153955000, starPlayers: ['Oumar Solet (CB)', 'Jesper Karlström (CDM)', 'Nicolò Zaniolo (ST)', 'Maduka Okoye (GK)', 'Jurgen Ekkelenkamp (CM)', 'Keinan Davis (ST)', 'Thomas Kristensen (CB)', 'Christian Kabasele (CB)', 'Adam Buksa (ST)'], description: 'Udinese. Compite en Serie A Enilive.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  // --- ITALIA (SEGUNDA) ---
  // ==========================================
  { id: 'bari', name: 'Bari', league: 'Italiana', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Lorenzo Dickmann (RB)', 'Giulio Maggiore (CM)', 'Christian Gytkjær (ST)', 'Andrea Cistana (CB)', 'Gabriele Moncini (ST)'], description: 'Bari. Compite en Serie BKT.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'juve_stabia', name: 'Juve Stabia', league: 'Italiana', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Salim Diakité (RB)', 'Marco Bellich (CB)', 'Leonardo Candellone (ST)', 'Andrea Giorgini (CB)', 'Fabio Maistro (CAM)', 'Omar Correia (CDM)', 'Christian Pierobon (CM)'], description: 'Juve Stabia. Compite en Serie BKT.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/juve_stabia.png', division: 2 },
  { id: 'mantova', name: 'Mantova', league: 'Italiana', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['César Falletti (CAM)', 'Leonardo Mancuso (ST)', 'Davis Mensah (ST)', 'Davide Bragantini (RM)', 'Tiago Gonçalves (LB)', 'Francesco Ruocco (LM)', 'Nicolò Radaelli (RB)'], description: 'Mantova. Compite en Serie BKT.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'reggiana', name: 'Reggiana', league: 'Italiana', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Manolo Portanova (CM)', 'Mario Sampirisi (RB)', 'Matteo Rover (RM)', 'Cedric Diomandè Gondo (ST)', 'Francesco Vicari (CB)', 'Alessandro Micai (GK)', 'Andrea Papetti (CB)', 'Danilo Quaranta (CB)'], description: 'Reggiana. Compite en Serie BKT.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'sassuolo', name: 'Sassuolo', league: 'Italiana', dt: 'Alberto Aquilani', reputation: 2, initialSalary: 800, marketValue: 166120000, starPlayers: ['Domenico Berardi (RW)', 'Armand Laurienté (LW)', 'Nemanja Matić (CDM)', 'Kristian Thorstvedt (CM)', 'Ismaël Koné (CM)', 'Andrea Pinamonti (ST)', 'Jay Idzes (CB)', 'Josh Doig (LB)'], description: 'Sassuolo. Compite en Serie BKT.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/sassuolo.png', division: 1 },
  { id: 'spezia', name: 'Spezia', league: 'Italiana', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 17235000, starPlayers: ['Filippo Bandinelli (CM)', 'Petko Hristov (CB)', 'Szymon Żurkowski (CM)', 'Mattia Valoti (CAM)', 'Ádám Nagy (CM)'], description: 'Spezia. Compite en Serie BKT.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
 ...
 // ==========================================
  ...
  { id: 'angers_sco', name: 'Angers SCO', league: 'Francesa', dt: 'Stéphane Gilli', reputation: 4, initialSalary: 2000, marketValue: 58175000, starPlayers: ['Hervé Koffi (GK)', 'Jordan Lefort (CB)', 'Haris Belkebla (CDM)', 'Ousmane Camara (CB)', 'Carlens Arcus (RB)', 'Jacques Ekomié (LB)', 'Branco van den Boomen (CM)', 'Yassin Belkhdim (CM)', 'Amine Sbaï (LM)', 'Louis Mouton (CAM)'], description: 'Angers SCO. Compite en Ligue 1 McDonalds.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'le_mans_fc', name: 'Le Mans FC', league: 'Francesa', dt: 'Julien Le Cardinal', reputation: 2, initialSalary: 800, marketValue: 20250000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Les Sang et Or du Maine.', badgeColor: 'border-l-4 border-yellow-500 bg-red-900 text-white', badgeLogoUrl: '🟡',
    division: 2 },
  { id: 'le_havre_ac', name: 'Le Havre AC', league: 'Francesa', dt: 'Didier Digard', reputation: 4, initialSalary: 2000, marketValue: 73650000, starPlayers: ['Abdoulaye Touré (CDM)', 'Sofiane Boufal (CAM)', 'Mory Diaw (GK)', 'Ayumu Seko (CDM)', 'Rassoul Ndiaye (CM)', 'Loïc Négo (RB)', 'Étienne Youté Kinkoué (CB)'], description: 'Le Havre AC. Compite en Ligue 1 McDonalds.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'montpellier_hsc', name: 'Montpellier HSC', league: 'Francesa', dt: 'Zoumana Camara', reputation: 4, initialSalary: 2000, marketValue: 48775000, starPlayers: ['Julien Laporte (CB)', 'Enzo Tchato (RB)', 'Christopher Jullien (CB)', 'Alexandre Mendy (ST)', 'Khalil Fayad (CM)', 'Théo Sainte-Luce (LB)', 'Lucas Mincarelli (LB)', 'Simon Ngapandouetnbu (GK)', 'Mathieu Michel (GK)'], description: 'Montpellier HSC. Compite en Ligue 1 McDonalds.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'olympique_de_marseille', themeColor: { primary: '#2FAEE0', secondary: '#FFFFFF' }, name: 'Olympique de Marseille', league: 'Francesa', dt: 'Bruno Genesio', reputation: 5, initialSalary: 50500, marketValue: 262750000, starPlayers: ['Benjamin Pavard (CB)', 'Pierre-Emile Højbjerg (CDM)', 'Pierre-Emerick Aubameyang (ST)', 'Nayef Aguerd (CB)', 'Leonardo Balerdi (CB)', 'Igor Paixão (LM)', 'Quinten Timber (CM)', 'Amine Gouiri (ST)'], description: 'Olympique de Marseille. Compite en Ligue 1 McDonalds.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'fc_twente', name: 'FC Twente', league: 'Holandesa', dt: 'Joseph Oosting', reputation: 4, initialSalary: 2000, marketValue: 78585000, starPlayers: ['Lars Unnerstall (GK)', 'Bart van Rooij (RB)', 'Robin Pröpper (CB)', 'Daan Rots (RW)', 'Sam Lammers (ST)', 'Mees Hilgers (CB)', 'Sondre Ørjasæter (LW)', 'Mathias Kjølø (CDM)', 'Ricky van Wolfswinkel (ST)'], description: 'FC Twente. Compite en Eredivisie.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/fc_twente.png', division: 1 },
  { id: 'fc_utrecht', name: 'FC Utrecht', league: 'Holandesa', dt: 'Ron Jans', reputation: 4, initialSalary: 2000, marketValue: 92335000, starPlayers: ['Vasilios Barkas (GK)', 'Mike van der Hoorn (CB)', 'Yoann Cathline (LW)', 'Sébastien Haller (ST)', 'Dani de Wit (CAM)', 'Mike Eerdhuijzen (CB)'], description: 'FC Utrecht. Compite en Eredivisie.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/fc_utrecht.png', division: 1 },
  { id: 'feyenoord', name: 'Feyenoord', league: 'Holandesa', dt: 'Robin van Persie', reputation: 4, initialSalary: 2000, marketValue: 203125000, starPlayers: ['Ayase Ueda (ST)', 'Raheem Sterling (LW)', 'Tsuyoshi Watanabe (CB)', 'Luciano Valente (CM)', 'Sem Steijn (CAM)', 'Hwang In Beom (CM)', 'Anis Hadj-Moussa (RW)', 'Givairo Read (RB)', 'Anel Ahmedhodžić (CB)', 'Oussama Targhalline (CM)'], description: 'Feyenoord. Compite en Eredivisie.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'girona_fc', name: 'Girona FC', league: 'Española', dt: 'Quique Álvarez', reputation: 2, initialSalary: 800, marketValue: 209400000, starPlayers: ['Marc-André ter Stegen (GK)', 'Paulo Gazzaniga (GK)', 'Arnau Martínez (RB)', 'Viktor Tsygankov (RM)', 'Azzedine Ounahi (CM)', 'Álex Moreno (LB)', 'Fran Beltrán (CM)', 'Bryan Gil (LW)', 'Vladyslav Vanat (ST)', 'Iván Martín (CM)'], description: 'Descendió a LALIGA HYPERMOTION para la temporada 2026-27.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'krc_genk', themeColor: { primary: '#3b82f6', secondary: '#f5f0e8' }, name: 'KRC Genk', league: 'Belga', dt: 'Jess Thorup', reputation: 4, initialSalary: 3100, marketValue: 21000000, starPlayers: ['Zakaria El Ouahdi', 'Matte Smets', 'Bryan Heynen', 'Ibrahima Sory Bangoura'], description: 'Clasificado a la Europa League 2025-26. Cantera prolífica del fútbol belga.', badgeColor: 'border-l-4 border-blue-500 bg-slate-900/40 text-blue-100', badgeLogoUrl: '🔵⚪',
  ...
  { id: 'fc_copenhagen', themeColor: { primary: '#ef4444', secondary: '#f5f0e8' }, name: 'FC København', league: 'Danesa', dt: 'Bo Svensson', reputation: 3, initialSalary: 1600, marketValue: 9200000, starPlayers: ['Mohamed Elyounoussi (RM)', 'Dominik Kotarski (GK)', 'Gabriel Pereira (CB)', 'Thomas Delaney (CDM)', 'Rodrigo Huescas (RB)', 'Jordan Larsson (RM)', 'Amir Richardson (CM)', 'Marcos López (LB)', 'Mads Emil Madsen (CM)', 'Youssoufa Moukoko (ST)'], description: 'Clasificado a la Champions League 2025-26. El más grande de Dinamarca.', badgeColor: 'border-l-4 border-red-500 bg-white text-slate-900', badgeLogoUrl: '⚪🔴', division: 1 },
  ...
  { id: 'fcsb', themeColor: { primary: '#dc2626', secondary: '#f5f0e8' }, name: 'FCSB', league: 'Rumana', dt: 'Marius Baciu', reputation: 2, initialSalary: 720, marketValue: 3000000, starPlayers: ['Florin Tănase (CAM)', 'Daniel Bîrligea (ST)', 'Juri Cisotti (CM)', 'Ștefan Târnovanu (GK)', 'Siyabonga Ngezana (CB)', 'Risto Radunović (LB)', 'Joyskim Dawa (CB)', 'André Duarte (CB)', 'David Miculescu (RW)'], description: 'Clasificado a la Europa League 2025-26. El histórico club de Bucarest.', badgeColor: 'border-l-4 border-red-600 bg-blue-950 text-red-200', badgeLogoUrl: '🔴🔵',
