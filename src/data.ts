...
// ==========================================
  ...
  { id: 'mazatlan', name: 'Mazatlán FC', league: 'Mexicana', dt: 'Ismael Rescalvo', reputation: 3, initialSalary: 2000, marketValue: 7500000, starPlayers: ['Yoel Bárcenas (LM)', 'Lucas Merolla (CB)', 'Facundo Almada (CB)', 'Dudu (RW)', 'Ricardo Rodríguez (GK)', 'Jair Díaz (CB)', 'Jordan Sierra (CM)', 'José Esquivel (CDM)', 'Mauro Laínez (LM)', 'Josué Ovalle (RW)', 'Fábio (ST)'], description: 'Los Cañoneros.', badgeColor: 'border-l-4 border-white bg-purple-800 text-white', badgeLogoUrl: '⚓',
    badgeImageUrl: 'badges/clubs/mazatlan.png', division: 2 },
 ...
 // ==========================================
  ...
  { id: 'nac_breda', name: 'NAC Breda', league: 'Holandesa', dt: 'Jo Jansen', reputation: 4, initialSalary: 2000, marketValue: 33750000, starPlayers: ['André Ayew (ST)', 'Daniel Bielica (GK)', 'Denis Odoi (CB)', 'Lewis Holtby (CM)', 'Leo Greiml (CB)', 'Boy Kemper (LB)', 'Kamal Sowah (LM)', 'Clint Leemans (CM)', 'Mohamed Nassoh (LM)', 'Amine Salama (ST)', 'Cherrion Valerius (RB)'], description: 'NAC Breda. Compite en la Eerste Divisie.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'colorado_rapids', name: 'Colorado Rapids', league: 'Estadounidense', dt: 'DT Genérico', reputation: 2, initialSalary: 2000, marketValue: 21000000, starPlayers: ['Paxten Aaronson (CM)', 'Zack Steffen (GK)', 'Rob Holding (CB)', 'Reggie Cannon (RB)', 'Alexis Manyoma (RM)', 'Keegan Rosenberry (RB)', 'Hamzat Ojediran (CDM)', 'Rafael Navarro (ST)', 'Connor Ronan (CDM)', 'Ian Murphy (CB)', 'Miguel Navarro (LB)'], description: 'Compite en MLS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/colorado_rapids.png', division: 1 },
  { id: 'columbus_crew', name: 'Columbus Crew', league: 'Estadounidense', dt: 'DT Genérico', reputation: 3, initialSalary: 2000, marketValue: 34000000, starPlayers: ['Diego Rossi (CAM)', 'Dániel Gazdag (CAM)', 'André Gomes (CDM)', 'Max Arfsten (LM)', 'Steven Moreira (CB)', 'Hugo Picard (LM)', 'Nariman Akhundzada (RW)', 'Patrick Schulte (GK)', 'Andrés Herrera (RB)', 'Dylan Chambost (CM)', 'Mohamed Farsi (RM)'], description: 'Compite en MLS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'portland_timbers', name: 'Portland Timbers', league: 'Estadounidense', dt: 'DT Genérico', reputation: 3, initialSalary: 2000, marketValue: 28000000, starPlayers: ['David da Costa (CAM)', 'Alexander Aravena (LM)', 'Kamal Miller (CB)', 'Antony (LM)', 'Brandon Bye (RB)', 'Diego Chará (CDM)', 'Joao Ortiz (CDM)', 'Kristoffer Velde (LM)', 'Felipe Mora (ST)', 'Cole Bassett (CAM)', 'Jímer Fory (LB)'], description: 'Compite en MLS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
