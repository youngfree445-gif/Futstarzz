...
export const CLUBS_DATABASE: Club[] = [
  ...
  // ==========================================
  {
    ...
    badgeLogoUrl: '🦈🔴⚪',
    badgeImageUrl: 'badges/clubs/junior.png',
    division: 1
  },
  {
    id: 'nacional',
  ...
  },
  {
    ...
    // Jhomier Guerrero: verificado en Transfermarkt (spieler/978950), hoy juega acá. El JSON viejo
    // lo tenía en Junior y además con el nombre mal escrito ("Jhonier").
    starPlayers: ['Radamel Falcao García', 'Álvaro Montero', 'Mackalister Silva', 'Daniel Ruiz', 'Andrey Estupiñán', 'James Aguirre', 'Darwin Quintero', 'Jhomier Guerrero'],
    ...
    badgeLogoUrl: '🦅🔵⚪',
    badgeImageUrl: 'badges/clubs/millonarios.png',
    division: 1
  },
  {
    id: 'santafe',
  ...
  },
  {
    ...
    badgeLogoUrl: '😈🔴🔴',
    badgeImageUrl: 'badges/clubs/america_cali.png',
    division: 1
  },
  {
    id: 'medellin',
  ...
  },
  {
    ...
    badgeLogoUrl: '🟤🟡🔥',
    badgeImageUrl: 'badges/clubs/tolima.png',
    division: 1
  },
  {
    id: 'once_caldas',
    ...
    badgeLogoUrl: '⚪🟢🔴',
    badgeImageUrl: 'badges/clubs/once_caldas.png',
    division: 1
  },
  {
    id: 'cali',
  ...
  },
  {
    ...
    badgeLogoUrl: '🐆🟡🟢',
    badgeImageUrl: 'badges/clubs/bucaramanga.png',
    division: 1
  },
  {
    id: 'aguilas',
    ...
    badgeLogoUrl: '🦅💛⚽',
    badgeImageUrl: 'badges/clubs/aguilas.png',
    division: 1
  },
  {
    ...
    badgeLogoUrl: '⚖️🟢⚪',
    badgeImageUrl: 'badges/clubs/internacional_bogota.png',
    division: 1
  },
  {
    id: 'pereira',
    ...
    badgeLogoUrl: '🟡🔴🐺',
    badgeImageUrl: 'badges/clubs/pereira.png',
    division: 1
  },
  {
    id: 'fortaleza_fc',
    ...
    badgeLogoUrl: '🏰🔵🔴',
    badgeImageUrl: 'badges/clubs/fortaleza_fc.png',
    division: 1
  },
  {
    id: 'pasto',
    ...
    badgeLogoUrl: '🌋🔴🔵',
    badgeImageUrl: 'badges/clubs/pasto.png',
    division: 1
  },
  {
    id: 'alianza_fc',
  ...
  },
  {
    ...
    badgeLogoUrl: '🏁🟢🏁',
    badgeImageUrl: 'badges/clubs/boyaca_chico.png',
    division: 1
  },
  {
    id: 'llaneros_fc',
    ...
    badgeLogoUrl: '🐴⚙️🔸',
    badgeImageUrl: 'badges/clubs/llaneros_fc.png',
    division: 1
  },
  {
    id: 'jaguares',
    ...
    badgeLogoUrl: '🐱🔵🟢',
    badgeImageUrl: 'badges/clubs/jaguares.png',
    division: 1
  },
  {
    id: 'cucuta',
    ...
    badgeLogoUrl: '🔴⚫🏹',
    badgeImageUrl: 'badges/clubs/cucuta.png',
    division: 1
  },
  ...
  },
  {
    ...
    initialSalary: 550,
    marketValue: 1800000,
    starPlayers: ['Kevin Álvarez (CAM)', 'Juan Espitia (GK)', 'Alexander Porras (RB)', 'Freyn Figueroa (CM)', 'Juan Hurtado (CB)', 'Alexander Carabalí (CB)', 'Luis Rentería (LB)', 'Johan Campaña (LW)', 'Carlos Copete (ST)', 'Víctor Perea (CB)', 'Hánser Angulo (LB)'],
  ...
  },
  {
    ...
    initialSalary: 550,
    marketValue: 1800000,
    starPlayers: ['Juan Chala (RW)', 'Andrés Carabalí (ST)', 'Sergio Pabón (GK)', 'Santiago Roa (RB)', 'Santiago Orozco (CDM)', 'Jaminson Sandoval (CB)', 'Luis Morán (CB)', 'Martín Payares (CB)', 'Juan Ocampo (CB)', 'José Preciado (CM)', 'Wilmar Arango (CAM)'],
  ...
  },
  {
    ...
    initialSalary: 500,
    marketValue: 1600000,
    starPlayers: ['Kevin Tamayo (LB)', 'Juan Peña (CAM)', 'Roinner Fruto (RB)', 'Germán Meneses (CB)', 'Juan Felipe Hincapié (CB)', 'Johan E. Martínez (CB)', 'Juan Rentería (LB)', 'Juan David Ruiz (LW)', 'Cristian Rodriguez (CAM)', 'Cristian Holguín (GK)', 'Óscar Segura (RW)'],
  ...
  },
  {
    ...
    initialSalary: 450,
    marketValue: 1400000,
    starPlayers: ['Sebastián Hernández (CM)', 'José Ampudia (RB)', 'Federico Arbeláez (LB)', 'Francisco Rodríguez (CDM)', 'Julián Rodríguez (CB)', 'José Ordóñez (CAM)', 'Luciano Ospina (CB)', 'Juan José Rubiano (CAM)', 'Lucas Farías (ST)', 'Breiner Moya (RW)', 'Tomás Díaz (RW)'],
    ...
    badgeImageUrl: 'badges/clubs/indep_yumbo.png', badgeLogoUrl: '⚪⚫',
    division: 2
  },
  {
    id: 'inter_palmira',
    ...
    initialSalary: 450,
    marketValue: 1400000,
    starPlayers: ['Kener González (CDM)', 'Carlos Cortés (ST)', 'Manuel Caicedo (CB)', 'Jaison Mina (CB)', 'Jaider Moreno (LW)', 'David Orozco (ST)', 'Danny Zúñiga (ST)', 'Jhon Vélez (CM)', 'Carlos Franco (CM)', 'Ramiro Brochero (ST)', 'Andrés Pérez (GK)'],
  ...
  },
  {
    ...
    initialSalary: 450,
    marketValue: 1400000,
    starPlayers: ['Marlon Balanta (CB)', 'Deivi Barrios (CB)', 'Royner Benítez (CAM)', 'Héctor Arango (GK)', 'Juan Salinas (CB)', 'Jhon Barreiro (LB)', 'Andres Ruíz (LW)', 'Yilbert Palacios (CB)', 'Juan Hernandez (CB)', 'Santiago Agámez (RB)', 'Álvaro Montaño (CDM)'],
  ...
  },
  {
    ...
    initialSalary: 450,
    marketValue: 1400000,
    starPlayers: ['Fabián Villa (CB)', 'Juan Farías (ST)', 'José Palacios (CB)', 'Juan Jaramillo (GK)', 'Eder Balanta (CB)', 'Jhon Veira (LB)', 'Junior Escobar (LB)', 'Nelson Mosorongo (CDM)', 'Jhonier Julio (CM)', 'Carlos Restrepo (CM)', 'Alejandro Oñate (ST)'],
...
// ==========================================
  ...
  { id: 'san_lorenzo', themeColor: { primary: '#991b1b', secondary: '#f5f0e8' }, name: 'San Lorenzo de Almagro', league: 'Argentina', dt: 'Néstor Gorosito', reputation: 4, initialSalary: 2100, marketValue: 13000000, starPlayers: ['Adam Bareiro', 'Nahuel Barrios', 'Luciano Vietto', 'Gonzalo Ábrego'], description: 'El Ciclón de Boedo, con Luciano Vietto llegando libre tras su paso por Racing.', badgeColor: 'border-l-4 border-red-800 bg-blue-950 text-white', badgeLogoUrl: '🌪️',
    badgeImageUrl: 'badges/clubs/san_lorenzo.png', division: 1 },
  { id: 'river', themeColor: { primary: '#ef4444', secondary: '#f5f0e8' }, name: 'River Plate', league: 'Argentina', dt: 'Eduardo Coudet', reputation: 5, initialSalary: 3800, marketValue: 83300000, starPlayers: ['Aníbal Moreno (CDM)', 'Gonzalo Montiel (RB)', 'Marcos Acuña (LB)', 'Ángel Correa (CAM)', 'Nicolás Otamendi (CB)', 'Lucas Martínez Quarta (CB)', 'Sebastián Driussi (ST)', 'Mauro Arambarri (CDM)', 'Maximiliano Salas (ST)'], description: 'El Millonario, con Ángel Correa como fichaje récord del club para heredar la camiseta 10 tras la salida de Juanfer Quintero.', badgeColor: 'border-l-4 border-red-500 bg-white text-slate-900', badgeLogoUrl: '🐓',
    badgeImageUrl: 'badges/clubs/river.png', division: 1 },
  { id: 'boca', name: 'Boca Juniors', league: 'Argentina', dt: 'Rodolfo Arruabarrena', reputation: 5, initialSalary: 3600, marketValue: 34300000, starPlayers: ['Leandro Paredes (CM)', 'Santiago Ascacíbar (CDM)', 'Miguel Ángel Merentiel (ST)', 'Ayrton Costa (CB)', 'Sebastián Villa (RW)', 'Rodrigo Battaglia (CDM)', 'Álvaro Montero (GK)', 'Lautaro Blanco (LB)', 'Carlos Palacios (CAM)', 'Leandro Lozano (RB)'], description: 'El Xeneize, reforzado en el arco con la llegada de Álvaro Montero desde Vélez tras el Mundial 2026.', badgeColor: 'border-l-4 border-amber-500 bg-blue-900 text-amber-400', badgeLogoUrl: '🏆',
    badgeImageUrl: 'badges/clubs/boca.png', division: 1 },
  { id: 'estudiantes_lp', themeColor: { primary: '#dc2626', secondary: '#f5f0e8' }, name: 'Estudiantes de La Plata', league: 'Argentina', dt: 'Alexander Medina', reputation: 4, initialSalary: 2450, marketValue: 11550000, starPlayers: ['Enzo Pérez', 'Adolfo Gaich', 'Guido Carrillo', 'Tomás Palacios'], description: 'El Pincha, con Adolfo Gaich como primer refuerzo tras su salida libre del CSKA Moscú y Tomás Palacios a préstamo desde el Inter de Milán.', badgeColor: 'border-l-4 border-red-600 bg-slate-900 text-white', badgeLogoUrl: '🦁',
    badgeImageUrl: 'badges/clubs/estudiantes_lp.png', division: 1 },
  { id: 'gimnasia_lp', themeColor: { primary: '#1e40af', secondary: '#f5f0e8' }, name: 'Gimnasia y Esgrima La Plata', league: 'Argentina', dt: 'Ariel Pereyra', reputation: 3, initialSalary: 1500, marketValue: 8000000, starPlayers: ['Benjamín Domínguez', 'Leonardo Morales', 'Nelson Insfrán', 'Pablo De Blasis'], description: 'El Lobo platense.', badgeColor: 'border-l-4 border-blue-800 bg-white text-blue-900', badgeLogoUrl: '🐺',
    badgeImageUrl: 'badges/clubs/gimnasia_lp.png', division: 1 },
  ...
  { id: 'newells', themeColor: { primary: '#dc2626', secondary: '#f5f0e8' }, name: 'Newells Old Boys', league: 'Argentina', dt: 'Frank Kudelka', reputation: 3, initialSalary: 1700, marketValue: 9000000, starPlayers: ['Ever Banega', 'Ignacio Ramírez', 'Armando Méndez', 'Ian Glavinovich'], description: 'La Lepra.', badgeColor: 'border-l-4 border-red-600 bg-black text-white', badgeLogoUrl: '🔴⚫',
    badgeImageUrl: 'badges/clubs/newells.png', division: 1 },
  { id: 'banfield', themeColor: { primary: '#16a34a', secondary: '#f5f0e8' }, name: 'Banfield', league: 'Argentina', dt: 'Pedro Troglio', reputation: 3, initialSalary: 1400, marketValue: 7000000, starPlayers: ['Sergio Vittor (CB)', 'Santiago López García (RB)', 'Mauro Méndez (ST)', 'Ignacio Abraham (LB)', 'Lautaro Ríos (CM)', 'Gino Santilli (GK)'], description: 'El Taladro.', badgeColor: 'border-l-4 border-green-600 bg-white text-green-800', badgeLogoUrl: ' drill ',
    badgeImageUrl: 'badges/clubs/banfield.png', division: 1 },
  { id: 'rosario_central', themeColor: { primary: '#eab308', secondary: '#f5f0e8' }, name: 'Rosario Central', league: 'Argentina', dt: 'Jorge Almirón', reputation: 4, initialSalary: 2500, marketValue: 16000000, starPlayers: ['Ángel Di María (RW)', 'Jaminton Campaz (LM)', 'Franco Ibarra (CDM)', 'Facundo Mallo (CB)', 'Agustín Sández (LB)', 'Pol Fernández (CM)', 'Emanuel Coronel (RB)', 'Alejo Veliz (ST)', 'Federico Navarro (CDM)'], description: 'El Canalla.', badgeColor: 'border-l-4 border-yellow-500 bg-blue-900 text-yellow-400', badgeLogoUrl: '🇺🇦',
    badgeImageUrl: 'badges/clubs/rosario_central.png', division: 1 },
  { id: 'instituto', themeColor: { primary: '#eab308', secondary: '#f5f0e8' }, name: 'Instituto de Córdoba', league: 'Argentina', dt: 'Diego Flores', reputation: 3, initialSalary: 1300, marketValue: 6500000, starPlayers: ['Silvio Romero', 'Gastón Lodico', 'Fernando Alarcón'], description: 'La Gloria.', badgeColor: 'border-l-4 border-yellow-500 bg-red-600 text-yellow-200', badgeLogoUrl: '🔴🟡',
    badgeImageUrl: 'badges/clubs/instituto.png', division: 1 },
  { id: 'argentinos_jrs', name: 'Argentinos Juniors', league: 'Argentina', dt: 'Nicolás Diez', reputation: 3, initialSalary: 1600, marketValue: 8500000, starPlayers: ['Alan Lescano', 'Maximiliano Romero', 'Luciano Gondou'], description: 'El Bicho de La Paternal.', badgeColor: 'border-l-4 border-white bg-red-600 text-white', badgeLogoUrl: '🐞',
    badgeImageUrl: 'badges/clubs/argentinos_jrs.png', division: 1 },
  { id: 'belgrano', name: 'Belgrano de Córdoba', league: 'Argentina', dt: 'Ricardo Zielinski', reputation: 3, initialSalary: 1550, marketValue: 8000000, starPlayers: ['Lucas Passerini', 'Ulises Sánchez', 'Nahuel Losada', 'Matías Marín'], description: 'El Pirata.', badgeColor: 'border-l-4 border-black bg-sky-400 text-white', badgeLogoUrl: '🏴‍☠️',
    badgeImageUrl: 'badges/clubs/belgrano.png', division: 1 },
  { id: 'atl_tucuman', name: 'Atlético Tucumán', league: 'Argentina', dt: 'Julio César Falcioni', reputation: 3, initialSalary: 1350, marketValue: 6800000, starPlayers: ['Leandro Díaz (ST)', 'Martín Benítez (CAM)', 'Leonel Di Plácido (RB)', 'Gastón Suso (CB)', 'Ramiro Ruiz Rodríguez (RM)', 'Gianluca Ferrari (CB)', 'Renzo Tesuri (RM)', 'Maximiliano Villa (RB)', 'Luis Ingolotti (GK)'], description: 'El Decano.', badgeColor: 'border-l-4 border-white bg-sky-300 text-slate-900', badgeLogoUrl: '🩵⚪',
    badgeImageUrl: 'badges/clubs/atl_tucuman.png', division: 1 },
  { id: 'defensa_y_justicia', themeColor: { primary: '#eab308', secondary: '#f5f0e8' }, name: 'Defensa y Justicia', league: 'Argentina', dt: 'Julio Vaccari', reputation: 3, initialSalary: 1650, marketValue: 8800000, starPlayers: ['Nicolás Fernández', 'Gastón Togni', 'Kevin Gutiérrez'], description: 'El Halcón de Varela.', badgeColor: 'border-l-4 border-yellow-500 bg-green-700 text-yellow-300', badgeLogoUrl: '🦅',
    badgeImageUrl: 'badges/clubs/defensa_y_justicia.png', division: 1 },
  { id: 'huracan', themeColor: { primary: '#dc2626', secondary: '#f5f0e8' }, name: 'Huracán', league: 'Argentina', dt: 'Diego Martínez', reputation: 3, initialSalary: 1450, marketValue: 7500000, starPlayers: ['Óscar Romero (CAM)', 'Hernán Galíndez (GK)', 'Martín Nervo (CB)', 'Fabio Pereyra (CB)', 'Leonardo Gil (CDM)', 'Facundo Waller (LM)', 'Sebastián Meza (GK)'], description: 'El Globo.', badgeColor: 'border-l-4 border-red-600 bg-white text-slate-900', badgeLogoUrl: '🎈',
    badgeImageUrl: 'badges/clubs/huracan.png', division: 1 },
  { id: 'tigre', themeColor: { primary: '#dc2626', secondary: '#f5f0e8' }, name: 'Tigre', league: 'Argentina', dt: 'Diego Dabove', reputation: 3, initialSalary: 1300, marketValue: 6200000, starPlayers: ['Gonzalo Martínez (CAM)', 'Joaquín Laso (CB)', 'Bruno Leyes (CDM)', 'Joaquín Mosqueira (CDM)', 'Felipe Zenobio (GK)', 'Nahuel Banegas (LB)', 'Elías Cabrera (LM)', 'Sebastián Medina (LM)'], description: 'El Matador de Victoria.', badgeColor: 'border-l-4 border-red-600 bg-blue-800 text-white', badgeLogoUrl: '🐯',
    badgeImageUrl: 'badges/clubs/tigre.png', division: 1 },
  { id: 'union_sf', name: 'Unión de Santa Fe', league: 'Argentina', dt: 'Leonardo Madelón', reputation: 3, initialSalary: 1350, marketValue: 6500000, starPlayers: ['Lucas Gamba', 'Mauro Luna Diale', 'Claudio Corvalán', 'Nicolás Campisi'], description: 'El Tatengue.', badgeColor: 'border-l-4 border-white bg-red-600 text-white', badgeLogoUrl: '🔴⚪',
    badgeImageUrl: 'badges/clubs/union_sf.png', division: 1 },
  { id: 'talleres', name: 'Talleres de Córdoba', league: 'Argentina', dt: 'Jorge Sampaoli', reputation: 4, initialSalary: 2100, marketValue: 13000000, starPlayers: ['Ramón Sosa', 'Federico Girotti', 'Gastón Benavídez'], description: 'La T cordobesa.', badgeColor: 'border-l-4 border-blue-900 bg-white text-blue-900', badgeLogoUrl: 'T',
    badgeImageUrl: 'badges/clubs/talleres.png', division: 1 },
  { id: 'platense', themeColor: { primary: '#d97706', secondary: '#f5f0e8' }, name: 'Platense', league: 'Argentina', dt: 'Walter Zunino', reputation: 2, initialSalary: 1100, marketValue: 4800000, starPlayers: ['Víctor Cuesta (CB)', 'Ignacio Vázquez (CB)', 'Augusto Lotti (ST)', 'Juan Saborido (RB)', 'Maximiliano Amarfil (CM)', 'Guido Mainero (RM)', 'Franco Zapiola (LM)', 'Bautista Merlini (CAM)'], description: 'El Calamar.', badgeColor: 'border-l-4 border-amber-600 bg-white text-amber-700', badgeLogoUrl: '🦑',
    badgeImageUrl: 'badges/clubs/platense.png', division: 1 },
  { id: 'sarmiento', name: 'Sarmiento', league: 'Argentina', dt: 'Facundo Sava', reputation: 2, initialSalary: 1050, marketValue: 4500000, starPlayers: ['Mauricio Martínez (CDM)', 'Jonatan Gómez (CM)', 'Juan Manuel Insaurralde (CB)', 'Yair Arismendi (LB)', 'Cristian Zabala (CDM)', 'Renzo Orihuela (CB)'], description: 'El Verde de Junín.', badgeColor: 'border-l-4 border-white bg-green-600 text-white', badgeLogoUrl: '🟢',
    badgeImageUrl: 'badges/clubs/sarmiento.png', division: 1 },
  { id: 'central_cordoba', name: 'Central Córdoba', league: 'Argentina', dt: 'Sebastián Domínguez', reputation: 2, initialSalary: 1000, marketValue: 4200000, starPlayers: ['Alan Aguerre (GK)', 'Facundo Mansilla (CB)', 'Horacio Tijanovich (LM)', 'Matías Vera (CDM)', 'Santiago Moyano (RB)'], description: 'El Ferroviario.', badgeColor: 'border-l-4 border-white bg-black text-white', badgeLogoUrl: '🚂',
    badgeImageUrl: 'badges/clubs/central_cordoba.png', division: 1 },
  { id: 'barracas', name: 'Barracas Central', league: 'Argentina', dt: 'Damián Ayude', reputation: 2, initialSalary: 1000, marketValue: 4200000, starPlayers: ['Iván Tapia (CAM)', 'Yonatthan Rak (CB)', 'Rodrigo Insua (LB)', 'Juan Espínola (GK)', 'Dardo Miloc (CDM)', 'Gastón Campi (CB)', 'Damián Martínez (RB)', 'Rodrigo Bogarín (CAM)'], description: 'El Guapo.', badgeColor: 'border-l-4 border-white bg-red-600 text-white', badgeLogoUrl: '🔴⚪',
    badgeImageUrl: 'badges/clubs/barracas.png', division: 1 },
  ...
  { id: 'riestra', name: 'Riestra', league: 'Argentina', dt: 'Guillermo Duró', reputation: 2, initialSalary: 900, marketValue: 3800000, starPlayers: ['Milton Céliz', 'Nicolás Caro Torres', 'Ignacio Arce'], description: 'Los Malevos.', badgeColor: 'border-l-4 border-white bg-black text-white', badgeLogoUrl: '⚫',
    badgeImageUrl: 'badges/clubs/riestra.png', division: 1 },
  { id: 'aldosivi', themeColor: { primary: '#facc15', secondary: '#f5f0e8' }, name: 'Aldosivi', league: 'Argentina', dt: 'Israel Damonte', reputation: 2, initialSalary: 1100, marketValue: 4800000, starPlayers: ['Sebastián Moyano (GK)', 'Axel Werner (GK)', 'Guillermo Enrique (RB)', 'Nicolás Zalazar (CB)', 'Néstor Breitenbruch (CB)', 'Nicolás Cordero (ST)', 'Lucas Rodríguez (LB)', 'Ignacio Chicco (GK)'], description: 'El Tiburón de Mar del Plata.', badgeColor: 'border-l-4 border-yellow-400 bg-green-700 text-yellow-300', badgeLogoUrl: '🦈',
    badgeImageUrl: 'badges/clubs/aldosivi.png', division: 1 },
  ...
  { id: 'gimnasia_mza', name: 'Gimnasia de Mendoza', league: 'Argentina', dt: 'Darío Franco', reputation: 2, initialSalary: 1000, marketValue: 4200000, starPlayers: ['Aaron Spetale', 'Leandro Ciccolini', 'Maximiliano Padilla', 'Luis Ojeda'], description: 'El Pituco.', badgeColor: 'border-l-4 border-white bg-black text-white', badgeLogoUrl: '🐺',
    badgeImageUrl: 'badges/clubs/gimnasia_mza.png', division: 1 },
  ...
  { id: 'san_martin_sj', themeColor: { primary: '#16a34a', secondary: '#f5f0e8' }, name: 'San Martín de San Juan', league: 'Argentina', dt: 'Alejandro Schiapparelli', reputation: 2, initialSalary: 800, marketValue: 3000000, starPlayers: ['Jugador 1', 'Jugador 2', 'Jugador 3'], description: 'Compite en B Nacional.', badgeColor: 'border-l-4 border-green-600 bg-black text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/tm/san_martin_sj.png', division: 2 },
  { id: 'godoy_cruz', name: 'Godoy Cruz', league: 'Argentina', dt: 'Mariano Toedtli', reputation: 3, initialSalary: 1400, marketValue: 7000000, starPlayers: ['Roberto Ramírez (GK)', 'Lucas Arce (RB)', 'Mateo Mendoza (CB)', 'Vicente Poggi (CM)', 'Nahuel Ulariaga (ST)', 'Matías Ramírez (LM)', 'Gastón Gil Romero (CDM)', 'Misael Sosa (RW)', 'Esteban Burgos (CB)', 'Martín Pino (ST)', 'Federico Milo (LB)'], description: 'El Tomba (Descendido en el mod).', badgeColor: 'border-l-4 border-white bg-blue-800 text-white', badgeLogoUrl: '🍷',
    badgeImageUrl: 'badges/clubs/godoy_cruz.png', division: 2 },
  { id: 'agropecuario', themeColor: { primary: '#dc2626', secondary: '#f5f0e8' }, name: 'Agropecuario', league: 'Argentina', dt: 'Gabriel Gómez', reputation: 2, initialSalary: 750, marketValue: 2500000, starPlayers: ['Carlos Auzqui (CAM)', 'Rodrigo Castro (CAM)', 'Brian Blando (ST)', 'Alejandro Gagliardi (ST)', 'Luciano Acosta (GK)', 'Alan Aguirre (CB)', 'Santiago Gallucci (CDM)', 'Jorge Valdéz Chamarro (CM)', 'Rodrigo Mosqueira (LM)', 'Milton Ramos (LB)'], description: 'Compite en B Nacional.', badgeColor: 'border-l-4 border-red-600 bg-green-700 text-white', badgeLogoUrl: '🚜',
    badgeImageUrl: 'badges/clubs/agropecuario.png', division: 2 },
  { id: 'all_boys', name: 'All Boys', league: 'Argentina', dt: 'Aníbal Biggeri', reputation: 2, initialSalary: 750, marketValue: 2500000, starPlayers: ['Ricardo Blanco (CAM)', 'Iván Zafarana (CB)', 'Maximiliano Coronel (CB)', 'Hernán Grana (RB)', 'Agustin Gallo (CM)', 'Matías Nouet (RW)', 'Franco Quiróz (LB)', 'Emiliano Purita (RB)', 'Alejo Tabares (LM)', 'Tomás Assenato (CM)', 'Juan Pablo Noce (GK)'], description: 'El Albo. Compite en B Nacional.', badgeColor: 'border-l-4 border-black bg-white text-black', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/all_boys.png', division: 2 },
  { id: 'almagro', name: 'Almagro', league: 'Argentina', dt: 'Carlos Mayor', reputation: 2, initialSalary: 700, marketValue: 2000000, starPlayers: ['Gonzalo Asís (RB)', 'Matías Cortave (CB)', 'Franco Bustamante (RM)', 'Julián Marchioni (CM)', 'Santiago Úbeda (CM)', 'Tobías Macies (CAM)', 'Enzo Silcan (LB)', 'Enzo Martínez (LM)', 'Juan Pablo Zozaya (GK)'], description: 'El Tricolor. Compite en B Nacional.', badgeColor: 'border-l-4 border-black bg-sky-400 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/almagro.png', division: 2 },
  { id: 'almirante_brown', themeColor: { primary: '#eab308', secondary: '#f5f0e8' }, name: 'Almirante Brown', league: 'Argentina', dt: 'Rodrigo Alonso', reputation: 2, initialSalary: 750, marketValue: 2500000, starPlayers: ['Facundo Quignon (CDM)', 'Gustavo Cabral (CB)', 'Leonardo Jara (RB)', 'Agustín Dattola (CB)', 'Jonatan Goya (CAM)', 'Máximo Levi (CB)', 'Tomas Villoldo (LB)', 'Hernan Perrone (CM)', 'Tobías Zárate (ST)', 'Ramiro Fernández (LB)'], description: 'La Fragata. Compite en B Nacional.', badgeColor: 'border-l-4 border-yellow-500 bg-black text-yellow-400', badgeLogoUrl: '⚓',
    badgeImageUrl: 'badges/clubs/almirante_brown.png', division: 2 },
  { id: 'atlanta', themeColor: { primary: '#eab308', secondary: '#f5f0e8' }, name: 'Atlanta', league: 'Argentina', dt: 'Cristian Pellerano', reputation: 2, initialSalary: 700, marketValue: 2000000, starPlayers: ['Christian Bernardi (CAM)', 'Nicolás Previtali (CDM)', 'Leonel Galeano (CB)', 'Braian Rivero (CDM)', 'Alejandro Quintana (ST)', 'Tomás Castro Ponce (CAM)', 'Francisco Rago (GK)', 'Rodrigo Moreira (CB)', 'Martin García (RB)', 'Gustavo Mendoza (CDM)', 'Federico Castro (ST)'], description: 'El Bohemio. Compite en B Nacional.', badgeColor: 'border-l-4 border-yellow-500 bg-blue-800 text-yellow-400', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/atlanta.png', division: 2 },
  { id: 'mitre', themeColor: { primary: '#eab308', secondary: '#f5f0e8' }, name: 'Atlético Mitre', league: 'Argentina', dt: 'Carlos Mayor', reputation: 2, initialSalary: 650, marketValue: 1800000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Compite en B Nacional.', badgeColor: 'border-l-4 border-yellow-500 bg-black text-yellow-400', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/mitre.png', division: 2 },
  { id: 'central_norte', name: 'Central Norte', league: 'Argentina', dt: 'Adrián Bastía', reputation: 2, initialSalary: 600, marketValue: 1500000, starPlayers: ['Arián Pucheta (CB)', 'Ramiro Costa (ST)', 'Agustin Aleo (LB)', 'Mauricio Rosales (RB)', 'Matías Villarreal (CDM)', 'Franco Vedoya (RW)', 'Joaquin Mateo (ST)', 'Leonardo Felissia (CB)'], description: 'El Cuervo salteño. Compite en B Nacional.', badgeColor: 'border-l-4 border-white bg-black text-white', badgeLogoUrl: '🐦',
    badgeImageUrl: 'badges/clubs/central_norte.png', division: 2 },
  ...
  { id: 'chaco_for_ever', name: 'Chaco For Ever', league: 'Argentina', dt: 'Ricardo Pancaldo', reputation: 2, initialSalary: 650, marketValue: 1800000, starPlayers: ['Matías Noble (LM)', 'Andrés Lioi (RM)', 'Gabriel Ramírez (CM)', 'Tomás Bolzicco (ST)', 'Ricardo Garay (CB)', 'Brian Nievas (CDM)', 'Gaston Canuto (GK)', 'David Valdez (CB)', 'Lucas Pruzzo (LB)'], description: 'Compite en B Nacional.', badgeColor: 'border-l-4 border-white bg-black text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/chaco_for_ever.png', division: 2 },
  { id: 'colegiales', themeColor: { primary: '#eab308', secondary: '#f5f0e8' }, name: 'Colegiales', league: 'Argentina', dt: 'Leonardo Fernández', reputation: 2, initialSalary: 600, marketValue: 1500000, starPlayers: ['Emanuel Insua (LB)', 'Mauro Albertengo (ST)', 'Leandro Martínez Montagnoli (CB)', 'Gonzalo Baglivo (CDM)', 'Facundo Rivero (CB)', 'Lucio Castillo (CAM)', 'Nicolás Toloza (ST)', 'Alejandro Chiavetto (CM)', 'Leonardo González (RW)', 'Mateo Mamaní (ST)'], description: 'Compite en B Nacional.', badgeColor: 'border-l-4 border-yellow-500 bg-blue-800 text-yellow-400', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/colegiales.png', division: 2 },
  { id: 'colon', name: 'Colón', league: 'Argentina', dt: 'Ezequiel Medrán', reputation: 3, initialSalary: 1200, marketValue: 5500000, starPlayers: ['Federico Lértora (CDM)', 'Pier Barrios (CB)', 'Federico Rasmussen (CB)', 'Facundo Castro (ST)', 'Nicolás Thaller (CB)', 'Matías Godoy (LM)', 'Lucas Cano (ST)', 'Agustín Toledo (CDM)'], description: 'El Sabalero. Histórico en la B Nacional.', badgeColor: 'border-l-4 border-black bg-red-600 text-white', badgeLogoUrl: '🐘',
    badgeImageUrl: 'badges/clubs/colon.png', division: 2 },
  { id: 'defensores_belgrano', name: 'Defensores de Belgrano', league: 'Argentina', dt: 'Fabián Nardozza', reputation: 2, initialSalary: 650, marketValue: 1800000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Compite en B Nacional.', badgeColor: 'border-l-4 border-black bg-red-600 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/defensores_belgrano.png', division: 2 },
  { id: 'dep_madryn', themeColor: { primary: '#eab308', secondary: '#f5f0e8' }, name: 'Deportivo Madryn', league: 'Argentina', dt: 'Cristian Díaz', reputation: 2, initialSalary: 650, marketValue: 1800000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Compite en B Nacional.', badgeColor: 'border-l-4 border-yellow-500 bg-black text-yellow-400', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/dep_madryn.png', division: 2 },
  { id: 'dep_maipu', name: 'Deportivo Maipú', league: 'Argentina', dt: 'Mariano Echeverría', reputation: 2, initialSalary: 650, marketValue: 1800000, starPlayers: ['Fausto Emanuel Montero (CM)', 'Nicolás Faggioli (CB)', 'Gastón Mansilla (RM)', 'Nahuel Galardi (GK)', 'Juan Pablo Gobetto (CM)', 'Matias Viguet (LM)', 'Nicolás Fernández (CB)', 'Mirko Bonfigli (CM)', 'Felipe Rivarola (ST)', 'Luciano Arnijas (CM)'], description: 'Compite en B Nacional.', badgeColor: 'border-l-4 border-white bg-red-600 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/tm/dep_maipu.png', division: 2 },
  { id: 'dep_moron', themeColor: { primary: '#dc2626', secondary: '#f5f0e8' }, name: 'Deportivo Morón', league: 'Argentina', dt: 'Walter Otta', reputation: 2, initialSalary: 700, marketValue: 2000000, starPlayers: ['Mariano Bíttolo (LB)', 'Gonzalo Berterame (RM)', 'Juan Manuel Olivares (CM)', 'Matías Benítez (RW)', 'Julio Salvá (GK)', 'Braian Salvareschi (CB)', 'Joaquín Livera (LB)', 'Santiago Kubiszyn (CAM)', 'Franco Toloza (ST)'], description: 'El Gallo. Compite en B Nacional.', badgeColor: 'border-l-4 border-red-600 bg-white text-red-600', badgeLogoUrl: '🐓',
    badgeImageUrl: 'badges/clubs/dep_moron.png', division: 2 },
  { id: 'estudiantes_ba', name: 'Estudiantes de Buenos Aires', league: 'Argentina', dt: 'Juan Manuel Sara', reputation: 2, initialSalary: 700, marketValue: 2000000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Compite en B Nacional.', badgeColor: 'border-l-4 border-black bg-white text-black', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/estudiantes_ba.png', division: 2 },
  { id: 'ferro', name: 'Ferro', league: 'Argentina', dt: 'Sergio Rondina', reputation: 2, initialSalary: 750, marketValue: 2500000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Compite en B Nacional.', badgeColor: 'border-l-4 border-white bg-green-600 text-white', badgeLogoUrl: '🚂',
    badgeImageUrl: 'badges/clubs/ferro.png', division: 2 },
  ...
  { id: 'gimnasia_tiro', themeColor: { primary: '#38bdf8', secondary: '#f5f0e8' }, name: 'Gimnasia y Tiro de Salta', league: 'Argentina', dt: 'Juan Manuel Azconzábal', reputation: 2, initialSalary: 650, marketValue: 1800000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Compite en B Nacional.', badgeColor: 'border-l-4 border-sky-400 bg-white text-sky-400', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/gimnasia_tiro.png', division: 2 },
  { id: 'los_andes', name: 'Los Andes', league: 'Argentina', dt: 'Leonardo Lemos', reputation: 2, initialSalary: 600, marketValue: 1500000, starPlayers: ['Sergio Fabián Ortíz (CM)', 'Daniel Franco (CB)', 'Gabriel Carrasco (RB)', 'Julián Navas (RB)', 'Mario Galeano (ST)', 'Mauricio Asenjo (ST)', 'Matías González (RM)', 'Sebastian López (GK)', 'Juan Manuel Vázquez (LM)', 'Javier Bustillos (GK)'], description: 'El Milrayitas. Compite en B Nacional.', badgeColor: 'border-l-4 border-white bg-red-600 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/los_andes.png', division: 2 },
  ...
  { id: 'quilmes', themeColor: { primary: '#1e40af', secondary: '#f5f0e8' }, name: 'Quilmes', league: 'Argentina', dt: 'Leandro Gracián', reputation: 2, initialSalary: 850, marketValue: 3200000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'El Cervecero. Compite en B Nacional.', badgeColor: 'border-l-4 border-blue-800 bg-white text-blue-900', badgeLogoUrl: '🍺',
    badgeImageUrl: 'badges/clubs/quilmes.png', division: 2 },
  { id: 'racing_cba', themeColor: { primary: '#38bdf8', secondary: '#f5f0e8' }, name: 'Racing de Córdoba', league: 'Argentina', dt: 'Pablo Fornasari', reputation: 2, initialSalary: 650, marketValue: 1800000, starPlayers: ['Ricardo Centurión (LM)', 'Sebastian Marfort (CB)', 'Alejandro Rébola (CB)', 'Marcio Gómez (CB)', 'Gaspar Vega (CM)', 'Pablo Chavarría (ST)', 'Gaspar Iñiguez (CM)', 'Luciano Viano (LW)', 'Gonzalo Laborda (GK)', 'Sergio González (ST)'], description: 'Compite en B Nacional.', badgeColor: 'border-l-4 border-sky-400 bg-white text-sky-400', badgeLogoUrl: '⚽', badgeImageUrl: 'badges/clubs/racing_cba.png', division: 2 },
  { id: 'san_martin_tuc', name: 'San Martín de Tucumán', league: 'Argentina', dt: 'Alejandro Orfila', reputation: 3, initialSalary: 950, marketValue: 4000000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'El Ciruja. Compite en B Nacional.', badgeColor: 'border-l-4 border-white bg-red-600 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/san_martin_tuc.png', division: 2 },
  { id: 'san_miguel', name: 'San Miguel', league: 'Argentina', dt: 'Gustavo Coleoni', reputation: 2, initialSalary: 600, marketValue: 1500000, starPlayers: ['Leandro Desábato (CDM)', 'Bruno Nasta (ST)', 'Juan Lungarzo (GK)', 'Lucas Delgado (ST)', 'Facundo Omar Cardozo (LB)', 'Alexis Cruz (LB)', 'Lucio Pérez (RB)', 'Dixon Renteria (CB)', 'Máximo Oses (LM)'], description: 'Compite en B Nacional.', badgeColor: 'border-l-4 border-white bg-green-700 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/san_miguel.png', division: 2 },
  { id: 'san_telmo', themeColor: { primary: '#38bdf8', secondary: '#f5f0e8' }, name: 'San Telmo', league: 'Argentina', dt: 'Marcelo Perugini', reputation: 2, initialSalary: 600, marketValue: 1500000, starPlayers: ['Facundo Roncaglia (CB)', 'Matías Laba (CDM)', 'Fabián Henríquez (CM)', 'Javier Iritier (LW)', 'Martín Batallini (ST)', 'Franco Tisera (ST)', 'Lucas Baldunciel (RW)', 'Emanuel Díaz (CB)', 'Juan Cruz Zurbriggen (ST)', 'Gabriel Paredes (LB)'], description: 'El Candombero. Compite en B Nacional.', badgeColor: 'border-l-4 border-sky-400 bg-blue-800 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/san_telmo.png', division: 2 },
  { id: 'temperley', name: 'Temperley', league: 'Argentina', dt: 'Nicolás Domingo', reputation: 2, initialSalary: 700, marketValue: 2000000, starPlayers: ['Gabriel Hauche (CAM)', 'Gabriel Esparza (LW)', 'Adrián Arregui (CDM)', 'Franco Díaz (CDM)', 'Fernando Brandán (LM)', 'Ezequiel Mastrolía (GK)', 'Luciano Nieto (CAM)', 'Pedro Souto (LB)', 'Jerónimo Pourtau (GK)', 'Santiago Flores (CB)'], description: 'El Gasolero. Compite en B Nacional.', badgeColor: 'border-l-4 border-white bg-sky-400 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/temperley.png', division: 2 },
  { id: 'tristan_suarez', name: 'Tristán Suárez', league: 'Argentina', dt: 'José María Martínez', reputation: 2, initialSalary: 600, marketValue: 1500000, starPlayers: ['Nicolás Sánchez (LM)', 'Diego Becker (LM)', 'Joaquín Bigo (GK)', 'Nicolás Fernández (LB)', 'Nicolás Del Priore (CM)', 'Álvaro Veliez (ST)', 'Mauricio Manuel Guzmán (CB)', 'Alejandro Molina (RB)'], description: 'El Lechero. Compite en B Nacional.', badgeColor: 'border-l-4 border-white bg-blue-800 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/tristan_suarez.png', division: 2 },
  { id: 'midland', name: 'Midland', league: 'Argentina', dt: 'Joaquín Iturrería', reputation: 2, initialSalary: 550, marketValue: 1200000, starPlayers: ['Fernando González (CB)', 'Juan Cruz Vega (CAM)', 'Leonel Gigli (CB)', 'Emilio Porro (RB)', 'Lautaro Díaz Laharque (RB)', 'Genaro Cepeda (CB)', 'Maximiliano Rogoski (CM)', 'Santino Primante (ST)', 'Pablo Casarico (CB)', 'Marcos Roseti (RM)'], description: 'Compite en B Nacional.', badgeColor: 'border-l-4 border-white bg-blue-800 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/midland.png', division: 2 },
  { id: 'acassuso', name: 'Acassuso', league: 'Argentina', dt: 'Darío Lema', reputation: 2, initialSalary: 550, marketValue: 1200000, starPlayers: ['Kevin Dubini (CAM)', 'David Escalante (ST)', 'Mariano Monllor (GK)', 'Ramiro Reynoso (CM)', 'Lucas Rey (RW)', 'Álex Ruiz (LB)', 'Nahuel Petillo (CM)', 'Juan Ponce de León (RB)', 'Lucas Pioli (CB)', 'Joel Gonzalo Ghirardello (CB)'], description: 'Compite en B Nacional.', badgeColor: 'border-l-4 border-white bg-blue-800 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/acassuso.png', division: 2 },
  { id: 'c_bolivar', name: 'C. Bolivar', league: 'Argentina', dt: 'Diego Funes', reputation: 2, initialSalary: 550, marketValue: 1200000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Compite en B Nacional.', badgeColor: 'border-l-4 border-white bg-sky-400 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/c_bolivar.png', division: 2 },
  ...
  { id: 'alvarado', name: 'Alvarado', league: 'Argentina', dt: 'Pablo Martel', reputation: 1, initialSalary: 400, marketValue: 1000000, starPlayers: ['Tomás Berra (CB)', 'Tomás Fernández (CB)', 'Leonardo Incorvaia (CB)', 'Fermín Iriarte (RB)', 'Nahuel González (GK)', 'Nahuel Speck (LW)', 'Lucas Chiozza (CAM)', 'Germán Cervera (ST)', 'Facundo Centurión (CB)', 'Germán Sosa (ST)', 'Cristian Gorgerino (LB)'], description: 'Compite en Tercera División.', badgeColor: 'border-l-4 border-white bg-blue-800 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/tm/alvarado.png', division: 3 },
  ...
  { id: 'arsenal_sarandi', themeColor: { primary: '#38bdf8', secondary: '#f5f0e8' }, name: 'Arsenal de Sarandí', league: 'Argentina', dt: 'Fabián Lisa', reputation: 1, initialSalary: 500, marketValue: 1200000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'El Arse. Compite en Tercera División.', badgeColor: 'border-l-4 border-sky-400 bg-red-600 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/tm/arsenal_sarandi.png', division: 3 },
  ...
  { id: 'comunicaciones', name: 'Comunicaciones', league: 'Argentina', dt: 'Sergio Leroy', reputation: 1, initialSalary: 400, marketValue: 1000000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'El Cartero. Compite en Tercera.', badgeColor: 'border-l-4 border-black bg-yellow-500 text-black', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/comunicaciones.png', division: 3 },
  { id: 'def_unidos', name: 'Defensores Unidos', league: 'Argentina', dt: 'Sebastián Farías', reputation: 1, initialSalary: 400, marketValue: 1000000, starPlayers: ['Martin Gimenez (ST)', 'Fabricio Henricot (GK)', 'Luis Olivera (LB)', 'Maximiliano Ortigoza (RM)', 'Fernando Arébalo (RB)', 'Alan Sombra (ST)', 'Mauro Alarcon (RB)', 'Franco Suárez (CB)', 'Kevin Redondo (CDM)', 'Julio López (CB)', 'Matias Rapetti (LB)'], description: 'Compite en Tercera División.', badgeColor: 'border-l-4 border-white bg-sky-400 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/tm/def_unidos.png', division: 3 },
  ...
  { id: 'excursionistas', name: 'Excursionistas', league: 'Argentina', dt: 'Rodrigo Bilbao', reputation: 1, initialSalary: 400, marketValue: 1000000, starPlayers: ['Gonzalo Pedrosa (CB)', 'Mathias Fernández (RB)', 'Mariano Arango (LB)', 'Miguel López (CAM)', 'Alejandro Ávalos (CM)', 'Federico Haberkorn (ST)', 'Nicolás Rodríguez (GK)', 'Héctor Igarzábal (CB)', 'Alan Espeche (RW)', 'Iván Arbello (LW)', 'Antonio Paulides (CB)'], description: 'Compite en Tercera División.', badgeColor: 'border-l-4 border-white bg-green-600 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/excursionistas.png', division: 3 },
  ...
  // ==========================================
  { id: 'cruzeiro', name: 'Cruzeiro', league: 'Brasileña', dt: 'Artur Jorge', reputation: 4, initialSalary: 4100, marketValue: 81400000, starPlayers: ['Fabrício Bruno (CB)', 'Gerson (CM)', 'Matheus Pereira (CAM)', 'Fagner (RB)', 'Cássio (GK)', 'Wanderson (LW)', 'Matheus Henrique (CM)'], description: 'La Bestia Negra.', badgeColor: 'border-l-4 border-white bg-blue-600 text-white', badgeLogoUrl: '🦊',
    badgeImageUrl: 'badges/clubs/cruzeiro.png', division: 1 },
  { id: 'gremio', themeColor: { primary: '#3b82f6', secondary: '#f5f0e8' }, name: 'Grêmio', league: 'Brasileña', dt: 'Luís Castro', reputation: 4, initialSalary: 4350, marketValue: 42900000, starPlayers: ['Weverton (GK)', 'Cristian Pavón (RW)', 'Martin Braithwaite (ST)', 'Juan Ignacio Nardoni (CM)', 'Walter Kannemann (CB)', 'Arthur (CM)', 'Tetê (RW)', 'Marcos Rocha (RB)', 'Willian (LW)', 'Mathías Villasanti (CDM)', 'Wagner Leonardo (CB)'], description: 'Imortal Tricolor.', badgeColor: 'border-l-4 border-blue-500 bg-slate-900 text-white', badgeLogoUrl: '🔵',
    badgeImageUrl: 'badges/clubs/gremio.png', division: 1 },
  { id: 'palmeiras', name: 'Palmeiras', league: 'Brasileña', dt: 'Abel Ferreira', reputation: 5, initialSalary: 6200, marketValue: 121300000, starPlayers: ['Felipe Anderson (LW)', 'Gustavo Gómez (CB)', 'Vitor Roque (ST)', 'Jhon Arias (RW)', 'Andreas Pereira (CM)', 'José Manuel López (ST)', 'Marcelo Lomba (GK)', 'Murilo (CB)', 'Ramón Sosa (CAM)', 'Paulinho (CAM)', 'Joaquín Piquerez (LB)'], description: 'O Verdão.', badgeColor: 'border-l-4 border-white bg-green-600 text-white', badgeLogoUrl: '🟢',
    badgeImageUrl: 'badges/clubs/palmeiras.png', division: 1 },
  { id: 'botafogo', name: 'Botafogo', league: 'Brasileña', dt: 'Franclim Carvalho', reputation: 4, initialSalary: 4200, marketValue: 75800000, starPlayers: ['Alex Telles (LB)', 'Bastos (CB)', 'Allan (CDM)', 'Edenílson (CM)', 'Neto (GK)', 'Danilo (CM)', 'Marçal (LB)', 'Artur (RW)', 'Arthur Cabral (ST)'], description: 'O Glorioso.', badgeColor: 'border-l-4 border-white bg-black text-white', badgeLogoUrl: '🌟',
    badgeImageUrl: 'badges/clubs/botafogo.png', division: 1 },
  { id: 'fluminense', themeColor: { primary: '#b91c1c', secondary: '#f5f0e8' }, name: 'Fluminense', league: 'Brasileña', dt: 'Luis Zubeldía', reputation: 4, initialSalary: 4300, marketValue: 20450000, starPlayers: ['Luciano Acosta (CAM)', 'Germán Cano (ST)', 'Fábio (GK)', 'Guilherme Arana (LB)', 'Jefferson Savarino (CAM)', 'Otávio (CDM)', 'Yeferson Soteldo (LW)', 'Ganso (CAM)', 'Samuel Xavier (RB)', 'John Kennedy (ST)', 'Matheus Martinelli (CDM)'], description: 'Tricolor das Laranjeiras.', badgeColor: 'border-l-4 border-red-700 bg-green-800 text-white', badgeLogoUrl: '🔴🟢',
    badgeImageUrl: 'badges/clubs/fluminense.png', division: 1 },
  { id: 'sao_paulo', themeColor: { primary: '#dc2626', secondary: '#f5f0e8' }, name: 'São Paulo', league: 'Brasileña', dt: 'Dorival Júnior', reputation: 4, initialSalary: 4200, marketValue: 47700000, starPlayers: ['Jonathan Calleri (ST)', 'Rafael Tolói (CB)', 'Lucas Moura (RW)', 'Wendell (LB)', 'Pablo Maia (CDM)', 'Rafael (GK)', 'Enzo Díaz (LB)', 'Luciano (ST)', 'Ferreirinha (LW)'], description: 'El Tricolor Paulista.', badgeColor: 'border-l-4 border-red-600 bg-white text-black', badgeLogoUrl: '⚪',
    badgeImageUrl: 'badges/clubs/sao_paulo.png', division: 1 },
  { id: 'atletico_mineiro', name: 'Atlético Mineiro', league: 'Brasileña', dt: 'Eduardo Domínguez', reputation: 4, initialSalary: 4400, marketValue: 88400000, starPlayers: ['Dudu (LW)', 'Everson (GK)', 'Renan Lodi (LB)', 'Bernard (LW)', 'Vitor Hugo (CB)', 'Gustavo Scarpa (CAM)', 'Ángelo Preciado (RB)', 'Maycon (CM)', 'Mateo Cassierra (ST)'], description: 'O Galo.', badgeColor: 'border-l-4 border-white bg-black text-white', badgeLogoUrl: '🐔',
    badgeImageUrl: 'badges/tm/atletico_mineiro.png', division: 1 },
  { id: 'corinthians', name: 'Corinthians', league: 'Brasileña', dt: 'Fernando Diniz', reputation: 4, initialSalary: 4500, marketValue: 53700000, starPlayers: ['Memphis Depay (CAM)', 'Hugo Souza (GK)', 'Gabriel Paulista (CB)', 'Rodrigo Garro (CAM)', 'Allan (CDM)', 'Matheuzinho (RB)', 'André Ramalho (CB)', 'Yuri Alberto (ST)', 'Jesse Lingard (CAM)', 'Pedro Raul (ST)'], description: 'El Timão.', badgeColor: 'border-l-4 border-black bg-white text-black', badgeLogoUrl: '⚓',
    badgeImageUrl: 'badges/clubs/corinthians.png', division: 1 },
  { id: 'flamengo', name: 'Flamengo', league: 'Brasileña', dt: 'Leonardo Jardim', reputation: 5, initialSalary: 6500, marketValue: 137000000, starPlayers: ['Jorginho (CDM)', 'Lucas Paquetá (CAM)', 'Giorgian de Arrascaeta (CAM)', 'Bruno Henrique (ST)', 'Agustín Rossi (GK)', 'Gonzalo Plata (RW)', 'Samuel Lino (LW)', 'Pedro (ST)', 'Danilo (CB)', 'Everton Cebolinha (LW)', 'Nicolás de la Cruz (CM)'], description: 'El Megaclube de Río.', badgeColor: 'border-l-4 border-black bg-red-600 text-white', badgeLogoUrl: '🔴⚫',
    badgeImageUrl: 'badges/clubs/flamengo.png', division: 1 },
  { id: 'internacional', name: 'Internacional', league: 'Brasileña', dt: 'Paulo Pezzolano', reputation: 4, initialSalary: 4400, marketValue: 49400000, starPlayers: ['Sergio Rochet (GK)', 'Alan Patrick (CAM)', 'Rafael Borré (ST)', 'Thiago Maia (CDM)', 'Rodrigo Villagra (CDM)', 'Gabriel Mercado (CB)', 'Bruno Henrique (CM)', 'Paulinho (CM)', 'Johan Carbonero (LW)'], description: 'O Colorado.', badgeColor: 'border-l-4 border-white bg-red-600 text-white', badgeLogoUrl: '🔴',
    badgeImageUrl: 'badges/clubs/internacional.png', division: 1 },
  { id: 'rb_bragantino', themeColor: { primary: '#dc2626', secondary: '#f5f0e8' }, name: 'RB Bragantino', league: 'Brasileña', dt: 'Pedro Caixinha', reputation: 3, initialSalary: 3000, marketValue: 15000000, starPlayers: ['Juninho Capixaba (LB)', 'Cleiton (GK)', 'Tiago Volpi (GK)', 'Gabriel (CDM)', 'Eduardo Sasha (ST)', 'Fernando (ST)', 'Agustín Sant\'Anna (RB)', 'Pedro Henrique (CB)', 'Guzmán Rodríguez (CB)', 'Eduardo (CB)', 'Bruno Praxedes (CM)'], description: 'Massa Bruta.', badgeColor: 'border-l-4 border-red-600 bg-white text-black', badgeLogoUrl: '🐂',
    badgeImageUrl: 'badges/clubs/rb_bragantino.png', division: 1 },
  { id: 'vitoria', name: 'Vitória', league: 'Brasileña', dt: 'Jair Ventura', reputation: 3, initialSalary: 2000, marketValue: 25000000, starPlayers: ['Marinho (RW)', 'Gabriel (GK)', 'Emmanuel Martínez (CAM)', 'Osvaldo (RW)', 'Aitor (CAM)', 'Lucas Arcanjo (GK)', 'Fabrício (ST)', 'Camutanga (CB)', 'Gabriel Baralhas (CDM)', 'Matheuzinho (CAM)', 'Luan Cândido (LB)'], description: 'O Leão da Barra.', badgeColor: 'border-l-4 border-black bg-red-600 text-white', badgeLogoUrl: '🦁',
    badgeImageUrl: 'badges/clubs/vitoria.png', division: 1 },
  { id: 'vasco_da_gama', name: 'Vasco da Gama', league: 'Brasileña', dt: 'Pedro Emanuel', reputation: 4, initialSalary: 3500, marketValue: 65125000, starPlayers: ['Jair (CDM)', 'Thiago Mendes (CDM)', 'Tchê Tchê (CM)', 'Lucas Piton (LB)', 'Léo Jardim (GK)', 'Paulo Henrique (RB)', 'Robert Renan (CB)', 'Nuno Moreira (RW)', 'Andrés Gómez (LW)', 'David (LW)'], description: 'Gigante da Colina.', badgeColor: 'border-l-4 border-white bg-black text-white', badgeLogoUrl: '⚓',
    badgeImageUrl: 'badges/clubs/vasco_da_gama.png', division: 1 },
  { id: 'bahia', themeColor: { primary: '#dc2626', secondary: '#f5f0e8' }, name: 'Bahia', league: 'Brasileña', dt: 'Rogério Ceni', reputation: 3, initialSalary: 2800, marketValue: 23200000, starPlayers: ['Éverton Ribeiro (CAM)', 'Willian José (ST)', 'Rodrigo Nestor (CM)', 'Iago (LB)', 'Santiago Ramos Mingo (CB)', 'Luciano Juba (LB)', 'Erick (CDM)', 'Kanu (CB)', 'Ademir (RW)'], description: 'Esquadrão de Aço.', badgeColor: 'border-l-4 border-red-600 bg-blue-600 text-white', badgeLogoUrl: '🔵🔴',
    badgeImageUrl: 'badges/clubs/bahia.png', division: 1 },
  { id: 'mirassol', themeColor: { primary: '#16a34a', secondary: '#f5f0e8' }, name: 'Mirassol', league: 'Brasileña', dt: 'Rafael Guanaes', reputation: 2, initialSalary: 1500, marketValue: 6000000, starPlayers: ['Muralha', 'Fernandinho', 'Dellatorre', 'Danielzinho'], description: 'Leão da Alta.', badgeColor: 'border-l-4 border-green-600 bg-yellow-500 text-black', badgeLogoUrl: '🦁',
    badgeImageUrl: 'badges/clubs/mirassol.png', division: 1 },
  { id: 'santos', name: 'Santos', league: 'Brasileña', dt: 'Cuca', reputation: 4, initialSalary: 3800, marketValue: 106550000, starPlayers: ['Neymar (CAM)', 'Gabriel (ST)', 'Zé Rafael (CM)', 'Willian Arão (CDM)', 'Lucas Veríssimo (CB)', 'Luan Peres (CB)', 'Rony (ST)', 'Mayke (RB)', 'Adonis Frías (CB)', 'Benjamín Rollheiser (RW)'], description: 'O Peixe.', badgeColor: 'border-l-4 border-black bg-white text-black', badgeLogoUrl: '🐟',
    badgeImageUrl: 'badges/clubs/santos.png', division: 1 },
  { id: 'athletico_pr', name: 'Athletico Paranaense', league: 'Brasileña', dt: 'Odair Hellmann', reputation: 4, initialSalary: 3500, marketValue: 18000000, starPlayers: ['Fernandinho', 'Thiago Heleno', 'Bento', 'Canobbio'], description: 'El Furacão.', badgeColor: 'border-l-4 border-black bg-red-600 text-white', badgeLogoUrl: '🌪️',
    badgeImageUrl: 'badges/tm/athletico_pr.png', division: 1 },
  { id: 'remo', name: 'Clube do Remo', league: 'Brasileña', dt: 'Léo Condé', reputation: 2, initialSalary: 1200, marketValue: 7300000, starPlayers: ['Yago Pikachu (RW)', 'Ivan (GK)', 'Duplexe Tchamba (CB)', 'Zé Welison (CDM)', 'Marllon (CB)', 'Leonel Picco (CDM)', 'Panagiotis Tachtsidis (CDM)'], description: 'Leão Azul.', badgeColor: 'border-l-4 border-white bg-blue-900 text-white', badgeLogoUrl: '🦁',
    badgeImageUrl: 'badges/tm/remo.png', division: 1 },
  { id: 'coritiba', themeColor: { primary: '#16a34a', secondary: '#f5f0e8' }, name: 'Coritiba', league: 'Brasileña', dt: 'Fernando Seabra', reputation: 3, initialSalary: 2000, marketValue: 10000000, starPlayers: ['Rodrigo Moledo (CB)', 'Maicon (CB)', 'Josué (CAM)', 'Breno (LW)', 'Sebastián Gómez (CM)', 'Pedro Rocha (LW)', 'Tinga (RB)', 'Fernando Sobral (CM)', 'Thiago Santos (CB)'], description: 'Coxa-Branca.', badgeColor: 'border-l-4 border-green-600 bg-white text-black', badgeLogoUrl: '🟢⚪',
    badgeImageUrl: 'badges/clubs/coritiba.png', division: 1 },
  { id: 'chapecoense', name: 'Chapecoense', league: 'Brasileña', dt: 'Rafael Lacerda', reputation: 3, initialSalary: 1800, marketValue: 9000000, starPlayers: ['Jean Carlos (CAM)', 'Yannick Bolasie (ST)', 'Bruno Pacheco (LB)', 'Higor Meritão (CDM)', 'Rafael Thyere (CB)', 'Giovanni Augusto (CAM)', 'Maurício Garcez (LW)', 'Ênio (LW)', 'Neto Pessoa (ST)'], description: 'El Huracán del Oeste.', badgeColor: 'border-l-4 border-white bg-green-600 text-white', badgeLogoUrl: '🏹',
    badgeImageUrl: 'badges/clubs/chapecoense.png', division: 1 },

  // ==========================================
  // --- BRASIL (BRASILEIRAO B) ---
  // ==========================================
  { id: 'juventude', name: 'Juventude', league: 'Brasileña', dt: 'Jair Ventura', reputation: 2, initialSalary: 900, marketValue: 5500000, starPlayers: ['Alan Kardec (ST)', 'Manuel Castro (RW)', 'Messias (CB)', 'Titi (CB)', 'Rodrigo Sam (CB)', 'Marcos Paulo (LW)', 'Alan Ruschel (LB)', 'Alisson Safira (ST)', 'Lucas Mineiro (CDM)'], description: 'Compite en Brasileirao B.', badgeColor: 'border-l-4 border-white bg-green-600 text-white', badgeLogoUrl: '🟢',
    badgeImageUrl: 'badges/clubs/juventude.png', division: 2 },
  { id: 'fortaleza_br', themeColor: { primary: '#dc2626', secondary: '#f5f0e8' }, name: 'Fortaleza', league: 'Brasileña', dt: 'Juan Pablo Vojvoda', reputation: 3, initialSalary: 1500, marketValue: 5450000, starPlayers: ['Tomás Pochettino (CAM)', 'João Ricardo (GK)', 'Tomás Cardona (CB)', 'Vitinho (RW)', 'Lucas Crispim (CAM)', 'Lucas Sasha (CDM)', 'Gazal (CB)', 'Brenno (GK)'], description: 'Descendido sorpresivamente en el mod.', badgeColor: 'border-l-4 border-red-600 bg-blue-800 text-white', badgeLogoUrl: '🦁',
    badgeImageUrl: 'badges/clubs/fortaleza_br.png', division: 2 },
  { id: 'ceara', name: 'Ceará', league: 'Brasileña', dt: 'Léo Condé', reputation: 2, initialSalary: 900, marketValue: 3000000, starPlayers: ['Erick Pulga', 'Lourenço', 'Aylon', 'Richard'], description: 'O Vozão.', badgeColor: 'border-l-4 border-white bg-black text-white', badgeLogoUrl: '⚫',
    badgeImageUrl: 'badges/clubs/ceara.png', division: 2 },
  { id: 'sport_recife', name: 'Sport Recife', league: 'Brasileña', dt: 'Pepa', reputation: 2, initialSalary: 900, marketValue: 3000000, starPlayers: ['Lucas Lima', 'Zé Roberto', 'Fabricio Domínguez', 'Caíque França'], description: 'Compite en Brasileirao B.', badgeColor: 'border-l-4 border-black bg-red-600 text-white', badgeLogoUrl: '🦁',
    badgeImageUrl: 'badges/clubs/sport_recife.png', division: 2 },
  { id: 'america_mineiro', themeColor: { primary: '#16a34a', secondary: '#f5f0e8' }, name: 'América Mineiro', league: 'Brasileña', dt: 'Lisca', reputation: 2, initialSalary: 900, marketValue: 3000000, starPlayers: ['Juninho', 'Benítez', 'Elias', 'Ricardo Silva'], description: 'Compite en Brasileirao B.', badgeColor: 'border-l-4 border-green-600 bg-black text-white', badgeLogoUrl: '🐰',
    badgeImageUrl: 'badges/clubs/america_mineiro.png', division: 2 },
  { id: 'cuiaba', themeColor: { primary: '#eab308', secondary: '#f5f0e8' }, name: 'Cuiabá', league: 'Brasileña', dt: 'Bernardo Franco', reputation: 2, initialSalary: 900, marketValue: 3000000, starPlayers: ['João Basso (CB)', 'Pepê (CM)', 'Raul (CDM)', 'Alan Empereur (CB)', 'Marcelo Carné (GK)', 'Marlon (LB)', 'Gabriel (CB)', 'João Carlos (GK)', 'Railan (RB)', 'Yamil Asad (LW)', 'Rodrigo Rodrigues (ST)'], description: 'Compite en Brasileirao B.', badgeColor: 'border-l-4 border-yellow-500 bg-green-600 text-white', badgeLogoUrl: '🔰',
    badgeImageUrl: 'badges/clubs/cuiaba.png', division: 2 },
  { id: 'atletico_goianiense', name: 'Atlético Goianiense', league: 'Brasileña', dt: 'Umberto Louzer', reputation: 2, initialSalary: 900, marketValue: 3000000, starPlayers: ['Luiz Fernando', 'Shaylon', 'Ronaldo', 'Alix Vinicius'], description: 'Compite en Brasileirao B.', badgeColor: 'border-l-4 border-black bg-red-600 text-white', badgeLogoUrl: '🐉',
    badgeImageUrl: 'badges/tm/atletico_goianiense.png', division: 2 },
  { id: 'novorizontino', name: 'Novorizontino', league: 'Brasileña', dt: 'Eduardo Baptista', reputation: 2, initialSalary: 900, marketValue: 3000000, starPlayers: ['Jean Lucas (GK)', 'Leo Naldi (CDM)', 'Rômulo (CAM)', 'Robson (RW)', 'Christian Ortíz (CAM)', 'Jordi (GK)', 'Jhilmar Lora (RB)', 'Luís Oyama (CDM)', 'Carlinhos (CB)'], description: 'Compite en Brasileirao B.', badgeColor: 'border-l-4 border-black bg-yellow-500 text-black', badgeLogoUrl: '🐯',
    badgeImageUrl: 'badges/clubs/novorizontino.png', division: 2 },
  { id: 'goias', name: 'Goiás', league: 'Brasileña', dt: 'Vágner Mancini', reputation: 2, initialSalary: 900, marketValue: 3000000, starPlayers: ['Tadeu (GK)', 'Juninho (CDM)', 'Lucas Lima (CAM)', 'Rodrigo (RB)', 'Luiz Felipe (CB)', 'João Paulo Lourenço (CM)', 'Nicolas (LB)', 'Anselmo Ramon (ST)', 'Ramon Menezes (CB)'], description: 'Compite en Brasileirao B.', badgeColor: 'border-l-4 border-white bg-green-600 text-white', badgeLogoUrl: '🟢',
    badgeImageUrl: 'badges/clubs/goias.png', division: 2 },
  { id: 'criciuma', name: 'Criciúma', league: 'Brasileña', dt: 'Cláudio Tencati', reputation: 2, initialSalary: 900, marketValue: 3000000, starPlayers: ['Fellipe Mateus (CAM)', 'Bruno Alves (CB)', 'Rodrigo (CB)', 'Jean (CDM)', 'Romarinho (RW)', 'Alisson (GK)', 'Luciano Castán (CB)', 'Waguininho (LW)', 'César Martins (CB)', 'Marcelo Hermes (LB)'], description: 'O Tigre.', badgeColor: 'border-l-4 border-black bg-yellow-500 text-black', badgeLogoUrl: '🐯',
    badgeImageUrl: 'badges/clubs/criciuma.png', division: 2 },
  { id: 'crb', name: 'CRB', league: 'Brasileña', dt: 'Hélio dos Anjos', reputation: 2, initialSalary: 900, marketValue: 3000000, starPlayers: ['Bressan (CB)', 'Danielzinho (CAM)', 'Luiz Phellype (ST)', 'Lucas Lovat (LB)', 'Pedro Castro (CM)', 'Douglas Baggio (RW)', 'Diogo Hereda (RB)', 'Henri (CB)', 'Guilherme Pato (LW)', 'Fábio Alemão (CB)', 'Vitor Caetano (GK)'], description: 'Compite en Brasileirao B.', badgeColor: 'border-l-4 border-white bg-red-600 text-white', badgeLogoUrl: '🔴⚪',
    badgeImageUrl: 'badges/clubs/crb.png', division: 2 },
  ...
  { id: 'botafogo_sp', name: 'Botafogo de Ribeirão Preto', league: 'Brasileña', dt: 'Paulo Gomes', reputation: 2, initialSalary: 900, marketValue: 3000000, starPlayers: ['João Carlos', 'Fábio Sanches', 'Bochecha', 'Alexandre Jesus'], description: 'Botafogo de Ribeirão Preto.', badgeColor: 'border-l-4 border-white bg-red-600 text-white', badgeLogoUrl: '🔴⚪',
    badgeImageUrl: 'badges/tm/botafogo_sp.png', division: 2 },
  ...
  { id: 'ponte_preta', name: 'Ponte Preta', league: 'Brasileña', dt: 'Nelsinho Baptista', reputation: 2, initialSalary: 900, marketValue: 3000000, starPlayers: ['Jonathan Cafú (RW)', 'William Pottker (RW)', 'David Braz (CB)', 'Élvis (CAM)', 'Diogo Silva (GK)', 'Luís Phelipe (LW)'], description: 'Macaca.', badgeColor: 'border-l-4 border-black bg-white text-black', badgeLogoUrl: '🐒',
    badgeImageUrl: 'badges/clubs/ponte_preta.png', division: 2 },
  { id: 'sao_bernardo', name: 'Sao Bernardo', league: 'Brasileña', dt: 'Ricardo Catalá', reputation: 2, initialSalary: 900, marketValue: 3000000, starPlayers: ['Pablo (CB)', 'Jemerson (CB)', 'Hyoran (CAM)', 'Lucas Fernandes (CAM)', 'Rodrigo Andrade (CDM)', 'Fabrício Daniel (RW)', 'Luizão (CB)', 'Júnior Urso (CDM)', 'Pará (LB)', 'Pablo Dyego (RB)', 'Marcão (CDM)'], description: 'Compite en Brasileirao B.', badgeColor: 'border-l-4 border-black bg-yellow-500 text-black', badgeLogoUrl: '🟡',
    badgeImageUrl: 'badges/clubs/sao_bernardo.png', division: 2 },
  { id: 'nautico', themeColor: { primary: '#dc2626', secondary: '#f5f0e8' }, name: 'Nautico', league: 'Brasileña', dt: 'Marquinhos Santos', reputation: 2, initialSalary: 900, marketValue: 3000000, starPlayers: ['Muriel (GK)', 'Auremir (CDM)', 'Mateus Silva (CB)', 'Felipe Cardoso (CAM)', 'Dodô (CAM)', 'Vinícius (LW)', 'Gastón Guruceaga (GK)', 'Wanderson (CB)', 'Paulo Sérgio (ST)', 'Igor Fernandes (LB)'], description: 'O Timbu.', badgeColor: 'border-l-4 border-red-600 bg-white text-red-600', badgeLogoUrl: '🔴⚪',
    badgeImageUrl: 'badges/clubs/nautico.png', division: 2 },
  // ==========================================
  // --- MEXICO (LIGA MX Y EXPANSIÓN) ---
  // ==========================================
  { id: 'america_mex', themeColor: { primary: '#facc15', secondary: '#f5f0e8' }, name: 'América', league: 'Mexicana', dt: 'Guillermo Almada', reputation: 5, initialSalary: 4500, marketValue: 24000000, starPlayers: ['Alejandro Zendejas (RW)', 'Brian Rodríguez (LW)', 'Israel Reyes (CB)', 'Luis Malagón (GK)', 'Víctor Dávila (ST)', 'Cristián Borja (LB)', 'Jonathan dos Santos (CDM)', 'Henry Martín (ST)'], description: 'Las Águilas del Estadio Azteca.', badgeColor: 'border-l-4 border-yellow-400 bg-blue-900 text-yellow-200', badgeLogoUrl: '🦅',
    badgeImageUrl: 'badges/clubs/america_mex.png', division: 1 },
  { id: 'monterrey', themeColor: { primary: '#2563eb', secondary: '#f5f0e8' }, name: 'Monterrey', league: 'Mexicana', dt: 'Matías Almeyda', reputation: 5, initialSalary: 4200, marketValue: 22000000, starPlayers: ['Lucas Ocampos (LW)', 'Óliver Torres (CAM)', 'Anthony Martial (ST)', 'Luca Orellano (LM)', 'Uros Djurdjevic (ST)', 'Jesús Corona (RW)', 'Víctor Guzmán (CB)', 'Fidel Ambríz (CDM)', 'Stefan Medina (CB)'], description: 'Rayados.', badgeColor: 'border-l-4 border-blue-600 bg-white text-blue-900', badgeLogoUrl: '🔵',
    badgeImageUrl: 'badges/clubs/monterrey.png', division: 1 },
  { id: 'tigres', themeColor: { primary: '#eab308', secondary: '#f5f0e8' }, name: 'Tigres U.A.N.L.', league: 'Mexicana', dt: 'Guido Pizarro', reputation: 5, initialSalary: 4300, marketValue: 23000000, starPlayers: ['Nahuel Guzmán (GK)', 'Diego Lainez (RW)', 'Juan Brunetta (CAM)', 'Fernando Gorriarán (CDM)', 'Joaquim (CB)', 'Rodrigo Aguirre (ST)', 'André-Pierre Gignac (ST)', 'Jesús Angulo (CB)', 'Rômulo (CDM)', 'Jesús Garza (RB)'], description: 'Los Felinos.', badgeColor: 'border-l-4 border-yellow-500 bg-blue-900 text-yellow-300', badgeLogoUrl: '🐯',
  ...
  { id: 'toluca', name: 'Toluca', league: 'Mexicana', dt: 'Antonio Mohamed', reputation: 4, initialSalary: 3500, marketValue: 15000000, starPlayers: ['Paulinho (ST)', 'Alexis Vega (LW)', 'Federico Pereira (CB)', 'Marcel Ruiz (CM)', 'Jesús Gallardo (LB)', 'Helinho (RM)', 'Nicolás Castro (CM)', 'Jesús Angulo (CAM)', 'Santiago Simón (CM)', 'Bruno Méndez (CB)', 'Franco Romero (CDM)'], description: 'Los Diablos Rojos.', badgeColor: 'border-l-4 border-black bg-red-600 text-white', badgeLogoUrl: '😈',
    badgeImageUrl: 'badges/clubs/toluca.png', division: 1 },
  { id: 'pachuca', name: 'Pachuca', league: 'Mexicana', dt: 'Benjamín Mora', reputation: 4, initialSalary: 3200, marketValue: 14000000, starPlayers: ['Oussama Idrissi (LW)', 'Salomón Rondón (ST)', 'Elías Montiel (CM)', 'William Carvalho (CDM)', 'Carlos Moreno (GK)', 'Eduardo Bauermann (CB)', 'Sergio Barreto (CB)', 'Víctor Guzmán (CAM)'], description: 'Los Tuzos.', badgeColor: 'border-l-4 border-white bg-blue-900 text-white', badgeLogoUrl: '🐿️',
    badgeImageUrl: 'badges/clubs/pachuca.png', division: 1 },
  { id: 'leon', name: 'León', league: 'Mexicana', dt: 'Javier Gandolfi', reputation: 4, initialSalary: 3000, marketValue: 13000000, starPlayers: ['Diber Cambindo (ST)', 'Rodrigo Echeverría (CM)', 'Ismael Díaz (LW)', 'Salvador Reyes (LB)', 'Rogelio Funes Mori (ST)', 'Óscar García (GK)', 'Jordi Cortizo (LM)', 'Juan Domínguez (RM)', 'Fernando Beltrán (CDM)'], description: 'La Fiera.', badgeColor: 'border-l-4 border-white bg-green-600 text-white', badgeLogoUrl: '🦁',
    badgeImageUrl: 'badges/tm/leon.png', division: 1 },
  { id: 'atlas', themeColor: { primary: '#dc2626', secondary: '#f5f0e8' }, name: 'Atlas', league: 'Mexicana', dt: 'Beñat San José', reputation: 3, initialSalary: 2500, marketValue: 10000000, starPlayers: ['Camilo Vargas', 'Aldo Rocha', 'Hugo Nervo'], description: 'Los Zorros.', badgeColor: 'border-l-4 border-red-600 bg-black text-white', badgeLogoUrl: '🦊',
    badgeImageUrl: 'badges/clubs/atlas.png', division: 1 },
  { id: 'santos_laguna', name: 'Santos Laguna', league: 'Mexicana', dt: 'Renato Paiva', reputation: 3, initialSalary: 2500, marketValue: 10000000, starPlayers: ['Carlos Acevedo (GK)', 'Lucas Di Yorio (ST)', 'Carlos Gruezo (CDM)', 'Javier Güemez (CDM)', 'Choco Lozano (ST)', 'Bruno Amione (CB)', 'Fran Villalba (RM)', 'Ramiro Sordo (LW)'], description: 'Los Guerreros.', badgeColor: 'border-l-4 border-white bg-green-700 text-white', badgeLogoUrl: '👼',
    badgeImageUrl: 'badges/clubs/santos_laguna.png', division: 1 },
  { id: 'tijuana', name: 'Club Tijuana', league: 'Mexicana', dt: 'Sebastián Abreu', reputation: 3, initialSalary: 2400, marketValue: 9500000, starPlayers: ['Carlos González', 'Christian Rivera', 'Joe Corona'], description: 'Xolos.', badgeColor: 'border-l-4 border-black bg-red-600 text-white', badgeLogoUrl: '🐕',
    badgeImageUrl: 'badges/clubs/tijuana.png', division: 1 },
  { id: 'puebla', themeColor: { primary: '#38bdf8', secondary: '#f5f0e8' }, name: 'Puebla', league: 'Mexicana', dt: 'Gerardo Espinoza', reputation: 3, initialSalary: 2200, marketValue: 8500000, starPlayers: ['Emiliano Gómez (ST)', 'Julio González (GK)', 'Juan Pablo Vargas (CB)', 'Nicolás Díaz (CB)', 'Lucas Cavallini (ST)', 'Daniel Gutiérrez (GK)', 'Kevin Velasco (LM)', 'Alejandro Organista (CM)', 'Brayan Garnica (RM)'], description: 'La Franja.', badgeColor: 'border-l-4 border-sky-400 bg-white text-slate-900', badgeLogoUrl: '🎽',
    badgeImageUrl: 'badges/clubs/puebla.png', division: 1 },
  { id: 'queretaro', name: 'Querétaro', league: 'Mexicana', dt: 'Esteban González', reputation: 3, initialSalary: 2000, marketValue: 7500000, starPlayers: ['Santiago Homenchenko (CDM)', 'Lucas Abascia (CB)', 'Diego Reyes (CB)', 'Pablo Barrera (RM)', 'Guillermo Allison (GK)', 'Lucas Rodríguez (LM)', 'Alí Ávila (ST)', 'Jaime Gómez (RB)'], description: 'Los Gallos Blancos.', badgeColor: 'border-l-4 border-black bg-blue-800 text-white', badgeLogoUrl: '🐓',
    badgeImageUrl: 'badges/clubs/queretaro.png', division: 1 },
  { id: 'mazatlan', name: 'Mazatlán FC', league: 'Mexicana', dt: 'Ismael Rescalvo', reputation: 3, initialSalary: 2000, marketValue: 7500000, starPlayers: ['Yoel Bárcenas (LM)', 'Dudu (RW)', 'Ricardo Rodríguez (GK)', 'Jordan Sierra (CM)', 'José Esquivel (CDM)', 'Josué Ovalle (RW)', 'Fábio (ST)'], description: 'Los Cañoneros.', badgeColor: 'border-l-4 border-white bg-purple-800 text-white', badgeLogoUrl: '⚓',
    badgeImageUrl: 'badges/clubs/mazatlan.png', division: 1 },
  { id: 'necaxa', themeColor: { primary: '#dc2626', secondary: '#f5f0e8' }, name: 'Necaxa', league: 'Mexicana', dt: 'Martín Varini', reputation: 3, initialSalary: 2000, marketValue: 7500000, starPlayers: ['Lorenzo Faravelli (CM)', 'Julián Carranza (ST)', 'Alexis Peña (CB)', 'Javier Ruiz (RW)', 'Agustín Oliveros (CB)', 'Kevin Rosero (RM)'], description: 'Los Rayos.', badgeColor: 'border-l-4 border-red-600 bg-white text-slate-900', badgeLogoUrl: '⚡',
    badgeImageUrl: 'badges/clubs/necaxa.png', division: 1 },
  { id: 'juarez', themeColor: { primary: '#dc2626', secondary: '#f5f0e8' }, name: 'FC Juárez', league: 'Mexicana', dt: 'Pedro Caixinha', reputation: 3, initialSalary: 2000, marketValue: 7500000, starPlayers: ['Sebastián Jurado', 'Denzell García', 'Dieter Villalpando', 'Avilés Hurtado'], description: 'Bravos.', badgeColor: 'border-l-4 border-red-600 bg-green-600 text-white', badgeLogoUrl: '🐎',
    badgeImageUrl: 'badges/clubs/juarez.png', division: 1 },
  ...
  { id: 'atlante', name: 'Atlante', league: 'Mexicana', dt: 'Miguel Herrera', reputation: 2, initialSalary: 1000, marketValue: 3000000, starPlayers: ['Christian Bermúdez (CAM)', 'Luis Calzadilla (RM)', 'Hardy Meza (CDM)', 'Luis Olivas (CB)', 'Diego Cruz (CB)', 'Armando Escobar (LW)', 'Maximiliano García (CM)', 'Ronaldo González (CM)', 'Axl Padilla (RB)'], description: 'Liga de Expansión MX.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/tm/atlante.png', division: 1 },
  { id: 'venados_fc', name: 'Venados FC', league: 'Mexicana', dt: 'DT Genérico', reputation: 2, initialSalary: 1000, marketValue: 3000000, starPlayers: ['Juan José Calero (ST)', 'Santiago Ramírez (GK)', 'Adolfo Domínguez (CDM)', 'Sleyther Lora (RW)', 'Jonathan Martínez (CAM)', 'Mario Trejo (CB)', 'Duilio Tejeda (RW)', 'Néstor Vidrio (CB)', 'Lanchi (RB)', 'Paul Galván (CDM)'], description: 'Liga de Expansión MX.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/tm/venados_fc.png', division: 2 },
  { id: 'jaiba_brava', name: 'Jaiba Brava', league: 'Mexicana', dt: 'DT Genérico', reputation: 2, initialSalary: 1000, marketValue: 3000000, starPlayers: ['Antonio Portales (CB)', 'Sergio Flores (CDM)', 'Diego García (RB)', 'Edson Torres (CAM)', 'José Guadalupe Hernández (LB)', 'Luis Razo (ST)', 'Deivoon Magaña (RM)', 'José Peralta (RW)', 'Alonso Escoboza (LB)', 'Miguel Pedroza (ST)'], description: 'Liga de Expansión MX.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/tm/jaiba_brava.png', division: 2 },
  { id: 'morelia', name: 'Morelia', league: 'Mexicana', dt: 'DT Genérico', reputation: 2, initialSalary: 1000, marketValue: 3000000, starPlayers: ['Alejandro Andrade (CDM)', 'Brian Figueroa (CAM)', 'Brayton Vázquez (CB)', 'Arturo Palma (LW)', 'Damián Torres (CM)', 'Rubén Del Campo (ST)', 'Misael Domínguez (CAM)', 'Diego Gallegos (LB)', 'Zahid Muñoz (CAM)', 'Alonso Flores (ST)'], description: 'Liga de Expansión MX.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/morelia.png', division: 2 },
  ...
  { id: 'leones_negros', name: 'Leones Negros', league: 'Mexicana', dt: 'DT Genérico', reputation: 2, initialSalary: 1000, marketValue: 3000000, starPlayers: ['Carlos Cisneros (LW)', 'Carlos Fierro (LW)', 'Jonathan Sánchez (CB)', 'Jesús Brígido (LW)', 'Felipe López (GK)', 'Juan de Dios Aguayo (CB)', 'Arturo Ledesma (CB)', 'Sergio Hernández (CAM)', 'Alejandro Bravo (CM)', 'Joél Pérez (LW)', 'Édson Rivera (ST)'], description: 'Liga de Expansión MX.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/tm/leones_negros.png', division: 2 },
  { id: 'tapatio', name: 'Tapatio', league: 'Mexicana', dt: 'DT Genérico', reputation: 2, initialSalary: 1000, marketValue: 3000000, starPlayers: ['Vladimir Moragrega (ST)', 'Leonardo Jiménez (RB)', 'Jorge Guzmán (LB)'], description: 'Liga de Expansión MX.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/tm/tapatio.png', division: 2 },
  { id: 'mineros', name: 'Mineros', league: 'Mexicana', dt: 'DT Genérico', reputation: 2, initialSalary: 1000, marketValue: 3000000, starPlayers: ['Leonardo Durán (GK)', 'Andrés Mendoza (CDM)', 'Andrés Ávila (CAM)', 'Kevin Magaña (RW)', 'Mauro Pérez (ST)', 'Óscar Mazatán (RB)', 'Francisco López (LW)', 'Juan Machado (ST)', 'Japheth Jiménez (CM)', 'Luis Donaldo Hernández (CB)', 'Weymmar Castro (CB)'], description: 'Liga de Expansión MX.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'tepatitlan', name: 'Tepatitlan', league: 'Mexicana', dt: 'DT Genérico', reputation: 2, initialSalary: 1000, marketValue: 3000000, starPlayers: ['Jesús Venegas (CDM)', 'Josué Gómez (LW)', 'Gustavo Gutiérrez (GK)', 'Idekel Domínguez (RB)'], description: 'Liga de Expansión MX.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/tm/tepatitlan.png', division: 2 },
  { id: 'tlaxcala', name: 'Tlaxcala', league: 'Mexicana', dt: 'DT Genérico', reputation: 2, initialSalary: 1000, marketValue: 3000000, starPlayers: ['Ismael Govea (RB)', 'Jordan Silva (CB)', 'Pablo González (CM)', 'Tony Figueroa (RM)', 'Christian (ST)', 'Andrés Iniestra (CM)', 'Giovani Hernández (CAM)', 'Gabino Espinoza (GK)', 'Edson Santos (LB)', 'Salomón Obama Ondo (RW)', 'Juan Blanco (LW)'], description: 'Liga de Expansión MX.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/tm/tlaxcala.png', division: 2 },
  { id: 'cancun_fc', name: 'Cancun FC', league: 'Mexicana', dt: 'DT Genérico', reputation: 2, initialSalary: 1000, marketValue: 3000000, starPlayers: ['José Rodríguez (ST)', 'Leonel López (CM)', 'Daniel Guillén (CB)', 'Christopher Trejo (ST)'], description: 'Liga de Expansión MX.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/tm/cancun_fc.png', division: 2 },
  ...
  // ==========================================
  { id: 'colocolo', name: 'Colo-Colo', league: 'Chilena', dt: 'Jorge Almirón', reputation: 4, initialSalary: 2300, marketValue: 16000000, starPlayers: ['Claudio Aquino (CAM)', 'Arturo Vidal (CM)', 'Javier Méndez (CB)', 'Javier Correa (ST)', 'Fernando De Paul (GK)', 'Felipe Méndez (CDM)', 'Maximiliano Romero (ST)', 'Tomás Alarcón (CDM)', 'Matías Fernández (RB)', 'Jonathan Villagra (CB)'], description: 'El Cacique.', badgeColor: 'border-l-4 border-white bg-black text-white', badgeLogoUrl: '🏁',
    badgeImageUrl: 'badges/clubs/colocolo.png', division: 1 },
  ...
  { id: 'palestino', themeColor: { primary: '#dc2626', secondary: '#f5f0e8' }, name: 'Palestino', league: 'Chilena', dt: 'Pablo Sánchez', reputation: 3, initialSalary: 1500, marketValue: 7000000, starPlayers: ['Joe Abrigo (CAM)', 'Fernando Meza (CB)', 'Bryan Carrasco (RW)', 'Sebastián Pérez (GK)', 'Jonathan Benítez (LW)', 'Dilan Zúñiga (LB)', 'César Munder (LW)', 'Enzo Roco (CB)', 'Ronnie Fernández (ST)', 'Ariel Martínez (CM)'], description: 'Los Árabes.', badgeColor: 'border-l-4 border-red-600 bg-green-700 text-white', badgeLogoUrl: '🇵🇸',
    badgeImageUrl: 'badges/clubs/palestino.png', division: 1 },
  { id: 'coquimbo_unido', name: 'Coquimbo Unido', league: 'Chilena', dt: 'DT Genérico', reputation: 3, initialSalary: 1200, marketValue: 5000000, starPlayers: ['Alejandro Camargo (CDM)', 'Rodrigo Holgado (ST)', 'Diego Sánchez (GK)', 'Lucas Pratto (ST)', 'Benjamín Gazzolo (CB)', 'Manuel Fernández (CB)', 'Matías Fracchia (CB)', 'Salvador Cordero (CDM)'], description: 'Primera División de Chile.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/coquimbo_unido.png', division: 1 },
  { id: 'cobresal', name: 'Cobresal', league: 'Chilena', dt: 'DT Genérico', reputation: 3, initialSalary: 1200, marketValue: 5000000, starPlayers: ['César Yanis (RW)', 'Bryan Carvallo (CAM)', 'Julián Brea (RW)', 'Guillermo Pacheco (RB)', 'Juan Fuentes (CDM)', 'Esteban Valencia (CM)', 'José Tiznado (CB)', 'Franco Bechtholdt (CB)'], description: 'Primera División de Chile.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/cobresal.png', division: 1 },
  { id: 'everton', name: 'Everton de Viña del Mar', league: 'Chilena', dt: 'DT Genérico', reputation: 3, initialSalary: 83400, marketValue: 433750000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Primera División de Chile.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/everton.png', division: 1 },
  { id: 'unión_la_calera', name: 'Unión La Calera', league: 'Chilena', dt: 'DT Genérico', reputation: 3, initialSalary: 1200, marketValue: 5000000, starPlayers: ['Kevin Méndez (RW)', 'Juan Requena (CDM)', 'Sebastián Sáez (ST)', 'Yerko Leiva (CM)', 'Camilo Moya (CDM)', 'Nicolás Avellaneda (GK)', 'Rodrigo Cáseres (CB)', 'Cristián Gutiérrez (LB)', 'Bayron Oyarzo (RW)'], description: 'Primera División de Chile.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/unión_la_calera.png', division: 1 },
  { id: 'huachipato', name: 'Huachipato', league: 'Chilena', dt: 'DT Genérico', reputation: 3, initialSalary: 1200, marketValue: 5000000, starPlayers: ['Cris Martínez (LW)', 'Rafael Caroca (CB)', 'Nicolás Vargas (CB)', 'Ezequiel Cañete (CM)', 'Lionel Altamirano (ST)', 'Rodrigo Odriozola (GK)', 'Maximiliano Rodríguez Vejar (ST)', 'Claudio Sepúlveda (CDM)', 'Benjamín Mellado (CB)'], description: 'Primera División de Chile.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/huachipato.png', division: 1 },
  { id: 'ñublense', name: 'Ñublense', league: 'Chilena', dt: 'DT Genérico', reputation: 3, initialSalary: 1200, marketValue: 5000000, starPlayers: ['Gabriel Graciani (RM)', 'Nicola Pérez (GK)', 'Lorenzo Reyes (CDM)', 'Osvaldo Bosso (CB)', 'Manuel Rivera (CM)', 'Felipe Campos (RB)', 'Jovany Campusano (LB)', 'Matías Plaza (LM)'], description: 'Primera División de Chile.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/ñublense.png', division: 1 },
  { id: 'audax_italiano', name: 'Audax Italiano', league: 'Chilena', dt: 'DT Genérico', reputation: 3, initialSalary: 1200, marketValue: 5000000, starPlayers: ['Federico Mateos (CM)', 'Diego Coelho (ST)', 'Franco Troyansky (ST)', 'Marcelo Ortíz (CB)', 'Michael Vadulli (LW)', 'Nicolás Orellana (CM)', 'Raimundo Rebolledo (RB)', 'Marco Collao (CM)', 'Daniel Piña (CB)', 'Giovani Chiaverano (RW)'], description: 'Primera División de Chile.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/audax_italiano.png', division: 1 },
  { id: 'ohiggins', name: 'O\'Higgins', league: 'Chilena', dt: 'DT Genérico', reputation: 3, initialSalary: 1200, marketValue: 5000000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Primera División de Chile.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeImageUrl: 'badges/clubs/ohiggins.png', badgeLogoUrl: '⚽', division: 1 },
  { id: 'deportes_limache', name: 'Deportes Limache', league: 'Chilena', dt: 'DT Genérico', reputation: 3, initialSalary: 1200, marketValue: 5000000, starPlayers: ['Jean Meneses (LW)', 'Joaquín Montecinos (RW)', 'Nicolás Peñailillo (LB)', 'Alfonso Parot (LB)', 'Ramón Martínez (CDM)', 'César Fuentes (CDM)', 'Daniel Castro (LW)', 'Claudio González (GK)', 'Marcos Arturia (ST)'], description: 'Primera División de Chile.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/deportes_limache.png', division: 1 },
  { id: 'deportes_la_serena', name: 'Deportes La Serena', league: 'Chilena', dt: 'DT Genérico', reputation: 3, initialSalary: 1200, marketValue: 5000000, starPlayers: ['Gonzalo Escalante (CM)', 'Federico Lanzillotta (GK)', 'Rafael Delgado (LB)', 'Francis Mac Allister (CDM)', 'Diego Rubio (ST)', 'Nicolás Stefanelli (ST)', 'Lucas Alarcón (CB)', 'Alexander Oroz (LW)', 'Andrés Zanini (CB)', 'Ángelo Henríquez (ST)'], description: 'Primera División de Chile.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/deportes_la_serena.png', division: 1 },
  { id: 'deportes_concepción', name: 'Deportes Concepción', league: 'Chilena', dt: 'DT Genérico', reputation: 3, initialSalary: 1200, marketValue: 5000000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Primera División de Chile.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/deportes_concepción.png', division: 1 },
  ...
  { id: 'santiago_wanderers', name: 'Santiago Wanderers', league: 'Chilena', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Cristóbal Cáceres (CDM)', 'Martín Villarroel (CDM)', 'Víctor Espinoza (CB)', 'Luis Margas (CB)', 'Axel Herrera (RB)', 'Bayron Martínez (GK)', 'Marcos Camarda (ST)', 'Joaquín Silva (CM)', 'Pedro Navarro (LB)', 'Denilson San Martín (LW)', 'Cristóbal Ponce (CAM)'], description: 'Primera B de Chile.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeImageUrl: 'badges/clubs/santiago_wanderers.png', badgeLogoUrl: '⚽', division: 2 },
  ...
  { id: 'deportes_copiapó', name: 'Deportes Copiapó', league: 'Chilena', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Lautaro Palacios (ST)', 'Fabián Torres (CB)', 'Iván Ledezma (CM)', 'Agustín Ortiz (RB)', 'Gastón Pérez (CDM)', 'Carlos Ross (RW)', 'John Santander (LB)', 'Claudio Zamorano (CDM)', 'Manuel López (ST)', 'Nicolás Temperini (GK)'], description: 'Primera B de Chile.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeImageUrl: 'badges/clubs/deportes_copiapó.png', badgeLogoUrl: '⚽', division: 2 },
  { id: 'san_luis_de_quillota', name: 'San Luis de Quillota', league: 'Chilena', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Nicolás Peranic (GK)', 'Gael Acosta (LM)', 'Guillermo Madrigal (ST)', 'Joel Torres (CM)', 'Felipe Flores (ST)', 'Fabián Pastenes (CAM)', 'Sergio Vergara (RW)', 'Yerald Pinilla (LW)', 'Cristian Gonzalez (CB)', 'Sebastián Parada (ST)', 'Daniel Monardes (CM)'], description: 'Primera B de Chile.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'https://upload.wikimedia.org/wikipedia/commons/7/7a/LOGO_SAN_LUIS_DE_QUILLOTA_OFICIAL.png', division: 2 },
  { id: 'san_marcos_de_arica', name: 'San Marcos de Arica', league: 'Chilena', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Rodrigo Saracho (GK)', 'Álvaro Cazula (CB)', 'Augusto Barrios (CM)', 'Alfredo Ábalos (LW)', 'Camilo Melivilú (ST)', 'Agustin Maidana (CAM)', 'Bairon Monroy (ST)', 'Nicolás Orrego (RW)', 'Boris Sagredo (CAM)', 'Nicolás Zedán (ST)', 'Nahuel Donadell (CAM)'], description: 'Primera B de Chile.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeImageUrl: 'badges/clubs/san_marcos_de_arica.png', badgeLogoUrl: '⚽', division: 2 },
  { id: 'cobreloa', name: 'Cobreloa', league: 'Chilena', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Sebastián Zúñiga (CAM)', 'Cristian Insaurralde (LW)', 'Felipe Fritz (LB)', 'Tomás Aránguiz (CM)', 'Gustavo Gotti (ST)', 'Jorge Gatica (CM)', 'Diego Tapia (GK)', 'Rodolfo González (CB)', 'Hugo Araya (GK)', 'Facundo Velazco (LM)'], description: 'Primera B de Chile.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/tm/cobreloa.png', division: 2 },
  { id: 'deportes_antofagasta', name: 'Deportes Antofagasta', league: 'Chilena', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Christian Bravo (RW)', 'Simón Ramírez (RB)', 'Alex Ibacache (LB)', 'Diego Rojas (CAM)', 'Brayan Hurtado (LW)', 'Iván Rozas (CM)', 'Sebastián Leyton (CDM)', 'Adrián Cuadra (CM)', 'Josepablo Monreal (ST)', 'Fernando Hurtado (GK)', 'Cristián Díaz (CB)'], description: 'Primera B de Chile.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeImageUrl: 'badges/clubs/deportes_antofagasta.png', badgeLogoUrl: '⚽', division: 2 },
  { id: 'deportes_recoleta', name: 'Deportes Recoleta', league: 'Chilena', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Gonzalo Álvarez (RW)', 'Francisco Alarcón (CB)', 'Germán Estigarribia (ST)', 'Álvaro Salazar (GK)', 'Felipe Saavedra (LB)', 'Christian Cepeda (CB)', 'Camilo Rodríguez (RB)', 'Federico Martin (CDM)', 'Pedro Sánchez (ST)', 'Mikel Arguinarena (CAM)', 'Brayams Viveros (CB)'], description: 'Primera B de Chile.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeImageUrl: 'badges/clubs/deportes_recoleta.png', badgeLogoUrl: '⚽', division: 2 },
  { id: 'deportes_temuco', name: 'Deportes Temuco', league: 'Chilena', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Brian Torrealba (RB)', 'Diego Buonanotte (CAM)', 'Felipe Reynero (RW)', 'Rodrigo González (RB)', 'Maximiliano Cuadra (ST)', 'Yerko Urra (GK)', 'Camilo Núñez (CDM)', 'Luis Acevedo (ST)', 'César Huanca (ST)', 'Miguel Sanhueza (CB)'], description: 'Primera B de Chile.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'rangers_de_talca', name: 'Rangers de Talca', league: 'Chilena', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Junior Arias (ST)', 'Alejandro Márquez (CM)', 'Carlos Labrín (CB)', 'Juan Méndez (CM)', 'José Luis Gamonal (GK)', 'Sebastián Silva (CB)', 'Sebastián Acuña (CB)', 'Ignacio Ibáñez (RW)', 'Gary Moya (CM)', 'Damián González (LW)', 'Ignacio Mesías (ST)'], description: 'Primera B de Chile.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeImageUrl: 'badges/clubs/rangers_de_talca.png', badgeLogoUrl: '⚽', division: 2 },
  { id: 'deportes_santa_cruz', name: 'Deportes Santa Cruz', league: 'Chilena', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Nazareno Romero (LB)', 'Esteban Flores (LB)', 'Braian Camisassa (CB)', 'Felipe Orellana (CM)', 'Juan Delgado (RW)', 'Santiago Mederos (LM)', 'Nadir Zeineddin (ST)', 'David Tati (RB)', 'Martín Quezada (GK)', 'Mathías Pinto (RW)', 'Juan Dobboletta (GK)'], description: 'Primera B de Chile.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeImageUrl: 'badges/clubs/deportes_santa_cruz.png', badgeLogoUrl: '⚽', division: 2 },
  { id: 'unión_san_felipe', name: 'Unión San Felipe', league: 'Chilena', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Agustín Fontana (ST)', 'Gonzalo Jara (LW)', 'Bruno Vides (ST)', 'Valentín Perales (CB)', 'Ignacio Jara (CAM)', 'Leandro Cañete (GK)', 'Luis García (CDM)', 'Diego Pereira (LB)', 'Nicolás Brun (LM)', 'Kevin Serrano (CB)', 'Patricio Muñoz (ST)'], description: 'Primera B de Chile.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeImageUrl: 'badges/clubs/unión_san_felipe.png', badgeLogoUrl: '⚽', division: 2 },
  { id: 'puerto_montt', name: 'Puerto Montt', league: 'Chilena', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Alexis Sabella (LW)', 'Luciano Vázquez (ST)', 'Byron Nieto (RB)', 'Jason Flores (LM)', 'Luis Ureta (GK)', 'Ariel Morales (CB)', 'Kevin Egaña (LB)', 'Cristóbal Vargas (CAM)', 'Maximiliano Riveros (CB)', 'Gabriel Castillo (CM)', 'Richard Paredes (CAM)'], description: 'Primera B de Chile.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeImageUrl: 'badges/clubs/puerto_montt.png', badgeLogoUrl: '⚽', division: 2 },

  // ==========================================
  // --- URUGUAY (PRIMERA DIVISIÓN) ---
  // ==========================================
  { id: 'penarol', themeColor: { primary: '#eab308', secondary: '#f5f0e8' }, name: 'Peñarol', league: 'Uruguaya', dt: 'Diego Aguirre', reputation: 4, initialSalary: 2200, marketValue: 15400000, starPlayers: ['Leonardo Fernández (CAM)', 'Gastón Togni (LM)', 'Diego Laxalt (LB)', 'Matías Arezo (ST)', 'Javier Cabrera (RM)', 'Abel Hernández (ST)', 'Facundo Batista (ST)', 'Washington Aguerre (GK)', 'Luis Miguel Angulo (LM)'], description: 'El Carbonero.', badgeColor: 'border-l-4 border-yellow-500 bg-black text-yellow-300', badgeLogoUrl: '🏆',
    badgeImageUrl: 'badges/clubs/penarol.png', division: 1 },
  { id: 'nacional_uru', themeColor: { primary: '#2563eb', secondary: '#f5f0e8' }, name: 'Nacional', league: 'Uruguaya', dt: 'Martín Lasarte', reputation: 4, initialSalary: 2150, marketValue: 14800000, starPlayers: ['Sebastián Coates', 'Luis Mejía', 'Mauricio Pereyra'], description: 'El Bolso.', badgeColor: 'border-l-4 border-blue-600 bg-red-950 text-blue-200', badgeLogoUrl: '🔴⚪🔵',
    badgeImageUrl: 'badges/clubs/nacional_uru.png', division: 1 },
  { id: 'defensor_sporting', themeColor: { primary: '#9333ea', secondary: '#f5f0e8' }, name: 'Defensor Sporting', league: 'Uruguaya', dt: 'Martín Varini', reputation: 3, initialSalary: 1500, marketValue: 7000000, starPlayers: ['Octavio Rivero', 'Fernando Elizari', 'Renzo Giampaoli', 'Kevin Dawson'], description: 'El Tuerto.', badgeColor: 'border-l-4 border-purple-600 bg-purple-900 text-white', badgeLogoUrl: '🟣',
    badgeImageUrl: 'badges/clubs/defensor_sporting.png', division: 1 },
  { id: 'danubio', name: 'Danubio', league: 'Uruguaya', dt: 'Alejandro Apud', reputation: 3, initialSalary: 1400, marketValue: 6500000, starPlayers: ['Sebastián Rodríguez (CM)', 'Mauro Goicoechea (GK)', 'Sebastián Fernández (ST)', 'Iván Rossi (CDM)', 'Emiliano Velázquez (CB)', 'Tomás Cavanagh (LB)', 'Leandro Sosa (CDM)', 'Mateo Rinaldi (CB)', 'Mateo Peralta (CM)', 'Juan Millán (CDM)'], description: 'La Franja.', badgeColor: 'border-l-4 border-black bg-white text-black', badgeLogoUrl: '🎽',
    badgeImageUrl: 'badges/clubs/danubio.png', division: 1 },
  { id: 'racing_club_uru', name: 'Racing Club', league: 'Uruguaya', dt: 'DT Genérico', reputation: 2, initialSalary: 1100, marketValue: 4000000, starPlayers: ['Lautaro Díaz (ST)', 'Guillermo Cotugno (RB)', 'Martín Ferreira (LB)', 'José Varela (CM)', 'Erik De Los Santos (CM)', 'Ramiro Brazionis (CB)', 'Nicolás Sosa Sánchez (ST)', 'Óscar Quiñónez (CB)', 'Juan Antonio Pérez (CM)', 'Facundo Parada (CB)', 'Bautista Tomatis (ST)'], description: 'Campeonato Uruguayo.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/racing_club_uru.png', division: 1 },
  { id: 'liverpool_uru', name: 'Liverpool de Montevideo', league: 'Uruguaya', dt: 'DT Genérico', reputation: 2, initialSalary: 169100, marketValue: 879500000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Campeonato Uruguayo.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/liverpool_uru.png', division: 1 },
  { id: 'cerro_largo_uru', name: 'Cerro Largo', league: 'Uruguaya', dt: 'DT Genérico', reputation: 2, initialSalary: 1100, marketValue: 4000000, starPlayers: ['Sebastián Assís (CDM)', 'Nicolás Bertocchi (CDM)', 'Lucas Correa (CB)', 'Gustavo Viera (ST)', 'Juan Moreno (GK)', 'Mario García (CM)', 'Fernando Souza (RB)', 'Alexander Hernández (CAM)', 'Ihojan Pérez (RM)', 'Federico Sellecchia (ST)'], description: 'Campeonato Uruguayo.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/cerro_largo_uru.png', division: 1 },
  ...
  { id: 'boston_river_uru', name: 'Boston River', league: 'Uruguaya', dt: 'DT Genérico', reputation: 2, initialSalary: 1100, marketValue: 4000000, starPlayers: ['Gastón Ramírez (CM)', 'Agustín Amado (CM)', 'Bruno Antúnez (GK)', 'Juan Acosta (RB)', 'Andrés Romero (CM)', 'Leandro Suhr (RW)', 'Fredy Martínez (LB)', 'Martín González (CB)', 'Facundo Muñoa (CM)', 'Facundo Rodríguez (ST)'], description: 'Campeonato Uruguayo.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/boston_river_uru.png', division: 1 },
  { id: 'cerro_uru', name: 'Cerro', league: 'Uruguaya', dt: 'DT Genérico', reputation: 2, initialSalary: 1100, marketValue: 4000000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Campeonato Uruguayo.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/cerro_uru.png', division: 1 },
  { id: 'progreso_uru', name: 'Progreso', league: 'Uruguaya', dt: 'DT Genérico', reputation: 2, initialSalary: 1100, marketValue: 4000000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Campeonato Uruguayo.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/progreso_uru.png', division: 1 },
  { id: 'juventud_de_las_piedras_uru', name: 'Juventud de Las Piedras', league: 'Uruguaya', dt: 'DT Genérico', reputation: 2, initialSalary: 1100, marketValue: 4000000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Campeonato Uruguayo.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/juventud_de_las_piedras_uru.png', division: 1 },
  { id: 'albion_uru', name: 'Albion', league: 'Uruguaya', dt: 'DT Genérico', reputation: 2, initialSalary: 1100, marketValue: 4000000, starPlayers: ['Hernán Toledo (LM)', 'Matías de los Santos (CB)', 'Francisco Ginella (CM)', 'Tobías Figueroa (ST)', 'José Álvarez (LM)', 'Leonardo Pais (RM)', 'Agustín Pereira (RB)', 'Andrés Romero (CB)', 'Briam Acosta (RM)', 'Tomás Moschión (CDM)'], description: 'Campeonato Uruguayo.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/albion_uru.png', division: 1 },
  ...
  { id: 'maldonado_uru', name: 'Maldonado', league: 'Uruguaya', dt: 'DT Genérico', reputation: 2, initialSalary: 1100, marketValue: 4000000, starPlayers: ['Hernán Menosse (CB)', 'Christian Tabó (RM)', 'Bruno Mendes (ST)', 'Juan Ramos (LB)', 'Hernán Petryk (RB)', 'Facundo Tealde (CB)', 'Santiago Cartagena (CDM)', 'Adriano Freitas (GK)', 'Santiago Ramírez (ST)', 'Maximiliano Noble (CAM)'], description: 'Campeonato Uruguayo.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/tm/maldonado_uru.png', division: 1 },

  // ==========================================
  // --- PERÚ (LIGA 1) ---
  // ==========================================
  { id: 'universitario', themeColor: { primary: '#fef08a', secondary: '#f5f0e8' }, name: 'Universitario', league: 'Peruana', dt: 'Fabián Bustos', reputation: 4, initialSalary: 1800, marketValue: 9000000, starPlayers: ['Williams Riveros (CB)', 'Andy Polo (RW)', 'Jairo Concha (CM)', 'Alex Valera (ST)', 'Edison Flores (ST)', 'Anderson Santamaría (CB)', 'Martín Pérez Guedes (CM)', 'Aldo Corzo (CB)', 'Lisandro Alzugaray (RW)'], description: 'Los Cremas.', badgeColor: 'border-l-4 border-yellow-200 bg-red-900 text-yellow-100', badgeLogoUrl: '🟨🟥',
    badgeImageUrl: 'badges/clubs/universitario.png', division: 1 },
  { id: 'alianza_lima', themeColor: { primary: '#1e40af', secondary: '#f5f0e8' }, name: 'Alianza Lima', league: 'Peruana', dt: 'Mariano Soso', reputation: 4, initialSalary: 1700, marketValue: 8500000, starPlayers: ['Luis Advíncula (RB)', 'Guillermo Viscarra (GK)', 'Paolo Guerrero (ST)', 'Renzo Garcés (CB)', 'Fernando Gaibor (CM)', 'Eryc Castillo (RW)', 'Gaspar Gentile (RW)', 'Josué Estrada (RB)', 'Federico Girotti (ST)', 'Esteban Pavez (CDM)'], description: 'Los Íntimos.', badgeColor: 'border-l-4 border-blue-800 bg-slate-100 text-blue-900', badgeLogoUrl: '🔵⚪',
    badgeImageUrl: 'badges/clubs/alianza_lima.png', division: 1 },
  { id: 'sporting_cristal', themeColor: { primary: '#38bdf8', secondary: '#f5f0e8' }, name: 'Sporting Cristal', league: 'Peruana', dt: 'Enderson Moreira', reputation: 4, initialSalary: 1600, marketValue: 8000000, starPlayers: ['Santiago González (RW)', 'Christofer Gonzáles (CAM)', 'Martín Távara (CM)', 'Yoshimar Yotún (CM)', 'Luis Iberico (ST)', 'Luis Abram (CB)', 'Diego Enríquez (GK)', 'Írven Ávila (ST)', 'Renato Solís (GK)'], description: 'Los Celestes.', badgeColor: 'border-l-4 border-sky-400 bg-sky-800 text-white', badgeLogoUrl: '🩵',
    badgeImageUrl: 'badges/clubs/sporting_cristal.png', division: 1 },
  { id: 'melgar', name: 'Melgar', league: 'Peruana', dt: 'Marco Valencia', reputation: 3, initialSalary: 1400, marketValue: 7000000, starPlayers: ['Bernardo Cuesta', 'Horacio Orzán', 'Leonel Galeano', 'Carlos Cáceda'], description: 'El Dominó.', badgeColor: 'border-l-4 border-black bg-red-600 text-white', badgeLogoUrl: '🔴⚫',
    badgeImageUrl: 'badges/clubs/melgar.png', division: 1 },
  { id: 'deportivo_garcilaso', name: 'Deportivo Garcilaso', league: 'Peruana', dt: 'DT Genérico', reputation: 2, initialSalary: 1000, marketValue: 3500000, starPlayers: ['Kevin Sandoval (LW)', 'Agustin Gómez (CB)', 'Horacio Benincasa (CB)', 'Claudio Torrejón (CDM)', 'Aldair Salazar (CB)', 'Patrick Zubczuk (GK)', 'Agustín González (CM)', 'José Luis Sinisterra (ST)', 'Francisco Arancibia (RW)', 'Beto da Silva (LW)'], description: 'Liga 1 Te Apuesto.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/deportivo_garcilaso.png', division: 1 },
  { id: 'adt', name: 'ADT', league: 'Peruana', dt: 'DT Genérico', reputation: 2, initialSalary: 1000, marketValue: 3500000, starPlayers: ['Jonathan Bauman (ST)', 'Joao Rojas (CAM)', 'Víctor Cedrón (CAM)', 'Luis Pérez (CM)', 'Aldair Rodríguez (ST)', 'John Narváez (CB)', 'Carlos Solís (GK)', 'Juan Valencia (GK)', 'Luis Benítes (LW)'], description: 'Liga 1 Te Apuesto.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/adt.png', division: 1 },
  { id: 'sport_huancayo', name: 'Sport Huancayo', league: 'Peruana', dt: 'DT Genérico', reputation: 2, initialSalary: 1000, marketValue: 3500000, starPlayers: ['Jimmy Valoyes (CB)', 'Ángel Zamudio (GK)', 'Ricardo Salcedo (CDM)', 'Javier Sanguinetti (CAM)', 'Jeremy Rostaing (RB)', 'Hugo Ángeles Chávez (LB)', 'Yonatan Murillo (CB)', 'Nahuel Luján (LW)', 'Diego Campos (GK)', 'Ronal Huaccha (ST)'], description: 'Liga 1 Te Apuesto.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'sport_boys', name: 'Sport Boys', league: 'Peruana', dt: 'DT Genérico', reputation: 2, initialSalary: 1000, marketValue: 3500000, starPlayers: ['Carlos Zambrano (CB)', 'Miguel Trauco (LB)', 'Diego Melián (GK)', 'Luis Urruti (LW)', 'Carlos López (RW)', 'Jostin Alarcón (LW)', 'Oslimg Mora (RB)', 'Luciano Nequecaur (ST)', 'Renzo Alfani (CB)'], description: 'Liga 1 Te Apuesto.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/sport_boys.png', division: 1 },
  { id: 'utc', name: 'UTC', league: 'Peruana', dt: 'DT Genérico', reputation: 2, initialSalary: 1000, marketValue: 3500000, starPlayers: ['Marcos Lliuya (CAM)', 'Ángelo Campos (GK)', 'Luis Garro (RB)', 'Adolfo Muñoz (LW)', 'David Camacho (RW)', 'Marlon de Jesús (ST)', 'Luis Arce (CDM)', 'Arquímedes Figuera (CDM)', 'Ignacio Barrios (GK)', 'David Dioses (CDM)'], description: 'Liga 1 Te Apuesto.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/utc.png', division: 1 },
  { id: 'atlético_grau', name: 'Atlético Grau', league: 'Peruana', dt: 'DT Genérico', reputation: 2, initialSalary: 1000, marketValue: 3500000, starPlayers: ['Raúl Ruidíaz (ST)', 'Patricio Álvarez (GK)', 'Rodrigo Tapia (CB)', 'Freddy Oncoy (CM)', 'Rafael Guarderas (CDM)', 'Elsar Rodas (LB)', 'Nicolás Delgadillo (LW)', 'Paulo de la Cruz (RW)', 'Lucas Acevedo (CB)', 'Diego Barreto (CAM)'], description: 'Liga 1 Te Apuesto.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/atlético_grau.png', division: 1 },
  { id: 'cusco_fc', name: 'Cusco FC', league: 'Peruana', dt: 'DT Genérico', reputation: 2, initialSalary: 1000, marketValue: 3500000, starPlayers: ['Iván Colman (CAM)', 'Andy Vidal (GK)', 'Lucas Colitto (LW)', 'Nicolás Silva (RW)', 'Facundo Callejo (ST)', 'Miguel Aucca (CM)', 'Oswaldo Valenzuela (CDM)', 'Juan Manuel Tévez (ST)', 'Aldair Fuentes (CB)', 'José Bolívar (LB)'], description: 'Liga 1 Te Apuesto.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/cusco_fc.png', division: 1 },
  { id: 'cienciano', name: 'Cienciano', league: 'Peruana', dt: 'DT Genérico', reputation: 2, initialSalary: 1000, marketValue: 3500000, starPlayers: ['Alejandro Hohberg (LW)', 'Carlos Garcés (ST)', 'Claudio Nuñez (CB)', 'Neri Bandiera (ST)', 'Juan Romagnoli (RW)', 'Ray Sandoval (LW)', 'Gonzalo Falcón (GK)', 'Ítalo Espinoza (GK)', 'Kevin Becerra (CB)', 'Ademar Robles (CM)', 'Maximiliano Amondarain (CB)'], description: 'Liga 1 Te Apuesto.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/cienciano.png', division: 1 },
  { id: 'los_chankas', name: 'Los Chankas', league: 'Peruana', dt: 'DT Genérico', reputation: 2, initialSalary: 1000, marketValue: 3500000, starPlayers: ['Franco Saravia (GK)', 'Carlos Pimienta (CB)', 'Jarlín Quintero (ST)', 'Kelvin Sánchez (CDM)', 'Abdiel Ayarza (CM)', 'Héctor González (CB)', 'Ayrthon Quintana (LB)', 'Kenyi Barrios (RW)', 'Gonzalo Rizzo (CB)', 'Marlon Junior Torres (RW)'], description: 'Liga 1 Te Apuesto.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/los_chankas.png', division: 1 },
  { id: 'comerciantes_unidos', name: 'Comerciantes Unidos', league: 'Peruana', dt: 'DT Genérico', reputation: 2, initialSalary: 1000, marketValue: 3500000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Liga 1 Te Apuesto.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/comerciantes_unidos.png', division: 1 },
  { id: 'atlético_sullana', name: 'Atlético Sullana', league: 'Peruana', dt: 'DT Genérico', reputation: 2, initialSalary: 1000, marketValue: 3500000, starPlayers: ['José Carlos Villegas (CB)', 'Cristian Penilla (LW)', 'Sergio Quiroga (CAM)', 'Erick Perleche (RB)', 'Jesús Mendieta (LB)', 'Daniel Prieto (GK)', 'Anthony Gordillo (LB)', 'German Díaz (CAM)', 'Franco Coronel (ST)', 'Juan Jesús Quiñones (CB)', 'Éder Hermoza (GK)'], description: 'Liga 1 Te Apuesto.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeImageUrl: 'badges/clubs/atlético_sullana.png', badgeLogoUrl: '⚽', division: 1 },
  { id: 'juan_pablo_ii', name: 'Juan Pablo II', league: 'Peruana', dt: 'DT Genérico', reputation: 2, initialSalary: 1000, marketValue: 3500000, starPlayers: ['Cristian García (CDM)', 'Cristhian Tizón (LW)', 'Paolo Fuentes (CB)', 'Martín Alaníz (LW)', 'Jack Durán (RW)', 'Erinson Ramírez (CAM)', 'Gustavo Aliaga (CM)', 'Jorge Toledo (RB)', 'Maximiliano Juambeltz (ST)', 'Adán Henricks (ST)'], description: 'Liga 1 Te Apuesto.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/juan_pablo_ii.png', division: 1 },
  { id: 'fc_cajamarca', name: 'FC Cajamarca', league: 'Peruana', dt: 'DT Genérico', reputation: 2, initialSalary: 1000, marketValue: 3500000, starPlayers: ['Brandon Palacios (LW)', 'Enmanuel Páucar (CDM)', 'Nilson Loyola (LB)', 'Jonathan Betancourt (LW)', 'Tomás Andrade (CAM)', 'Jefferson Orejuela (CDM)'], description: 'Liga 1 Te Apuesto.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/fc_cajamarca.png', division: 1 },
  ...
  { id: 'alianza_udh', name: 'Alianza Universidad', league: 'Peruana', dt: 'DT Genérico', reputation: 2, initialSalary: 900, marketValue: 2500000, starPlayers: ['Carlos Mosquera (GK)', 'Keyvin Paico (CDM)', 'Juan Carlos Gonzáles (LW)', 'Abel Casquete (RW)', 'Carlos Montoya (CB)', 'Anghelo Flores (CB)', 'Orlando Cúneo (LB)', 'Rudy Palomino (CDM)', 'Jorginho Sernaqué (CM)', 'Jhojan Domínguez (LW)', 'Fernando Leguía (RW)'], description: 'Liga 1 Te Apuesto.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 1 },

  // ==========================================
  // --- ECUADOR (LIGA PRO A Y B) ---
  // ==========================================
  { id: 'ldu_quito', name: 'LDU Quito', league: 'Ecuatoriana', dt: 'Vitamina Sánchez', reputation: 4, initialSalary: 2300, marketValue: 16500000, starPlayers: ['Gonzalo Valle (GK)', 'Ricardo Adé (CB)', 'Deyverson (ST)', 'Fernando Cornejo (CM)', 'Leonel Quiñonez (LB)', 'Alexander Domínguez (GK)', 'Janner Corozo (RW)', 'Luis Segovia (CB)', 'José Quintero (RB)'], description: 'El Rey de Copas.', badgeColor: 'border-l-4 border-gray-100 bg-slate-900 text-white', badgeLogoUrl: '⚪',
  ...
  { id: 'emelec', name: 'Emelec', league: 'Ecuatoriana', dt: 'Hernán Torres', reputation: 3, initialSalary: 1800, marketValue: 10000000, starPlayers: ['Pedro Ortíz', 'Luis Fernando León', 'Cristhian Noboa', 'Facundo Castelli'], description: 'El Bombillo.', badgeColor: 'border-l-4 border-gray-300 bg-blue-800 text-white', badgeLogoUrl: '💡',
    badgeImageUrl: 'badges/clubs/emelec.png', division: 1 },
  ...
  { id: 'delfín', name: 'Delfín', league: 'Ecuatoriana', dt: 'DT Genérico', reputation: 2, initialSalary: 1200, marketValue: 5000000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Liga Pro Serie A.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/delfín.png', division: 1 },
  { id: 'deportivo_cuenca', name: 'Deportivo Cuenca', league: 'Ecuatoriana', dt: 'DT Genérico', reputation: 2, initialSalary: 1200, marketValue: 5000000, starPlayers: ['Lucas Mancinelli (RW)', 'Carlos Arboleda (LW)', 'Edison Vega (CDM)', 'Mateo Maccari (CDM)', 'Romario Ibarra (LW)', 'Jorge Ordóñez (RW)', 'Patricio Boolsen (CB)', 'David Noboa (CDM)'], description: 'Liga Pro Serie A.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'universidad_católica_ecu', name: 'Universidad Católica de Quito', league: 'Ecuatoriana', dt: 'DT Genérico', reputation: 2, initialSalary: 1200, marketValue: 5000000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Liga Pro Serie A.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/universidad_católica_ecu.png', division: 1 },
  { id: 'mushuc_runa', name: 'Mushuc Runa', league: 'Ecuatoriana', dt: 'DT Genérico', reputation: 2, initialSalary: 1200, marketValue: 5000000, starPlayers: ['Facundo Castelli (ST)', 'Renato Ibarra (RW)', 'Rodrigo Formento (GK)', 'José Hernández (LB)', 'Tomson Minda (RW)', 'Manuel Gamboa (CB)', 'Adonnis Pabón (GK)'], description: 'Liga Pro Serie A.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/mushuc_runa.png', division: 1 },
  { id: 'macará', name: 'Macará', league: 'Ecuatoriana', dt: 'DT Genérico', reputation: 2, initialSalary: 1200, marketValue: 5000000, starPlayers: ['José Luis Marrufo (CB)', 'Federico Paz (ST)', 'José Luis Cazares (CDM)', 'Gastón Blanc (CM)', 'Jean Carlos Estacio (CDM)', 'Denilson Bolaños (RB)', 'Santiago Etchebarne (CB)', 'Luis Ayala (LB)', 'Franco Posse (ST)', 'Marlon Medranda (LB)'], description: 'Liga Pro Serie A.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/macará.png', division: 1 },
  { id: 'aucas', name: 'Aucas', league: 'Ecuatoriana', dt: 'DT Genérico', reputation: 2, initialSalary: 1200, marketValue: 5000000, starPlayers: ['Hamilton Piedra (GK)', 'Ayrton Preciado (LW)', 'Stiven Tapiero (CDM)', 'John Ontaneda (CB)', 'Romario Bolaños (LM)', 'Luis Arroyo (CAM)', 'Danny Luna (LW)', 'Luis Gustavino (CB)'], description: 'Liga Pro Serie A.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/aucas.png', division: 1 },
  { id: 'orense', name: 'Orense', league: 'Ecuatoriana', dt: 'DT Genérico', reputation: 2, initialSalary: 1200, marketValue: 5000000, starPlayers: ['Ángel Mena (RW)', 'Valentín Burgoa (CAM)', 'Erick Plúas (CDM)', 'Stefano Callegari (CB)', 'Diego Armas (CAM)', 'Nixon Molina (CDM)', 'Rolando Silva (GK)', 'Renny Jaramillo (CDM)', 'Alan Lorenzo (CB)'], description: 'Liga Pro Serie A.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/orense.png', division: 1 },
  { id: 'libertad_fc', name: 'Libertad FC', league: 'Ecuatoriana', dt: 'DT Genérico', reputation: 2, initialSalary: 1200, marketValue: 5000000, starPlayers: ['David Cabezas (GK)', 'Gabriel Cortez (CAM)', 'Vilington Branda (RW)', 'Jhon Jairo Cifuente (ST)'], description: 'Liga Pro Serie A.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/libertad_fc.png', division: 1 },
  { id: 'manta_fc', name: 'Manta FC', league: 'Ecuatoriana', dt: 'DT Genérico', reputation: 2, initialSalary: 1200, marketValue: 5000000, starPlayers: ['Jean Carlos Blanco (ST)', 'Glendys Mina (LB)', 'Robert Burbano (RW)'], description: 'Liga Pro Serie A.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/manta_fc.png', division: 1 },
  { id: 'leones_fc_ecu', name: 'Leones FC de Ecuador', league: 'Ecuatoriana', dt: 'DT Genérico', reputation: 2, initialSalary: 1200, marketValue: 5000000, starPlayers: ['Juan Luis Anangonó (ST)', 'Segundo Portocarrero (LM)', 'Charles Vélez (CDM)', 'Kevin Mina (ST)', 'José Angulo (GK)', 'Herlin Lino (ST)', 'Leonel Nazareno (GK)', 'Elian Pepinos (CM)', 'Mauro Luque (RB)', 'Darío Pazmiño (CAM)'], description: 'Liga Pro Serie A.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeImageUrl: 'badges/clubs/leones_fc_ecu.png', badgeLogoUrl: '⚽', division: 1 },
  { id: 'guayaquil_city', name: 'Guayaquil City', league: 'Ecuatoriana', dt: 'DT Genérico', reputation: 2, initialSalary: 1200, marketValue: 5000000, starPlayers: ['Esnáider Cabezas (CB)', 'Dixon Arroyo (CDM)', 'Pablo González (CAM)', 'Junior Ayoví (RB)', 'Edinson Mero (RW)', 'Stalin Caicedo (LW)', 'Anderson Naula (ST)', 'Rodrigo Perea (GK)'], description: 'Liga Pro Serie A.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeImageUrl: 'badges/clubs/guayaquil_city.png', badgeLogoUrl: '⚽', division: 1 },
  { id: 'vinotinto_fc', name: 'Vinotinto FC', league: 'Ecuatoriana', dt: 'DT Genérico', reputation: 1, initialSalary: 700, marketValue: 2000000, starPlayers: ['Lisandro Mitre (GK)', 'Juan Pablo Segovia (CB)', 'Patricio Vargas (ST)', 'Andrés Oña (CDM)', 'Horacio García (CAM)', 'Edison Hernández (CB)', 'Kevin Coba (LB)', 'Edwin Rodríguez (RB)', 'Maximiliano Gatani (CM)', 'Leandro Lucero (CB)', 'Juan Frías (CDM)'], description: 'Liga Pro Serie B.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'gualaceo', name: 'Gualaceo', league: 'Ecuatoriana', dt: 'DT Genérico', reputation: 1, initialSalary: 700, marketValue: 2000000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Liga Pro Serie B.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/gualaceo.png', division: 2 },
  ...
  { id: 'san_antonio', name: 'San Antonio', league: 'Ecuatoriana', dt: 'DT Genérico', reputation: 1, initialSalary: 700, marketValue: 2000000, starPlayers: ['Ramiro Ballivián (RB)', 'Adalid Terrazas (CAM)', 'Luca Giossa (GK)', 'Cristhian Machado (CDM)', 'Huberth Sánchez (CB)', 'Saulo Guerra (RM)', 'Ronald Bustos (RB)'], description: 'Liga Pro Serie B.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/tm/san_antonio.png', division: 2 },
  { id: 'cumbayá', name: 'Cumbayá', league: 'Ecuatoriana', dt: 'DT Genérico', reputation: 1, initialSalary: 700, marketValue: 2000000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Liga Pro Serie B.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeImageUrl: 'badges/clubs/cumbayá.png', badgeLogoUrl: '⚽', division: 2 },
  ...
  { id: 'atlético_fc', name: 'Atlético FC', league: 'Ecuatoriana', dt: 'Andrés Sicachá', reputation: 1, initialSalary: 700, marketValue: 2000000, starPlayers: ['Jean Humanante (CDM)', 'Jairo Mairongo (ST)', 'Daniel Mejia (CM)', 'Carlos Arroyo (ST)', 'Joseph Espinoza (CDM)', 'Denilson Ovando (RW)', 'John Mero (GK)', 'Carlos Micolta (CB)', 'Jacson Pita (ST)', 'Jhonnier Estrada (CB)', 'Ramiro Ríos (CB)'], description: 'Liga Pro Serie B.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 1 },
  ...
  { id: '22_de_julio', name: '22 de Julio', league: 'Ecuatoriana', dt: 'DT Genérico', reputation: 1, initialSalary: 700, marketValue: 2000000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Liga Pro Serie B.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeImageUrl: 'badges/clubs/22_de_julio.png', badgeLogoUrl: '⚽', division: 2 },
  { id: 'cuenca_jrs', name: 'Cuenca Jrs', league: 'Ecuatoriana', dt: 'DT Genérico', reputation: 1, initialSalary: 700, marketValue: 2000000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Liga Pro Serie B.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeImageUrl: 'badges/clubs/cuenca_jrs.png', badgeLogoUrl: '⚽', division: 2 },
  { id: 'ldup', name: 'LDUP', league: 'Ecuatoriana', dt: 'DT Genérico', reputation: 1, initialSalary: 700, marketValue: 2000000, starPlayers: ['Ángel Gracia (LB)', 'Manuel Mendoza (GK)', 'Jordan Ponguillo (CB)', 'Pablo Cifuentes (CB)', 'Edison Caicedo (CDM)', 'Richard Sánchez (CAM)', 'Jeison Mina (CB)', 'Efrén Proaño (CB)', 'Jairon Bonett (RM)', 'César Espínola (ST)'], description: 'Liga Pro Serie B.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeImageUrl: 'badges/clubs/ldup.png', badgeLogoUrl: '⚽', division: 2 },
  // ==========================================
  // --- LIGA BOLIVIANA ---
  // ==========================================
  {
    ...
    badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/real_tomayapo.png',
    division: 1
  },
  {
    ...
    badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white',
    badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/universitario_de_vinto.png',
    division: 1
  },
  {
    id: 'bolívar',
    ...
    badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white',
    badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/bolívar.png',
    division: 1
  },
  {
    id: 'the_strongest',
    ...
    badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white',
    badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/the_strongest.png',
    division: 1
  },
  {
    id: 'real_potosí',
    ...
    description: 'Equipo compitiendo en Liga Boliviana.',
    badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white',
    badgeImageUrl: 'badges/clubs/real_potosí.png', badgeLogoUrl: '⚽',
    division: 1
  },
  {
    id: 'nacional_potosí',
    ...
    badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white',
    badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/nacional_potosí.png',
    division: 1
  },
  {
    id: 'always_ready',
    ...
    badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white',
    badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/always_ready.png',
    division: 1
  },
  {
    ...
    badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white',
    badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/independiente_petrolero.png',
    division: 1
  },
  {
    id: 'blooming',
    ...
    badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white',
    badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/blooming.png',
    division: 1
  },
  {
    id: 'aurora',
    ...
    badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white',
    badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/aurora.png',
    division: 1
  },
  {
  ...
  },
  {
    ...
    badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white',
    badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/san_antonio_bulo_bulo.png',
    division: 1
  },
  {
    id: 'guabirá',
    ...
    badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white',
    badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/guabirá.png',
    division: 1
  },
  {
    ...
    badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white',
    badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/oriente_petrolero.png',
    division: 1
  },
  {
    id: 'real_oruro',
    ...
    badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white',
    badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/real_oruro.png',
    division: 1
  },
  {
    id: 'club_abb',
    ...
    badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white',
    badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/club_abb.png',
    division: 1
  },
  ...
  // ==========================================
  {
    ...
    badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white',
    badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/sportivo_luqueño.png',
    division: 1
  },
  {
    id: 'libertad',
    ...
    badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white',
    badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/libertad.png',
    division: 1
  },
  {
    id: 'olimpia',
    ...
    badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white',
    badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/olimpia.png',
    division: 1
  },
  {
    id: 'cerro_porteño',
    ...
    badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white',
    badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/cerro_porteño.png',
    division: 1
  },
  {
    id: 'guaraní',
    ...
    badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white',
    badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/guaraní.png',
    division: 1
  },
  {
    ...
    badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white',
    badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/sportivo_ameliano.png',
    division: 1
  },
  {
    id: 'nacional_paraguay',
    name: 'Nacional de Asunción',
    league: 'Paraguaya',
    dt: 'Director Técnico',
    reputation: 2,
    initialSalary: 1100,
    ...
    badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white',
    badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/nacional_paraguay.png',
    division: 1
  },
  {
    ...
    badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white',
    badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/sportivo_trinidense.png',
    division: 1
  },
  {
    id: '2_de_mayo',
    ...
    badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white',
    badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/2_de_mayo.png',
    division: 1
  },
  {
    id: 'recoleta',
  ...
  },
  {
    ...
    badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white',
    badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/tm/rubio_ñu.png',
    division: 1
  },
  {
    ...
    badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white',
    badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/tm/sportivo_san_lorenzo.png',
    division: 1
  },
  ...
  // ==========================================
  {
    ...
    badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white',
    badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/carabobo_fc.png',
    division: 1
  },
  {
    id: 'rayo_zuliano',
    ...
    badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white',
    badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/rayo_zuliano.png',
    division: 1
  },
  {
    id: 'caracas_fc',
    ...
    badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white',
    badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/caracas_fc.png',
    division: 1
  },
  {
    ...
    badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white',
    badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/deportivo_táchira.png',
    division: 1
  },
  {
    ...
    badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white',
    badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/metropolitanos_fc.png',
    division: 1
  },
  {
    ...
    badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white',
    badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/tm/deportivo_la_guaira.png',
    division: 1
  },
  {
    ...
    badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white',
    badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/academia_puerto_cabello.png',
    division: 1
  },
  {
    id: 'monagas_sc',
    ...
    badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white',
    badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/monagas_sc.png',
    division: 1
  },
  {
    ...
    badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white',
    badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/tm/universidad_central.png',
    division: 1
  },
  {
    ...
    badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white',
    badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/estudiantes_de_mérida.png',
    division: 1
  },
  {
    id: 'portuguesa_fc',
    ...
    badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white',
    badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/portuguesa_fc.png',
    division: 1
  },
  {
  ...
  },
  {
    ...
    badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white',
    badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/zamora_fc.png',
    division: 1
  },
  {
    id: 'trujillanos',
    ...
    description: 'Equipo compitiendo en Liga Venezolana.',
    badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white',
    badgeImageUrl: 'badges/clubs/trujillanos.png', badgeLogoUrl: '⚽',
    division: 1
  },
  ...
  // ==========================================
  {
    ...
    initialSalary: 1500,
    marketValue: 5000000,
    starPlayers: ['Emanuel Hernández (CB)', 'Edrick Menjívar (GK)', 'Jorge Álvarez (CDM)', 'Edwin Rodríguez (RW)', 'Raul García (CDM)', 'Kevin Güity (RB)', 'Edwin Lobo (RB)', 'Michaell Chirinos (RW)', 'Jorge Benguché (ST)', 'Clinton Bennett (CB)', 'Jack Jean-Baptiste (CDM)'],
    description: 'Equipo compitiendo en Resto del Mundo.',
    badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white',
    badgeImageUrl: 'badges/clubs/olimpia_h.png', badgeLogoUrl: '⚽',
    division: 1
  },
  {
    id: 'motagua',
    ...
    description: 'Equipo compitiendo en Resto del Mundo.',
    badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white',
    badgeImageUrl: 'badges/clubs/motagua.png', badgeLogoUrl: '⚽',
    division: 1
  },
  {
    id: 'saprissa',
  ...
  },
  {
    ...
    initialSalary: 1500,
    marketValue: 5000000,
    starPlayers: ['Joel Campbell (CAM)', 'Jeison Lucumí (LW)', 'Celso Borges (CM)', 'Ángel Zaldívar (ST)', 'Washington Ortega (GK)', 'Ronald Matarrita (LB)', 'Alexis Gamboa (CB)', 'Ronaldo Cisneros (ST)', 'Malcom Pilone (CM)', 'Elián Quesada (LB)', 'Anthony Hernández (RW)'],
    description: 'Equipo compitiendo en Resto del Mundo.',
    badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white',
    badgeLogoUrl: '⚽',
  ...
  },
  {
    ...
    initialSalary: 1500,
    marketValue: 5000000,
    starPlayers: ['Elías Aguilar (CAM)', 'Marcel Hernández (ST)', 'Yeltsin Tejeda (CDM)', 'Ronaldo Araya (LW)', 'Keysher Fuller (RW)', 'Everardo Rubio (CB)', 'Randall Leal (LW)', 'Dany Carvajal (GK)', 'José González (ST)', 'Jurguens Montenegro (ST)', 'Allan Cruz (CM)'],
    description: 'Equipo compitiendo en Resto del Mundo.',
    badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white',
    badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/tm/herediano.png',
    division: 1
  },
  {
  ...
  },
  {
    ...
    description: 'Equipo compitiendo en Resto del Mundo.',
    badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white',
    badgeImageUrl: 'badges/clubs/real_estelí.png', badgeLogoUrl: '⚽',
    division: 1
  },
  {
    id: 'al_ahly',
    ...
    badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white',
    badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/tm/al_ahly.png',
    division: 1
  },
  {
    ...
    initialSalary: 1500,
    marketValue: 5000000,
    starPlayers: ['Shoya Nakajima (CAM)', 'Samuel Gustafson (CDM)', 'Ado Onaiwu (ST)', 'Danilo Boza (CB)', 'Isaac Kiese Thelin (ST)', 'Takuro Kaneko (RW)', 'Shusaku Nishikawa (GK)', 'Kai Shibato (CDM)', 'Takuya Ogiwara (LB)', 'Takahiro Sekine (LM)', 'Yusuke Matsuo (LW)'],
    description: 'Equipo compitiendo en Resto del Mundo.',
    badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white',
    badgeLogoUrl: '⚽',
  ...
  },
  {
    ...
    description: 'Equipo compitiendo en Resto del Mundo.',
    badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white',
    badgeImageUrl: 'badges/clubs/auckland_city.png', badgeLogoUrl: '⚽',
    division: 1
  },
  {
    id: 'espérance',
  ...
  },
  {
    ...
    initialSalary: 1500,
    marketValue: 5000000,
    starPlayers: ['Wissam Ben Yedder (ST)', 'Hakim Ziyech (RW)', 'El Mehdi Benabid (GK)', 'Hamza Hannouri (ST)', 'Ramiro Vaca (CAM)', 'Hamza Sakhi (CAM)', 'Ayoub Boucheta (LB)', 'Mohamed Rayhi (LW)', 'Naïm Byar (CM)', 'Amine Aboulfath (CB)', 'Walid Sabbar (CM)'],
    description: 'Equipo compitiendo en Resto del Mundo.',
    badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white',
    badgeLogoUrl: '⚽',
  ...
  },
  {
    ...
    initialSalary: 1500,
    marketValue: 5000000,
    starPlayers: ['Gonzalo Castillo (CB)', 'Cristian Chávez (CAM)', 'Arnaldo Giménez (GK)', 'Sergio Adrián (CM)', 'Lucas Salinas (GK)', 'Luis Rodríguez (LB)', 'Claudio Ancieta (ST)', 'Santiago Zotes (GK)', 'Matias Delgadillo (RB)', 'Wilder Soto (ST)', 'Andy Velásquez (CM)'],
    description: 'Equipo compitiendo en Resto del Mundo.',
    badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white',
    badgeLogoUrl: '⚽',
  ...
  },
  {
    ...
    initialSalary: 1500,
    marketValue: 5000000,
    starPlayers: ['Carlos Muñoz (ST)', 'Marcelo Jorquera (LB)', 'Fernando Manríquez (CM)', 'Tomás Asprea (RM)', 'Wladimir Cid (ST)', 'Diego Cerón (CB)', 'Douglas Estay (CB)', 'Alejandro Arana (GK)', 'Matías Coronado (LW)', 'Gonzalo Santelices (CB)', 'Bryan Taiva (ST)'],
    description: 'Equipo compitiendo en Resto del Mundo.',
    badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white',
    badgeImageUrl: 'badges/clubs/santiago_morning.png', badgeLogoUrl: '⚽',
    division: 1
  },
  {
    id: 'imbabura',
    ...
    description: 'Equipo compitiendo en Resto del Mundo.',
    badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white',
    badgeImageUrl: 'badges/clubs/imbabura.png', badgeLogoUrl: '⚽',
    division: 1
  },
  {
    id: 'chacaritas',
    ...
    description: 'Equipo compitiendo en Resto del Mundo.',
    badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white',
    badgeImageUrl: 'badges/clubs/chacaritas.png', badgeLogoUrl: '⚽',
    division: 1
  },
  {
    ...
    initialSalary: 1500,
    marketValue: 5000000,
    starPlayers: ['Darío Lezcano (ST)', 'Pablo Adorno (CB)', 'Willian Candia (CM)', 'Víctor Barrios (RB)', 'Rodrigo Izquierdo (RB)', 'Edgar Ferreira (CDM)', 'Jorge Chena (GK)', 'Wildo Alonso (LB)', 'Lucas Guiñazú (CDM)', 'Cristian Mercado (CM)', 'Juan Francisco Esteche (RW)'],
    description: 'Equipo compitiendo en Resto del Mundo.',
    badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white',
    badgeLogoUrl: '⚽',
  ...
  },
  {
    ...
    initialSalary: 1500,
    marketValue: 5000000,
    starPlayers: ['Tales (GK)', 'Manuel Romero (CB)', 'Pablo Vargas (GK)', 'Carlos Urán (GK)', 'Tobías Castellano (CB)', 'Junior Cantero (CB)', 'Gabriel Molinas (LB)', 'Jesús Barrios (LB)', 'Miller Mareco (RB)', 'Erik Mareco (RB)', 'José Vera (CDM)'],
    description: 'Equipo compitiendo en Resto del Mundo.',
    badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white',
    badgeLogoUrl: '⚽',
  ...
  },
  {
    ...
    description: 'Equipo compitiendo en Resto del Mundo.',
    badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white',
    badgeImageUrl: 'badges/clubs/alianza_universidad.png', badgeLogoUrl: '⚽',
    division: 1
  },
  {
    id: 'ayacucho_fc',
    ...
    description: 'Equipo compitiendo en Resto del Mundo.',
    badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white',
    badgeImageUrl: 'badges/clubs/ayacucho_fc.png', badgeLogoUrl: '⚽',
    division: 1
  },
  {
    id: 'plaza_colonia',
  ...
  },
  {
    ...
    initialSalary: 1500,
    marketValue: 5000000,
    starPlayers: ['Gabriel Costa (RW)', 'Maximiliano Perg (CB)', 'Carlos Rodríguez (CB)', 'Rodrigo Rodríguez (RM)', 'Diego Vera (ST)', 'Diego Sánchez (LW)', 'Rodrigo Hernández (ST)', 'Vitinho (ST)', 'Alejandro García (CM)', 'Maximiliano Burruzo (ST)', 'Felipe Chiappini (CM)'],
    description: 'Equipo compitiendo en Resto del Mundo.',
    badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white',
    badgeLogoUrl: '⚽',
  ...
  { id: 'fc_st_pauli', themeColor: { primary: '#92400e', secondary: '#f5f0e8' }, name: 'FC St. Pauli', league: 'Alemana', dt: 'Marcel Rapp', reputation: 4, initialSalary: 2000, marketValue: 37700000, starPlayers: ['Nikola Vasilj (GK)', 'Eric Smith (CB)', 'Jackson Irvine (CM)', 'Mathias Rasmussen (CM)', 'Mathias Pereira Lage (ST)', 'Joel Chima Fujita (CM)', 'Martijn Kaars (ST)'], description: 'FC St. Pauli. Compite en Bundesliga.', badgeColor: 'border-l-4 border-amber-800 bg-zinc-950/40 text-amber-200', badgeLogoUrl: '🟤⚪',
  ...
  { id: 'rb_leipzig', themeColor: { primary: '#ef4444', secondary: '#f5f0e8' }, name: 'RB Leipzig', league: 'Alemana', dt: 'Martín Demichelis', reputation: 5, initialSalary: 97200, marketValue: 505550000, starPlayers: ['Willi Orban (CB)', 'David Raum (LB)', 'Castello Lukeba (CB)', 'Christoph Baumgartner (CAM)', 'Benjamin Henrichs (RB)', 'Ridle Baku (RB)', 'Nicolas Seiwald (CDM)', 'Rômulo (ST)', 'Antonio Nusa (LW)'], description: 'RB Leipzig. Compite en Bundesliga.', badgeColor: 'border-l-4 border-red-500 bg-slate-900/40 text-red-200', badgeLogoUrl: '🔴⚪',
    badgeImageUrl: 'badges/clubs/rb_leipzig.png', division: 1 },
  { id: 'sc_freiburg', themeColor: { primary: '#dc2626', secondary: '#f5f0e8' }, name: 'SC Freiburg', league: 'Alemana', dt: 'Julian Schuster', reputation: 4, initialSalary: 24100, marketValue: 188625000, starPlayers: ['Matthias Ginter (CB)', 'Vincenzo Grifo (LM)', 'Philipp Lienhart (CB)', 'Christian Günter (LB)', 'Maximilian Eggestein (CDM)', 'Jan-Niklas Beste (RM)', 'Lukas Kübler (RB)', 'Philipp Treu (RB)', 'Yuito Suzuki (CAM)'], description: 'SC Freiburg. Compite en Bundesliga.', badgeColor: 'border-l-4 border-red-600 bg-zinc-950/40 text-red-200', badgeLogoUrl: '🔴⚫',
  ...
  { id: 'vfl_wolfsburg', themeColor: { primary: '#22c55e', secondary: '#f5f0e8' }, name: 'VfL Wolfsburg', league: 'Alemana', dt: 'Tobias Strobl', reputation: 4, initialSalary: 55400, marketValue: 230625000, starPlayers: ['Maximilian Arnold (CDM)', 'Joakim Mæhle (LB)', 'Lovro Majer (CAM)', 'Moritz Jenz (CB)', 'Christian Eriksen (CAM)', 'Mattias Svanberg (CM)'], description: 'VfL Wolfsburg. Compite en Bundesliga.', badgeColor: 'border-l-4 border-green-500 bg-green-950/40 text-green-200', badgeLogoUrl: '🟢⚪',
  ...
  { id: 'vfb_stuttgart', themeColor: { primary: '#dc2626', secondary: '#f5f0e8' }, name: 'VfB Stuttgart', league: 'Alemana', dt: 'Sebastian Hoenss', reputation: 4, initialSalary: 32600, marketValue: 355725000, starPlayers: ['Maximilian Mittelstädt (LB)', 'Angelo Stiller (CDM)', 'Deniz Undav (ST)', 'Julian Chabot (CB)', 'Ermedin Demirović (ST)', 'Jamie Leweling (RM)', 'Atakan Karazor (CDM)', 'Chris Führich (LM)', 'Tiago Tomás (LM)'], description: 'VfB Stuttgart. Compite en Bundesliga.', badgeColor: 'border-l-4 border-red-600 bg-slate-900/40 text-red-200', badgeLogoUrl: '🔴⚪',
  ...
  { id: 'bayer_leverkusen', themeColor: { primary: '#dc2626', secondary: '#f5f0e8' }, name: 'Bayer 04 Leverkusen', league: 'Alemana', dt: 'Carles Martínez', reputation: 5, initialSalary: 67800, marketValue: 352750000, starPlayers: ['Edmond Tapsoba (CB)', 'Patrik Schick (ST)', 'Aleix García (CM)', 'Jarell Quansah (CB)', 'Malik Tillman (CAM)', 'Robert Andrich (CB)', 'Martin Terrier (CAM)', 'Ibrahim Maza (CAM)', 'Nathan Tella (RM)', 'Loïc Badé (CB)'], description: 'Bayer 04 Leverkusen. Compite en Bundesliga, tras las salidas de Alejandro Grimaldo (Atlético de Madrid) y Jonathan Tah (Bayern Múnich).', badgeColor: 'border-l-4 border-red-600 bg-zinc-950/40 text-red-300', badgeLogoUrl: '🔴⚫',
    badgeImageUrl: 'badges/clubs/bayer_leverkusen.png', division: 1 },
  { id: 'hamburg', themeColor: { primary: '#1d4ed8', secondary: '#f5f0e8' }, name: 'Hamburger SV', league: 'Alemana', dt: 'Merlin Polzin', reputation: 4, initialSalary: 2000, marketValue: 91325000, starPlayers: ['Luka Vušković (CB)', 'Daniel Heuer Fernandes (GK)', 'Albert Sambi Lokonga (CM)', 'Miro Muheim (LB)', 'Jordan Torunarigha (CB)', 'Albert Grønbæk (CAM)', 'Nicolai Remberg (CM)'], description: 'Hamburger SV. Compite en Bundesliga.', badgeColor: 'border-l-4 border-blue-700 bg-zinc-950/40 text-blue-200', badgeLogoUrl: '🔵⚫',
  ...
  // --- ALEMANIA (SEGUNDA) ---
  // ==========================================
  { id: '1_fc_kaiserslautern', themeColor: { primary: '#dc2626', secondary: '#f5f0e8' }, name: '1. FC Kaiserslautern', league: 'Alemana', dt: 'Torsten Lieberknecht', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Mergim Berisha (ST)', 'Naatan Skyttä (CAM)', 'Paul Joly (RB)', 'Semih Sahin (CDM)', 'Julian Krahl (GK)', 'Fabian Kunze (CDM)', 'Marlon Ritter (CAM)', 'Jacob Rasmussen (CB)', 'Ivan Prtajin (ST)'], description: '1. FC Kaiserslautern. Compite en Bundesliga 2.', badgeColor: 'border-l-4 border-red-600 bg-red-950/40 text-red-200', badgeLogoUrl: '🔴⚪',
    badgeImageUrl: 'badges/clubs/1_fc_kaiserslautern.png', division: 2 },
  { id: '1_fc_nurnberg', themeColor: { primary: '#991b1b', secondary: '#f5f0e8' }, name: '1. FC Nürnberg', league: 'Alemana', dt: 'Miroslav Klose', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Julian Justvan (CAM)', 'Finn Ole Becker (CM)', 'Rabby Nzingoula (CDM)', 'Jan Reichert (GK)', 'Berkay Yilmaz (LB)', 'Adam Markhiev (CDM)', 'Rafael Lubach (CM)', 'Mohamed Alì Zoma (ST)', 'Henri Koudossou (RB)'], description: '1. FC Nürnberg. Compite en Bundesliga 2.', badgeColor: 'border-l-4 border-red-800 bg-zinc-950/40 text-red-200', badgeLogoUrl: '🔴⚪',
  ...
  { id: 'hannover_96', themeColor: { primary: '#16a34a', secondary: '#f5f0e8' }, name: 'Hannover 96', league: 'Alemana', dt: 'Christian Titz', reputation: 2, initialSalary: 800, marketValue: 13950000, starPlayers: ['Enzo Leopold (CM)', 'Benjamin Källman (ST)', 'Boris Tomiak (CB)', 'Maurice Neubauer (LB)', 'Elias Saad (LW)', 'Noah Weißhaupt (LM)', 'Virgil Ghiță (CB)', 'Maik Nawrocki (CB)', 'Mustapha Bundu (RW)'], description: 'Hannover 96. Compite en Bundesliga 2.', badgeColor: 'border-l-4 border-green-600 bg-zinc-950/40 text-green-200', badgeLogoUrl: '🟢⚫',
    badgeImageUrl: 'badges/clubs/hannover_96.png', division: 2 },
  { id: 'hertha_bsc', themeColor: { primary: '#2563eb', secondary: '#f5f0e8' }, name: 'Hertha BSC', league: 'Alemana', dt: 'Stefan Leitl', reputation: 2, initialSalary: 26400, marketValue: 22885000, starPlayers: ['Josip Brekalo (LM)', 'Paul Seguin (CDM)', 'Toni Leistner (CB)', 'Márton Dárdai (CB)', 'Michał Karbownik (LB)', 'Diego Demme (CDM)', 'Linus Gechter (CB)'], description: 'Hertha BSC. Compite en Bundesliga 2.', badgeColor: 'border-l-4 border-blue-600 bg-blue-950/40 text-blue-200', badgeLogoUrl: '🔵⚪',
  ...
  { id: 'karlsruher_sc', themeColor: { primary: '#0ea5e9', secondary: '#f5f0e8' }, name: 'Karlsruher SC', league: 'Alemana', dt: 'Maximilian Senft', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Marvin Wanitzek (CM)', 'Marcel Franke (CB)', 'David Herold (LB)', 'Christoph Kobald (CB)', 'Dženis Burnić (CM)', 'Marcel Beifus (CB)', 'Hans Christian Bernat (GK)'], description: 'Karlsruher SC. Compite en Bundesliga 2.', badgeColor: 'border-l-4 border-sky-500 bg-sky-950/40 text-sky-200', badgeLogoUrl: '🔵⚪',
  ...
  { id: 'preussen_munster', themeColor: { primary: '#16a34a', secondary: '#f5f0e8' }, name: 'Preußen Münster', league: 'Alemana', dt: 'Thomas Wörle', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Johannes Schenk (GK)', 'Jorrit Hendrix (CDM)', 'Joshua Mees (CAM)', 'Jannis Heuer (CB)', 'Marcel Benger (CDM)', 'Marvin Schulz (CM)', 'Rico Preißinger (CDM)'], description: 'Preußen Münster. Compite en Bundesliga 2.', badgeColor: 'border-l-4 border-green-600 bg-zinc-950/40 text-green-200', badgeImageUrl: 'badges/clubs/preussen_munster.png', badgeLogoUrl: '⚫💚', division: 2 },
  ...
  { id: 'sc_paderborn_07', themeColor: { primary: '#2563eb', secondary: '#f5f0e8' }, name: 'SC Paderborn 07', league: 'Alemana', dt: 'Ralf Kettemann', reputation: 2, initialSalary: 800, marketValue: 7675000, starPlayers: ['Felix Götze (CB)', 'Raphael Obermair (RM)', 'Tjark Scheller (CB)', 'Laurin Curda (RM)', 'Santiago Castañeda (CDM)', 'Steffen Tigges (ST)', 'Sebastian Klaas (CM)'], description: 'SC Paderborn 07. Compite en Bundesliga 2.', badgeColor: 'border-l-4 border-blue-600 bg-blue-950/40 text-blue-200', badgeLogoUrl: '🔵⚪',
    badgeImageUrl: 'badges/clubs/sc_paderborn_07.png', division: 2 },
  { id: 'sv_elversberg', themeColor: { primary: '#3b82f6', secondary: '#f5f0e8' }, name: 'SV Elversberg', league: 'Alemana', dt: 'Vincent Wagner', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Nicolas Kristof (GK)', 'Lukas Petkov (RM)', 'Lukas Pinckert (CB)', 'Maximilian Rohr (CB)', 'Tom Zimmerschied (LM)', 'Łukasz Poręba (CDM)', 'Florian Le Joncour (CB)', 'Jan Gyamerah (RB)', 'Lasse Günther (LB)'], description: 'SV Elversberg. Compite en Bundesliga 2.', badgeColor: 'border-l-4 border-blue-500 bg-blue-950/40 text-blue-200', badgeLogoUrl: '🔵⚪',
  ...
  { id: 'holstein_kiel', themeColor: { primary: '#2563eb', secondary: '#f5f0e8' }, name: 'Holstein Kiel', league: 'Alemana', dt: 'Tim Walter', reputation: 2, initialSalary: 800, marketValue: 21575000, starPlayers: ['David Zec (CB)', 'Jonas Meffert (CDM)', 'Umut Tohumcu (CAM)', 'John Tolkin (LB)', 'Steven Skrzybski (ST)', 'Carl Johansson (CB)', 'Jonas Therkelsen (CAM)'], description: 'Holstein Kiel. Compite en Bundesliga 2.', badgeColor: 'border-l-4 border-blue-600 bg-blue-950/40 text-blue-200', badgeLogoUrl: '🔵⚪',
  ...
  { id: 'west_ham_united', themeColor: { primary: '#7A263A', secondary: '#1BB1E7' }, name: 'West Ham United', league: 'Inglesa', dt: 'Graham Potter', reputation: 4, initialSalary: 67900, marketValue: 436325000, starPlayers: ['Jarrod Bowen (RM)', 'Valentin Castellanos (ST)', 'Crysencio Summerville (LM)', 'Konstantinos Mavropanos (CB)', 'Alphonse Areola (GK)'], description: 'West Ham United. Compite en Premier League.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'brighton_hove_albion', name: 'Brighton & Hove Albion', league: 'Inglesa', dt: 'Fabian Hürzeler', reputation: 4, initialSalary: 47700, marketValue: 527100000, starPlayers: ['Kaoru Mitoma (LM)', 'Bart Verbruggen (GK)', 'Yankuba Minteh (RM)', 'Ferdi Kadıoğlu (LB)', 'Yasin Ayari (CDM)', 'Maxim De Cuyper (LB)', 'Mats Wieffer (CDM)', 'Pascal Groß (CDM)'], description: 'Brighton & Hove Albion. Compite en Premier League.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/brighton_hove_albion.png', division: 1 },
  { id: 'brentford', name: 'Brentford', league: 'Inglesa', dt: 'Keith Andrews', reputation: 3, initialSalary: 32000, marketValue: 421025000, starPlayers: ['Igor Thiago (ST)', 'Michael Kayode (RB)', 'Mikkel Damsgaard (CAM)', 'Caoimhin Kelleher (GK)', 'Kevin Schade (LM)', 'Mathias Jensen (CM)', 'Nathan Collins (CB)', 'Dango Ouattara (RM)', 'Sepp van den Berg (CB)', 'Yehor Yarmoliuk (CDM)'], description: 'Brentford. Compite en Premier League.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/brentford.png', division: 1 },
  { id: 'crystal_palace', name: 'Crystal Palace', league: 'Inglesa', dt: 'Pierre Sage', reputation: 3, initialSalary: 46000, marketValue: 451335000, starPlayers: ['Dean Henderson (GK)', 'Jean-Philippe Mateta (ST)', 'Adam Wharton (CDM)', 'Ismaïla Sarr (RW)', 'Chris Richards (CB)', 'Tyrick Mitchell (LB)', 'Yeremy Pino (LW)', 'Daichi Kamada (CM)'], description: 'Crystal Palace. Compite en Premier League.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/crystal_palace.png', division: 1 },
  { id: 'everton_eng', name: 'Everton', league: 'Inglesa', dt: 'David Moyes', reputation: 3, initialSalary: 83400, marketValue: 433750000, starPlayers: ['Jordan Pickford (GK)', 'Jack Grealish (LM)', 'James Tarkowski (CB)', 'James Garner (CDM)', 'Jarrad Branthwaite (CB)', 'Idrissa Gueye (CDM)', 'Kiernan Dewsbury-Hall (CAM)', 'Vitaliy Mykolenko (LB)', 'Jake O\'Brien (RB)'], description: 'Everton. Compite en Premier League.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/everton_eng.png', division: 1 },
  { id: 'fulham', name: 'Fulham', league: 'Inglesa', dt: 'Álvaro Arbeloa', reputation: 3, initialSalary: 28400, marketValue: 347600000, starPlayers: ['Antonee Robinson (LB)', 'Alex Iwobi (LM)', 'Bernd Leno (GK)', 'Joachim Andersen (CB)', 'Sander Berge (CDM)', 'Kenny Tete (RB)', 'Calvin Bassey (CB)'], description: 'Fulham. Compite en Premier League.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/fulham.png', division: 1 },
  { id: 'wolverhampton_wanderers', name: 'Wolverhampton Wanderers', league: 'Inglesa', dt: 'Vítor Pereira', reputation: 3, initialSalary: 75200, marketValue: 260925000, starPlayers: ['André (CDM)', 'José Sá (GK)', 'Santiago Bueno (CB)', 'Hugo Bueno (LB)', 'Jean-Ricner Bellegarde (CAM)', 'Toti (CB)'], description: 'Wolverhampton Wanderers. Compite en Premier League.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/wolverhampton_wanderers.png', division: 1 },
  { id: 'nottingham_forest', name: 'Nottingham Forest', league: 'Inglesa', dt: 'Oliver Glasner', reputation: 3, initialSalary: 1500, marketValue: 521925000, starPlayers: ['Matz Sels (GK)', 'Murillo (CB)', 'Nikola Milenković (CB)', 'Morgan Gibbs-White (CAM)', 'Chris Wood (ST)', 'Ola Aina (RB)', 'Neco Williams (LB)', 'Ibrahim Sangaré (CDM)', 'Callum Hudson-Odoi (LM)'], description: 'Nottingham Forest. Compite en Premier League.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/nottingham_forest.png', division: 1 },
  { id: 'afc_bournemouth', name: 'AFC Bournemouth', league: 'Inglesa', dt: 'Marco Rose', reputation: 3, initialSalary: 21700, marketValue: 403600000, starPlayers: ['Evanilson (ST)', 'Đorđe Petrović (GK)', 'Adrien Truffert (LB)', 'Alex Scott (CDM)', 'Tyler Adams (CDM)', 'Bafodé Diakité (CB)', 'Justin Kluivert (CAM)', 'Eli Junior Kroupi (ST)', 'Ryan Christie (CDM)', 'Lewis Cook (CDM)'], description: 'AFC Bournemouth. Compite en Premier League.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/afc_bournemouth.png', division: 1 },
  { id: 'burnley', name: 'Burnley', league: 'Inglesa', dt: 'Scott Parker', reputation: 2, initialSalary: 27900, marketValue: 304050000, starPlayers: ['Florentino (CDM)', 'Kyle Walker (RB)', 'Josh Cullen (CDM)', 'Quilindschy Hartman (LB)', 'Hannibal (CM)', 'Marcus Edwards (RM)'], description: 'Burnley. Compite en Premier League.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/burnley.png', division: 1 },
  { id: 'leeds_united', name: 'Leeds United', league: 'Inglesa', dt: 'Daniel Farke', reputation: 2, initialSalary: 48600, marketValue: 312800000, starPlayers: ['Anton Stach (CM)', 'Ethan Ampadu (CDM)', 'Joe Rodon (CB)', 'Gabriel Gudmundsson (LB)', 'Dominic Calvert-Lewin (ST)', 'Jaka Bijol (CB)', 'Jayden Bogle (RB)', 'Brenden Aaronson (RW)', 'Noah Okafor (ST)'], description: 'Leeds United. Compite en Premier League.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/leeds_united.png', division: 1 },
  { id: 'sunderland', name: 'Sunderland', league: 'Inglesa', dt: 'Régis Le Bris', reputation: 2, initialSalary: 1000, marketValue: 226700000, starPlayers: ['Granit Xhaka (CDM)', 'Nordi Mukiele (CB)', 'Omar Alderete (CB)', 'Reinildo (LB)', 'Robin Roefs (GK)', 'Daniel Ballard (CB)', 'Trai Hume (RB)', 'Enzo Le Fée (CM)', 'Habib Diarra (CM)', 'Noah Sadiki (CM)'], description: 'Sunderland. Compite en Premier League.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/sunderland.png', division: 1 },
  { id: 'southampton', name: 'Southampton', league: 'Inglesa', dt: 'DT Genérico', reputation: 2, initialSalary: 9000, marketValue: 60000000, starPlayers: ['Aaron Ramsdale (GK)', 'Nathan Wood (CB)', 'Mads Roerslev (RB)', 'Welington (LB)', 'Flynn Downes (CDM)', 'Caspar Jander (CM)', 'Tom Fellows (CM)', 'Lewis Dobbin (LM)', 'Gavin Bazunu (GK)'], description: 'Southampton. Compite en el Championship.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeImageUrl: 'badges/clubs/southampton.png', badgeLogoUrl: '⚽', division: 2 },
  { id: 'middlesbrough', name: 'Middlesbrough', league: 'Inglesa', dt: 'DT Genérico', reputation: 2, initialSalary: 9000, marketValue: 60000000, starPlayers: ['Sol Brynn (GK)', 'Alfie Jones (CB)', 'George Edmundson (CB)', 'Callum Brittain (RB)', 'Alex Bangura (LB)', 'Riley McGree (CM)', 'Sebastian Berhalter (CM)', 'Morgan Whittaker (RM)', 'David Strelec (ST)'], description: 'Middlesbrough. Compite en el Championship.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeImageUrl: 'badges/clubs/middlesbrough.png', badgeLogoUrl: '⚽', division: 2 },
  { id: 'sheffield_united', name: 'Sheffield United', league: 'Inglesa', dt: 'DT Genérico', reputation: 2, initialSalary: 9000, marketValue: 60000000, starPlayers: ['Michael Cooper (GK)', 'Japhet Tanganga (CB)', 'Mark McGuinness (CB)', 'Jamie Shackleton (RB)', 'Rhys Norrington-Davies (LB)', 'Jaïro Riedewald (CDM)', 'Joe Rothwell (CM)', 'Christian Nwachukwu (LM)', 'Ehije Ukaki (RM)', 'Tyrese Campbell (ST)'], description: 'Sheffield United. Compite en el Championship.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeImageUrl: 'badges/clubs/sheffield_united.png', badgeLogoUrl: '⚽', division: 2 },
  { id: 'norwich_city', name: 'Norwich City', league: 'Inglesa', dt: 'DT Genérico', reputation: 2, initialSalary: 9000, marketValue: 60000000, starPlayers: ['Vladan Kovacevic (GK)', 'Harry Darling (CB)', 'Jack Stacey (RB)', 'Ben Chrisene (LB)', 'Sam Field (CDM)', 'Paris Maghoma (CM)', 'Ali Ahmed (CM)', 'Papa Amadou Diallo (LM)', 'Matěj Jurásek (RM)', 'Mathias Kvistgaarden (ST)'], description: 'Norwich City. Compite en el Championship.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeImageUrl: 'badges/clubs/norwich_city.png', badgeLogoUrl: '⚽', division: 2 },
  { id: 'birmingham_city', name: 'Birmingham City', league: 'Inglesa', dt: 'DT Genérico', reputation: 1, initialSalary: 5500, marketValue: 35000000, starPlayers: ['Christoph Klarer (CB)', 'Dael Fry (CB)', 'Bright Osayi-Samuel (RB)', 'Alex Cochrane (LB)', 'Tomoki Iwata (CDM)', 'Seung-ho Paik (CM)', 'Marc Leonard (CM)', 'Demarai Gray (LM)', 'Carlos Vicente (RM)', 'Luis Vázquez (ST)'], description: 'Birmingham City. Compite en el Championship.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeImageUrl: 'badges/clubs/birmingham_city.png', badgeLogoUrl: '⚽', division: 2 },
  ...
  { id: 'stoke_city', name: 'Stoke City', league: 'Inglesa', dt: 'DT Genérico', reputation: 1, initialSalary: 5500, marketValue: 35000000, starPlayers: ['Viktor Johansson (GK)', 'Ben Wilmot (CB)', 'Maksym Taloverov (CB)', 'Junior Tchamadeu (RB)', 'Eric-Junior Bocat (LB)', 'Djibril Soumaré (CDM)', 'Svante Ingelsson (CM)', 'Tatsuki Seko (CM)', 'Million Manhoef (RM)', 'Róbert Boženík (ST)'], description: 'Stoke City. Compite en el Championship.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeImageUrl: 'badges/clubs/stoke_city.png', badgeLogoUrl: '⚽', division: 2 },
  { id: 'watford', name: 'Watford', league: 'Inglesa', dt: 'DT Genérico', reputation: 1, initialSalary: 5500, marketValue: 35000000, starPlayers: ['Federico Ravaglia (GK)', 'Mattie Pollock (CB)', 'Kévin Keben (CB)', 'Omar Traoré (RB)', 'Marc Bola (LB)', 'Hector Kyprianou (CDM)', 'Martín Payero (CM)', 'Kwadwo Baah (LM)', 'Othmane Maamma (RM)', 'Luca Kjerrumgaard (ST)'], description: 'Watford. Compite en el Championship.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeImageUrl: 'badges/clubs/watford.png', badgeLogoUrl: '⚽', division: 2 },
  { id: 'wrexham', name: 'Wrexham', league: 'Inglesa', dt: 'DT Genérico', reputation: 2, initialSalary: 9000, marketValue: 60000000, starPlayers: ['Callum Burton (GK)', 'Zak Vyner (CB)', 'Liberato Cacace (LB)', 'Ben Sheaf (CDM)', 'Lewis O\'Brien (CM)', 'George Thomason (CM)', 'Nathan Broadhead (LM)', 'Sam Smith (ST)'], description: 'Wrexham. Compite en el Championship.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeImageUrl: 'badges/clubs/wrexham.png', badgeLogoUrl: '⚽', division: 2 },
  ...
  { id: 'portsmouth', name: 'Portsmouth', league: 'Inglesa', dt: 'DT Genérico', reputation: 2, initialSalary: 9000, marketValue: 60000000, starPlayers: ['Daniel Bielica (GK)', 'Regan Poole (CB)', 'Zak Swanson (RB)', 'Connor Ogilvie (LB)', 'Luke Le Roux (CM)', 'Márk Kosznovszky (CM)', 'Josh Murphy (LM)', 'Adrian Segečić (RM)', 'Colby Bishop (ST)', 'Nicolas Schmid (GK)'], description: 'Portsmouth. Compite en el Championship.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeImageUrl: 'badges/clubs/portsmouth.png', badgeLogoUrl: '⚽', division: 2 },
  { id: 'charlton_athletic', name: 'Charlton Athletic', league: 'Inglesa', dt: 'DT Genérico', reputation: 2, initialSalary: 9000, marketValue: 60000000, starPlayers: ['Will Mannion (GK)', 'Reece Burke (CB)', 'Ivan Mesik (CB)', 'Danny McNamara (RB)', 'Josh Edwards (LB)', 'Conor Coventry (CDM)', 'Greg Docherty (CM)', 'Millenic Alli (LM)', 'Rob Apter (RM)', 'Karlan Grant (ST)'], description: 'Charlton Athletic. Compite en el Championship.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeImageUrl: 'badges/clubs/charlton_athletic.png', badgeLogoUrl: '⚽', division: 2 },
  { id: 'cardiff_city', name: 'Cardiff City', league: 'Inglesa', dt: 'DT Genérico', reputation: 1, initialSalary: 5500, marketValue: 35000000, starPlayers: ['Gabriel Osho (CB)', 'Perry Ng (RB)', 'Joel Bagan (LB)', 'David Turnbull (CM)', 'Alex Robertson (CM)', 'Chris Willock (LM)', 'Ollie Tanner (RM)', 'Yousef Salech (ST)'], description: 'Cardiff City. Compite en el Championship.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeImageUrl: 'badges/clubs/cardiff_city.png', badgeLogoUrl: '⚽', division: 2 },
  ...
  { id: 'ipswich_town', name: 'Ipswich Town', league: 'Inglesa', dt: 'DT Genérico', reputation: 3, initialSalary: 18000, marketValue: 180000000, starPlayers: ['Kjell Scherpen (GK)', 'Dara O\'Shea (CB)', 'Jacob Greaves (CB)', 'Ben Johnson (RB)', 'Leif Davis (LB)', 'Azor Matusiwa (CDM)', 'Marcelino Núñez (CM)', 'Jack Taylor (CM)', 'Daizen Maeda (LM)', 'Chiedozie Ogbene (RM)'], description: 'Ipswich Town. Compite en la Premier League.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeImageUrl: 'badges/clubs/ipswich_town.png', badgeLogoUrl: '⚽', division: 2 },
  { id: 'coventry_city', name: 'Coventry City', league: 'Inglesa', dt: 'DT Genérico', reputation: 3, initialSalary: 18000, marketValue: 180000000, starPlayers: ['Luke Woolfenden (CB)', 'Liam Kitching (CB)', 'Milan van Ewijk (RB)', 'Jay Dasilva (LB)', 'Matt Grimes (CDM)', 'Victor Torp (CM)', 'Josh Eccles (CM)', 'Tatsuhiro Sakamoto (RM)', 'Brandon Thomas-Asante (ST)'], description: 'Coventry City. Compite en la Premier League.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeImageUrl: 'badges/clubs/coventry_city.png', badgeLogoUrl: '⚽', division: 2 },
  { id: 'hull_city', name: 'Hull City', league: 'Inglesa', dt: 'DT Genérico', reputation: 3, initialSalary: 18000, marketValue: 180000000, starPlayers: ['Paddy McNair (CB)', 'Charlie Hughes (CB)', 'Ryan Giles (LB)', 'Regan Slater (CDM)', 'Abdülkadir Ömür (CM)', 'Eliot Matazo (CM)', 'Mohamed Belloumi (RM)', 'Oli McBurnie (ST)'], description: 'Hull City. Compite en la Premier League.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeImageUrl: 'badges/clubs/hull_city.png', badgeLogoUrl: '⚽', division: 2 },
  ...
  { id: 'bologna', name: 'Bologna', league: 'Italiana', dt: 'Domenico Tedesco', reputation: 4, initialSalary: 2000, marketValue: 250770000, starPlayers: ['Riccardo Orsolini (RM)', 'Łukasz Skorupski (GK)', 'Lewis Ferguson (CDM)', 'João Mário (RB)', 'Jens Odgaard (CAM)', 'Juan Miranda (LB)', 'Nicolò Cambiaghi (LM)', 'Nikola Moro (CDM)'], description: 'Bologna. Compite en Serie A Enilive.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/bologna.png', division: 1 },
  { id: 'cagliari', name: 'Cagliari', league: 'Italiana', dt: 'Fabio Pisacane', reputation: 4, initialSalary: 2000, marketValue: 97845000, starPlayers: ['Elia Caprile (GK)', 'Yerry Mina (CB)', 'Andrea Belotti (ST)', 'Zé Pedro (CB)', 'Gianluca Gaetano (CAM)', 'Michel Ndary Adopo (CM)'], description: 'Cagliari. Compite en Serie A Enilive.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/cagliari.png', division: 1 },
  { id: 'como', name: 'Como', league: 'Italiana', dt: 'Cesc Fàbregas', reputation: 4, initialSalary: 2000, marketValue: 301450000, starPlayers: ['Nico Paz (CAM)', 'Morata (ST)', 'Martin Baturina (CAM)', 'Maxence Caqueret (CM)', 'Jean Butez (GK)', 'Nicolas Kühn (RW)', 'Jesús Rodríguez (LM)', 'Assane Diao (LM)'], description: 'Como. Compite en Serie A Enilive.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/tm/como.png', division: 1 },
  { id: 'empoli', name: 'Empoli', league: 'Italiana', dt: 'Roberto D\'Aversa', reputation: 4, initialSalary: 2000, marketValue: 49060000, starPlayers: ['Gerard Yepes (CDM)', 'Tyronne Ebuehi (RB)', 'Daniel Fila (ST)', 'Rareș Ilie (LM)', 'Marco Curto (CB)', 'Samuele Perisan (GK)', 'Simone Romagnoli (CB)'], description: 'Empoli. Compite en Serie A Enilive.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/empoli.png', division: 2 },
  { id: 'fiorentina', themeColor: { primary: '#682E8B', secondary: '#FFFFFF' }, name: 'Fiorentina', league: 'Italiana', dt: 'Fabio Grosso', reputation: 4, initialSalary: 47800, marketValue: 303560000, starPlayers: ['De Gea (GK)', 'Dodô (RB)', 'Albert Guðmundsson (ST)', 'Manor Solomon (LM)', 'Nicolò Fagioli (CM)', 'Luca Ranieri (CB)', 'Fabiano Parisi (LB)'], description: 'Fiorentina. Compite en Serie A Enilive.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/fiorentina.png', division: 1 },
  { id: 'genoa', name: 'Genoa', league: 'Italiana', dt: 'Daniele De Rossi', reputation: 4, initialSalary: 2000, marketValue: 132070000, starPlayers: ['Morten Frendrup (CDM)', 'Justin Bijlow (GK)', 'Leo Østigård (CB)', 'Johan Vásquez (CB)', 'Vitinha (ST)', 'Tommaso Baldanzi (CAM)'], description: 'Genoa. Compite en Serie A Enilive.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/genoa.png', division: 1 },
  { id: 'hellas_verona', name: 'Hellas Verona', league: 'Italiana', dt: 'Paolo Zanetti', reputation: 2, initialSalary: 20900, marketValue: 108450000, starPlayers: ['Suat Serdar (CM)', 'Ali Al Musrati (CDM)', 'Nicolás Valentini (CB)', 'Pol Lirola (RB)', 'Domagoj Bradarić (LB)', 'Roberto Gagliardini (CDM)'], description: 'Hellas Verona. Descendió a la Serie BKT para la temporada 2026-27.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'https://pub-3bd35431294c47068cbf31a95d572166.r2.dev/logos/hellas-verona/hellas-verona-logo-footylogos.svg', division: 1 },
  { id: 'inter', themeColor: { primary: '#0068A8', secondary: '#000000' }, name: 'Inter', league: 'Italiana', dt: 'Cristian Chivu', reputation: 5, initialSalary: 110200, marketValue: 573300000, starPlayers: ['Lautaro Martínez (ST)', 'Nicolò Barella (CM)', 'Yann Sommer (GK)', 'Hakan Çalhanoğlu (CM)', 'Alessandro Bastoni (CB)', 'Federico Dimarco (LB)', 'Aleksandar Stanković (CDM)', 'Yann Bisseck (CB)', 'Henrikh Mkhitaryan (CM)'], description: 'Inter. Compite en Serie A Enilive, reforzado con Manuel Akanji y Aleksandar Stanković, tras la salida de Denzel Dumfries.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/tm/inter.png', division: 1 },
  { id: 'juventus', themeColor: { primary: '#000000', secondary: '#FFFFFF' }, name: 'Juventus', league: 'Italiana', dt: 'Luciano Spalletti', reputation: 5, initialSalary: 123200, marketValue: 640400000, starPlayers: ['Bremer (CB)', 'Manuel Locatelli (CDM)', 'Loïs Openda (ST)', 'Khéphren Thuram (CM)', 'Kenan Yıldız (CAM)', 'Pierre Kalulu (CB)', 'Andrea Cambiaso (LB)', 'Teun Koopmeiners (CAM)'], description: 'Juventus. Compite en Serie A Enilive.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'lecce', name: 'Lecce', league: 'Italiana', dt: 'Eusebio Di Francesco', reputation: 4, initialSalary: 2000, marketValue: 120330000, starPlayers: ['Wladimiro Falcone (GK)', 'Antonino Gallo (LB)', 'Lassana Coulibaly (CDM)', 'Omri Gandelman (CAM)', 'Kialonda Gaspar (CB)', 'Jamil Siebert (CB)', 'Ylber Ramadani (CDM)', 'Santiago Pierotti (RM)'], description: 'Lecce. Compite en Serie A Enilive.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/lecce.png', division: 1 },
  { id: 'milan', themeColor: { primary: '#FB090B', secondary: '#000000' }, name: 'Milan', league: 'Italiana', dt: 'Rúben Amorim', reputation: 4, initialSalary: 89800, marketValue: 626510000, starPlayers: ['Christian Pulisic (RW)', 'Mike Maignan (GK)', 'Adrien Rabiot (CM)', 'Strahinja Pavlović (CB)', 'Fikayo Tomori (CB)', 'Samuel Chukwueze (RW)', 'Ardon Jashari (CM)', 'Ruben Loftus-Cheek (CM)'], description: 'Milan. Compite en Serie A Enilive, reforzado con Ardon Jashari (Club Brugge) y Samuel Chukwueze.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/milan.png', division: 1 },
  { id: 'monza', name: 'Monza', league: 'Italiana', dt: 'Ivan Jurić', reputation: 4, initialSalary: 2000, marketValue: 40975000, starPlayers: ['Matteo Pessina (CM)', 'Andrea Colpani (CAM)', 'Samuele Birindelli (RB)', 'Dany Mota (ST)', 'Demba Thiam (GK)', 'Patrick Ciurria (CAM)', 'Agustín Álvarez (ST)'], description: 'Monza. Compite en Serie A Enilive.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/monza.png', division: 2 },
  { id: 'napoli', themeColor: { primary: '#12A0D7', secondary: '#003C7A' }, name: 'Napoli', league: 'Italiana', dt: 'Massimiliano Allegri', reputation: 5, initialSalary: 99600, marketValue: 517750000, starPlayers: ['Kevin De Bruyne (CM)', 'Scott McTominay (CM)', 'Noa Lang (LW)', 'Stanislav Lobotka (CM)', 'André-Franck Zambo Anguissa (CM)', 'Giovanni Di Lorenzo (RB)', 'Alessandro Buongiorno (CB)', 'Alex Meret (GK)', 'Matteo Politano (RW)', 'Luca Marianucci (CB)'], description: 'Napoli. Compite en Serie A Enilive, reforzado con Noa Lang (PSV) tras la salida de Kvaratskhelia al PSG.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/napoli.png', division: 1 },
  { id: 'parma', name: 'Parma', league: 'Italiana', dt: 'Carlos Cuesta', reputation: 4, initialSalary: 2000, marketValue: 104085000, starPlayers: ['Gabriel Strefezza (RM)', 'Enrico Delprato (CB)', 'Emanuele Valeri (LB)', 'Hans Nicolussi Caviglia (CDM)', 'Adrián Bernabé (CM)', 'Abdoulaye Ndiaye (CB)', 'Mandela Keita (CDM)', 'Gaetano Oristanio (CAM)', 'Matija Frigan (ST)'], description: 'Parma. Compite en Serie A Enilive.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/parma.png', division: 1 },
  { id: 'roma', themeColor: { primary: '#8E1F2F', secondary: '#F0BC42' }, name: 'Roma', league: 'Italiana', dt: 'Gian Piero Gasperini', reputation: 4, initialSalary: 78900, marketValue: 410350000, starPlayers: ['Paulo Dybala (CAM)', 'Mile Svilar (GK)', 'Gianluca Mancini (CB)', 'Evan Ndicka (CB)', 'Bryan Cristante (CM)', 'Kouadio Manu Koné (CM)', 'Lorenzo Pellegrini (CAM)', 'Mario Hermoso (CB)', 'Matías Soulé (CAM)'], description: 'Roma. Compite en Serie A Enilive.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/roma.png', division: 1 },
  { id: 'torino', name: 'Torino', league: 'Italiana', dt: 'Ignazio Abate', reputation: 4, initialSalary: 35400, marketValue: 217995000, starPlayers: ['Duván Zapata (ST)', 'Nikola Vlašić (CAM)', 'Ché Adams (ST)', 'Cristiano Biraghi (LB)', 'Valentino Lazaro (RM)', 'Saúl Coco (CB)', 'Cesare Casadei (CM)', 'Franco Israel (GK)'], description: 'Torino. Compite en Serie A Enilive.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/torino.png', division: 1 },
  { id: 'udinese', name: 'Udinese', league: 'Italiana', dt: 'Kosta Runjaic', reputation: 4, initialSalary: 2000, marketValue: 153955000, starPlayers: ['Oumar Solet (CB)', 'Jesper Karlström (CDM)', 'Nicolò Zaniolo (ST)', 'Maduka Okoye (GK)', 'Jurgen Ekkelenkamp (CM)', 'Keinan Davis (ST)', 'Thomas Kristensen (CB)', 'Christian Kabasele (CB)'], description: 'Udinese. Compite en Serie A Enilive.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/udinese.png', division: 1 },
  { id: 'venezia', name: 'Venezia', league: 'Italiana', dt: 'Giovanni Stroppa', reputation: 4, initialSalary: 2000, marketValue: 36985000, starPlayers: ['Filip Stanković (GK)', 'Gianluca Busio (CM)', 'Kike Pérez (CM)', 'Andrea Adorante (ST)', 'Alfred Duncan (CM)', 'Lion Lauberbach (ST)', 'John Yeboah (ST)', 'Casas (ST)', 'Joël Marcel Schingtienne (CB)'], description: 'Venezia. Compite en Serie A Enilive.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/venezia.png', division: 2 },
  // ==========================================
  // --- ITALIA (SEGUNDA) ---
  // ==========================================
  { id: 'bari', name: 'Bari', league: 'Italiana', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Lorenzo Dickmann (RB)', 'Giulio Maggiore (CM)', 'Christian Gytkjær (ST)', 'Andrea Cistana (CB)'], description: 'Bari. Compite en Serie BKT.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/bari.png', division: 2 },
  { id: 'brescia', name: 'Brescia', league: 'Italiana', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 13950000, starPlayers: ['Marco Frigerio (CM)', 'Gioele Zacchi (GK)', 'Tiago Casasola (RM)', 'Andrea Rizzo Pinna (CAM)', 'Valerio Crespi (ST)', 'Davide Balestrero (CM)', 'Jacopo Pellegrini (ST)', 'Stefano Gori (GK)', 'Alberto Rizzo (CB)', 'Luigi Silvestri (CB)', 'Vincent De Maria (LM)'], description: 'Brescia. Compite en Serie BKT.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/brescia.png', division: 2 },
  { id: 'carrarese', name: 'Carrarese', league: 'Italiana', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Nicolas Schiavi (CM)', 'Julián Illanes (CB)', 'Luis Hasa (CM)', 'Fabio Abiuso (ST)', 'Filippo Oliana (CB)', 'Mattia Finotto (ST)', 'Vincenzo Fiorillo (GK)', 'Bartosz Salamon (CB)'], description: 'Carrarese. Compite en Serie BKT.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/carrarese.png', division: 2 },
  { id: 'catanzaro', name: 'Catanzaro', league: 'Italiana', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Mirko Pigliacelli (GK)', 'Pietro Iemmello (ST)', 'Jacopo Petriccione (CDM)', 'Marco D\'Alessandro (LM)', 'Rémi Oudin (CAM)', 'Tommaso Cassandro (RB)'], description: 'Catanzaro. Compite en Serie BKT.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/catanzaro.png', division: 2 },
  { id: 'cesena', name: 'Cesena', league: 'Italiana', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 1810000, starPlayers: ['Giovanni Zaro (CB)', 'Dimitri Bisoli (CM)', 'Gaetano Castrovilli (CM)', 'Cristian Shpendi (ST)', 'Jonathan Klinsmann (GK)', 'Andrea Ciofi (CB)', 'Gianluca Frabotta (LB)'], description: 'Cesena. Compite en Serie BKT.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/cesena.png', division: 2 },
  { id: 'cittadella', name: 'Cittadella', league: 'Italiana', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Davis Mensah (ST)', 'Francesco Amatucci (CM)', 'Mirko Antonucci (CAM)', 'Francesco D\'Alessio (RM)', 'Alessandro Zanellati (GK)', 'Alex Redolfi (CB)', 'Lorenzo Paolucci (CM)', 'Emanuele Anastasia (LW)', 'Francesco Toffanin (CB)', 'Andrea Zilio (CB)', 'Bruno Martella (LB)'], description: 'Cittadella. Compite en Serie BKT.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/tm/cittadella.png', division: 2 },
  { id: 'cosenza', name: 'Cosenza', league: 'Italiana', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Orhan Džepar (CDM)', 'Andrea Cogoni (CB)', 'Velizar-Iliya Iliev (GK)', 'Nicolò Contiliano (CDM)', 'Mattia Almaviva (CAM)', 'Paolo Dametto (CB)', 'Baldovino Cimino (RB)', 'Daniele Quieto (CAM)', 'Alessandro Dalmazzi (CB)', 'Gianluca Clemente (RB)', 'Antonio Energe (RW)'], description: 'Cosenza. Compite en Serie BKT.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/cosenza.png', division: 2 },
  { id: 'cremonese', name: 'Cremonese', league: 'Italiana', dt: 'Giovanni Persico', reputation: 2, initialSalary: 800, marketValue: 93450000, starPlayers: ['Sebastiano Luperto (CB)', 'Jamie Vardy (ST)', 'Federico Baschirotto (CB)', 'Alessio Zerbin (RM)', 'Martín Payero (CM)', 'Jari Vandeputte (CM)', 'Federico Bonazzoli (ST)', 'Morten Thorsby (CM)', 'Marco Silvestri (GK)'], description: 'Cremonese. Compite en Serie BKT.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/cremonese.png', division: 1 },
  { id: 'frosinone', name: 'Frosinone', league: 'Italiana', dt: 'Massimiliano Alvini', reputation: 4, initialSalary: 2000, marketValue: 27335000, starPlayers: ['Giacomo Calò (CDM)', 'Ilario Monterisi (CB)', 'Ilias Koutsoupias (CM)', 'Farès Ghedjemis (RW)', 'Anthony Oyono (RB)', 'Gabriele Calvani (CB)', 'Gabriele Bracaglia (CB)', 'Antonio Raimondo (ST)', 'Antonio Fiori (LM)', 'Lorenzo Palmisani (GK)', 'Riccardo Marchizza (LB)'], description: 'Frosinone. Ascendió a la Serie A Enilive para la temporada 2026-27.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/frosinone.png', division: 2 },
  { id: 'juve_stabia', name: 'Juve Stabia', league: 'Italiana', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Salim Diakité (RB)', 'Marco Bellich (CB)', 'Leonardo Candellone (ST)', 'Andrea Giorgini (CB)', 'Fabio Maistro (CAM)', 'Christian Pierobon (CM)'], description: 'Juve Stabia. Compite en Serie BKT.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/juve_stabia.png', division: 2 },
  { id: 'mantova', name: 'Mantova', league: 'Italiana', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['César Falletti (CAM)', 'Davis Mensah (ST)', 'Davide Bragantini (RM)', 'Tiago Gonçalves (LB)', 'Francesco Ruocco (LM)', 'Nicolò Radaelli (RB)'], description: 'Mantova. Compite en Serie BKT.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/tm/mantova.png', division: 2 },
  { id: 'modena', name: 'Modena', league: 'Italiana', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Leandro Chichizola (GK)', 'Luca Zanimacchia (RM)', 'Davide Adorni (CB)', 'Francesco Zampano (LB)', 'Simone Santoro (CM)', 'Niklas Pyyhtiä (CM)', 'Daniel Tonoli (CB)', 'Pedro Mendes (ST)', 'Grégoire Defrel (ST)'], description: 'Modena. Compite en Serie BKT.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/modena.png', division: 2 },
  { id: 'palermo', name: 'Palermo', league: 'Italiana', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 14150000, starPlayers: ['Joel Pohjanpalo (ST)', 'Tommaso Augello (LB)', 'Antonio Palumbo (CAM)', 'Jesse Joronen (GK)', 'Mattia Bani (CB)', 'Niccolò Pierozzi (RB)', 'Filippo Ranocchia (CM)', 'Giangiacomo Magnani (CB)', 'Pietro Ceccaroni (CB)', 'Jacopo Segre (CM)'], description: 'Palermo. Compite en Serie BKT.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/palermo.png', division: 2 },
  { id: 'pisa', name: 'Pisa', league: 'Italiana', dt: 'Alberto Gilardino', reputation: 2, initialSalary: 800, marketValue: 61150000, starPlayers: ['Juan Cuadrado (RM)', 'Calvin Stengs (CAM)', 'Raúl Albiol (CB)', 'Mattéo Tramoni (CAM)', 'Felipe Loyola (CM)', 'Simone Canestrelli (CB)', 'Stefano Moreo (ST)', 'Simone Scuffet (GK)', 'Samuel Iling-Junior (LM)'], description: 'Pisa. Compite en Serie BKT.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/pisa.png', division: 1 },
  { id: 'reggiana', name: 'Reggiana', league: 'Italiana', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Manolo Portanova (CM)', 'Mario Sampirisi (RB)', 'Matteo Rover (RM)', 'Cedric Diomandè Gondo (ST)', 'Francesco Vicari (CB)', 'Alessandro Micai (GK)', 'Danilo Quaranta (CB)'], description: 'Reggiana. Compite en Serie BKT.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/tm/reggiana.png', division: 2 },
  { id: 'salernitana', name: 'Salernitana', league: 'Italiana', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 17660000, starPlayers: ['Paolo Ghiglione (RB)', 'Facundo Lescano (ST)', 'Simone Pieraccini (CB)', 'Luca Villa (LB)', 'Kees de Boer (CM)', 'Gianluca Longobardi (RB)', 'Mattia Tascone (CM)', 'Antonino La Gumina (ST)', 'Cesare Galeotti (GK)', 'Eugenio D\'Ursi (LW)', 'Ismail Achik (RW)'], description: 'Salernitana. Compite en Serie BKT.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/salernitana.png', division: 2 },
  { id: 'sampdoria', name: 'Sampdoria', league: 'Italiana', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 39570000, starPlayers: ['Massimo Coda (ST)', 'Mattia Viti (CB)', 'Oliver Abildgaard (CB)', 'Fabio Depaoli (RB)', 'Lorenzo Venuti (RB)', 'Jordan Ferri (CDM)'], description: 'Sampdoria. Compite en Serie BKT.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/sampdoria.png', division: 2 },
  { id: 'sassuolo', name: 'Sassuolo', league: 'Italiana', dt: 'Alberto Aquilani', reputation: 2, initialSalary: 800, marketValue: 166120000, starPlayers: ['Domenico Berardi (RW)', 'Armand Laurienté (LW)', 'Nemanja Matić (CDM)', 'Kristian Thorstvedt (CM)', 'Ismaël Koné (CM)', 'Jay Idzes (CB)', 'Josh Doig (LB)'], description: 'Sassuolo. Compite en Serie BKT.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/sassuolo.png', division: 1 },
  { id: 'spezia', name: 'Spezia', league: 'Italiana', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 17235000, starPlayers: ['Petko Hristov (CB)', 'Szymon Żurkowski (CM)', 'Ádám Nagy (CM)'], description: 'Spezia. Compite en Serie BKT.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  // Los 7 que faltaban para completar la Serie B 2026/27, subidos desde la Serie C.
  // Fuente: https://www.espn.com.co/futbol/posiciones/_/liga/ita.2
  // Con ellos la Serie B queda entera y su calendario real (380 partidos) pasa del 41% al 100%.
  { id: 'arezzo', name: 'Arezzo', league: 'Italiana', dt: 'Cristian Bucchi', reputation: 2, initialSalary: 800, marketValue: 6800000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Arezzo. Compite en Serie BKT.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 2 },
  { id: 'ascoli', name: 'Ascoli', league: 'Italiana', dt: 'Francesco Tomei', reputation: 2, initialSalary: 800, marketValue: 7400000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Ascoli. Compite en Serie BKT.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 2 },
  { id: 'avellino', name: 'Avellino', league: 'Italiana', dt: 'Raffaele Biancolino', reputation: 2, initialSalary: 800, marketValue: 8100000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'US Avellino. Compite en Serie BKT.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 2 },
  { id: 'benevento', name: 'Benevento', league: 'Italiana', dt: 'Gaetano Auteri', reputation: 2, initialSalary: 800, marketValue: 9200000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Benevento. Compite en Serie BKT.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 2 },
  { id: 'padova', name: 'Padova', league: 'Italiana', dt: 'Matteo Andreoletti', reputation: 2, initialSalary: 800, marketValue: 8600000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Padova. Compite en Serie BKT.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 2 },
  { id: 'lr_vicenza', name: 'LR Vicenza', league: 'Italiana', dt: 'Stefano Vecchi', reputation: 2, initialSalary: 800, marketValue: 9800000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'LR Vicenza. Compite en Serie BKT.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 2 },
  { id: 'virtus_entella', name: 'Virtus Entella', league: 'Italiana', dt: 'Fabio Gallo', reputation: 2, initialSalary: 800, marketValue: 5900000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Virtus Entella. Compite en Serie BKT.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 2 },
 // ==========================================
  // --- FRANCIA (PRIMERA) ---
  // ==========================================
  { id: 'aj_auxerre', name: 'AJ Auxerre', league: 'Francesa', dt: 'Will Still', reputation: 4, initialSalary: 2000, marketValue: 73450000, starPlayers: ['Donovan Léon (GK)', 'Romain Faivre (RM)', 'Kévin Danois (CM)', 'Clément Akpa (CB)', 'Sinaly Diomandé (CB)', 'Elisha Owusu (CDM)', 'Danny Namaso (LM)', 'Josué Casimir (RM)'], description: 'AJ Auxerre. Compite en Ligue 1 McDonalds.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'angers_sco', name: 'Angers SCO', league: 'Francesa', dt: 'Stéphane Gilli', reputation: 4, initialSalary: 2000, marketValue: 58175000, starPlayers: ['Hervé Koffi (GK)', 'Jordan Lefort (CB)', 'Haris Belkebla (CDM)', 'Ousmane Camara (CB)', 'Carlens Arcus (RB)', 'Branco van den Boomen (CM)', 'Yassin Belkhdim (CM)', 'Amine Sbaï (LM)', 'Louis Mouton (CAM)'], description: 'Angers SCO. Compite en Ligue 1 McDonalds.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'as_monaco', themeColor: { primary: '#CC092F', secondary: '#FFFFFF' }, name: 'AS Monaco', league: 'Francesa', dt: 'Filipe Luís', reputation: 5, initialSalary: 67500, marketValue: 350900000, starPlayers: ['Denis Zakaria (CDM)', 'Lukáš Hrádecký (GK)', 'Lamine Camara (CM)', 'Alexandr Golovin (CAM)', 'Folarin Balogun (ST)', 'Paul Pogba (CM)', 'Eric Dier (CB)', 'Takumi Minamino (LM)', 'Vanderson (RB)'], description: 'AS Monaco. Compite en Ligue 1 McDonalds.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/as_monaco.png', division: 1 },
  { id: 'as_saint_etienne', name: 'AS Saint-Étienne', league: 'Francesa', dt: 'Ian Cathro', reputation: 4, initialSalary: 2000, marketValue: 57885000, starPlayers: ['Gautier Larsonneur (GK)', 'Julien Le Cardinal (CB)', 'Zuriko Davitashvili (LW)', 'Irvin Cardona (RW)', 'Augustine Boakye (RW)', 'João Ferreira (RB)', 'Chico Lamba (CB)', 'Mickaël Nadé (CB)', 'Maxime Bernauer (CB)'], description: 'AS Saint-Étienne. Compite en Ligue 1 McDonalds.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'estac_troyes', name: 'ESTAC Troyes', league: 'Francesa', dt: 'Stéphane Dumont', reputation: 3, initialSalary: 1200, marketValue: 31450000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'L\'Espérance Sportive Troyes Aube Champagne.', badgeColor: 'border-l-4 border-blue-500 bg-slate-900 text-white', badgeLogoUrl: '🔷',
    badgeImageUrl: 'badges/clubs/estac_troyes.png', division: 2 },
  ...
  { id: 'le_mans_fc', name: 'Le Mans FC', league: 'Francesa', dt: 'Julien Le Cardinal', reputation: 2, initialSalary: 800, marketValue: 20250000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Les Sang et Or du Maine.', badgeColor: 'border-l-4 border-yellow-500 bg-red-900 text-white', badgeLogoUrl: '🟡',
    division: 2 },
  { id: 'le_havre_ac', name: 'Le Havre AC', league: 'Francesa', dt: 'Didier Digard', reputation: 4, initialSalary: 2000, marketValue: 73650000, starPlayers: ['Abdoulaye Touré (CDM)', 'Sofiane Boufal (CAM)', 'Ayumu Seko (CDM)', 'Rassoul Ndiaye (CM)', 'Loïc Négo (RB)', 'Étienne Youté Kinkoué (CB)'], description: 'Le Havre AC. Compite en Ligue 1 McDonalds.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'lens', name: 'Lens', league: 'Francesa', dt: 'Dino Toppmöller', reputation: 4, initialSalary: 2000, marketValue: 98650000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Lens. Compite en Ligue 1 McDonalds.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/tm/lens.png', division: 1 },
  { id: 'lille_osc', name: 'Lille OSC', league: 'Francesa', dt: 'Davide Ancelotti', reputation: 4, initialSalary: 52300, marketValue: 272000000, starPlayers: ['Benjamin André (CDM)', 'Alexsandro Victor de Souza Ribeiro (CB)', 'Olivier Jonathan Giroud (ST)', 'Hákon Arnar Haraldsson (CAM)'], description: 'Lille OSC. Compite en Ligue 1 McDonalds.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/tm/lille_osc.png', division: 1 },
  { id: 'montpellier_hsc', name: 'Montpellier HSC', league: 'Francesa', dt: 'Zoumana Camara', reputation: 4, initialSalary: 2000, marketValue: 48775000, starPlayers: ['Julien Laporte (CB)', 'Christopher Jullien (CB)', 'Alexandre Mendy (ST)', 'Khalil Fayad (CM)', 'Théo Sainte-Luce (LB)', 'Lucas Mincarelli (LB)', 'Simon Ngapandouetnbu (GK)', 'Mathieu Michel (GK)'], description: 'Montpellier HSC. Compite en Ligue 1 McDonalds.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'stade_de_reims', name: 'Stade de Reims', league: 'Francesa', dt: 'Nicolas Usaï', reputation: 4, initialSalary: 2000, marketValue: 10000000, starPlayers: ['Nicolas Pallois (CB)', 'Joseph Okumu (CB)', 'Akieme (LB)', 'Théo Leoni (CDM)', 'Mory Gbane (CDM)', 'Maxime Busi (RB)'], description: 'Stade de Reims. Compite en Ligue 1 McDonalds.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'toulouse_fc', name: 'Toulouse FC', league: 'Francesa', dt: 'Jens Berthel Askou', reputation: 4, initialSalary: 2000, marketValue: 10000000, starPlayers: ['Guillaume Restes (GK)', 'Rasmus Nicolaisen (CB)', 'Yann Gboho (LW)', 'Aron Dønnum (RM)', 'Mark McKenzie (CB)', 'Cristian Cásseres Jr (CDM)', 'Frank Magri (ST)'], description: 'Toulouse FC. Compite en Ligue 1 McDonalds.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/toulouse_fc.png', division: 1 },

  // --- FRANCIA (LIGUE 2, SEGUNDA) ---
  // Fuente: https://www.espn.com.co/futbol/posiciones/_/liga/fra.2 (temporada 2026/27).
  // Ya estaban cargados Saint-Étienne, Nantes, Reims, Clermont y Montpellier; entran los 13 que
  // faltaban para completar los 18 de la categoría. AC Ajaccio queda como estaba: no figura en la
  // Ligue 2 2026/27 pero tampoco se toca sin fuente que diga a dónde fue.
  { id: 'fc_annecy', name: 'FC Annecy', league: 'Francesa', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 8400000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'FC Annecy. Compite en Ligue 2 BKT.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 2 },
  { id: 'us_boulogne', name: 'US Boulogne', league: 'Francesa', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 5200000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'US Boulogne. Compite en Ligue 2 BKT.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 2 },
  { id: 'dijon_fco', name: 'Dijon FCO', league: 'Francesa', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 9100000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Dijon FCO. Compite en Ligue 2 BKT.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 2 },
  { id: 'usl_dunkerque', name: 'USL Dunkerque', league: 'Francesa', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 10300000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'USL Dunkerque. Compite en Ligue 2 BKT.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 2 },
  { id: 'grenoble_foot', name: 'Grenoble Foot 38', league: 'Francesa', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 9800000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Grenoble Foot 38. Compite en Ligue 2 BKT.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 2 },
  { id: 'ea_guingamp', name: 'EA Guingamp', league: 'Francesa', dt: 'DT Genérico', reputation: 3, initialSalary: 1000, marketValue: 13500000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'EA Guingamp. Compite en Ligue 2 BKT.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 2 },
  { id: 'stade_lavallois', name: 'Stade Lavallois', league: 'Francesa', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 7600000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Stade Lavallois. Compite en Ligue 2 BKT.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 2 },
  { id: 'fc_metz', name: 'FC Metz', league: 'Francesa', dt: 'DT Genérico', reputation: 3, initialSalary: 1000, marketValue: 22400000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'FC Metz. Compite en Ligue 2 BKT.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 1 },
  { id: 'as_nancy', name: 'AS Nancy Lorraine', league: 'Francesa', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 6800000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'AS Nancy Lorraine. Compite en Ligue 2 BKT.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 2 },
  { id: 'pau_fc', name: 'Pau FC', league: 'Francesa', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 6100000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Pau FC. Compite en Ligue 2 BKT.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 2 },
  { id: 'red_star_fc', name: 'Red Star FC', league: 'Francesa', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 7200000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Red Star FC, de Saint-Ouen. Compite en Ligue 2 BKT.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 2 },
  { id: 'rodez_af', name: 'Rodez AF', league: 'Francesa', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 5900000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Rodez Aveyron Football. Compite en Ligue 2 BKT.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 2 },
  { id: 'fc_sochaux', name: 'FC Sochaux-Montbéliard', league: 'Francesa', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 6400000, starPlayers: ['Mathis Clairicia (ST)', 'Mehdi Jeannin (GK)', 'Alexandre Pierre (GK)', 'Louicius Deedson (RW)', 'Élie N\'Gatta (CB)', 'Benjamin Gomel (LW)', 'Arthur Vitelli (CB)', 'Julien Masson (CDM)', 'Kapit Djoco (ST)', 'Victor Lobry (CAM)', 'Samy Baghdadi (CAM)'], description: 'FC Sochaux-Montbéliard. Compite en Ligue 2 BKT.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 2 },
  // ==========================================
  // --- HOLANDA (PRIMERA) ---
  // ==========================================
  { id: 'ajax', themeColor: { primary: '#D2122E', secondary: '#FFFFFF' }, name: 'Ajax', league: 'Holandesa', dt: 'John Heitinga', reputation: 5, initialSalary: 66000, marketValue: 149525000, starPlayers: ['Youri Baas (CB)', 'Steven Berghuis (RW)', 'Oscar Gloukh (CAM)', 'Kasper Dolberg (ST)', 'Oleksandr Zinchenko (LB)', 'Davy Klaassen (CM)', 'Ko Itakura (CB)'], description: 'Ajax. Compite en Eredivisie.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/ajax.png', division: 1 },
  { id: 'almere_city_fc', name: 'Almere City FC', league: 'Holandesa', dt: 'Hedwiges Maduro', reputation: 4, initialSalary: 2000, marketValue: 10000000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Almere City FC. Compite en la Eerste Divisie.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/almere_city_fc.png', division: 2 },
  { id: 'az', name: 'AZ', league: 'Holandesa', dt: 'Maarten Martens', reputation: 4, initialSalary: 2000, marketValue: 91550000, starPlayers: ['Jordy Clasie (CDM)', 'Wouter Goes (CB)', 'Sven Mijnans (CAM)', 'Kees Smit (CAM)', 'Alexandre Penetra (CB)', 'Seiya Maikuma (RB)', 'Mexx Meerdink (ST)', 'Patati (RM)', 'Peer Koopmeiners (CDM)'], description: 'AZ. Compite en Eredivisie.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e0/AZ_Alkmaar.svg/250px-AZ_Alkmaar.svg.png', division: 1 },
  { id: 'fc_groningen', name: 'FC Groningen', league: 'Holandesa', dt: 'Dick Lukkien', reputation: 4, initialSalary: 2000, marketValue: 45125000, starPlayers: ['Etienne Vaessen (GK)', 'Thijmen Blokzijl (CB)', 'Marco Rente (RB)', 'Dies Janse (CB)', 'Thom van Bergen (ST)', 'Brynjólfur Willumsson (ST)', 'Tygo Land (CM)', 'Tika de Jonge (CM)'], description: 'FC Groningen. Compite en Eredivisie.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/fc_groningen.png', division: 1 },
  { id: 'fc_twente', name: 'FC Twente', league: 'Holandesa', dt: 'Joseph Oosting', reputation: 4, initialSalary: 2000, marketValue: 78585000, starPlayers: ['Lars Unnerstall (GK)', 'Bart van Rooij (RB)', 'Robin Pröpper (CB)', 'Daan Rots (RW)', 'Sondre Ørjasæter (LW)', 'Ricky van Wolfswinkel (ST)'], description: 'FC Twente. Compite en Eredivisie.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/fc_twente.png', division: 1 },
  { id: 'fc_utrecht', name: 'FC Utrecht', league: 'Holandesa', dt: 'Ron Jans', reputation: 4, initialSalary: 2000, marketValue: 92335000, starPlayers: ['Vasilios Barkas (GK)', 'Mike van der Hoorn (CB)', 'Yoann Cathline (LW)', 'Sébastien Haller (ST)', 'Dani de Wit (CAM)'], description: 'FC Utrecht. Compite en Eredivisie.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/fc_utrecht.png', division: 1 },
  { id: 'feyenoord', name: 'Feyenoord', league: 'Holandesa', dt: 'Robin van Persie', reputation: 4, initialSalary: 2000, marketValue: 203125000, starPlayers: ['Raheem Sterling (LW)', 'Tsuyoshi Watanabe (CB)', 'Luciano Valente (CM)', 'Sem Steijn (CAM)', 'Hwang In Beom (CM)', 'Anis Hadj-Moussa (RW)', 'Givairo Read (RB)', 'Oussama Targhalline (CM)'], description: 'Feyenoord. Compite en Eredivisie.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/feyenoord.png', division: 1 },
  { id: 'go_ahead_eagles', name: 'Go Ahead Eagles', league: 'Holandesa', dt: 'Mike Klein', reputation: 4, initialSalary: 2000, marketValue: 40800000, starPlayers: ['Melle Meulensteen (CDM)', 'Joris Kramer (CB)', 'Mathis Suray (LM)', 'Victor Edvardsen (ST)', 'Dean James (LB)', 'Alfons Sampsted (RB)', 'Gerrit Nauber (CB)', 'Evert Linthorst (CDM)'], description: 'Go Ahead Eagles. Compite en Eredivisie.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/go_ahead_eagles.png', division: 1 },
  { id: 'heracles_almelo', name: 'Heracles Almelo', league: 'Holandesa', dt: 'Bas Sibum', reputation: 4, initialSalary: 2000, marketValue: 38185000, starPlayers: ['Jeff Reine-Adélaïde (CAM)', 'Damon Mirani (CB)', 'Ajdin Hrustić (CM)', 'Walid Ould-Chikh (LM)', 'Luka Kulenović (ST)', 'Fabian de Keijzer (GK)', 'Jan Žambůrek (CDM)'], description: 'Heracles Almelo. Compite en la Eerste Divisie.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/heracles_almelo.png', division: 1 },
  { id: 'nac_breda', name: 'NAC Breda', league: 'Holandesa', dt: 'Jo Jansen', reputation: 4, initialSalary: 2000, marketValue: 33750000, starPlayers: ['André Ayew (ST)', 'Denis Odoi (CB)', 'Lewis Holtby (CM)', 'Leo Greiml (CB)', 'Kamal Sowah (LM)', 'Clint Leemans (CM)', 'Mohamed Nassoh (LM)'], description: 'NAC Breda. Compite en la Eerste Divisie.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'pec_zwolle', name: 'PEC Zwolle', league: 'Holandesa', dt: 'Mirjam Clifford', reputation: 4, initialSalary: 2000, marketValue: 39975000, starPlayers: ['Jasper Schendelaar (GK)', 'Younes Namli (RM)', 'Jamiro Monteiro (CAM)', 'Zico Buurmeester (CM)', 'Simon Graves (CB)', 'Koen Kostons (ST)', 'Ryan Thomas (CM)', 'Odysseus Velanas (LM)'], description: 'PEC Zwolle. Compite en Eredivisie.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/pec_zwolle.png', division: 1 },
  { id: 'psv', themeColor: { primary: '#ED1C24', secondary: '#FFFFFF' }, name: 'PSV', league: 'Holandesa', dt: 'Peter Bosz', reputation: 5, initialSalary: 30400, marketValue: 287900000, starPlayers: ['Ivan Perišić (LW)', 'Mauro Júnior (LB)', 'Jerdy Schouten (CB)', 'Sergiño Dest (RB)', 'Alassane Pléa (ST)', 'Dennis Man (RW)', 'Guus Til (CAM)', 'Ryan Flamingo (CB)'], description: 'PSV. Compite en Eredivisie.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'rkc_waalwijk', name: 'RKC Waalwijk', league: 'Holandesa', dt: 'Henk Fraser', reputation: 4, initialSalary: 2000, marketValue: 21025000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'RKC Waalwijk. Compite en la Eerste Divisie.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/rkc_waalwijk.png', division: 2 },
  ...
  { id: 'willem_ii', name: 'Willem II', league: 'Holandesa', dt: 'Peter Maes', reputation: 4, initialSalary: 2000, marketValue: 24675000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Willem II. Compite en Eredivisie.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/willem_ii.png', division: 2 },

  // --- HOLANDA (EERSTE DIVISIE, SEGUNDA) ---
  // Fuente: https://www.espn.com.co/futbol/posiciones/_/liga/ned.2 (temporada 2026/27).
  //
  // Las divisiones siguen a ESA temporada, no a la 2024/25 con la que se cargaron primero: entre
  // una y otra hubo intercambio y cuatro clubes cambiaron de lado. Bajaron Almere City, Heracles,
  // NAC Breda y RKC Waalwijk; subieron ADO Den Haag, Cambuur, Excelsior y Telstar (por eso esos
  // cuatro figuran ahora con division 1, más abajo en el bloque de Eredivisie).
  //
  // Faltan a propósito los cuatro filiales -- Jong Ajax, Jong PSV, Jong AZ y Jong FC Utrecht --:
  // por reglamento de la KNVB NO pueden ascender a la Eredivisie, así que meterlos dejaría a
  // `resolverMovimientos` subiendo a "Jong Ajax" a Primera, que es imposible.
  { id: 'fc_den_bosch', name: 'FC Den Bosch', league: 'Holandesa', dt: 'Box Bruins', reputation: 2, initialSalary: 900, marketValue: 4200000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'FC Den Bosch, de Bolduque. Compite en la Eerste Divisie.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 2 },
  // Los filiales que juegan la Eerste Divisie de verdad. Transfermarkt los escribe "Ajax U21",
  // "PSV U21"; en Holanda se los conoce como Jong (= joven). No son el primer equipo y el
  // importador de calendarios lo cuida explícitamente: un filial sólo puede cruzar con un filial,
  // porque emparejar por prefijo metía al Ajax y al PSV a jugar la Segunda además de la Eredivisie.
  //
  // Van sin plantel propio: son canteras, cambian de nombres cada temporada y lo que importa acá es
  // que la Eerste Divisie tenga sus 20 clubes y el descenso holandés pueda funcionar.
  // Juega la Eredivisie 2025/26 y no estaba en la base. Se agrega en vez de sustituirlo: sustituir
  // le habría dado su lugar a un club de la Eerste Divisie, que después faltaba abajo.
  { id: 'fortuna_sittard', name: 'Fortuna Sittard', league: 'Holandesa', dt: 'Danny Buijs', reputation: 2, initialSalary: 1200, marketValue: 12000000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Fortuna Sittard. Compite en la Eredivisie.', badgeColor: 'border-l-4 border-yellow-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 1 },
  { id: 'jong_ajax', name: 'Jong Ajax', league: 'Holandesa', dt: 'Cantera', reputation: 2, initialSalary: 700, marketValue: 4000000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Filial del Ajax. Compite en la Eerste Divisie.', badgeColor: 'border-l-4 border-red-600 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 2 },
  { id: 'jong_psv', name: 'Jong PSV', league: 'Holandesa', dt: 'Cantera', reputation: 2, initialSalary: 700, marketValue: 4000000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Filial del PSV. Compite en la Eerste Divisie.', badgeColor: 'border-l-4 border-red-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 2 },
  { id: 'jong_az', name: 'Jong AZ', league: 'Holandesa', dt: 'Cantera', reputation: 2, initialSalary: 650, marketValue: 3500000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Filial del AZ Alkmaar. Compite en la Eerste Divisie.', badgeColor: 'border-l-4 border-red-700 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 2 },
  { id: 'jong_utrecht', name: 'Jong FC Utrecht', league: 'Holandesa', dt: 'Cantera', reputation: 2, initialSalary: 650, marketValue: 3500000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Filial del FC Utrecht. Compite en la Eerste Divisie.', badgeColor: 'border-l-4 border-red-800 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 2 },
  { id: 'fc_dordrecht', name: 'FC Dordrecht', league: 'Holandesa', dt: 'Michele Santoni', reputation: 2, initialSalary: 900, marketValue: 5100000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'FC Dordrecht. Compite en la Eerste Divisie.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 2 },
  { id: 'fc_eindhoven', name: 'FC Eindhoven', league: 'Holandesa', dt: 'Rick Kruys', reputation: 2, initialSalary: 900, marketValue: 5800000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'FC Eindhoven. Compite en la Eerste Divisie.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 2 },
  { id: 'fc_emmen', name: 'FC Emmen', league: 'Holandesa', dt: 'Fred Grim', reputation: 3, initialSalary: 1200, marketValue: 8100000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'FC Emmen. Compite en la Eerste Divisie.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 2 },
  // Excelsior, ADO Den Haag, Cambuur y Telstar ascendieron: en 2026/27 juegan la Eredivisie.
  { id: 'excelsior_rotterdam', name: 'Excelsior Rotterdam', league: 'Holandesa', dt: 'Rick Kruys', reputation: 3, initialSalary: 1200, marketValue: 11400000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Excelsior, de Róterdam. Compite en la Eredivisie.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 1 },
  { id: 'ado_den_haag', name: 'ADO Den Haag', league: 'Holandesa', dt: 'Darije Kalezić', reputation: 3, initialSalary: 1200, marketValue: 9500000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'ADO Den Haag, de La Haya. Compite en la Eredivisie.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 2 },
  { id: 'sc_cambuur', name: 'SC Cambuur', league: 'Holandesa', dt: 'Henk de Jong', reputation: 3, initialSalary: 1200, marketValue: 8600000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'SC Cambuur, de Leeuwarden. Compite en la Eredivisie.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 2 },
  { id: 'de_graafschap', name: 'De Graafschap', league: 'Holandesa', dt: 'Jan Vreman', reputation: 3, initialSalary: 1200, marketValue: 7300000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'De Graafschap, de Doetinchem. Compite en la Eerste Divisie.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 2 },
  { id: 'helmond_sport', name: 'Helmond Sport', league: 'Holandesa', dt: 'Bob Peeters', reputation: 2, initialSalary: 900, marketValue: 3800000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Helmond Sport. Compite en la Eerste Divisie.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 2 },
  { id: 'mvv_maastricht', name: 'MVV Maastricht', league: 'Holandesa', dt: 'Maurice Verberne', reputation: 2, initialSalary: 900, marketValue: 4600000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'MVV Maastricht. Compite en la Eerste Divisie.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 2 },
  { id: 'roda_jc', name: 'Roda JC Kerkrade', league: 'Holandesa', dt: 'Bas Sibum', reputation: 3, initialSalary: 1200, marketValue: 7900000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Roda JC, de Kerkrade. Compite en la Eerste Divisie.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 2 },
  { id: 'sc_telstar', name: 'SC Telstar', league: 'Holandesa', dt: 'Mike Snoei', reputation: 2, initialSalary: 900, marketValue: 4400000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'SC Telstar, de Velsen. Compite en la Eredivisie.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 1 },
  { id: 'top_oss', name: 'TOP Oss', league: 'Holandesa', dt: 'Bob Peeters', reputation: 2, initialSalary: 900, marketValue: 3600000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'TOP Oss. Compite en la Eerste Divisie.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 2 },
  { id: 'sbv_vitesse', name: 'SBV Vitesse', league: 'Holandesa', dt: 'John van den Brom', reputation: 3, initialSalary: 1200, marketValue: 12800000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Vitesse, de Arnhem. Compite en la Eerste Divisie.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 2 },
  { id: 'vvv_venlo', name: 'VVV-Venlo', league: 'Holandesa', dt: 'Rick Kruys', reputation: 2, initialSalary: 900, marketValue: 5400000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'VVV-Venlo. Compite en la Eerste Divisie.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 2 },
  { id: 'fc_volendam', name: 'FC Volendam', league: 'Holandesa', dt: 'Regillio Simons', reputation: 3, initialSalary: 1200, marketValue: 13200000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'FC Volendam. Compite en la Eerste Divisie.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 1 },
  // ==========================================
  // --- PORTUGAL (PRIMERA) ---
  // ==========================================
  { id: 'avs_futebol_sad', name: 'AVS Futebol SAD', league: 'Portuguesa', dt: 'José Mota', reputation: 4, initialSalary: 2000, marketValue: 18450000, starPlayers: ['Rúben Semedo (CB)', 'Kiki (LB)', 'Algobia (CM)', 'Tomané (ST)', 'Simão Bertelli (GK)', 'Carlos Ponck (CB)', 'Aderllan Santos (CB)', 'Guillem Molina (RB)', 'Babatunde Akinsola (LM)', 'Óscar Perea (LM)'], description: 'Compite en Liga Portugal.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'https://pub-3bd35431294c47068cbf31a95d572166.r2.dev/logos/avs-futebol-sad/avs-futebol-sad-logo-footylogos.svg', division: 2 },
  ...
  { id: 'fc_porto', themeColor: { primary: '#00408B', secondary: '#004990' }, name: 'FC Porto', league: 'Portuguesa', dt: 'Francesco Farioli', reputation: 4, initialSalary: 51000, marketValue: 312325000, starPlayers: ['Diogo Costa (GK)', 'Alan Varela (CDM)', 'Jan Bednarek (CB)', 'Gabri Veiga (CAM)', 'Samu (ST)', 'Victor Froholdt (CM)', 'Pepê (CAM)', 'Borja Sainz (LW)', 'Pablo Rosario (CDM)'], description: 'Compite en Liga Portugal.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/fc_porto.png', division: 1 },
  { id: 'gil_vicente_fc', name: 'Gil Vicente FC', league: 'Portuguesa', dt: 'César Peixoto', reputation: 4, initialSalary: 2000, marketValue: 66025000, starPlayers: ['Ghislain Konan (LB)', 'Santi García (CM)', 'Luís Esteves (CM)', 'Héctor (ST)', 'Zé Carlos (RB)', 'Murilo (RM)', 'Daniel Figueira (GK)', 'Weverson (LB)', 'Buatu (CB)', 'Facundo Agustín Cáseres (CDM)'], description: 'Compite en Liga Portugal.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'sc_farense', name: 'SC Farense', league: 'Portuguesa', dt: 'José Mota', reputation: 4, initialSalary: 2000, marketValue: 17400000, starPlayers: ['Gabriel Barbosa (ST)', 'Joseph Nduquidi (CM)', 'Rafinha (CAM)', 'Miguel Menino (CM)', 'André Candeias (RW)', 'Sarpreet Singh (CAM)', 'Fabijan Buntic (GK)', 'Claudio Falcão (CDM)', 'Toni Herrero (LB)', 'Lucas D\'Agrella (RB)', 'Jakob Tånnander (GK)'], description: 'Compite en Liga Portugal.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/sc_farense.png', division: 2 },
  { id: 'sporting_cp', themeColor: { primary: '#00713C', secondary: '#FFFFFF' }, name: 'Sporting CP', league: 'Portuguesa', dt: 'Rui Borges', reputation: 5, initialSalary: 38100, marketValue: 468650000, starPlayers: ['Trincão (CAM)', 'Rui Silva (GK)', 'Gonçalo Inácio (CB)', 'Luis Javier Suárez (ST)', 'Maximiliano Araújo (LM)', 'Geny Catamo (RM)', 'Zeno Debast (CB)'], description: 'Compite en Liga Portugal.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  // --- PORTUGAL (LIGA PORTUGAL 2, SEGUNDA) ---
  // Fuente: https://www.transfermarkt.co/liga-portugal-2/startseite/wettbewerb/PO2 (2026/27).
  //
  // De los 18 de la categoría quedan afuera los tres filiales -- FC Porto B, SL Benfica B y
  // Sporting CP B --: igual que los Jong holandeses, por reglamento NO pueden ascender a Primera,
  // y cargarlos dejaría al motor subiendo "Benfica B" a la Liga Portugal. Van los 15 restantes.
  // Farense ya estaba cargado como club de Primera y en 2026/27 juega la Segunda: se corrige abajo.
  { id: 'uniao_torreense', name: 'SC União Torreense', league: 'Portuguesa', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 4200000, starPlayers: ['João Marques (LW)', 'Stopira (CB)', 'Adriel (GK)', 'Jonathan Mutombo (RB)', 'Lisandru Olmeta (GK)', 'Karem Zoabi (ST)', 'Javi Vázquez (LB)', 'Mohamed Ali Diadié (CB)', 'Dany Jean (LW)', 'Lucas Paes (GK)', 'Manu Pozo (RW)'], description: 'Compite en Liga Portugal 2.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 2 },
  { id: 'fc_vizela', name: 'FC Vizela', league: 'Portuguesa', dt: 'DT Genérico', reputation: 3, initialSalary: 1000, marketValue: 11500000, starPlayers: ['Neto (CM)', 'Matías Lacava (RW)', 'Abdul Awudu (RW)', 'Giovani Bamba (CDM)', 'Luis Miguel Mina (RB)', 'Alfred Caicedo (RB)', 'Yassin Fortuné (ST)', 'Heinz Mörschel (CAM)', 'Antonio Gomis (GK)', 'Miguel Pires (CM)', 'Bright Godwin (LB)'], description: 'Compite en Liga Portugal 2.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 2 },
  { id: 'cd_tondela', name: 'CD Tondela', league: 'Portuguesa', dt: 'DT Genérico', reputation: 3, initialSalary: 1000, marketValue: 9800000, starPlayers: ['Jordan Siebatcheu (ST)', 'Rony Lopes (RM)', 'Bebeto (RB)', 'Maranhão (RM)', 'João Afonso (CB)', 'João Talocha (LB)', 'Brayan Medina (CB)', 'Tiago Manso (RB)', 'Rémy Vita (LB)', 'João Silva (CB)', 'Christian Marques (CB)'], description: 'Compite en Liga Portugal 2.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 2 },
  { id: 'gd_chaves', name: 'GD Chaves', league: 'Portuguesa', dt: 'DT Genérico', reputation: 3, initialSalary: 1000, marketValue: 8900000, starPlayers: ['Rodrigo Moura (GK)', 'João Valido (GK)', 'Aílson Tavares (CDM)', 'GB (ST)', 'Bruno Rodrigues (CB)', 'Gilberto García (CDM)', 'Dru Yearwood (CM)', 'Léo Alaba (RB)', 'Tiago Simões (CB)', 'Ivo Vázquez (LB)', 'Kiko (LB)'], description: 'Compite en Liga Portugal 2.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 2 },
  { id: 'ud_leiria', name: 'UD Leiria', league: 'Portuguesa', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 5400000, starPlayers: ['Juan Muñoz (ST)', 'Maga (RB)', 'Zé Pedro (CB)', 'Marc Baró (LB)', 'Christian Joel (GK)', 'Borislav Rupanov (ST)', 'Jordan van der Gaag (RW)', 'Pablo Fernández (ST)', 'Jair Silva (RW)', 'Miguel Nóbrega (CB)', 'Ibrahima Guirassy (CDM)'], description: 'Compite en Liga Portugal 2.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 2 },
  { id: 'fc_felgueiras', name: 'FC Felgueiras 1932', league: 'Portuguesa', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 3600000, starPlayers: ['Henrique Martins (CDM)', 'Armando Lopes (LB)', 'Lucas Duarte (ST)', 'Mario Rivas (ST)', 'Dário (CB)', 'Michel Costa (CM)', 'João Pinto (CB)', 'Felipe Scheibig (GK)', 'Afonso Freitas (LB)', 'Francisco França (CDM)', 'Tiago Leite (ST)'], description: 'Compite en Liga Portugal 2.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 2 },
  { id: 'fc_penafiel', name: 'FC Penafiel', league: 'Portuguesa', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 4800000, starPlayers: ['Adrián Pica (CB)', 'Cláudio Silva (CB)', 'Joan Femenías (GK)', 'Iano Simão (LB)', 'Douglas Borel (RB)', 'Gonçalo Negrão (RB)', 'Àlex Carbonell (CM)', 'Alexéi Rojas (GK)', 'Juanda Fuentes (LW)', 'Max Svensson (ST)', 'Eric Puerto (GK)'], description: 'Compite en Liga Portugal 2.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 2 },
  { id: 'leixoes_sc', name: 'Leixões SC', league: 'Portuguesa', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 5100000, starPlayers: ['Alysson (CB)', 'Caio Secco (GK)', 'Claudio Araujo (CM)', 'Lourenço (CB)', 'Bica (ST)', 'Amadu Baldé (CM)', 'Serif Nhaga (LB)', 'Miguel Sousa (CM)', 'Matheus Costa (CB)', 'Luccas Paraizo (ST)', 'Semeu Commey (CB)'], description: 'Compite en Liga Portugal 2.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 2 },
  { id: 'lusitania_lourosa', name: 'Lusitânia FC Lourosa', league: 'Portuguesa', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 3200000, starPlayers: ['Fabinho (CM)', 'Vítor Hugo (GK)', 'Brian Araújo (GK)', 'Dylan Collard (CB)', 'Miguel Teixeira (CM)', 'Ricardinho (RB)', 'Bruno Faria (CB)', 'André Ricardo (CAM)', 'Guilherme Soares (CB)', 'Paulité (LW)', 'Danny (RB)'], description: 'Compite en Liga Portugal 2.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 2 },
  { id: 'cd_feirense', name: 'CD Feirense', league: 'Portuguesa', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 5600000, starPlayers: ['Isaac (CAM)', 'Pedrinho (LW)', 'Antonio Leal (CB)', 'Luiz Gustavo (RB)', 'Henrique Pereira (LW)', 'Francisco Meixedo (GK)', 'Jójó (RB)', 'Diego Altube (GK)', 'Desmond Nketia (ST)', 'Samad Popoola (CDM)', 'Gui Meira (CAM)'], description: 'Compite en Liga Portugal 2.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 2 },
  { id: 'portimonense', name: 'Portimonense SAD', league: 'Portuguesa', dt: 'DT Genérico', reputation: 3, initialSalary: 1000, marketValue: 10200000, starPlayers: ['Yanis da Rocha (CDM)', 'Edney (RB)', 'Jader Gentil (LW)', 'Marlon Júnior (CB)', 'Shoya Nakajima (CAM)', 'Mamede (RW)', 'Thauan Lara (LB)', 'Jarleysom (CB)', 'Welat Cagro (CM)', 'Dânio Djassi (LW)', 'Xavier (CDM)'], description: 'Compite en Liga Portugal 2.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 2 },
  { id: 'academica_coimbra', name: 'Académica Coimbra', league: 'Portuguesa', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 4400000, starPlayers: ['Xavi Grande (RB)', 'Pontus Texel (RB)', 'Martim Tavares (ST)', 'Victor Braga (GK)', 'Kauan (CB)', 'Ilies Faure (ST)', 'Amadou Coundoul (ST)', 'Hélder Lopes (LB)', 'Alioune Mané (LW)', 'Rui Gomes (LW)', 'Afonso Rodrigues (RW)'], description: 'Compite en Liga Portugal 2.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 2 },
  { id: 'amarante_fc', name: 'Amarante FC', league: 'Portuguesa', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 2800000, starPlayers: ['Diogo Fernandes (GK)', 'Tokinho Dória (CM)', 'Simão Silva (LW)', 'Alemão (RB)', 'Rúben Alves (CAM)', 'Nito (CDM)', 'Rodrigo Beirão (CB)', 'Luís Machado (LW)', 'Didi (GK)', 'Rodrigo Guedes (CDM)', 'Faissal Zangré (CAM)'], description: 'Compite en Liga Portugal 2.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', division: 2 },
  // ==========================================
  // --- ESTADOS UNIDOS (MLS) ---
  // ==========================================
  { id: 'atlanta_united', name: 'Atlanta United', league: 'Estadounidense', dt: 'DT Genérico', reputation: 4, initialSalary: 2000, marketValue: 38000000, starPlayers: ['Aleksey Miranchuk (CAM)', 'Miguel Ángel Almirón Rejala (RW)', 'Bartosz Slisz (CDM)'], description: 'Compite en MLS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/atlanta_united.png', division: 1 },
  { id: 'austin_fc', name: 'Austin FC', league: 'Estadounidense', dt: 'DT Genérico', reputation: 3, initialSalary: 2000, marketValue: 26000000, starPlayers: ['Facundo Torres (RM)', 'Myrto Uzuni (ST)', 'Mikkel Desler (RB)', 'Brandon Vazquez (ST)', 'Oleksandr Svatok (CB)', 'Ilie Sánchez (CM)', 'Brad Stuver (GK)', 'Joseph Rosales (LB)', 'Besard Sabovic (CM)'], description: 'Compite en MLS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/austin_fc.png', division: 1 },
  { id: 'cf_montreal', name: 'CF Montréal', league: 'Estadounidense', dt: 'DT Genérico', reputation: 2, initialSalary: 2000, marketValue: 18000000, starPlayers: ['Prince Owusu (ST)', 'Brayan Vera (CB)', 'Samuel Piette (CDM)', 'Tomás Avilés (CB)', 'Matty Longstaff (CM)', 'Jalen Neal (CB)', 'Wikelman Carmona (LM)', 'Kwadwo Opoku (ST)'], description: 'Compite en MLS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/cf_montreal.png', division: 1 },
  { id: 'charlotte_fc', name: 'Charlotte FC', league: 'Estadounidense', dt: 'DT Genérico', reputation: 3, initialSalary: 2000, marketValue: 27000000, starPlayers: ['Pep Biel (CAM)', 'Kristijan Kahlina (GK)', 'Ashley Westwood (CDM)', 'Liel Abada (RM)', 'Tim Ream (CB)', 'Luca de la Torre (CM)', 'Harry Toffolo (LB)', 'David Schnegg (LB)', 'Henry Kessler (CB)', 'Nathan Byrne (RB)'], description: 'Compite en MLS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/charlotte_fc.png', division: 1 },
  { id: 'chicago_fire', name: 'Chicago Fire', league: 'Estadounidense', dt: 'DT Genérico', reputation: 3, initialSalary: 2000, marketValue: 26000000, starPlayers: ['Robert Lewandowski (ST)', 'Jonathan Bamba (LM)', 'Hugo Jean-Marc Cuypers (ST)', 'Philip Aksel Frigast Zinckernagel (RW)'], description: 'Compite en MLS, reforzado con la llegada de Robert Lewandowski tras su salida del FC Barcelona.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/chicago_fire.png', division: 1 },
  { id: 'colorado_rapids', name: 'Colorado Rapids', league: 'Estadounidense', dt: 'DT Genérico', reputation: 2, initialSalary: 2000, marketValue: 21000000, starPlayers: ['Paxten Aaronson (CM)', 'Zack Steffen (GK)', 'Rob Holding (CB)', 'Reggie Cannon (RB)', 'Keegan Rosenberry (RB)', 'Hamzat Ojediran (CDM)'], description: 'Compite en MLS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/colorado_rapids.png', division: 1 },
  { id: 'columbus_crew', name: 'Columbus Crew', league: 'Estadounidense', dt: 'DT Genérico', reputation: 3, initialSalary: 2000, marketValue: 34000000, starPlayers: ['Steven Moreira (CB)', 'Nariman Akhundzada (RW)', 'Patrick Schulte (GK)', 'Andrés Herrera (RB)', 'Dylan Chambost (CM)', 'Mohamed Farsi (RM)'], description: 'Compite en MLS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/columbus_crew.png', division: 1 },
  { id: 'dc_united', name: 'DC United', league: 'Estadounidense', dt: 'DT Genérico', reputation: 2, initialSalary: 2000, marketValue: 20000000, starPlayers: ['Christian Benteke Liolo (ST)', 'Randall Enrique Leal Arley (RM)', 'Aarón Joseph Herrera (RB)', 'Kye Francis Rowles (CB)'], description: 'Compite en MLS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/dc_united.png', division: 1 },
  { id: 'fc_cincinnati', name: 'FC Cincinnati', league: 'Estadounidense', dt: 'DT Genérico', reputation: 3, initialSalary: 2000, marketValue: 33000000, starPlayers: ['Evander (CAM)', 'Kévin Denkey (ST)', 'Pavel Bucha (CM)', 'Miles Robinson (CB)', 'Bryan Ramírez (LM)', 'Obinna Nwobodo (CM)', 'Matt Miazga (CB)', 'Roman Celentano (GK)', 'Teenage Hadebe (CB)', 'Nick Hagglund (CB)', 'Ender Echenique (RM)'], description: 'Compite en MLS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/fc_cincinnati.png', division: 1 },
  { id: 'fc_dallas', name: 'FC Dallas', league: 'Estadounidense', dt: 'DT Genérico', reputation: 2, initialSalary: 2000, marketValue: 24000000, starPlayers: ['Petar Musa (ST)', 'Herman Johansson (RM)', 'Ramiro (CDM)', 'Shaq Moore (RB)', 'Osaze Urhoghide (CB)', 'Joaquín Valiente (CAM)', 'Anderson Julio (ST)', 'Sebastien Ibeagha (CB)', 'Kaick (CM)', 'Patrickson Delgado (CM)', 'Christian Cappis (CM)'], description: 'Compite en MLS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/fc_dallas.png', division: 1 },
  { id: 'houston_dynamo', name: 'Houston Dynamo', league: 'Estadounidense', dt: 'DT Genérico', reputation: 2, initialSalary: 2000, marketValue: 24000000, starPlayers: ['Agustín Bouzat (CDM)', 'Guilherme (LM)', 'Mateusz Bogusz (LW)', 'Diadié Samassékou (CDM)', 'Héctor Herrera (CM)', 'Antônio Carlos (CB)', 'Artur (CDM)', 'Lucas Halter (CB)'], description: 'Compite en MLS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/houston_dynamo.png', division: 1 },
  { id: 'inter_miami_cf', name: 'Inter Miami CF', league: 'Estadounidense', dt: 'DT Genérico', reputation: 4, initialSalary: 2000, marketValue: 48000000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Compite en MLS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/inter_miami_cf.png', division: 1 },
  { id: 'la_galaxy', name: 'LA Galaxy', league: 'Estadounidense', dt: 'DT Genérico', reputation: 3, initialSalary: 2000, marketValue: 35000000, starPlayers: ['Ricard Puig Martí (CM)', 'Marco Reus (CAM)', 'Joseph Martin Paintsil (LM)', 'Gabriel Fortes Chaves (RM)'], description: 'Compite en MLS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'https://pub-3bd35431294c47068cbf31a95d572166.r2.dev/logos/la-galaxy/la-galaxy-logo-footylogos.svg', division: 1 },
  { id: 'lafc', name: 'LAFC', league: 'Estadounidense', dt: 'DT Genérico', reputation: 4, initialSalary: 2000, marketValue: 40000000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Compite en MLS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', badgeImageUrl: 'https://upload.wikimedia.org/wikipedia/commons/8/86/Los_Angeles_Football_Club.svg', division: 1 },
  { id: 'minnesota_united', name: 'Minnesota United', league: 'Estadounidense', dt: 'DT Genérico', reputation: 2, initialSalary: 2000, marketValue: 24000000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Compite en MLS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/minnesota_united.png', division: 1 },
  { id: 'nashville_sc', name: 'Nashville SC', league: 'Estadounidense', dt: 'DT Genérico', reputation: 2, initialSalary: 2000, marketValue: 25000000, starPlayers: ['Hany Mukhtar (CAM)', 'Cristian Espinoza (RM)', 'Sam Surridge (ST)', 'Andy Nájar (RB)', 'Maxwell Woledzi (CB)', 'Bryan Acosta (CM)', 'Joe Willis (GK)', 'Daniel Lovitz (LB)', 'Alex Muyl (LM)', 'Jeison Palacios (CB)', 'Edvard Tagseth (CM)'], description: 'Compite en MLS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/nashville_sc.png', division: 1 },
  { id: 'new_england', name: 'New England', league: 'Estadounidense', dt: 'DT Genérico', reputation: 2, initialSalary: 2000, marketValue: 22000000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Compite en MLS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/new_england.png', division: 1 },
  { id: 'new_york_city_fc', name: 'New York City FC', league: 'Estadounidense', dt: 'DT Genérico', reputation: 3, initialSalary: 2000, marketValue: 30000000, starPlayers: ['Nicolás Fernández (RM)', 'Hannes Wolf (RM)', 'Maxi Moralez (CAM)', 'Alonso Martínez (ST)', 'Thiago (CB)', 'Keaton Parks (CDM)', 'Matt Freese (GK)', 'Aiden O\'Neill (CDM)', 'Raul Gustavo (CB)', 'Kai Trewin (CB)', 'Agustín Ojeda (LM)'], description: 'Compite en MLS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/new_york_city_fc.png', division: 1 },
  { id: 'ny_red_bulls', name: 'NY Red Bulls', league: 'Estadounidense', dt: 'DT Genérico', reputation: 3, initialSalary: 2000, marketValue: 27000000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Compite en MLS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeImageUrl: 'badges/clubs/ny_red_bulls.png', badgeLogoUrl: '⚽', division: 1 },
  { id: 'orlando_city', name: 'Orlando City', league: 'Estadounidense', dt: 'DT Genérico', reputation: 3, initialSalary: 2000, marketValue: 31000000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Compite en MLS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/orlando_city.png', division: 1 },
  { id: 'philadelphia', name: 'Philadelphia', league: 'Estadounidense', dt: 'DT Genérico', reputation: 3, initialSalary: 2000, marketValue: 30000000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Compite en MLS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/tm/philadelphia.png', division: 1 },
  { id: 'portland_timbers', name: 'Portland Timbers', league: 'Estadounidense', dt: 'DT Genérico', reputation: 3, initialSalary: 2000, marketValue: 28000000, starPlayers: ['David da Costa (CAM)', 'Kamal Miller (CB)', 'Antony (LM)', 'Brandon Bye (RB)', 'Diego Chará (CDM)', 'Joao Ortiz (CDM)', 'Kristoffer Velde (LM)', 'Cole Bassett (CAM)', 'Jímer Fory (LB)'], description: 'Compite en MLS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/portland_timbers.png', division: 1 },
  { id: 'real_salt_lake', name: 'Real Salt Lake', league: 'Estadounidense', dt: 'DT Genérico', reputation: 2, initialSalary: 2000, marketValue: 23000000, starPlayers: ['Juan Manuel Sanabria (LB)', 'Victor Olatunji (ST)', 'Morgan Guilavogui (LW)', 'Diego Luna (LM)', 'Stijn Spierings (CM)', 'Lukas Engel (LB)', 'DeAndre Yedlin (RB)', 'Emeka Eneli (CDM)', 'Juan Arias (CB)', 'Justen Glad (CB)'], description: 'Compite en MLS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'san_diego_fc', name: 'San Diego FC', league: 'Estadounidense', dt: 'DT Genérico', reputation: 2, initialSalary: 2000, marketValue: 20000000, starPlayers: ['Anders Dreyer (RW)', 'Hirving Lozano (LW)', 'Marcus Ingvartsen (ST)', 'Jeppe Tverskov (CM)', 'Amahl Pellegrino (LM)', 'Aníbal Godoy (CM)', 'Onni Valakari (CM)', 'Alex Mighten (LM)', 'Christopher McVey (CB)'], description: 'Compite en MLS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/san_diego_fc.png', division: 1 },
  { id: 'san_jose', name: 'San Jose', league: 'Estadounidense', dt: 'DT Genérico', reputation: 2, initialSalary: 2000, marketValue: 20000000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Compite en MLS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/tm/san_jose.png', division: 1 },
  { id: 'seattle_sounders', name: 'Seattle Sounders', league: 'Estadounidense', dt: 'DT Genérico', reputation: 3, initialSalary: 2000, marketValue: 30000000, starPlayers: ['Albert Rusnák (CAM)', 'Cristian Roldan (CDM)', 'Yeimar Gómez Andrade (CB)', 'Pedro De la Vega (RM)', 'Jordan Morris (ST)', 'Jackson Ragen (CB)', 'Nouhou Tolo (LB)', 'Jesús Ferreira (ST)', 'Alex Roldan (RB)', 'Stefan Frei (GK)', 'Kim Kee Hee (CB)'], description: 'Compite en MLS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/seattle_sounders.png', division: 1 },
  { id: 'sporting_kc', name: 'Sporting KC', league: 'Estadounidense', dt: 'DT Genérico', reputation: 2, initialSalary: 2000, marketValue: 22000000, starPlayers: ['Manu García (CAM)', 'Lasse Berg Johnsen (CM)', 'Magomed-Shapi Suleymanov (RM)', 'Jake Davis (RB)', 'John Pulskamp (GK)', 'Ethan Bartlow (CB)', 'Stefan Cleveland (GK)', 'Zorhan Bassong (LB)', 'Calvin Harris (RM)', 'Jansen Miller (CB)'], description: 'Compite en MLS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽', badgeImageUrl: 'https://upload.wikimedia.org/wikipedia/commons/0/09/Sporting_Kansas_City_logo.svg', division: 1 },
  { id: 'st_louis_city_sc', name: 'St. Louis CITY SC', league: 'Estadounidense', dt: 'DT Genérico', reputation: 2, initialSalary: 2000, marketValue: 24000000, starPlayers: ['Roman Bürki (GK)', 'Marcel Hartel (CAM)', 'Eduard Löwen (CM)', 'Conrad Wallem (RM)', 'Timo Baumgartl (CB)', 'Mamadou Mbacke (CB)', 'Cedric Teuchert (CAM)', 'Kyle Hiebert (CB)', 'Daniel Edelman (CDM)', 'Sergio Córdova (ST)', 'Fallou Fall (CB)'], description: 'Compite en MLS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/st_louis_city_sc.png', division: 1 },
  { id: 'toronto_fc', name: 'Toronto FC', league: 'Estadounidense', dt: 'DT Genérico', reputation: 3, initialSalary: 2000, marketValue: 28000000, starPlayers: ['Djordje Mihailovic (CAM)', 'Josh Sargent (ST)', 'Walker Zimmerman (CB)', 'Richie Laryea (RM)', 'Dániel Sallói (LW)', 'Jonathan Osorio (CM)', 'Matheus Pereira (LB)', 'Theo Corbeanu (RM)'], description: 'Compite en MLS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/toronto_fc.png', division: 1 },
  { id: 'vancouver_whitecaps', name: 'Vancouver Whitecaps', league: 'Estadounidense', dt: 'DT Genérico', reputation: 2, initialSalary: 2000, marketValue: 22000000, starPlayers: ['Thomas Müller (CAM)', 'Ryan Gauld (LW)', 'Brian White (ST)', 'Andrés Cubas (CDM)', 'Cheikh Sabaly (ST)', 'Yohei Takaoka (GK)', 'Kenji Cabrera (CAM)', 'Mathías Laborda (CB)', 'Tristan Blackmon (CB)', 'Emmanuel Sabbi (RW)'], description: 'Compite en MLS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/vancouver_whitecaps.png', division: 1 },
  // ==========================================
  // --- ESPAÑA (PRIMERA) ---
  // ==========================================
  { id: 'athletic_club_esp', themeColor: { primary: '#EE2523', secondary: '#FFFFFF' }, name: 'Athletic Club', league: 'Española', dt: 'Edin Terzic', reputation: 5, initialSalary: 36200, marketValue: 188300000, starPlayers: ['Fabrício Isidoro (CM)', 'Ronaldo Tavares (ST)', 'Polli (GK)', 'Philipe Sampaio (CB)', 'Zeca (RB)', 'Gustavinho (CAM)', 'Glauco (GK)', 'Léo Chú (LM)', 'Dixon Vera (LW)', 'Sidimar (CB)', 'Gian Franco Cabezas (CM)'], description: 'Compite en LALIGA EA SPORTS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/tm/athletic_club_esp.png', division: 1 },
  { id: 'atletico_de_madrid', themeColor: { primary: '#CB3524', secondary: '#272E61' }, name: 'Atlético de Madrid', league: 'Española', dt: 'Diego Simeone', reputation: 5, initialSalary: 145200, marketValue: 526700000, starPlayers: ['Jan Oblak (GK)', 'Julián Alvarez (ST)', 'Alejandro Grimaldo (LB)', 'Morten Hjulmand (CDM)', 'Pablo Barrios (CM)', 'Álex Baena (LM)', 'Alexander Sørloth (ST)', 'Ademola Lookman (ST)', 'José María Giménez (CB)', 'Giuliano (RM)'], description: 'Compite en LALIGA EA SPORTS, reforzado con Alejandro Grimaldo (Bayer Leverkusen) y Morten Hjulmand (Sporting CP).', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/atletico_de_madrid.png', division: 1 },
  { id: 'ca_osasuna', name: 'CA Osasuna', league: 'Española', dt: 'Luis Miguel Ramis', reputation: 4, initialSalary: 18000, marketValue: 119585000, starPlayers: ['Ante Budimir (ST)', 'Sergio Herrera (GK)', 'Flavien-Enzo Boyomo (CB)', 'Catena (CB)', 'Moncayola (CM)', 'Lucas Torró (CDM)', 'Rubén García (RM)', 'Valentin Rosier (RB)', 'Aimar Oroz (CAM)'], description: 'Compite en LALIGA EA SPORTS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'r_oviedo', name: 'R. Oviedo', league: 'Española', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Descendió a LALIGA HYPERMOTION para la temporada 2026-27.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/tm/r_oviedo.png', division: 1 },
  { id: 'rcd_espanyol', name: 'RCD Espanyol', league: 'Española', dt: 'Manolo González', reputation: 4, initialSalary: 2000, marketValue: 109550000, starPlayers: ['Marko Dmitrović (GK)', 'Edu Expósito (CAM)', 'Leandro Cabrera (CB)', 'Puado (LM)', 'Omar El Hilali (RB)', 'Pol Lozano (CDM)', 'Pere Milla (LM)', 'Calero (CB)', 'Urko González (CDM)', 'Tyrhys Dolan (RW)'], description: 'Compite en LALIGA EA SPORTS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/rcd_espanyol.png', division: 1 },
  { id: 'rcd_mallorca', name: 'RCD Mallorca', league: 'Española', dt: 'Luis García', reputation: 2, initialSalary: 800, marketValue: 84550000, starPlayers: ['Raíllo (CB)', 'Sergi Darder (CM)', 'Maffeo (RB)', 'Leo Román (GK)', 'Martin Valjent (CB)', 'Manu Morlanes (CDM)', 'Marash Kumbulla (CB)'], description: 'Descendió a LALIGA HYPERMOTION para la temporada 2026-27.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/rcd_mallorca.png', division: 1 },
  { id: 'rayo_vallecano', name: 'Rayo Vallecano', league: 'Española', dt: 'Beñat San José', reputation: 4, initialSalary: 2000, marketValue: 105050000, starPlayers: ['Álvaro García (LM)', 'Isi (CAM)', 'De Frutos (RM)', 'Augusto Batalla (GK)', 'Andrei Rațiu (RB)', 'Florian Lejeune (CB)', 'Pathé Ciss (CDM)', 'Óscar Valentín (CDM)', 'Unai López (CM)'], description: 'Compite en LALIGA EA SPORTS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'real_sociedad', name: 'Real Sociedad', league: 'Española', dt: 'Pellegrino Matarazzo', reputation: 4, initialSalary: 72500, marketValue: 287575000, starPlayers: ['Álex Remiro (GK)', 'Oyarzabal (ST)', 'Takefusa Kubo (RM)', 'Yangel Herrera (CM)', 'Sergio Gómez (LM)', 'Barrenetxea (LW)', 'Jon Mikel Aramburu (RB)', 'Carlos Soler (CM)', 'Zubeldia (CB)', 'Gorrotxa (CDM)'], description: 'Compite en LALIGA EA SPORTS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/real_sociedad.png', division: 1 },
  { id: 'sevilla_fc', themeColor: { primary: '#D71920', secondary: '#FFFFFF' }, name: 'Sevilla FC', league: 'Española', dt: 'Matías Almeyda', reputation: 4, initialSalary: 82600, marketValue: 192675000, starPlayers: ['Odysseas Vlachodimos (GK)', 'Azpilicueta (CB)', 'Ruben Vargas (LW)', 'Carmona (RB)', 'Chidera Ejuke (LW)', 'Nemanja Gudelj (CDM)', 'Kike Salas (CB)', 'Lucien Agoumé (CDM)'], description: 'Compite en LALIGA EA SPORTS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'albacete_bp', name: 'Albacete BP', league: 'Española', dt: 'Alberto González', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Compite en LALIGA HYPERMOTION.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/tm/albacete_bp.png', division: 2 },
  { id: 'burgos_cf', name: 'Burgos CF', league: 'Española', dt: 'Sergio Francisco', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Atienza (CDM)', 'Cantero (GK)', 'Curro Sánchez (CAM)', 'Sergio González (CB)', 'Mario González (ST)', 'Kévin Appin (CM)'], description: 'Compite en LALIGA HYPERMOTION.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/burgos_cf.png', division: 2 },
  { id: 'cd_castellon', name: 'CD Castellón', league: 'Española', dt: 'Pablo Hernández', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Cala (CAM)', 'Jérémy Mellot (RB)', 'Raúl Sánchez (LM)', 'Romain Matthys (GK)', 'Alberto Jiménez (CB)', 'Fabrizio Brignani (CB)', 'Ousmane Camara (ST)', 'Isra Suero (ST)', 'Amir Abedzadeh (GK)'], description: 'Compite en LALIGA HYPERMOTION.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/cd_castellon.png', division: 2 },
  { id: 'cd_leganes', name: 'CD Leganés', league: 'Española', dt: 'Rubén Albés', reputation: 2, initialSalary: 800, marketValue: 27760000, starPlayers: ['Juan Soriano (GK)', 'Dani Rodríguez (LM)', 'Amadou Diawara (CDM)', 'Lalo Aguilar (CB)', 'Juan Cruz (RW)', 'Rubén Peña (RB)', 'Franquesa (LB)', 'Duk (LW)', 'Jorge Sáenz (CB)', 'Melero (CM)'], description: 'Compite en LALIGA HYPERMOTION.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/cd_leganes.png', division: 2 },
  { id: 'cd_mirandes', name: 'CD Mirandés', league: 'Española', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Carlos Fernández (ST)', 'Igor Nikic (GK)', 'Juan Gutiérrez (CB)', 'Postigo (CB)', 'Pica (CB)', 'Martín Pascual (CB)', 'Mickaël Malsa (CDM)'], description: 'Compite en LALIGA HYPERMOTION.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/cd_mirandes.png', division: 2 },
  { id: 'cultural_leonesa', name: 'Cultural Leonesa', league: 'Española', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Edgar Badia (GK)', 'Nemanja Radoja (CDM)', 'Chacón (CAM)', 'Lucas Ribeiro (RM)', 'Rubén Sobrino (RM)', 'Iván Calero (RB)', 'Rodri Suárez (CB)', 'Tresaco (LM)'], description: 'Compite en LALIGA HYPERMOTION.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/cultural_leonesa.png', division: 2 },
  { id: 'cadiz_cf', name: 'Cádiz CF', league: 'Española', dt: 'Imanol Idiakez', reputation: 2, initialSalary: 800, marketValue: 34450000, starPlayers: ['Suso (RM)', 'Ontiveros (LM)', 'Iza Carcelén (RB)', 'Álex Fernández (CM)', 'David Gil (GK)', 'Iuri Tabatadze (RM)', 'Antoñito Cordero (LM)', 'Víctor Aznar (GK)'], description: 'Compite en LALIGA HYPERMOTION.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/cadiz_cf.png', division: 2 },
  { id: 'cordoba_cf', name: 'Córdoba CF', league: 'Española', dt: 'Iván Ania', reputation: 2, initialSalary: 800, marketValue: 4600000, starPlayers: ['Carracedo (RW)', 'Adri Fuentes (ST)', 'Isma Ruiz (CDM)', 'Albarrán (RB)', 'Xavi Sintes (CB)', 'Iker Álvarez (GK)', 'Franck Fomeyem (CB)', 'Vilarrasa (LB)'], description: 'Compite en LALIGA HYPERMOTION.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/cordoba_cf.png', division: 2 },
  { id: 'fc_andorra', name: 'FC Andorra', league: 'Española', dt: 'Carles Manso', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Edgar (CB)', 'Imanol (LB)', 'Kim Min Su (LW)', 'Nicolás Ratti (GK)', 'Lautaro (ST)', 'Manu Nieto (ST)', 'Olabarrieta (RW)', 'Jastin (LM)', 'Marc Cardona (ST)', 'Thomas Carrique (RB)'], description: 'Compite en LALIGA HYPERMOTION.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/fc_andorra.png', division: 2 },
  { id: 'granada_cf', name: 'Granada CF', league: 'Española', dt: 'Pacheta', reputation: 2, initialSalary: 800, marketValue: 39475000, starPlayers: ['Rubén Alcaraz (CM)', 'José Arnáiz (CAM)', 'Manu Lama (CB)', 'Baïla Diallo (LB)', 'Alemañ (CM)', 'Jorge Pascual (ST)'], description: 'Compite en LALIGA HYPERMOTION.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'malaga_cf', name: 'Málaga CF', league: 'Española', dt: 'DT Genérico', reputation: 4, initialSalary: 2000, marketValue: 8035000, starPlayers: ['Alfonso Herrero (GK)', 'Larrubia (RW)', 'Chupe (ST)', 'Joaquín (LW)', 'Adrián Niño (ST)', 'Izan Merino (CM)', 'Luismi (CDM)', 'Puga (RB)', 'Dani Lorenzo (CM)', 'Murillo (CB)', 'Einar Galilea (CB)'], description: 'Ascendió a LALIGA EA SPORTS para la temporada 2026-27 tras ganar la final del playoff a la UD Almería.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/malaga_cf.png', division: 2 },
  { id: 'r_racing_club', name: 'R. Racing Club', league: 'Española', dt: 'DT Genérico', reputation: 4, initialSalary: 2000, marketValue: 10000000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Ascendió a LALIGA EA SPORTS para la temporada 2026-27 como campeón de Segunda, tras 14 años fuera de Primera.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'https://upload.wikimedia.org/wikipedia/commons/5/56/Escudo_de_Racing_Club_%282014%29.svg', division: 2 },
  { id: 'r_sporting', name: 'R. Sporting', league: 'Española', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Compite en LALIGA HYPERMOTION.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeImageUrl: 'badges/clubs/r_sporting.png', badgeLogoUrl: '⚽', division: 2 },
  ...
  { id: 'rc_deportivo', name: 'RC Deportivo', league: 'Española', dt: 'DT Genérico', reputation: 4, initialSalary: 2000, marketValue: 10000000, starPlayers: ['Yeremay (LM)', 'Mario Soriano (CAM)', 'Álvaro Ferllo (GK)', 'Alti (RB)', 'Loureiro (CB)', 'Villares (CM)', 'Luismi Cruz (RM)', 'Ximo Navarro (RB)', 'Mella (RM)', 'Samuele Mulattieri (ST)'], description: 'Ascendió a LALIGA EA SPORTS para la temporada 2026-27, tras 8 años fuera de Primera.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/tm/rc_deportivo.png', division: 2 },
  { id: 'real_sociedad_b', name: 'Real Sociedad B', league: 'Española', dt: 'Jon Ansotegui', reputation: 2, initialSalary: 800, marketValue: 2500000, starPlayers: ['Luken Beitia (CB)', 'Fraga (GK)', 'Mariezkurrena (ST)', 'Dadie (RB)', 'Job Nguono Ochieng (LM)', 'Gorka Carrera (ST)', 'Kazunari Kita (CB)', 'Jon Balda (LB)', 'Dani Díaz (RM)', 'Rupérez (RB)'], description: 'Compite en LALIGA HYPERMOTION.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/tm/real_sociedad_b.png', division: 2 },
  { id: 'real_zaragoza', name: 'Real Zaragoza', league: 'Española', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 3450000, starPlayers: ['Insua (CB)', 'Keidi Bare (CDM)', 'Tachi (CB)', 'Sebas Moyano (LM)', 'Rober (RM)', 'Valery (LM)'], description: 'Compite en LALIGA HYPERMOTION.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/real_zaragoza.png', division: 2 },
  { id: 'sd_eibar', name: 'SD Eibar', league: 'Española', dt: 'Jokin Aranbarri', reputation: 2, initialSalary: 800, marketValue: 16350000, starPlayers: ['Juan Bernat (LB)', 'Nolaskoain (CDM)', 'Magunagoitia (GK)', 'Corpas (RM)', 'Sergio Álvarez (CDM)', 'Cubero (RB)', 'Arbilla (CB)', 'Jon Bautista (ST)', 'Javi Martón (ST)', 'Aleix Garrido (CM)'], description: 'Compite en LALIGA HYPERMOTION.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/sd_eibar.png', division: 2 },
  { id: 'sd_huesca', name: 'SD Huesca', league: 'Española', dt: 'DT Genérico', reputation: 2, initialSalary: 800, marketValue: 10900000, starPlayers: ['Dani Jiménez (GK)', 'Pulido (CB)', 'Óscar Sielva (CM)', 'Nacho Laquintana (RW)', 'Jaime Seoane (CM)', 'Joaquín (CB)', 'Jesús Alvarez (CDM)', 'Portillo (CAM)', 'Jordi Martín (LM)'], description: 'Compite en LALIGA HYPERMOTION.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/sd_huesca.png', division: 2 },
  { id: 'ud_almeria', name: 'UD Almería', league: 'Española', dt: 'García Pimienta', reputation: 2, initialSalary: 800, marketValue: 46100000, starPlayers: ['Arribas (CAM)', 'Embarba (LW)', 'Rodrigo Ely (CB)', 'Andrés Fernández (GK)', 'Álex Muñoz (LB)', 'Morci (LW)', 'Daijiro Chirino (RB)', 'Federico Bonini (CB)', 'Puigmal (RM)'], description: 'Compite en LALIGA HYPERMOTION.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'badges/clubs/ud_almeria.png', division: 2 },
  { id: 'ud_las_palmas', name: 'UD Las Palmas', league: 'Española', dt: 'Rubén de la Barrera', reputation: 2, initialSalary: 800, marketValue: 43350000, starPlayers: ['Sandro (RM)', 'Kirian (CM)', 'Dinko Horkaš (GK)', 'Manu Fuster (LM)', 'Enzo Loiodice (CM)', 'Taisei Miyashiro (LW)', 'Álex Suárez (CB)', 'Viti Rozada (RB)'], description: 'Compite en LALIGA HYPERMOTION.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'paok', name: 'PAOK Thessaloniki', league: 'Griega', dt: 'Alessio Lisci', reputation: 4, initialSalary: 2300, marketValue: 14000000, starPlayers: ['Christos Zafeiris', 'Andrija Zivkovic', 'Mady Camara', 'Kiril Despodov'], description: 'Clasificado a la Europa League 2025-26. Referente del norte de Grecia.', badgeColor: 'border-l-4 border-slate-300 bg-black text-white', badgeLogoUrl: '⚫⚪',
    badgeImageUrl: 'https://pub-3bd35431294c47068cbf31a95d572166.r2.dev/logos/paok/paok-logo-footylogos.svg', division: 1 },
  { id: 'panathinaikos', themeColor: { primary: '#22c55e', secondary: '#f5f0e8' }, name: 'Panathinaikos FC', league: 'Griega', dt: 'Jacob Neestrup', reputation: 4, initialSalary: 2400, marketValue: 15000000, starPlayers: ['Victor Kristiansen', 'Rick van Drongelen', 'Santino Andino', 'Pedro Chirivella'], description: 'Clasificado a la Europa League 2025-26. El trébol de Atenas.', badgeColor: 'border-l-4 border-green-500 bg-slate-900/40 text-green-100', badgeLogoUrl: '☘️💚',
  ...
  { id: 'bodo_glimt', themeColor: { primary: '#facc15', secondary: '#f5f0e8' }, name: 'FK Bodø/Glimt', league: 'Noruega', dt: 'Kjetil Knutsen', reputation: 3, initialSalary: 1700, marketValue: 10000000, starPlayers: ['Jens Petter Hauge', 'Fredrik Sjøvold', 'Patrick Berg', 'Håkon Evjen'], description: 'Clasificado a la Champions League 2025-26. La revelación noruega, fútbol vistoso desde el Ártico.', badgeColor: 'border-l-4 border-yellow-400 bg-black text-yellow-200', badgeLogoUrl: '💛⚫', badgeImageUrl: 'https://upload.wikimedia.org/wikipedia/en/8/8d/FK_Bodo_Glimt_logo.svg', division: 1 },
  { id: 'brann_sk', themeColor: { primary: '#ef4444', secondary: '#f5f0e8' }, name: 'SK Brann', league: 'Noruega', dt: 'Eirik Horneland', reputation: 2, initialSalary: 780, marketValue: 3400000, starPlayers: ['Fredrik Knudsen (CB)', 'Jacob Sørensen (CDM)', 'Mathias Dyngeland (GK)', 'Jón Dagur Þorsteinsson (LW)', 'Vetle Dragsnes (LB)', 'Joachim Soltvedt (LB)', 'Bård Finne (ST)', 'Niklas Castro (LW)', 'Sævar Atli Magnússon (RW)', 'Noah Jean Holm (ST)'], description: 'Clasificado a la Europa League 2025-26. Orgullo de Bergen.', badgeColor: 'border-l-4 border-red-500 bg-slate-900/40 text-red-100', badgeLogoUrl: '🔴⚪',
    badgeImageUrl: 'https://pub-3bd35431294c47068cbf31a95d572166.r2.dev/logos/sk-brann/sk-brann-logo-footylogos.svg', division: 1 },
  { id: 'fc_copenhagen', themeColor: { primary: '#ef4444', secondary: '#f5f0e8' }, name: 'FC København', league: 'Danesa', dt: 'Bo Svensson', reputation: 3, initialSalary: 1600, marketValue: 9200000, starPlayers: ['Mohamed Elyounoussi (RM)', 'Dominik Kotarski (GK)', 'Gabriel Pereira (CB)', 'Thomas Delaney (CDM)', 'Rodrigo Huescas (RB)', 'Amir Richardson (CM)', 'Marcos López (LB)', 'Mads Emil Madsen (CM)', 'Youssoufa Moukoko (ST)'], description: 'Clasificado a la Champions League 2025-26. El más grande de Dinamarca.', badgeColor: 'border-l-4 border-red-500 bg-white text-slate-900', badgeLogoUrl: '⚪🔴', division: 1 },
  { id: 'midtjylland', themeColor: { primary: '#dc2626', secondary: '#f5f0e8' }, name: 'FC Midtjylland', league: 'Danesa', dt: 'Mike Tullberg', reputation: 4, initialSalary: 2600, marketValue: 16500000, starPlayers: ['Philip Billing (CM)', 'Mads Bech Sørensen (CB)', 'Elías Rafn Ólafsson (GK)', 'Martin Erlić (CB)', 'Ousmane Diao (CB)', 'Lee Han Beom (CB)', 'Victor Bak (LB)', 'Mikael Uhre (ST)'], description: 'Clasificado a la Europa League 2025-26. Pionero del análisis de datos en el fútbol danés.', badgeColor: 'border-l-4 border-red-600 bg-black text-red-200', badgeLogoUrl: '🔴⚫',
  ...
  { id: 'pafos_fc', themeColor: { primary: '#0ea5e9', secondary: '#f5f0e8' }, name: 'Pafos FC', league: 'Chipriota', dt: 'Ricardo Sá Pinto', reputation: 2, initialSalary: 750, marketValue: 3200000, starPlayers: ['Lelê (ST)', 'Biel (LW)', 'Ivan Šunjić (CDM)', 'Ken Sema (LB)', 'Guga (CM)', 'Radoslaw Majecki (GK)', 'Nicolas Moumi Ngamaleu (LW)', 'Pêpê (CM)', 'Vlad Dragomir (CAM)', 'Yoram Zague (RB)', 'Afonso Patrão (ST)'], description: 'Clasificado a la Champions League 2025-26. Debut histórico del fútbol chipriota en la fase de liga.', badgeColor: 'border-l-4 border-sky-500 bg-slate-900/40 text-sky-100', badgeLogoUrl: '🔵⚪',
    badgeImageUrl: 'https://pub-3bd35431294c47068cbf31a95d572166.r2.dev/logos/pafos-fc/pafos-fc-logo-footylogos.svg', division: 1 },
  { id: 'kairat_almaty', themeColor: { primary: '#facc15', secondary: '#f5f0e8' }, name: 'Kairat Almaty', league: 'Kazaja', dt: 'Rafael Urazbakhtin', reputation: 2, initialSalary: 550, marketValue: 1800000, starPlayers: ['Marc Gual (ST)', 'Oiva Jukkola (LW)', 'Jorginho (ST)', 'Temirlan Anarbekov (GK)', 'Luís Mata (LB)', 'Aleksandr Mrynskiy (RB)', 'Jaakko Oksanen (CM)', 'Damir Kasabulat (CDM)', 'Gustavo Mendonça (CM)', 'Adilet Sadybekov (CDM)', 'Azamat Tuyakbaev (CAM)'], description: 'Clasificado a la Champions League 2025-26. Primer club kazajo en la fase de liga de la máxima competición europea.', badgeColor: 'border-l-4 border-yellow-400 bg-black text-yellow-200', badgeLogoUrl: '💛⚫',
  ...
  { id: 'celtic_fc', themeColor: { primary: '#16a34a', secondary: '#f5f0e8' }, name: 'Celtic FC', league: 'Escocesa', dt: "Martin O'Neill", reputation: 4, initialSalary: 3000, marketValue: 20000000, starPlayers: ['Cameron Carter-Vickers', 'Kieran Tierney', 'Alistair Johnston'], description: 'Clasificado a la Europa League 2025-26. Los Hoops verdiblancos de Glasgow.', badgeColor: 'border-l-4 border-green-600 bg-white text-green-800', badgeLogoUrl: '💚⚪',
    badgeImageUrl: 'badges/clubs/celtic_fc.png', division: 1 },
  { id: 'young_boys', themeColor: { primary: '#facc15', secondary: '#f5f0e8' }, name: 'BSC Young Boys', league: 'Suiza', dt: 'Gerardo Seoane', reputation: 3, initialSalary: 1450, marketValue: 8200000, starPlayers: ['Edimilson Fernandes (CDM)', 'Christian Fassnacht (RM)', 'Alvyn Sanches (CAM)', 'Marvin Keller (GK)', 'Gregory Wüthrich (CB)', 'Joël Almada Monteiro (LM)', 'Samuel Essende (ST)', 'Armin Gigović (CDM)', 'Rayan Raveloson (CM)', 'Darian Males (RM)'], description: 'Clasificado a la Europa League 2025-26. El más laureado de Suiza en la última década.', badgeColor: 'border-l-4 border-yellow-400 bg-black text-yellow-200', badgeLogoUrl: '💛⚫',
  ...
  { id: 'ludogorets', themeColor: { primary: '#f97316', secondary: '#f5f0e8' }, name: 'PFC Ludogorets 1945', league: 'Búlgara', dt: 'Thomas Reis', reputation: 3, initialSalary: 1150, marketValue: 6000000, starPlayers: ['Nathan Fernandes (RW)', 'Hossam Abdelmaguid (CB)', 'Deroy Duarte (CM)', 'Rwan Cruz (ST)', 'Petar Stanic (CAM)', 'Erick Marcus (RW)', 'Caio Vidal (LW)', 'Edvin Kurtulus (CB)', 'Bernard Tekpetey (RW)', 'Kwadwo Duah (ST)', 'Aguibou Camara (CAM)'], description: 'Clasificado a la Europa League 2025-26. Amo absoluto de la liga búlgara.', badgeColor: 'border-l-4 border-orange-500 bg-black text-orange-200', badgeLogoUrl: '🟠⚫',
    badgeImageUrl: 'badges/tm/ludogorets.png', division: 1 },
  { id: 'malmo_ff', themeColor: { primary: '#0ea5e9', secondary: '#f5f0e8' }, name: 'Malmö FF', league: 'Sueca', dt: 'Gaute Helstrup', reputation: 2, initialSalary: 820, marketValue: 3800000, starPlayers: ['Pontus Jansson (CB)', 'Busanello (LB)', 'Robin Olsen (GK)', 'Otto Rosengren (CM)', 'Sead Hakšabanović (LM)', 'Anders Christiansen (CAM)', 'Jens Stryger Larsen (RB)', 'Johan Dahlin (GK)', 'Erik Botheim (ST)', 'Arnór Sigurðsson (LM)'], description: 'Clasificado a la Europa League 2025-26. El más grande de Suecia.', badgeColor: 'border-l-4 border-sky-500 bg-white text-sky-700', badgeLogoUrl: '🔵⚪',
    badgeImageUrl: 'https://pub-3bd35431294c47068cbf31a95d572166.r2.dev/logos/malmo-ff/malmo-ff-logo-footylogos.svg', division: 1 },
  { id: 'fcsb', themeColor: { primary: '#dc2626', secondary: '#f5f0e8' }, name: 'FCSB', league: 'Rumana', dt: 'Marius Baciu', reputation: 2, initialSalary: 720, marketValue: 3000000, starPlayers: ['Florin Tănase (CAM)', 'Juri Cisotti (CM)', 'Ștefan Târnovanu (GK)', 'Siyabonga Ngezana (CB)', 'Risto Radunović (LB)', 'Joyskim Dawa (CB)', 'André Duarte (CB)', 'David Miculescu (RW)'], description: 'Clasificado a la Europa League 2025-26. El histórico club de Bucarest.', badgeColor: 'border-l-4 border-red-600 bg-blue-950 text-red-200', badgeLogoUrl: '🔴🔵',
    badgeImageUrl: 'https://pub-3bd35431294c47068cbf31a95d572166.r2.dev/logos/fcsb/fcsb-logo-footylogos.svg', division: 1 },
  { id: 'maccabi_tel_aviv', themeColor: { primary: '#facc15', secondary: '#f5f0e8' }, name: 'Maccabi Tel Aviv FC', league: 'Israelí', dt: 'Kenny Miller', reputation: 2, initialSalary: 850, marketValue: 4000000, starPlayers: ['Hélio Varela (LW)', 'Tyrese Asante (CB)', 'Issouf Sissokho (CDM)', 'Dor Peretz (CAM)', 'Ido Shahar (CM)', 'Osher Davida (RW)', 'Mohamed Camara (CB)', 'Kristijan Belic (CDM)', 'Kervin Andrade (CAM)', 'Ofek Melika (GK)', 'Noam Ben Harush (RB)'], description: 'Clasificado a la Europa League 2025-26. El más laureado de Israel en Europa.', badgeColor: 'border-l-4 border-yellow-400 bg-blue-900 text-yellow-200', badgeLogoUrl: '💛🔵',
 ...
 */
export function getClubWithRoster(clubName: string, clubId?: string): any {
  // 1. Buscamos el club base dentro de tu CLUBS_DATABASE actual.
  //    Por id cuando se conoce: buscar solo por nombre devuelve SIEMPRE el primero de la lista, y
  //    con 7 nombres repetidos entre países (Everton chileno/inglés, Liverpool uruguayo/inglés...)
  //    el segundo club era inalcanzable y heredaba la plantilla del primero.
  const baseClub = (CLUBS_DATABASE as any[]).find(
    club => (clubId && club.id === clubId)
      || (!clubId && club.name && club.name.toLowerCase() === clubName.toLowerCase())
  );
