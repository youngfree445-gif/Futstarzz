...
// ==========================================
  ...
  { id: 'tigre', name: 'Tigre', league: 'Argentina', dt: 'Guido Pizarro', reputation: 3, initialSalary: 1300, marketValue: 6200000, starPlayers: ['Gonzalo Martínez (CAM)', 'Jalil Elías (CDM)', 'Joaquín Laso (CB)', 'Bruno Leyes (CDM)', 'Jabes Saralegui (RM)', 'Joaquín Mosqueira (CDM)', 'Felipe Zenobio (GK)', 'David Romero (ST)', 'Nahuel Banegas (LB)', 'Elías Cabrera (LM)', 'Sebastián Medina (LM)'], description: 'El Matador de Victoria.', badgeColor: 'border-l-4 border-red-600 bg-blue-800 text-white', badgeLogoUrl: '🐯',
  ...
  { id: 'athletic_club', name: 'Athletic Club', league: 'Brasileña', dt: 'Edin Terzic', reputation: 2, initialSalary: 900, marketValue: 3000000, starPlayers: ['Jefferson', 'Danilo Cardoso', 'Yuri', 'Jonathas'], description: 'Compite en Brasileirao B.', badgeColor: 'border-l-4 border-white bg-black text-white', badgeLogoUrl: '⚫',
  ...
  { id: 'everton', name: 'Everton', league: 'Chilena', dt: 'David Moyes', reputation: 3, initialSalary: 1200, marketValue: 5000000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Primera División de Chile.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'liverpool_uru', name: 'Liverpool', league: 'Uruguaya', dt: 'Andoni Iraola', reputation: 2, initialSalary: 1100, marketValue: 4000000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Campeonato Uruguayo.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'https://pub-3bd35431294c47068cbf31a95d572166.r2.dev/logos/nacional/nacional-logo-footylogos.svg', division: 1 },
