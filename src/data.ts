...
// ==========================================
  ...
  { id: 'borussia_monchengladbach', name: 'Borussia Mönchengladbach', league: 'Alemana', dt: 'Eugen Polanski', reputation: 4, initialSalary: 2000, marketValue: 15000000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Borussia Mönchengladbach. Compite en Bundesliga.', badgeColor: 'border-l-4 border-zinc-300 bg-zinc-950/40 text-zinc-200', badgeLogoUrl: '⚫⚪',
  ...
  { id: 'fc_bayern_munchen', name: 'FC Bayern München', league: 'Alemana', dt: 'Vincent Kompany', reputation: 5, initialSalary: 2000, marketValue: 10000000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'FC Bayern München. Compite en Bundesliga.', badgeColor: 'border-l-4 border-red-600 bg-red-950/40 text-red-200', badgeLogoUrl: '🔴⚪',
  ...
  { id: 'vfb_stuttgart', name: 'VfB Stuttgart', league: 'Alemana', dt: 'Sebastian Hoenss', reputation: 4, initialSalary: 2000, marketValue: 15000000, starPlayers: ['Maximilian Mittelstädt (LB)', 'Angelo Stiller (CDM)', 'Deniz Undav (ST)', 'Alexander Nübel (GK)', 'Julian Chabot (CB)', 'Ermedin Demirović (ST)', 'Jamie Leweling (RM)', 'Bilal El Khannouss (CAM)', 'Atakan Karazor (CDM)', 'Chris Führich (LM)', 'Tiago Tomás (LM)'], description: 'VfB Stuttgart. Compite en Bundesliga.', badgeColor: 'border-l-4 border-red-600 bg-slate-900/40 text-red-200', badgeLogoUrl: '🔴⚪',
  ...
  { id: 'brighton_hove_albion', name: 'Brighton & Hove Albion', league: 'Inglesa', dt: 'Fabian Hürzeler', reputation: 4, initialSalary: 2000, marketValue: 15000000, starPlayers: ['Kaoru Mitoma (LM)', 'Bart Verbruggen (GK)', 'Jan Paul van Hecke (CB)', 'Carlos Baleba (CDM)', 'Yankuba Minteh (RM)', 'Ferdi Kadıoğlu (LB)', 'Danny Welbeck (ST)', 'Yasin Ayari (CDM)', 'Maxim De Cuyper (LB)', 'Mats Wieffer (CDM)', 'Pascal Groß (CDM)'], description: 'Brighton & Hove Albion. Compite en Premier League.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  // --- ITALIA (PRIMERA) ---
  // ==========================================
  { id: 'atalanta', name: 'Atalanta', league: 'Italiana', dt: 'Maurizio Sarri', reputation: 5, initialSalary: 2000, marketValue: 10000000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Atalanta. Compite en Serie A Enilive.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'inter', name: 'Inter', league: 'Italiana', dt: 'Cristian Chivu', reputation: 5, initialSalary: 2000, marketValue: 10000000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Inter. Compite en Serie A Enilive.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'https://assets.football-logos.cc/logos/italy/1500x1500/inter.d4ebfb95.png', division: 1 },
  { id: 'juventus', name: 'Juventus', league: 'Italiana', dt: 'Luciano Spalletti', reputation: 5, initialSalary: 2000, marketValue: 10000000, starPlayers: ['Bremer (CB)', 'Manuel Locatelli (CDM)', 'Loïs Openda (ST)', 'Khéphren Thuram (CM)', 'Kenan Yıldız (CAM)', 'Jonathan David (ST)', 'Michele Di Gregorio (GK)', 'Dušan Vlahović (ST)', 'Pierre Kalulu (CB)', 'Andrea Cambiaso (LB)', 'Teun Koopmeiners (CAM)'], description: 'Juventus. Compite en Serie A Enilive.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'milan', name: 'Milan', league: 'Italiana', dt: 'Rúben Amorim', reputation: 4, initialSalary: 2000, marketValue: 15000000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Milan. Compite en Serie A Enilive.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
 ...
 // ==========================================
  ...
  { id: 'as_monaco', name: 'AS Monaco', league: 'Francesa', dt: 'Filipe Luís', reputation: 5, initialSalary: 2000, marketValue: 10000000, starPlayers: ['Denis Zakaria (CDM)', 'Lukáš Hrádecký (GK)', 'Maghnes Akliouche (CAM)', 'Lamine Camara (CM)', 'Alexandr Golovin (CAM)', 'Folarin Balogun (ST)', 'Thilo Kehrer (CB)', 'Paul Pogba (CM)', 'Eric Dier (CB)', 'Takumi Minamino (LM)', 'Vanderson (RB)'], description: 'AS Monaco. Compite en Ligue 1 McDonalds.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'lens', name: 'Lens', league: 'Francesa', dt: 'Dino Toppmöller', reputation: 4, initialSalary: 2000, marketValue: 10000000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Lens. Compite en Ligue 1 McDonalds.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'https://tmssl.akamaized.net/scapps/cpn/img/wappen/normal/826.png', division: 1 },
  { id: 'lille_osc', name: 'Lille OSC', league: 'Francesa', dt: 'Davide Ancelotti', reputation: 4, initialSalary: 2000, marketValue: 15000000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Lille OSC. Compite en Ligue 1 McDonalds.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'olympique_de_marseille', name: 'Olympique de Marseille', league: 'Francesa', dt: 'Bruno Genesio', reputation: 5, initialSalary: 2000, marketValue: 10000000, starPlayers: ['Mason Greenwood (RM)', 'Gerónimo Rulli (GK)', 'Benjamin Pavard (CB)', 'Pierre-Emile Højbjerg (CDM)', 'Pierre-Emerick Aubameyang (ST)', 'Nayef Aguerd (CB)', 'Leonardo Balerdi (CB)', 'Igor Paixão (LM)', 'Quinten Timber (CM)', 'Facundo Medina (CB)', 'Amine Gouiri (ST)'], description: 'Olympique de Marseille. Compite en Ligue 1 McDonalds.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'https://upload.wikimedia.org/wikipedia/commons/4/4f/Olympique_de_Marseille_2026_logo.svg', division: 1 },
  { id: 'paris_saint_germain', name: 'Paris Saint-Germain', league: 'Francesa', dt: 'Luis Enrique', reputation: 5, initialSalary: 2000, marketValue: 10000000, starPlayers: ['Vitinha (CM)', 'Ousmane Dembélé (ST)', 'Achraf Hakimi (RB)', 'Nuno Mendes (LB)', 'Marquinhos (CB)', 'Willian Pacho (CB)', 'João Neves (CM)', 'Khvicha Kvaratskhelia (LW)', 'Fabián Ruiz (CM)', 'Désiré Doué (RW)', 'Bradley Barcola (LW)'], description: 'Paris Saint-Germain. Compite en Ligue 1 McDonalds.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  // --- HOLANDA (PRIMERA) ---
  // ==========================================
  { id: 'ajax', name: 'Ajax', league: 'Holandesa', dt: 'DT Genérico', reputation: 5, initialSalary: 2000, marketValue: 10000000, starPlayers: ['Josip Šutalo (CB)', 'Youri Baas (CB)', 'Takehiro Tomiyasu (RB)', 'Steven Berghuis (RW)', 'Wout Weghorst (ST)', 'Mika Godts (LW)', 'Oscar Gloukh (CAM)', 'Kasper Dolberg (ST)', 'Oleksandr Zinchenko (LB)', 'Davy Klaassen (CM)', 'Ko Itakura (CB)'], description: 'Ajax. Compite en Eredivisie.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'feyenoord', name: 'Feyenoord', league: 'Holandesa', dt: 'DT Genérico', reputation: 4, initialSalary: 2000, marketValue: 15000000, starPlayers: ['Ayase Ueda (ST)', 'Raheem Sterling (LW)', 'Tsuyoshi Watanabe (CB)', 'Luciano Valente (CM)', 'Sem Steijn (CAM)', 'Timon Wellenreuther (GK)', 'Hwang In Beom (CM)', 'Anis Hadj-Moussa (RW)', 'Givairo Read (RB)', 'Anel Ahmedhodžić (CB)', 'Oussama Targhalline (CM)'], description: 'Feyenoord. Compite en Eredivisie.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'psv', name: 'PSV', league: 'Holandesa', dt: 'DT Genérico', reputation: 5, initialSalary: 2000, marketValue: 10000000, starPlayers: ['Joey Veerman (CM)', 'Ivan Perišić (LW)', 'Mauro Júnior (LB)', 'Ismael Saibari (CAM)', 'Jerdy Schouten (CB)', 'Sergiño Dest (RB)', 'Alassane Pléa (ST)', 'Dennis Man (RW)', 'Guus Til (CAM)', 'Matěj Kovář (GK)', 'Ryan Flamingo (CB)'], description: 'PSV. Compite en Eredivisie.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'sl_benfica', name: 'SL Benfica', league: 'Portuguesa', dt: 'DT Genérico', reputation: 5, initialSalary: 2000, marketValue: 10000000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Compite en Liga Portugal.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'sc_braga', name: 'SC Braga', league: 'Portuguesa', dt: 'DT Genérico', reputation: 4, initialSalary: 2000, marketValue: 15000000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Compite en Liga Portugal.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'sporting_cp', name: 'Sporting CP', league: 'Portuguesa', dt: 'DT Genérico', reputation: 5, initialSalary: 2000, marketValue: 10000000, starPlayers: ['Morten Hjulmand (CDM)', 'Pedro Gonçalves (LM)', 'Trincão (CAM)', 'Rui Silva (GK)', 'Gonçalo Inácio (CB)', 'Ousmane Diomande (CB)', 'Luis Javier Suárez (ST)', 'Maximiliano Araújo (LM)', 'Hidemasa Morita (CM)', 'Geny Catamo (RM)', 'Zeno Debast (CB)'], description: 'Compite en Liga Portugal.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'fc_barcelona', name: 'FC Barcelona', league: 'Española', dt: 'Hansi Flick', reputation: 5, initialSalary: 2000, marketValue: 10000000, starPlayers: ['Pedri (CM)', 'Lamine Yamal (RW)', 'Raphinha (LW)', 'Frenkie de Jong (CM)', 'Joan García (GK)', 'Jules Koundé (RB)', 'Robert Lewandowski (ST)', 'João Cancelo (RB)', 'Ferran Torres (ST)', 'Dani Olmo (CAM)', 'Eric García (CB)'], description: 'Compite en LALIGA EA SPORTS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'real_betis', name: 'Real Betis', league: 'Española', dt: 'Manuel Pellegrini', reputation: 4, initialSalary: 2000, marketValue: 15000000, starPlayers: ['Jugador 1', 'Jugador 2'], description: 'Compite en LALIGA EA SPORTS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
    badgeImageUrl: 'https://assets.football-logos.cc/logos/spain/1500x1500/real-betis.18a05d13.png', division: 1 },
  { id: 'real_madrid', name: 'Real Madrid', league: 'Española', dt: 'José Mourinho', reputation: 5, initialSalary: 2000, marketValue: 10000000, starPlayers: ['Kylian Mbappé (ST)', 'Thibaut Courtois (GK)', 'Jude Bellingham (CAM)', 'Vini Jr. (LW)', 'Federico Valverde (CM)', 'Trent Alexander-Arnold (RB)', 'Antonio Rüdiger (CB)', 'Aurélien Tchouaméni (CDM)', 'Carvajal (RB)', 'Éder Militão (CB)', 'Rodrygo (LM)'], description: 'Compite en LALIGA EA SPORTS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'real_sociedad', name: 'Real Sociedad', league: 'Española', dt: 'Pellegrino Matarazzo', reputation: 4, initialSalary: 2000, marketValue: 15000000, starPlayers: ['Álex Remiro (GK)', 'Oyarzabal (ST)', 'Takefusa Kubo (RM)', 'Yangel Herrera (CM)', 'Sergio Gómez (LM)', 'Brais Méndez (CM)', 'Barrenetxea (LW)', 'Jon Mikel Aramburu (RB)', 'Carlos Soler (CM)', 'Zubeldia (CB)', 'Gorrotxa (CDM)'], description: 'Compite en LALIGA EA SPORTS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
  ...
  { id: 'villarreal_cf', name: 'Villarreal CF', league: 'Española', dt: 'DT Genérico', reputation: 5, initialSalary: 2000, marketValue: 10000000, starPlayers: ['Nicolas Pépé (RM)', 'Moleiro (LM)', 'Gerard Moreno (ST)', 'Ayoze (ST)', 'Pape Gueye (CM)', 'Parejo (CM)', 'Georges Mikautadze (ST)', 'Thomas Partey (CDM)', 'Sergi Cardona (LB)', 'Juan Foyth (CB)', 'Luiz Júnior (GK)'], description: 'Compite en LALIGA EA SPORTS.', badgeColor: 'border-l-4 border-slate-500 bg-slate-900 text-white', badgeLogoUrl: '⚽',
